...
version 1 {
    // enums ..... 17 (0x11)
    // structs ... 16 (0x10)
    // bit size .. 25248 (0x62a0)
    // byte size . 3156 (0xc54)
    // archive ... hash_4febc83688c2a283
    ...
    struct ValidationData {
        // offset: 0x0, bitSize: 0x5, array:0x5(hti:0x9)
    ...
    // bitSize: 0x15e8, members: 3
    struct SharedProgression {
        // offset: 0x0, bitSize: 0x15e0(0x2bc Byte(s)), array:0x46(hti:0xc)
        WeaponLevel weaponLevel[LoadoutWeapon];
        // offset: 0x15e0, bitSize: 0x5, array:0x5(hti:0x10)
        bool classicWeapons[ClassicWeapon];
    };
    ...
    struct RoundStats {
        ...
        byte awardCount;
        // offset: 0x118, bitSize: 0x60(0xc Byte(s)), array:0x3(hti:0xffff)
        int weaponXpEarned[3];
        ...
        short killStreak;
        // offset: 0x330, bitSize: 0x190(0x32 Byte(s)), array:0xa(hti:0xffff)
        AwardInfo awards[10];
        ...
        short assists;
        // offset: 0x598, bitSize: 0x20(0x4 Byte(s))
        int challengeXp;
        ...
        short captures;
        // offset: 0x5e8, bitSize: 0x1
        bool win;
        // offset: 0x5e9, bitSize: 0x1
        bool loss;
        // offset: 0x5ea, bitSize: 0x14, array:0x14(hti:0xffff)
    ...
    // bitSize: 0x61e8, members: 57
    struct CommonData {
        // offset: 0x0, bitSize: 0x20(0x4 Byte(s))
        int extraCustomClassesEntitlement;
        // offset: 0x20, bitSize: 0x600(0xc0 Byte(s))
        RoundStats round;
        ...
        // offset: 0x648, bitSize: 0x20(0x4 Byte(s))
        int eliteClanLevel;
        // offset: 0x668, bitSize: 0x8(0x1 Byte(s))
        byte previousProgressUpsellPopupRank;
        // offset: 0x670, bitSize: 0x28(0x5 Byte(s))
        string(5) clanTag;
        // offset: 0x698, bitSize: 0x190(0x32 Byte(s))
        PetWatchData petWatchData;
        // offset: 0x828, bitSize: 0x8(0x1 Byte(s))
        byte isbad_preview;
        // offset: 0x830, bitSize: 0x15e8(0x2bd Byte(s))
        SharedProgression sharedProgression;
        // offset: 0x1e18, bitSize: 0x20(0x4 Byte(s))
        int firstPlayedSPTime;
        // offset: 0x1e38, bitSize: 0x10(0x2 Byte(s))
        short common_scenario_flags;
        // offset: 0x1e48, bitSize: 0x20(0x4 Byte(s))
        uint CODAccountRestrictedTimestamp;
        // offset: 0x1e68, bitSize: 0x20(0x4 Byte(s))
        string(4) loggingCohort;
        // offset: 0x1e88, bitSize: 0x80(0x10 Byte(s)), array:0x4(hti:0xffff)
        int quartermasterEventIDs[4];
        // offset: 0x1f08, bitSize: 0x20(0x4 Byte(s))
        int common_entitlement_xp;
        // offset: 0x1f28, bitSize: 0x8(0x1 Byte(s))
        byte useEliteClanTag;
        // offset: 0x1f30, bitSize: 0x8(0x1 Byte(s))
        byte clanTagType;
        // offset: 0x1f38, bitSize: 0x120(0x24 Byte(s)), array:0x9(hti:0xffff)
        uint favoriteColors[9];
        // offset: 0x2058, bitSize: 0x8(0x1 Byte(s))
        byte mp_announcer_type;
        // offset: 0x2060, bitSize: 0x20(0x4 Byte(s))
        int sp_upsell_open_timestamp_0;
        // offset: 0x2080, bitSize: 0x20(0x4 Byte(s))
        int sp_upsell_open_timestamp_1;
        // offset: 0x20a0, bitSize: 0xc0(0x18 Byte(s)), array:0xc(hti:0xffff)
        short common_read_news_articles[12];
        // offset: 0x2160, bitSize: 0x20(0x4 Byte(s))
        int numConsumables;
        // offset: 0x2180, bitSize: 0x20(0x4 Byte(s))
        int lastPlayedTime;
        // offset: 0x21a0, bitSize: 0x20(0x4 Byte(s))
        int common_clan_wars_xp;
        // offset: 0x21c0, bitSize: 0x8(0x1 Byte(s))
        byte common_mounted_dlc_bits;
        // offset: 0x21c8, bitSize: 0x30(0x6 Byte(s))
        MPProgression mpProgression;
        // offset: 0x21f8, bitSize: 0x1040(0x208 Byte(s)), array:0x1a(hti:0xffff)
        FilteredPlaylist filteredPlaylists[26];
        // offset: 0x3238, bitSize: 0x8(0x1 Byte(s))
        byte season_pass_upsell_count;
        // offset: 0x3240, bitSize: 0x400(0x80 Byte(s)), array:0x20(hti:0xffff)
        int consumablesUsed[32];
        // offset: 0x3640, bitSize: 0x1700(0x2e0 Byte(s)), array:0xb8(hti:0x1)
        int awards[Awards];
        // offset: 0x4d40, bitSize: 0x80(0x10 Byte(s)), array:0x10(hti:0xffff)
        byte lastMatchGUID[16];
        // offset: 0x4dc0, bitSize: 0x20(0x4 Byte(s))
        int extraCustomClassesPrestige;
        // offset: 0x4de0, bitSize: 0x190(0x32 Byte(s))
        PetWatchData petWatchDataTurboAlt;
        // offset: 0x4f70, bitSize: 0x28(0x5 Byte(s))
        string(5) eliteClanTag;
        // offset: 0x4f98, bitSize: 0x98(0x13 Byte(s))
        PastTitleData pastTitleData;
        // offset: 0x5030, bitSize: 0x190(0x32 Byte(s))
        PetWatchData petWatchDataBlack;
        // offset: 0x51c0, bitSize: 0x190(0x32 Byte(s))
        PetWatchData petWatchDataTurbo;
        // offset: 0x5350, bitSize: 0x8(0x1 Byte(s))
        byte sp_upsell_action_0;
        // offset: 0x5358, bitSize: 0x8(0x1 Byte(s))
        byte sp_upsell_action_1;
        // offset: 0x5360, bitSize: 0x800(0x100 Byte(s)), array:0x40(hti:0xffff)
        int lastLootDrops[64];
        // offset: 0x5b60, bitSize: 0x200(0x40 Byte(s))
        PetWatchGoData petWatchGoData;
        // offset: 0x5d60, bitSize: 0x400(0x80 Byte(s)), array:0x80(hti:0xffff)
        byte reserved[128];
        // offset: 0x6160, bitSize: 0x20(0x4 Byte(s))
        int lastLootDropIndex;
        // offset: 0x6180, bitSize: 0x20(0x4 Byte(s))
        uint favoriteColorsCount;
        // offset: 0x61a0, bitSize: 0x1
        bool shouldCheckCohortSampling;
        // offset: 0x61a1, bitSize: 0x1
        bool quartermasterSale;
        // offset: 0x61a2, bitSize: 0x1
        bool newCrateRewards;
        // offset: 0x61a3, bitSize: 0x1
        bool shouldLogCohortData;
        // offset: 0x61a4, bitSize: 0x1
        bool gender;
        // offset: 0x61a5, bitSize: 0x1
        bool isPrivatePartyOpen;
        // offset: 0x61a6, bitSize: 0x1
        bool CODAccountSignupRequest;
        // offset: 0x61a7, bitSize: 0x40(0x8 Byte(s)), array:0x40(hti:0xffff)
        bool spCompletion[64];
    };
    ...
    // root: bitSize: 0x61f0, members: 2

    // offset: 0x0, bitSize: 0x61e8(0xc3d Byte(s))
    CommonData commonData;
    // offset: 0x61e8, bitSize: 0x8(0x1 Byte(s))
