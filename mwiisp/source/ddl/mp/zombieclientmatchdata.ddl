// file .... ddl\mp\zombieclientmatchdata.ddl

version 1 {
    // enums ..... 9 (0x9)
    // structs ... 6 (0x6)
    // bit size .. 43080 (0xa848)
    // byte size . 5385 (0x1509)
    // archive ... hash_3fb4efce48d4d814
    ...
    struct Death {
        ...
        byte player;
        // offset: 0x18, bitSize: 0x10(0x2 Byte(s)), array:0x2(hti:0xffff)
        byte attackerPos[2];
    };

    // bitSize: 0x14d0, members: 18
    struct Player {
        // offset: 0x0, bitSize: 0x10(0x2 Byte(s))
        short rank;
        ...
        // offset: 0x88, bitSize: 0x8c0(0x118 Byte(s)), array:0x46(hti:0x4)
        uint killsPerWeapon[LoadoutWeapon];
        // offset: 0x948, bitSize: 0x20(0x4 Byte(s))
        int xuidHigh;
        // offset: 0x968, bitSize: 0x20(0x4 Byte(s))
        int xuidLow;
        ...
        short prestige;
        // offset: 0x9b8, bitSize: 0x20(0x4 Byte(s))
        uint DeadliestWeaponKills;
        // offset: 0x9d8, bitSize: 0x170(0x2e Byte(s))
        string(46) username;
        // offset: 0xb48, bitSize: 0x8c0(0x118 Byte(s)), array:0x46(hti:0x4)
        int headShots[LoadoutWeapon];
        // offset: 0x1408, bitSize: 0xc8(0x19 Byte(s)), array:0x5(hti:0xffff)
        cards_used cardsUsed[5];
    };

    // idx 0x0 members: 0x18 type: 0
    enum questPiece {
        quest_piece_1, // 0x0
        quest_piece_2, // 0x1
        quest_piece_3, // 0x2
    ...
    // root: bitSize: 0xa838, members: 14
    ...
    int team_score;
    // offset: 0x180, bitSize: 0xa680(0x14d0 Byte(s)), array:0x8(hti:0xffff)
    Player player[8];
    // offset: 0xa800, bitSize: 0x8(0x1 Byte(s))
    byte totalNumOfQuestPieces;
    // offset: 0xa808, bitSize: 0x10(0x2 Byte(s))
    short deathCount;
    // offset: 0xa818, bitSize: 0x18(0x3 Byte(s)), array:0x18(hti:0x0)
    bool questPieces[questPiece];
    // offset: 0xa830, bitSize: 0x4, array:0x4(hti:0x8)
    bool playOutroVideo[map_pack];
    // offset: 0xa834, bitSize: 0x1
    bool isPublicMatch;
};
