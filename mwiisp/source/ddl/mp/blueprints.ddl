...
version 1 {
    // enums ..... 6 (0x6)
    // structs ... 4 (0x4)
    // bit size .. 288576 (0x46740)
    // byte size . 36072 (0x8ce8)
    // archive ... hash_6db3a585040ac664
    ...
    // bitSize: 0x1018, members: 1
    struct BlueprintWeaponEntry {
        // offset: 0x0, bitSize: 0x1018(0x203 Byte(s)), array:0x5(hti:0xffff)
    ...
    // root: bitSize: 0x46690, members: 1

    // offset: 0x0, bitSize: 0x46690(0x8cd2 Byte(s)), array:0x46(hti:0x2)
    BlueprintWeaponEntry blueprints[LoadoutWeapon];
};
