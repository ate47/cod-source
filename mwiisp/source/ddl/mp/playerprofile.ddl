...
version 1 {
    ...
    struct CustomizationSet {
        // offset: 0x0, bitSize: 0x30(0x6 Byte(s)), array:0x3(hti:0xffff)
        short customization_mp_public[3];
        // offset: 0x30, bitSize: 0x30(0x6 Byte(s)), array:0x3(hti:0xffff)
        short customization_mp_private[3];
        // offset: 0x60, bitSize: 0x20(0x4 Byte(s)), array:0x2(hti:0xffff)
        short execution[2];
    };
    ...
    // bitSize: 0x130, members: 5
    struct WeaponCustomizationSet {
        // offset: 0x0, bitSize: 0x8(0x1 Byte(s))
        Camouflage weaponCamo;
        // offset: 0x8, bitSize: 0x10(0x2 Byte(s))
        CosmeticAttachment cosmeticAttachment;
        // offset: 0x18, bitSize: 0x50(0xa Byte(s)), array:0x5(hti:0xffff)
        Sticker sticker[5];
        // offset: 0x68, bitSize: 0xa8(0x15 Byte(s)), array:0x7(hti:0xffff)
    ...
    struct ClanEmblemData {
        // offset: 0x0, bitSize: 0x10(0x2 Byte(s))
        short backgroundShapeId;
        // offset: 0x10, bitSize: 0x10(0x2 Byte(s))
        short foregroundColorId;
        // offset: 0x20, bitSize: 0x10(0x2 Byte(s))
        short foregroundShapeId;
        // offset: 0x30, bitSize: 0x10(0x2 Byte(s))
        short backgroundColorId;
    };

    // bitSize: 0x108, members: 17
    ...
    // root: bitSize: 0xcc0, members: 24

    // offset: 0x0, bitSize: 0x100(0x20 Byte(s))
    string(32) name;
    // offset: 0x100, bitSize: 0x8(0x1 Byte(s))
    byte team;
    // offset: 0x108, bitSize: 0x3a8(0x75 Byte(s))
    ProfileShowcaseCustomization showcaseCustomization;
    // offset: 0x4b0, bitSize: 0x40(0x8 Byte(s))
    uint64 ucdID;
    // offset: 0x4f0, bitSize: 0x20(0x4 Byte(s)), array:0x2(hti:0xffff)
    short customization_background[2];
    // offset: 0x510, bitSize: 0x108(0x21 Byte(s))
    LeaguePlayProfile leaguePlayProfile;
    // offset: 0x618, bitSize: 0x10(0x2 Byte(s))
    short rank_mp;
    // offset: 0x628, bitSize: 0x260(0x4c Byte(s)), array:0x2(hti:0xffff)
    ...
    // offset: 0x8c0, bitSize: 0x28(0x5 Byte(s))
    string(5) clanAbbrev;
    // offset: 0x8e8, bitSize: 0x8(0x1 Byte(s))
    byte prestige_alien;
    // offset: 0x8f0, bitSize: 0x8(0x1 Byte(s))
    byte prestige_mp;
    // offset: 0x8f8, bitSize: 0x20(0x4 Byte(s)), array:0x2(hti:0xffff)
    short customization_patch[2];
    // offset: 0x918, bitSize: 0x260(0x4c Byte(s)), array:0x2(hti:0xffff)
    WeaponCustomizationSet weaponCustomizationPublic[2];
    // offset: 0xb78, bitSize: 0x20(0x4 Byte(s)), array:0x2(hti:0xffff)
    short customization_playercard_frame[2];
    // offset: 0xb98, bitSize: 0x20(0x4 Byte(s)), array:0x2(hti:0xffff)
    short customization_playercard_title[2];
    // offset: 0xbb8, bitSize: 0x100(0x20 Byte(s)), array:0x2(hti:0xffff)
    CustomizationSet customizationSets[2];
    // offset: 0xcb8, bitSize: 0x1
    bool selectedOperatorIndexPrivate;
    // offset: 0xcb9, bitSize: 0x1
    bool myParty;
    // offset: 0xcba, bitSize: 0x1
    bool selectedOperatorIndexPublic;
    // offset: 0xcbb, bitSize: 0x1
