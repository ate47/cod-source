...
function function_4212369d()
{
    if ( is_true( getgametypesetting( #"hash_12e554c594614ee4" ) ) )
    {
        ...
        {
            vehicles[ vehicles.size ] = #"vehicle_t9_mil_ru_heli_gunship_hind";
        }
        
        if ( is_true( getgametypesetting( #"hash_21ac269b4a3e7e37" ) ) )
        {
            vehicles[ vehicles.size ] = #"vehicle_t9_mil_ru_tank_t72";
            vehicles[ vehicles.size ] = #"vehicle_t9_mil_ru_tank_t72";
        }
    ...
    if ( is_true( getgametypesetting( #"hash_7eb0bbf9b8410462" ) ) )
    {
        switch ( level.basegametype )
        {
            case #"fireteam_dirty_bomb":
                level thread namespace_3d2704b3::function_7fc18ad5( #"t9_dirty_bomb_stash_drop_parent", 2147483647, 80, 90, 180 );
                break;
            case #"fireteam_koth":
                level thread namespace_3d2704b3::function_7fc18ad5( #"t9_koth_stash_drop_parent", 2147483647, 80, 90, 180 );
                break;
            case #"fireteam_elimination":
                level thread namespace_3d2704b3::function_7fc18ad5( #"t9_elimination_stash_drop_parent", 2147483647, 38, 90, 180 );
                break;
            case #"fireteam_satlink":
                level thread namespace_3d2704b3::function_7fc18ad5( #"t9_satlink_stash_drop_parent", 2147483647, 80, 90, 180 );
                break;
        }
    }
}
