...
{
    instance.var_c8c31c6e = instance.contentgroups[ #"aether_mass_1" ][ 0 ];
    instance.var_32686fb7 = instance.contentgroups[ #"aether_mass_2" ][ 0 ];
    instance.var_c88cb786 = instance.contentgroups[ #"spawnpt_1" ];
    instance.var_b64812fd = instance.contentgroups[ #"spawnpt_2" ];
    instance.var_c30ec716 = instance.contentgroups[ #"horde_1" ];
    instance.var_f9d4b491 = instance.contentgroups[ #"horde_2" ];
...
function function_692bb7f7( instance, activator )
{
    if ( isplayer( activator ) )
    {
        ...
        instance.var_6720064d = function_5ce9975c( level.star_rating );
...
function function_fbaf0bd( a_s_pts )
{
    ...
    n_delay = get_spawn_delay( level.star_rating );
...
function function_e97e2683()
{
    ...
    switch ( n_players )
    {
        case 1:
            n_spawns = 4;
            n_spawns = min( 7, level.star_rating + n_spawns );
            break;
        case 2:
            n_spawns = 5;
            n_spawns = min( 9, level.star_rating + n_spawns );
            break;
        case 3:
            n_spawns = 7;
            n_spawns = min( 11, level.star_rating + n_spawns );
            break;
        case 4:
            n_spawns = 9;
            n_spawns = min( 14, level.star_rating + n_spawns );
            break;
        default:
            n_spawns = 16;
            break;
