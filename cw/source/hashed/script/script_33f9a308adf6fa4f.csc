...
function private function_f2a2832d( *player, msg )
{
    switch ( msg )
    {
        ...
        case #"hash_48b5a2ae2037fea":
            waitframe( 1 );
            level notify( #"flg_audio_srv_heli" );
            break;
        case #"outro_movie":
...
{
    level waittill( #"flg_audio_srv_land_bf" );
...
{
    level waittill( #"flg_audio_srv_heli" );
...
{
    level waittill( #"audio_outro_server_lift" );
    var_20608972 = snd::play( "cin_9010_out_heli_outro_server_02" );
    level waittill( #"audio_outro_server_lift_stop" );
