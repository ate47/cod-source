...
function function_7633f53d()
{
    ...
    level.adler waittill( #"spawn_prompt" );
...
function function_e9812a44( a_ents, str_shot )
{
    ...
    level.var_4c282d2a = function_e1e726bd( a_ents[ #"train_door_01" ], "train_car_01_door_02_r", "train_car_01_door_02_l" );
}
...
function function_6c744934( a_ents )
{
    ...
    player = getplayers()[ 0 ];
    level.var_77e3cd5f linkto( a_ents[ #"jprop" ], "j_prop_1", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
function function_63886603( a_ents, str_shot )
{
    ...
    if ( isdefined( a_ents[ #"train_door_01" ] ) )
    {
        level.var_4c282d2a = function_e1e726bd( a_ents[ #"train_door_01" ], "train_car_01_door_02_r", "train_car_01_door_02_l" );
    }
    
    if ( isdefined( a_ents[ #"train_door_02" ] ) && str_shot !== "lazar_close_behind" )
    {
        level.var_e0b9564e = function_e1e726bd( a_ents[ #"train_door_02" ], "train_car_02_door_01_l", "train_car_02_door_01_r" );
    }
}
...
function cin_stakeout_train_jumpout( a_ents, str_shot )
{
    ...
    {
        level.var_eefbf2d3 = function_e1e726bd( a_ents[ #"train_door_03" ], "train_car_02_door_02_r", "train_car_02_door_02_l" );
...
function private function_6d1d0dc8()
{
    ...
    level waittill( #"player_reset_fov" );
...
function function_adb5d442( a_ents )
{
    ...
    if ( isdefined( a_ents[ #"umbrella01" ] ) )
    {
        level.var_82bdfa96 = util::spawn_model( "par_umbrella_closed_01_85" );
        level.var_82bdfa96 linkto( a_ents[ #"umbrella01" ], "j_prop_1", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    }
...
{
    if ( isdefined( a_ents[ #"lady01" ] ) )
    {
        a_ents[ #"lady01" ] setmodel( #"hash_2d23880c67fba2af" );
        a_ents[ #"lady01" ].script_objective = "train";
    }
    
    if ( isdefined( a_ents[ #"lady02" ] ) )
    {
        a_ents[ #"lady02" ] setmodel( #"hash_2d23890c67fba462" );
        a_ents[ #"lady02" ].script_objective = "train";
    }
    
    if ( isdefined( a_ents[ #"lady03" ] ) )
    {
        a_ents[ #"lady03" ] setmodel( #"hash_2d238a0c67fba615" );
        a_ents[ #"lady03" ].script_objective = "train";
    }
    ...
    if ( isdefined( a_ents[ #"guy05" ] ) )
    {
        a_ents[ #"guy05" ] setmodel( #"hash_d8bd6d6d2845f34" );
        a_ents[ #"guy05" ].script_objective = "train";
    }
    
    if ( isdefined( a_ents[ #"guy06" ] ) )
    {
        a_ents[ #"guy06" ] setmodel( #"hash_d8bd9d6d284644d" );
        a_ents[ #"guy06" ].script_objective = "train";
    }
    ...
    if ( isdefined( a_ents[ #"guy08" ] ) )
    {
        level.var_662b1b35 = a_ents[ #"guy08" ];
        a_ents[ #"guy08" ] setmodel( #"hash_d8bcbd6d2844c83" );
        a_ents[ #"guy08" ].script_objective = "train";
    }
    ...
    if ( isdefined( a_ents[ #"guy10" ] ) )
    {
        a_ents[ #"guy10" ] setmodel( #"hash_d884dd6d2814092" );
        a_ents[ #"guy10" ].script_objective = "train";
    }
}
