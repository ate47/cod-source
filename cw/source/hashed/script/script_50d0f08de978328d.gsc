...
function give_capture_credit( touchlist, string, capturetime, capture_team, lastcaptureteam )
{
    ...
    foreach ( touch in touchlist )
    {
        ...
        if ( !is_score_boosting( player ) )
        {
            ...
            level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:player, #eventtype:#"capture" } );
            player recordgameevent( "hardpoint_captured" );
            level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:player, #eventtype:#"hardpoint_captured" } );
...
function function_32b7bf67()
{
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #eventtype:#"capture" } );
    resume_time();
...
function function_e4bd126f()
{
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #eventtype:#"hardpoint_contested" } );
    resume_time();
...
function function_2a6caaff( lastclaimteam )
{
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #eventtype:#"hardpoint_uncontested" } );
}
...
function function_4a415293( time )
{
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #eventtype:#"hardpoint_moved" } );
            ...
            else
            {
                if ( !medalgiven )
                {
                    if ( var_1cfdf798 )
                    {
                        ...
                        level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:attacker, #eventtype:#"defending" } );
                    }
