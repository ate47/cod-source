...
function function_98d37226()
{
    ...
    level waittill( #"sniper_shot_mb_2" );
...
function function_74774e71()
{
    ...
    level waittill( #"flg_lazar_respond" );
...
function function_146a9996()
{
    ...
    level waittill( #"sniper_shot_mb_1" );
...
{
    level.player endon( #"death" );
    level endoncallback( &function_8604d848, #"remove_encounter_trig" );
    var_1623c030 = getent( "vip_guards_flank_encounter_trigger", "targetname" );
