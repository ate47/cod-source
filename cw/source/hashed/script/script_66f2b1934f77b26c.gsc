...
function init()
{
    init_clientfields();
    init_quests();
    level thread scene::init( #"p9_zm_gold_man_wall_safe_bundle" );
}
...
function function_1dcf5339( *var_a276c861 )
{
    ...
    level scene::init( #"p9_fxanim_zm_gold_bunny_bundle" );
...
function function_efc48562()
{
    ...
    level scene::play( #"p9_fxanim_zm_gold_bunny_bundle", "turn" );
}
...
function function_664460fb( e_player )
{
    ...
    level scene::play( #"p9_fxanim_zm_gold_bunny_bundle", "float" );
    ...
    scene::add_scene_func( #"p9_fxanim_zm_gold_bunny_bundle", &function_10108818, "fly" );
    level thread scene::play( #"p9_fxanim_zm_gold_bunny_bundle", "fly" );
    wait 0.5;
    ...
    scene::remove_scene_func( #"p9_fxanim_zm_gold_bunny_bundle", &function_10108818, "fly" );
    level scene::delete_scene_spawned_ents( #"p9_fxanim_zm_gold_bunny_bundle" );
}
...
function function_869127f6()
{
    ...
    scene::add_scene_func( #"p9_fxanim_zm_gold_bunny_bundle", &function_ea2f5d05, "dance" );
    ...
    while ( true )
    {
        ...
        level.var_7a5b491e thread scene::play( #"p9_fxanim_zm_gold_bunny_bundle", "dance", level.var_7a5b491e );
    ...
    scene::remove_scene_func( #"p9_fxanim_zm_gold_bunny_bundle", &function_ea2f5d05, "dance" );
...
function function_70b8bf8f()
{
    ...
    level.var_15140b8d.trigger.var_cc1fb2d0 = #"supply_stash_zm_gold_bunny_room";
...
function private function_e6020995()
{
    ...
    while ( true )
    {
        ...
        if ( isalive( self ) && isdefined( level.var_7a5b491e ) && distancesquared( self.origin, level.var_7a5b491e.origin ) < 90000 )
        {
            ...
            self waittill( #"dance_with_bunny_break" );
            self animation::stop();
        }
...
{
    point = function_4ba8fde( #"item_zmquest_gold_head" );
...
function function_2f6288d8()
{
    ...
    wait 0.5;
    level thread scene::play( #"p9_t9_zmb_zombie_static_prop_head_bundle" );
...
function function_db1c9b86()
{
    ...
    if ( e_player function_47eb7a7a() )
    {
        level scene::init( #"p9_t9_zmb_zombie_static_prop_head_bundle" );
...
function function_e1ea43c1( params )
{
    if ( isplayer( self ) )
    {
        ...
        if ( item.itementry.name === #"item_zmquest_gold_head" )
        {
...
function function_c037252d( *var_a276c861 )
{
    ...
    level.e_safe gameobjects::init_game_objects( #"gameobject_zm_gold_safe" );
...
{
    level thread scene::play( #"p9_zm_gold_man_wall_safe_bundle" );
...
function function_ec80a97()
{
    ...
    level thread namespace_58949729::function_f82f361c( s_spawn, #"zm_gold_safe_perk_list", 0, 1 );
}
...
function private function_faf4646f( &var_500164d9 )
{
    ...
    ai = zm_utility::function_cce73165( "dog_location", #"spawner_bo5_zombie_dog_molotov", str_zone );
