...
{
    system::register( #"phase_rift", &preinit, undefined, undefined, #"content_manager" );
}
...
function private preinit()
{
    ...
    content_manager::register_script( #"phase_rift", &function_ea2db6a9 );
...
{
    var_d4f4d124 = isdefined( instance.contentgroups[ #"rift_loc" ] ) ? instance.contentgroups[ #"rift_loc" ] : [];
...
function function_16ee428c( *params )
{
    if ( isarray( level.var_ff7bf48c ) )
    {
        ...
        {
            if ( isdefined( mdl_portal ) && mdl_portal.instance.content_script_name !== #"sr_ee_mq4_step1" )
            {
                mdl_portal.fx_id = playfxontag( #"hash_7312068ea6037f71", mdl_portal, "tag_origin" );
            }
        }
...
function function_1c5803d9( eventstruct )
{
    ...
    {
        vehicle hide();
        vehicle val::set( #"phase_rift", "takedamage", 0 );
...
function private function_dda69211( player, vehicle, var_2b357ce9 )
{
    if ( isalive( player ) )
    {
        ...
        player val::set( #"phase_rift", "takedamage", 0 );
        player val::set( #"phase_rift", "allow_crouch", 0 );
        player val::set( #"phase_rift", "allow_prone", 0 );
        player val::set( #"phase_rift", "allow_stand", 1 );
        player val::set( #"phase_rift", "freezecontrols_allowlook", 1 );
        ...
        if ( isdefined( player ) )
        {
            ...
            player val::reset_all( #"phase_rift" );
        ...
        if ( isdefined( vehicle ) )
        {
            vehicle val::reset_all( #"phase_rift" );
...
function function_a41c43bd( var_2b357ce9, mdl_portal, *vehicle )
{
    ...
    var_f49d0155 = isdefined( self.instance.contentgroups[ #"rift_loc" ] ) ? self.instance.contentgroups[ #"rift_loc" ] : [];
