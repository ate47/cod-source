...
function function_85bd6953()
{
    ...
    level notify( #"f_zipline_snap_end" );
...
{
    level endon( #"f_zipline_snap_end" );
    n_time = 0;
...
function scene_yam_7010_exc_extraction()
{
    ...
    level waittill( #"survey_equipment_start_fade" );
...
{
    level endoncallback( &function_b6eaec4e, #"woods_elevator_descent_kill_skip_watcher" );
...
{
    self waittill( #"begin_sim" );
    self hide();
    level.e_server_cable_simmed show();
    self waittill( #"end_sim" );
    self show();
