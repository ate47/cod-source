...
{
    level flag::wait_till( "all_players_connected" );
    a_s_interacts = struct::get_array( #"arcade_machine_interact" );
...
function function_7fd3a4d8( var_7784a8ae = 0, var_a8627b29 = undefined, n_wait_time = undefined, var_ef49aa65 = 0 )
{
    ...
    if ( var_7784a8ae == 1 )
    {
        ...
        wait 2;
        level notify( #"light_controller_vibration" );
...
{
    level waittill( #"light_controller_vibration" );
...
{
    self endon( #"kill_whole_dialog_tree" );
    level.player endon( #"death" );
...
function function_28c8705b()
{
    ...
    self notify( #"kill_whole_dialog_tree" );
...
function function_877b571()
{
    while ( true )
    {
        ...
        level.player scripted_widgets::function_b0bad5ff();
        level.player playgestureviewmodel( "dem_lowreadyup" );
...
function function_1c7c20ac()
{
    ...
    {
        namespace_c8e236da::addprompt( item );
    }
...
function private function_19898473()
{
    ...
    namespace_6f1d35e1::function_487b4340( #"cp_computer_init_screensaver_cia", 1, 2 );
...
{
    namespace_6f1d35e1::function_487b4340( #"cp_computer_init_common_cia", 1, 2 );
...
{
    wait 1;
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_vault_db_ready_list" );
...
{
    namespace_6f1d35e1::function_487b4340( #"cp_computer_init_common_cia_topics_db", 1, 2 );
...
function function_ef3775d7()
{
    ...
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_vault_sleeperagent_list" );
...
{
    snd::play( "evt_kgb_vault_computer_enter_cmd" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_vault_yamantau_list" );
...
function function_2d5943c4()
{
    ...
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_vault_dragovich_list" );
...
function private function_b441e593( var_321b9d8c )
{
    ...
    {
        level.var_408db1a3 = [];
        var_1856af9d = getscriptbundle( #"cp_ger_hub_teammate_profile_computer" );
        
        foreach ( var_fdf21313 in var_1856af9d.profiles )
        {
            var_f3cb5eb6 = [];
            var_f3cb5eb6[ #"firstname" ] = var_fdf21313.first_name;
            var_f3cb5eb6[ #"lastname" ] = var_fdf21313.last_name;
...
{
    namespace_6f1d35e1::function_487b4340( #"cp_computer_init_common_cia_db", 1, 2 );
    namespace_6f1d35e1::function_5d2e6f6a( 8 );
    namespace_6f1d35e1::function_4951a2c8( 1, 5 );
    level waittill( #"typing_complete" );
    namespace_6f1d35e1::function_4951a2c8( 2, 15 );
...
function exit_func()
{
    ...
    namespace_6f1d35e1::function_487b4340( #"cp_computer_common_shutdown", 1, 2 );
    namespace_6f1d35e1::function_5d2e6f6a( 0 );
    wait 1;
    namespace_6f1d35e1::function_4951a2c8( 1, 5 );
    level waittill( #"typing_complete" );
...
function function_29279de1( var_8ced85ea )
{
    ...
    level.player thread flashback_tv::function_15eaa2db( var_ec670c03, var_46f9f605, "flag_player_approached_flashback_TV", "flag_player_not_in_darkroom", "flashback_tv_lookat", "flashback_tv_screen", "exp_post_takedown_special_tv", #"tv_flashback_safehouse_video" );
}
...
function function_63de26a4()
{
    while ( true )
    {
        self waittill( #"radio_change_station" );
...
function function_f5ee087c()
{
    ...
    namespace_6fdcb0::function_912776e6( #"cp_ger_hub_locker_combination" );
...
function function_58eff8e()
{
    ...
    for ( i = 0; i < level.var_31c52203.size ; i++ )
    {
        ...
        object_descriptions::register_trigger( hash( string ), level.var_31c52203[ i ], var_2b4f2503.desc, 256, var_2b4f2503.title, 1 );
        waitframe( 1 );
    }
}
...
{
    level waittill( #"show_park_paper" );
...
{
    namespace_c8e236da::addprompt( #"hash_2404b7b62786fa93" );
    namespace_c8e236da::addprompt( #"hash_2404b8b62786fc46" );
...
function function_d0c617ad( struct )
{
    ...
    while ( true )
    {
        ...
        if ( isusinggamepad && level.player scripted_widgets::function_70217795() || !isusinggamepad && self usebuttonpressed() )
        {
...
function function_77a7721()
{
    while ( true )
    {
        var_c564fe97 = level waittill( #"play_rumble_light", #"play_rumble_heavy", #"hash_7730e9e72bc8c4b2", #"start_rumble_heavy", #"stop_rumble_light", #"stop_rumble_heavy", #"hash_4559bc6bde09c1f0", #"hash_3af2de6bab0e3202" );
        
        switch ( var_c564fe97._notify )
        {
            case #"play_rumble_light":
                level.player playrumbleonentity( "damage_light" );
                break;
            case #"play_rumble_heavy":
                level.player playrumbleonentity( "damage_heavy" );
                break;
            case #"hash_7730e9e72bc8c4b2":
                level.player playrumblelooponentity( "damage_light" );
                break;
            case #"start_rumble_heavy":
                level.player playrumblelooponentity( "damage_heavy" );
                break;
            case #"stop_rumble_light":
                level.player stoprumble( "damage_light" );
                break;
            case #"stop_rumble_heavy":
