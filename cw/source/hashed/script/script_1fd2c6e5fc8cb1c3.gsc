...
// Size: 0xb0
function adler_spawn( var_d3440450, spawner = "adler" )
{
...
// Size: 0x74
function function_acd27ffb( var_678713c9, setflag )
{
...
// Size: 0x74
function function_ae7c9137( var_ec216292, setflag )
{
...
function function_c6e1b306()
{
    while ( true )
    {
        msg = level waittill( #"elevator_doorway_player_clip_solid", #"elevator_doorway_player_clip_notsolid" );
        
        if ( msg._notify == #"elevator_doorway_player_clip_solid" )
        {
            level.elevator_doorway_player_clip solid();
            continue;
        }
        
        if ( msg._notify == #"elevator_doorway_player_clip_notsolid" )
        {
...
{
    self endon( #"death" );
    self endon( #"stop_firing_magic_bullets" );
...
function function_c2c71c9f()
{
    ...
    for ( i = 0; i < level.var_31c52203.size ; i++ )
    {
        ...
        object_descriptions::register_trigger( hash( string ), level.var_31c52203[ i ], data[ 0 ], 256, data.size < 1 ? undefined : data[ 1 ], data.size < 2 ? undefined : data[ 2 ] );
        waitframe( 1 );
    }
}
...
function function_50de5cd0( poi )
{
    ...
    switch ( poi.script_noteworthy )
    {
        ...
        case #"restricted_records":
            return [ #"hash_5ec53fb034c31e3", var_a706170a, 2 ];
        case #"restricted_server":
...
function function_aa042bc7( model_str, tag, count, struct )
{
    ...
    object_descriptions::register_rect( hash( model_str + string( count ) ), struct.origin, struct.angles, 40, 40, var_4843b044[ 0 ], 128, door, var_4843b044[ 1 ], var_4843b044[ 2 ] );
}
...
function function_18b8373e( *prompt )
{
    ...
    level.player note_display::function_97c69304( #"cp_rus_kgb_arcade_workorder_note_list" );
