...
function function_61f56bb6( hotzones )
{
    ...
    foreach ( hotzone in hotzones )
    {
        if ( !isdefined( hotzone.hotzone_group ) )
        {
            var_be6053fa[ var_be6053fa.size ] = hotzone;
            continue;
        }
        
        if ( !isdefined( var_c6d0eb25[ hotzone.hotzone_group ] ) )
        {
            var_c6d0eb25[ hotzone.hotzone_group ] = [];
        }
        else if ( !isarray( var_c6d0eb25[ hotzone.hotzone_group ] ) )
        {
            var_c6d0eb25[ hotzone.hotzone_group ] = array( var_c6d0eb25[ hotzone.hotzone_group ] );
        }
        
        var_c6d0eb25[ hotzone.hotzone_group ][ var_c6d0eb25[ hotzone.hotzone_group ].size ] = hotzone;
    }
    
    foreach ( group in var_c6d0eb25 )
    {
        group = array::randomize( group );
        var_7e24bb5a = group[ 0 ].hotzone_group_num;
...
function function_c43e2960( var_89bd79c0, tunables )
{
    ...
    var_d9c7b945 = function_3759eaa0( var_89bd79c0, var_d9c7b945, isdefined( tunables.num_spawn_points ) ? tunables.num_spawn_points : 0 );
...
function function_ba8b8ba3( &spawn_points )
{
    ...
    {
        if ( point.spawn_anim_alias === #" " )
        {
            point.spawn_anim_alias = undefined;
        }
...
function function_3759eaa0( var_89bd79c0, var_9b694d6c, var_36a2355b )
{
    ...
    {
        if ( !is_true( var_89bd79c0.use_volume_generation ) )
        {
        ...
        {
            var_53911b23 = namespace_85745671::function_7a1b21f6( var_89bd79c0.origin, var_89bd79c0.angles, var_36a2355b - var_9b694d6c.size, var_89bd79c0.spawn_width, var_89bd79c0.spawn_length, var_89bd79c0.spawn_height, 0, 1 );
        }
...
function function_3c977c4f( hotzone, state )
{
    if ( hotzone.instance.current_state !== state )
    {
        ...
        hotzone.instance.max_active_ai = function_e670bffd( hotzone.scriptbundlename, state );
...
function function_e670bffd( var_f4a682a0, state )
{
    ...
    if ( state == 1 )
    {
        max_active_ai = namespace_679a22ba::function_b9ea4226( isdefined( tunables.var_e4de985f ) ? tunables.var_e4de985f : 0, isdefined( tunables.var_4dc06056 ) ? tunables.var_4dc06056 : 0 );
    }
    else if ( state == 2 )
    {
        max_active_ai = namespace_679a22ba::function_b9ea4226( isdefined( tunables.var_b8fc9deb ) ? tunables.var_b8fc9deb : 0, isdefined( tunables.var_a1208a9a ) ? tunables.var_a1208a9a : 0 );
    }
    
    return max_active_ai;
}
...
function function_89116a1e( &var_e592e473, var_8437e990, aitype )
{
    ...
    for ( i = 0; i < var_e592e473.size ; i++ )
    {
        ...
        if ( getplayers( undefined, spawn_point.origin, 256 ).size || isdefined( aitype ) && isdefined( spawn_point.spawn_anim_alias ) && !function_ee71d10f( aitype, spawn_point.spawn_anim_alias ) )
        {
            continue;
        }
...
function function_9e0aba37()
{
    ...
    while ( true )
    {
        ...
        foreach ( hotzone in level.var_3b4ee947 )
        {
            ...
            if ( instance.active_ai.size < instance.max_active_ai )
            {
                ...
                if ( hotzone.instance.current_state == 1 )
                {
                    ...
                    if ( var_13a8c4ed >= instance.max_active_ai )
                    {
...
function spawn_ai( hotzone )
{
    ...
    {
        var_9f9ede51 = #"spawner_bo5_zombie_sr_ronnie_raygun";
    }
    else
    {
    ...
    if ( isdefined( new_ai ) )
    {
        ...
        if ( isdefined( spawn_point.spawn_anim_alias ) && function_ee71d10f( spawn_info.aitype_name, spawn_point.spawn_anim_alias ) )
        {
            new_ai.var_c9b11cb3 = spawn_point.spawn_anim_alias;
        }
        
        if ( var_9f9ede51 == #"spawner_bo5_zombie_sr_ronnie_raygun" && !level flag::get( #"hash_ad588d53f52329a" ) )
        {
...
{
    if ( self.aitype === #"spawner_bo5_zombie_sr_ronnie_raygun" )
    {
...
/#
    ...
    function function_1a530376( hotzone, array_index, scale )
    {
        ...
        if ( is_true( options.var_3eef4d41 ) && !is_true( hotzone.use_volume_generation ) )
        {
        ...
        if ( is_true( options.var_3eef4d41 ) && is_true( hotzone.use_volume_generation ) )
        {
            draw_box( hotzone.origin, hotzone.angles, hotzone.spawn_width, hotzone.spawn_length, hotzone.spawn_height, ( 1, 1, 0 ) );
        }
    }
    ...
    function function_d937ea12( index, scale, alpha, color, hotzone, options )
    {
        ...
        index += 17 * scale * 0.75;
        print3d( hotzone.origin + ( 0, 0, index ), "<dev string:xa13>" + hotzone.instance.active_ai.size + "<dev string:xa21>" + hotzone.instance.max_active_ai, color, alpha, scale * 0.75, 1 );
        index += 17 * scale * 0.75;
    ...
    function function_42926dcf( index, scale, alpha, hotzone )
    {
        ...
        print3d( hotzone.origin + ( 0, 0, index ), "<dev string:xaaa>" + hotzone.hotzone_group + "<dev string:xab4>" + hotzone.hotzone_group_num, ( 1, 0, 1 ), alpha, scale * 0.75, 1 );
        index += 17 * scale * 0.75;
        return index;
    }
    ...
    function function_9c8936c1( &var_af4acf6e, origin, color )
    {
        foreach ( point in var_af4acf6e )
        {
            ...
            if ( is_true( level.var_70da9652.var_22a4a482 ) && isdefined( point.spawn_anim_alias ) )
            {
    ...
    {
        print3d( spawn_point.origin + ( 0, 0, index ), spawn_point.spawn_anim_alias, color, alpha, scale * scale, 1, 1 );
