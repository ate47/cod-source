...
{
    system::register( #"zm_zonslaught_holiday", undefined, &init, undefined, undefined );
}
...
function init()
{
    if ( ( is_true( getgametypesetting( #"hash_7e8e34cc69a77e0b" ) ) || getdvarint( #"hash_40bd34b35079cf2e", 0 ) > 0 ) && ( zm_utility::function_c200446c() || util::get_game_type() === #"zonslaught_holiday" ) )
    {
        level.var_70b6f044 = [ #"spawner_zm_zombie_onslaught":#"spawner_zm_zombie_ndu_xmas", #"spawner_bo5_zombie_dog_plague":#"spawner_bo5_zombie_dog_plague_xmas", #"spawner_zm_steiner":#"spawner_zm_steiner_xmas", #"spawner_zm_steiner_split_radiation_blast":#"spawner_zm_steiner_split_radiation_blast_xmas", #"spawner_zm_steiner_split_radiation_bomb":#"spawner_zm_steiner_split_radiation_bomb_xmas" ];
...
{
    self endon( #"death" );
    spawner = #"spawner_zm_zombie_ndu_xmas";
