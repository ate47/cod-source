...
function function_e677fbe0()
{
    switch ( getplayers().size )
    {
        case 1:
            n_spawns = 8;
            n_spawns = min( 12, int( level.star_rating * 0.5 + n_spawns ) );
            break;
        case 2:
            n_spawns = 12;
            n_spawns = min( 16, int( level.star_rating * 0.5 + n_spawns ) );
            break;
        case 3:
            n_spawns = 18;
            n_spawns = min( 22, int( level.star_rating * 0.5 + n_spawns ) );
            break;
        case 4:
            n_spawns = 24;
            n_spawns = min( 28, int( level.star_rating * 0.5 + n_spawns ) );
            break;
    }
...
function function_24735dd6( instance )
{
    ...
    while ( true )
    {
        ...
        {
            var_90a50598 = isdefined( instance.contentgroups[ #"jellyfish_bridge_riser" ] ) ? instance.contentgroups[ #"jellyfish_bridge_riser" ] : [];
        ...
        {
            var_90a50598 = isdefined( instance.contentgroups[ #"jellyfish_riser" ] ) ? instance.contentgroups[ #"jellyfish_riser" ] : [];
...
function function_81f989d5( instance )
{
    self endon( #"death" );
    self waittill( #"phase_enter" );
    var_ee024c6b = isdefined( instance.contentgroups[ #"legion" ] ) ? instance.contentgroups[ #"legion" ] : [];
...
function function_c97fdd1d( s_loot )
{
    ...
    {
        self.var_55b8433b = [];
        var_5504b0b = s_loot.contentgroups[ #"pod_phase_group" ];
