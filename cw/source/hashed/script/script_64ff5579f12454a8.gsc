...
function preinit()
{
    ...
    content_manager::register_script( #"sr_ee_mq4_step1", &function_7cdcb903 );
    content_manager::register_script( #"sr_ee_mq4_step2", &function_ba2ed0f6 );
    content_manager::register_script( #"sr_ee_mq4_step3", &function_830b8b01 );
    ...
    {
        content_manager::register_script( #"sr_ee_mq4_step5", &namespace_f865255e::function_42818ffd );
...
{
    if ( !getdvarint( #"hash_5d3079579464742a", 0 ) && ( level flag::get( #"hash_4c9bb7a770c9e973" ) || level.star_rating < 3 ) || level flag::get( #"hash_3b46a8a050e7823e" ) )
    {
        return;
    }
    
    level.var_ff7bf48c = [];
    var_2b357ce9 = instance.contentgroups[ #"rift_1" ][ 0 ];
    var_2b357ce9.s_teleport = struct::get( var_2b357ce9.targetname, "target" );
    var_edf7d1ed = 1;
    function_6b9a56f7( var_2b357ce9, var_edf7d1ed, 0, 80 );
    var_2b357ce9 = instance.contentgroups[ #"rift_2" ][ 0 ];
    var_2b357ce9.s_teleport = struct::get( var_2b357ce9.targetname, "target" );
    var_edf7d1ed = 2;
    ...
    var_2b357ce9 = instance.contentgroups[ #"rift_3" ][ 0 ];
    var_2b357ce9.s_teleport = struct::get( var_2b357ce9.targetname, "target" );
    var_edf7d1ed = 3;
    function_6b9a56f7( var_2b357ce9, var_edf7d1ed );
    ...
    var_2b357ce9 = instance.contentgroups[ #"rift_4" ][ 0 ];
    var_2b357ce9.s_teleport = struct::get( var_2b357ce9.targetname, "target" );
...
function private function_b1f268c1( v_loc, instance )
{
    ...
    a_spawns = array::randomize( isdefined( instance.contentgroups[ #"heli_ambush_spawn" ] ) ? instance.contentgroups[ #"heli_ambush_spawn" ] : [] );
...
function private unstable_orb( instance )
{
    ...
    while ( !level flag::get( #"hash_4b060b9820d4141d" ) )
    {
        ...
        var_853a6020 = 0;
        var_5848577a = arraycopy( isdefined( instance.contentgroups[ #"orb_move_loc" ] ) ? instance.contentgroups[ #"orb_move_loc" ] : [] );
...
function function_9ad91439( instance )
{
    ...
    var_b8c8ab67 = instance.contentgroups[ #"rover_audio" ][ 0 ];
...
{
    var_9f3b9a91 = instance.contentgroups[ #"rover_audio_land" ][ 0 ];
