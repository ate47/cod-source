...
function private function_6ef31de9( s_instance )
{
    ...
    var_7af625c6 = s_instance.contentgroups[ #"hulk_spawn" ][ 0 ];
    ...
    {
        s_instance.ai_hulk = namespace_85745671::function_9d3ad056( #"spawner_bo5_hulk", var_7af625c6.origin, var_7af625c6.angles, "world_event_orda" );
        wait 0.1;
    }
...
function function_b3a6e0bc( *eventstruct )
{
    ...
    if ( is_true( b_cleaned_up ) || !isdefined( self.ai_hulk ) || !isalive( self.ai_hulk ) )
    {
