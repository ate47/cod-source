...
function function_72c32279()
{
    ...
    function_92d1707f( #"dlog_event_zm_server_match_start", matchstart );
...
function function_d519e318()
{
    ...
    matchend.star_level = isdefined( level.star_rating ) ? level.star_rating : 0;
    ...
    function_92d1707f( #"dlog_event_zm_server_match_end", matchend );
...
function private on_round_end( data )
{
    ...
    function_92d1707f( #"dlog_event_zm_server_round_end", var_a5722144 );
}
...
function private function_2d28a3b3( *data )
{
    ...
    xp_total = int( self rank::getrankxp() - ( isdefined( self.pers[ #"telemetry" ].xp_at_start ) ? self.pers[ #"telemetry" ].xp_at_start : 0 ) );
    ...
    if ( zm_utility::is_survival() )
    {
        ...
        playerdata.var_50941cea = xp_total;
    }
    else
    {
        ...
        playerdata.var_50941cea = int( max( 0, xp_total - ( isdefined( self.pers[ #"telemetry" ].var_ff8bd64a.xp_total ) ? self.pers[ #"telemetry" ].var_ff8bd64a.xp_total : 0 ) ) );
    }
    ...
    playerdata.star_level = isdefined( level.star_rating ) ? level.star_rating : 0;
    ...
    self function_678f57c8( #"dlog_event_zm_player_round_end", playerdata );
    ...
    self.pers[ #"telemetry" ].var_ff8bd64a.xp_total = xp_total;
}
    ...
    if ( isdefined( self.pers[ #"hash_69b63c99be1fb428" ] ) )
    {
        ...
        while ( weapon_index < weapon_names.size )
        {
            ...
            if ( isdefined( var_fa5921b6 ) && var_fa5921b6 > 0 )
            {
                ...
                self function_678f57c8( #"dlog_event_zm_player_round_end_weapon_stats", var_cad81941 );
            }
...
function on_player_connect( *data )
{
    if ( !is_true( self.pers[ #"telemetry" ].connected ) )
    {
        ...
        self function_678f57c8( #"dlog_event_zm_player_match_start", playerdata );
    }
}
...
function function_143fa1b9()
{
    ...
    self function_678f57c8( #"dlog_event_zm_player_match_end", playerdata );
...
function private function_3f08a12b( data )
{
    ...
    data.purchaser function_678f57c8( #"dlog_event_zm_wallbuy", var_abb39438 );
}
...
function private on_item_pickup( params )
{
    ...
    if ( isdefined( item ) && isdefined( weapon ) )
    {
        ...
        if ( is_true( params.var_7b753bce ) )
        {
            ...
            params.player function_678f57c8( #"dlog_event_zm_weapon_pickup", itemdata );
        }
    }
}
...
function private on_item_drop( params )
{
    ...
    if ( isdefined( item ) && isdefined( weapon ) )
    {
        ...
        self function_678f57c8( #"dlog_event_zm_weapon_drop", itemdata );
    }
}
...
function private function_2d2b9f81( data )
{
    ...
    data.player function_678f57c8( #"dlog_event_zm_loadout", loadoutdata );
}
...
function private function_8a38be09( *params )
{
    ...
    foreach ( player in players )
    {
        ...
        player.pers[ #"telemetry" ].var_ff8bd64a.xp_total = isdefined( player.pers[ #"telemetry" ].xp_at_start ) ? player.pers[ #"telemetry" ].xp_at_start : 0;
    }
    
    var_bdad1c21 = { #var_579fb993:level.script, #var_e4ca5a4b:level.var_7cb19409, #var_c2b4f8d0:level.star_rating, #var_ea3397d3:getplayers().size, #var_b8cbcff2:hash( isdefined( level.contentmanager.var_1fcbdf50 ) ? level.contentmanager.var_1fcbdf50 : #"" ) };
    function_92d1707f( #"dlog_event_zm_sr_capsules", var_bdad1c21 );
}
...
function private function_f13d2749( params )
{
    ...
    foreach ( player in players )
    {
        ...
        function_92d1707f( #"dlog_event_player_zm_sr_objectives_end", var_b1c6f834 );
    }
}
...
function private on_ai_killed( params )
{
    ...
    {
        var_b850e84d = #"dlog_event_zm_player_ai_killed";
    }
    else if ( self.zm_ai_category === #"special" )
    {
        var_b850e84d = #"dlog_event_zm_player_ai_killed_special";
    }
    else if ( self.zm_ai_category === #"elite" )
    {
        var_b850e84d = #"dlog_event_zm_player_ai_killed_elite";
    }
    else if ( self.zm_ai_category === #"boss" )
    {
        var_b850e84d = #"dlog_event_zm_player_ai_killed_boss";
    }
...
function function_882720b2( data )
{
    ...
    {
        data.player function_678f57c8( #"dlog_event_zm_player_exploit_spot", struct );
    }
}
