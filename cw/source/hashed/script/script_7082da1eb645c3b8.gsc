...
function function_fef9a6fd()
{
    ...
    if ( isdefined( self.script_noteworthy ) && self.script_noteworthy == "ai_enemy_elevator_terminal" )
    {
        var_e0f6457b = [];
        var_e0f6457b[ 0 ] = self;
        level scene::init( #"scene_amk_5090_elv_hallway", var_e0f6457b );
        level thread scene::play( #"scene_amk_5090_elv_hallway", var_e0f6457b );
        var_facf831 = scene::function_8582657c( #"scene_amk_5090_elv_hallway", "enter" );
        wait var_facf831 - 1;
        self ai::set_pacifist( 0 );
        self.goalradius = 32;
...
function function_538dfcc4()
{
    ...
    level thread namespace_f6d09d1a::function_7b9feaa3( "lgtexp_perf_elevator", 1 );
    level thread namespace_f6d09d1a::function_7b9feaa3( "lgtexp_perf_mainstreet_keys_b", 1 );
    level waittill( #"terminal_scene_locked_out" );
...
function function_b53a12d0()
{
    ...
    level scene::play( #"scene_amk_6010_tml_player", var_a16bf7b3 );
    level thread scene::play( #"scene_amk_6010_tml_player", "player_loop" );
...
function function_2d735bd7( *params )
{
    ...
    scene::play( #"scene_amk_6010_tml_player", "player_exit" );
...
function function_ac774391()
{
    ...
    level.woods flag::wait_till( #"flg_woods_at_railing" );
