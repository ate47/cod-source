        ...
        foreach ( guy in level.poi.var_5ee53e3 )
        {
            if ( isalive( guy ) && is_true( guy.poi.doingpoi ) && !guy is_combat() )
            {
                ...
                if ( isdefined( poi ) && poi !== guy.poi.currentpoi )
                {
                    ...
                    var_8fbcda45 = isdefined( poi.script_aim ) ? poi.script_aim : self.poi.var_8fbcda45;
...
function private function_f3a2a643()
{
    ...
    {
        var_970aced0 = float( isdefined( var_a9af01c3.script_debounce ) ? var_a9af01c3.script_debounce : 0 ) * 1000;
...
function private function_c6ff2ee5()
{
    ...
    while ( true )
    {
        ...
        if ( nextaimtimer <= gettime() )
        {
            ...
            {
                nextaimtimer = gettime() + var_456b9fca + 550 + randomintrange( 1000, 2000 );
            }
        }
...
/#
    ...
    function private function_9c52ce45( poi )
    {
        ...
        var_711c17c1 = float( isdefined( poi.script_debounce ) ? poi.script_debounce : 0 ) * 1000;
        ...
        else
        {
            ...
            if ( auto )
            {
                time = time + "<dev string:xfe>" + ( float( isdefined( poi.script_debounce ) ? poi.script_debounce : 0 ) < 0 ? float( 5000 ) / 1000 : float( poi.script_debounce ) );
            }
