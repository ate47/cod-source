...
function function_8232a129()
{
    ...
    wait 3;
    level thread breadcrumb::function_61037c6c( #"breadcrumb_bunker_encounter_0" );
}
...
{
    if ( s_event.weapon.name != #"special_recurvebow_t9" )
    {
...
// Size: 0x194
function function_4e376bb9( flg_cleanup )
{
    self endon( #"death" );
    ...
    self.grenadeammo = 0;
    self thread function_3a9ba510( flg_cleanup );
...
// Size: 0x54
function function_3a9ba510( flg_cleanup )
{
    self endon( #"death" );
    level flag::wait_till( flg_cleanup );
    self delete();
}
...
{
    level thread breadcrumb::function_61037c6c( #"breadcrumb_woods_regroup_ladder" );
...
{
    level flag::wait_till( "flg_bunker_office_approach" );
    level thread breadcrumb::function_61037c6c( #"breadcrumb_woods_regroup_office" );
}
...
function function_deb7a15b( var_6e96c1c2 )
{
    ...
    level endon( #"server_outro_fade" );
    level notify( #"hash_2acb72769c464cfa" );
    
    if ( isdefined( var_6e96c1c2.weapon.name ) )
    {
        if ( var_6e96c1c2.weapon.name == #"special_recurvebow_t9" )
        {
