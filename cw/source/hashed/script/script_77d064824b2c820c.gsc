...
function function_63c5e2dc( var_f487c534 )
{
    ...
    if ( notetracks.size )
    {
        ...
        {
            if ( notetrack[ 1 ] == #"facade_bullet" && notetrack[ 2 ] != #"end" )
            {
...
function function_8cc9e7c2( var_43182387 = 0 )
{
    ...
    while ( true )
    {
        return_val = var_f487c534 waittill( #"facade_bullet" );
...
function function_f197858e()
{
    ...
    level waittill( #"notify_motorpool_door_anim_end" );
...
function function_1363e7a3()
{
    level flag::wait_till( "flg_amk_player_spawned" );
    level.player endon( #"death" );
    level endon( #"flg_motor_pool_start" );
