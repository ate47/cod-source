...
function function_d02dc0ba()
{
    ...
    a_ents[ #"vehicle 4" ] = function_433aff96( "ghost_station_car_04" );
    a_ents[ #"vehicle 5" ] = function_433aff96( "ghost_station_car_05" );
    a_ents[ #"vehicle 6" ] = function_433aff96( "ghost_station_car_06" );
    a_ents[ #"vehicle 7" ] = function_433aff96( "ghost_station_car_07" );
    a_ents[ #"vehicle 8" ] = function_433aff96( "ghost_station_car_08" );
    a_ents[ #"vehicle 9" ] = function_433aff96( "ghost_station_car_09" );
    a_ents[ #"vehicle 10" ] = function_433aff96( "ghost_station_car_caboose" );
    return a_ents;
}
...
function function_9e2e1f19()
{
    ...
    a_ents[ #"vehicle 4" ] = function_433aff96( "ghost_station_2_car_04" );
    a_ents[ #"vehicle 5" ] = function_433aff96( "ghost_station_2_car_05" );
    a_ents[ #"vehicle 6" ] = function_433aff96( "ghost_station_2_car_06" );
    a_ents[ #"vehicle 7" ] = function_433aff96( "ghost_station_2_car_07" );
    a_ents[ #"vehicle 8" ] = function_433aff96( "ghost_station_2_car_caboose" );
    return a_ents;
}
...
function function_61fc8e84( var_e24a3c09 = 0 )
{
    ...
    self[ #"vehicle 4" ] function_4df0bafb( self[ #"vehicle 4" ].animnode, randomintrange( min, max ) );
    self[ #"vehicle 5" ] function_4df0bafb( self[ #"vehicle 5" ].animnode, randomintrange( min, max ) );
    self[ #"vehicle 6" ] function_4df0bafb( self[ #"vehicle 6" ].animnode, randomintrange( min, max ) );
    self[ #"vehicle 7" ] function_4df0bafb( self[ #"vehicle 7" ].animnode, randomintrange( min, max ) );
    
    if ( is_true( var_e24a3c09 ) )
    {
        self[ #"vehicle 8" ] function_4df0bafb( self[ #"vehicle 8" ].animnode, randomintrange( min, max ) );
        self[ #"vehicle 9" ] function_4df0bafb( self[ #"vehicle 9" ].animnode, randomintrange( min, max ) );
        self[ #"vehicle 10" ] function_4df0bafb( self[ #"vehicle 10" ].animnode, randomintrange( min, max ) );
        return;
    }
...
// Size: 0x34
function function_a6404b66( s_animnode )
{
    self linkto( s_animnode, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
}
...
// Size: 0x198
function function_4df0bafb( s_animnode, num )
{
    if ( !isdefined( s_animnode ) )
    {
        return;
    }
    ...
    for ( i = 1; i < num + 1 ; i++ )
    {
        ...
        if ( level.var_91ee8248.size < level.var_5679f947 )
        {
            ...
            {
                actor = spawner::simple_spawn_single( "vista_train_civ_f", &function_a6404b66, s_animnode );
            }
            else
            {
                actor = spawner::simple_spawn_single( "vista_train_civ_m", &function_a6404b66, s_animnode );
            }
            
            waitframe( 1 );
            s_animnode thread scene::play( var_eed40cce, actor );
