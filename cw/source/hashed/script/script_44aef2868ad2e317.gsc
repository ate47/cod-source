...
function function_399a3c34()
{
    ...
    namespace_c8e236da::addprompt( #"hash_70a51dccafa85eb" );
    
    if ( level flag::get( "flag_tutorial_map_complete" ) )
    {
        namespace_c8e236da::addprompt( #"hash_3895e110abdb2bea" );
    }
...
function function_b2058d81( player )
{
    player endon( #"death" );
    level flag::wait_till( "flag_tutorial_map_complete" );
    player thread scripted_widgets::function_b0bad5ff( "show_itin" );
...
function function_c3120e0e( a_ents )
{
    ...
    guy.takedown_origin = ( level.player.origin + guy.origin ) / 2;
    guy.takedown_angles = vectortoangles( guy.origin - level.player.origin );
}
...
function function_f632133()
{
    ...
    self.takedown_origin = struct.origin;
    self.takedown_angles = struct.angles;
...
function function_9c6821fd( a_ents )
{
    if ( !level flag::get_any( level.var_dae73e42 ) )
    {
        ...
        if ( isdefined( a_ents[ #"charkov_folder" ] ) )
        {
            a_ents[ #"charkov_folder" ] delete();
        }
        
        if ( isdefined( a_ents[ #"charkov_cigar" ] ) )
        {
            a_ents[ #"charkov_cigar" ] delete();
        }
    }
}
...
function function_94385b7e()
{
    ...
    if ( dot < 0 )
    {
        ...
        self.takedown_angles = level.player.angles;
    }
...
function function_ac832cf3()
{
    ...
    level.player note_display::function_97c69304( #"cp_rus_kgb_prisoner_note_list" );
    ...
    level.player scripted_widgets::function_b0bad5ff( undefined, undefined, 1 );
    hint_tutorial::function_9f427d88( 0 );
    level.player notifyonplayercommand( "show_itin", "+actionslot 4" );
    level.player notifyonplayercommand( "show_itin", "+map" );
    level.player val::reset( #"hash_2463ab97c65a943c", "freezecontrols" );
...
function function_1948ba64( line_1, line_2 )
{
    ...
    level waittill( #"vo_line_clerk_01" );
...
function function_69897605( a_ents )
{
    ...
    if ( isdefined( a_ents[ #"billfold" ] ) )
    {
        a_ents[ #"billfold" ] delete();
    }
...
function function_cc8b4145()
{
    ...
    while ( true )
    {
        level waittill( #"toggle_charkov_distract" );
...
function function_76fddb1d()
{
    ...
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_reprogram_computer_intro" );
...
function function_736d0537()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_reprogram_computer_declined" );
    wait 1;
    namespace_6f1d35e1::function_5d2e6f6a( 3 );
...
function function_1e568a52()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_reprogram_computer_success" );
    wait 1;
    namespace_6f1d35e1::function_5d2e6f6a( 3 );
    namespace_6f1d35e1::function_4951a2c8( 1, 30 );
    level waittill( #"typing_complete" );
...
function function_48cb9056()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_reprogram_computer_remapping" );
    namespace_6f1d35e1::function_5d2e6f6a( 1 );
...
{
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_denied" );
...
function function_f5ee087c()
{
    ...
    function_c9965ab9( 1 );
    namespace_e77bf565::function_f6eb250d( "cinematicmotion_kgb_computer" );
    namespace_6fdcb0::function_912776e6( #"cp_rus_kgb_prepare_locker_combination" );
    namespace_c8e236da::addprompt( #"hash_2c16a04fab0346fa" );
    namespace_c8e236da::addprompt( #"hash_87cb1efbc51f19b" );
    namespace_c8e236da::addprompt( #"hash_5c8c8fae13b36286" );
    namespace_c8e236da::addprompt( #"hash_68ecec68c06f225b" );
    namespace_c8e236da::addprompt( #"hash_7d0ad4e924d219af" );
...
function function_a6dc6fea()
{
    ...
    object_descriptions::register_trigger( hash( "krav_clue_1" ), var_f3b47ae, #"hash_617f7cd3a1666c29", 256, undefined, 4 );
    var_20f66b24 = getent( "periodic_translate_2", "targetname" );
    object_descriptions::register_trigger( hash( "krav_clue_2" ), var_20f66b24, #"hash_617f79d3a1666710", 256, undefined, 4 );
    var_a5167306 = getent( "periodic_translate_3", "targetname" );
    object_descriptions::register_trigger( hash( "krav_clue_3" ), var_a5167306, #"hash_617f7ad3a16668c3", 256, undefined, 4 );
}
...
function function_85aa7da()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_krav_computer_start", 1, 1 );
    namespace_6f1d35e1::function_5d2e6f6a( 1 );
...
function function_c8954f13()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_krav_computer_nova6", 1, 1 );
...
function function_caa6a3ae()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_krav_computer_mole", 1, 1 );
    namespace_6f1d35e1::function_5d2e6f6a( 3 );
    namespace_6f1d35e1::function_4951a2c8( 1, 30 );
    level waittill( #"typing_complete" );
...
function function_c8feadcf()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_restricted_area_computer_search_for_intel_list" );
    namespace_6f1d35e1::function_5d2e6f6a( 3 );
...
function function_9ee7f44b()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_restricted_area_computer_node_intro" );
    namespace_6f1d35e1::function_5d2e6f6a( 3 );
...
function function_dfa1824b( success = 0 )
{
    ...
    if ( success )
    {
        namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_restricted_area_computer_node_success" );
        thread namespace_353d803e::function_988ff988();
    }
    else
    {
        namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_restricted_area_computer_node_fail" );
...
function function_bded9011()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_restricted_area_computer_falsify_intel_list" );
    namespace_6f1d35e1::function_5d2e6f6a( 3 );
...
function function_4526244e()
{
    ...
    wait 0.05;
    namespace_6f1d35e1::function_eea42dd9( #"hash_36ad27d8fa250b03" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_restricted_area_computer_print_false_intel_list" );
    namespace_6f1d35e1::function_5d2e6f6a( 3 );
...
function function_68dd1c91( a_ents )
{
    ...
    guy.takedown_origin = guy.origin;
    guy.takedown_angles = guy.angles;
    guy.takedown_ragdoll = 0;
}
...
function function_90ba5cf6()
{
    self endon( #"death" );
    level flag::wait_till( "stealth_spotted" );
    self.takedown_scene = undefined;
    self.takedown_origin = undefined;
    self.takedown_angles = undefined;
...
function function_d76e3cea()
{
    ...
    self.var_59212ad0 = "td_scene_nonlethal_behind_b";
    self.var_f535b314 = #"hash_2f16f66c7d8ae1de";
    self.takedown_origin = chair.origin;
    self.takedown_angles = chair.angles;
    self.takedown_ragdoll = 0;
}
...
function function_da84b47c()
{
    ...
    scripted_widgets::function_24e5fa63( #"hint_tutorial", [ #"ui_confirm", #"ui_cancel" ], 1 );
