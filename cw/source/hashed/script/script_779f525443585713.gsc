...
function function_6feed719( var_c79d614f, var_b16d80e2, flag )
{
    ...
    waitresult = var_15e1308b waittill( #"hash_7b78d67b14e33012", #"reached_path_end", #"reached_scene", #"out_of_trigger", #"death", #"entitydeleted" );
...
{
    level.var_94737018 = a_ents[ #"stop_and_chat_duo_b_guy01" ];
    level.var_86b4d49b = a_ents[ #"stop_and_chat_duo_b_guy02" ];
}
...
function function_c257b422( a_ents )
{
    ...
    civ_male = a_ents[ #"civ_male_stop_and_chat_duo_a" ];
    var_6c6006 = a_ents[ #"civ_male_02_stop_and_chat_duo_a" ];
    civ_male endon( #"death", #"delete" );
    var_6c6006 endon( #"death", #"delete" );
    civ_male waittill( #"vox_cue" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_ab67015 = a_ents[ #"prison_stairs_guard_1" ];
    var_e0ed1c83 = a_ents[ #"prison_stairs_guard_2" ];
    var_ab67015 endon( #"death", #"delete" );
    var_e0ed1c83 endon( #"death", #"delete" );
    var_ab67015 waittill( #"vox_cue" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_ce201c54 = a_ents[ #"prison_warden" ];
    var_42a4ecb2 = a_ents[ #"prison_guard01" ];
    var_306b483f = a_ents[ #"prison_guard02" ];
    var_ce201c54 endon( #"death", #"delete" );
    var_42a4ecb2 endon( #"death", #"delete" );
    var_306b483f endon( #"death", #"delete" );
    level waittill( #"vox_cue_scene_kgb_walkup_hall_talk" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_4f3a9c97 = a_ents[ #"civ_female" ];
    civ_male = a_ents[ #"civ_male" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_4f3a9c97 = a_ents[ #"civ_female_desk_a_mixed" ];
    civ_male = a_ents[ #"civ_male_desk_a_mixed" ];
    var_4f3a9c97 endon( #"death", #"delete" );
    civ_male endon( #"death", #"delete" );
...
function function_b31d08b0( a_ents )
{
    ...
    civ_male = a_ents[ #"atrium_talk_guy_02" ];
    var_6c6006 = a_ents[ #"atrium_talk_guy_03" ];
...
function function_792c3bbe( a_ents )
{
    ...
    var_4f3a9c97 = a_ents[ #"atrium_talk_secretary" ];
    civ_male = a_ents[ #"atrium_talk_guy_01" ];
...
function function_a44bd33e( a_ents, str_shot )
{
    level endon( #"kgb_aslt_elev_down_completed" );
    civ_male = a_ents[ #"atrium_talk_guy_01" ];
    var_6c6006 = a_ents[ #"atrium_talk_guy_02" ];
    var_f5b94aac = a_ents[ #"atrium_talk_guy_03" ];
    var_4f3a9c97 = a_ents[ #"atrium_talk_secretary" ];
    civ_male endon( #"death", #"delete" );
    var_6c6006 endon( #"death", #"delete" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_4f3a9c97 = a_ents[ #"civ_female_desk_d_mixed" ];
    civ_male = a_ents[ #"civ_male_desk_d_mixed" ];
    var_4f3a9c97 endon( #"death", #"delete" );
    civ_male endon( #"death", #"delete" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_4f3a9c97 = a_ents[ #"civ_female_desk_c_mixed" ];
    civ_male = a_ents[ #"civ_male_desk_c_mixed" ];
    var_4f3a9c97 endon( #"death", #"delete" );
    civ_male endon( #"death", #"delete" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_4f3a9c97 = a_ents[ #"civ_female_desk_b_mixed" ];
    civ_male = a_ents[ #"civ_male_desk_b_mixed" ];
    var_4f3a9c97 endon( #"death", #"delete" );
    civ_male endon( #"death", #"delete" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    civ_male = a_ents[ #"duo_standing_a_guy01" ];
    var_6c6006 = a_ents[ #"duo_standing_a_guy02" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    guard = a_ents[ #"prison_stairs_guard" ];
    civ_male = a_ents[ #"prison_stairs_civilian" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    civ_male = a_ents[ #"standing_armed_a_guy01" ];
    var_6c6006 = a_ents[ #"standing_armed_a_guy02" ];
    var_f5b94aac = a_ents[ #"standing_armed_a_guy03" ];
...
function function_18206d92( a_ents )
{
    ...
    civ_male = a_ents[ #"civ_male" ];
    var_6c6006 = a_ents[ #"civ_male_02" ];
    var_f5b94aac = a_ents[ #"civ_male_03" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    civ_male = a_ents[ #"standing_armed_b_guy01" ];
    var_6c6006 = a_ents[ #"standing_armed_b_guy02" ];
    var_f5b94aac = a_ents[ #"standing_armed_b_guy03" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    var_4f3a9c97 = a_ents[ #"civ_typing_female_a" ];
    var_4f3a9c97 endon( #"death", #"delete" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    civ_male = a_ents[ #"stop_and_chat_duo_b_guy01" ];
    var_6c6006 = a_ents[ #"stop_and_chat_duo_b_guy02" ];
    civ_male endon( #"death", #"delete" );
    var_6c6006 endon( #"death", #"delete" );
    civ_male waittill( #"vox_cue" );
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    guard = a_ents[ #"harass_ask_questions_guard01" ];
    var_cd0ea04d = a_ents[ #"harass_ask_questions_guard02" ];
    civ_male = a_ents[ #"harass_ask_questions_man" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    guard = a_ents[ #"harass_check_papers_guard01" ];
    var_cd0ea04d = a_ents[ #"harass_check_papers_guard02" ];
    civ_male = a_ents[ #"harass_check_papers_man" ];
    var_4f3a9c97 = a_ents[ #"harass_check_papers_woman" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    guard = a_ents[ #"harass_pat_down_guard01" ];
    var_cd0ea04d = a_ents[ #"harass_pat_down_guard02" ];
    civ_male = a_ents[ #"harass_pat_down_man" ];
...
{
    level endon( #"kgb_aslt_elev_down_completed" );
    guard = a_ents[ #"harass_wall_frisk_guard01" ];
    civ_male = a_ents[ #"harass_wall_frisk_man" ];
