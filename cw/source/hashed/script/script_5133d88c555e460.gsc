...
function function_8ef296ea()
{
    ...
    while ( true )
    {
        ...
        {
            if ( monkey.var_b0f99546 === #"jumpattack" )
            {
                if ( monkey == self )
                {
                    chance = 25;
...
function function_7ea2ce80( entity )
{
    ...
    {
        var_92423047[ var_92423047.size ] = #"boostattack";
    }
    
    if ( time > entity.var_434f2387 && randomint( 100 ) < 50 )
    {
        var_92423047[ var_92423047.size ] = #"jumpattack";
    }
...
function function_571bb3ac()
{
    ...
    if ( isdefined( silverback ) )
    {
        ...
        silverback.var_b0f99546 = #"jumpattack";
...
{
    return entity.var_b0f99546 === #"boostattack";
}
...
{
    return entity.var_b0f99546 === #"jumpattack";
}
...
{
    self endon( #"death" );
    self waittill( #"banana_attack_done" );
    self.var_b0f99546 = undefined;
}
