...
function function_dba43792( *str_objective )
{
    ...
    level thread breadcrumb::function_61037c6c( #"breadcrumb_server_reveal_start" );
...
function function_6137f397()
{
    ...
    level waittill( #"woods_starts_climbing" );
}
...
function function_e936fbf4( str_objective, var_50cc0d4f )
{
    ...
    level waittill( #"server_outro_fade" );
    skipto::function_4e3ab877( str_objective );
...
{
    level waittill( #"server_outro_gun_down" );
...
{
    level waittill( #"server_hook_dropped" );
    wait 1;
...
function function_f5c1bd9b()
{
    ...
    profilestop();
    level waittill( #"player_link_stop" );
    earthquake( 0.3, 0.2, level.player.origin, 64 );
    var_b8009024 delete();
    level waittill( #"server_lift_3_b" );
    ...
    level waittill( #"server_lift_3_c" );
    ...
    level waittill( #"server_lift_3_d" );
    ...
    level waittill( #"server_lift_4_a" );
    var_6ff151eb = spawner::simple_spawn( "ai_server_lift_floor_4_a" );
    level waittill( #"server_lift_drop_start" );
    level waittill( #"server_lift_drop_end" );
    ...
    level waittill( #"server_lift_stop_combat" );
