...
{
    instance.var_42dcbe3d = instance.contentgroups[ #"transmitter" ];
...
function function_79417d24( *einflictor, eattacker, idamage, *idflags, *smeansofdeath, *weapon, *var_fd90b0bb, *vpoint, *vdir, *shitloc, *psoffsettime, *iboneindex, *imodelindex )
{
    ...
    else
    {
        ...
        if ( isdefined( iboneindex ) && iboneindex.aitype === #"spawner_bo5_zombie_dog_molotov" && imodelindex > 100 )
        {
            imodelindex = 100;
        }
...
function function_ddb668e6()
{
    ...
    for ( i = 0; i < n_spawns ; i++ )
    {
        ...
        if ( isdefined( ai_spawned ) )
        {
            ...
            if ( ai_spawned.aitype === #"spawner_bo5_zombie_dog_molotov" )
            {
...
function on_dog_killed( *params )
{
    ...
    if ( str_aitype === #"spawner_bo5_zombie_dog_molotov" && isdefined( var_954ec1b6 ) )
    {
...
{
    var_cdce8e6f = self.contentgroups[ #"chopper_gunner_path" ][ 0 ];
...
{
    if ( self.aitype !== #"spawner_bo5_zombie_dog_molotov" && self.aitype !== #"spawner_bo5_zombie_dog_plague" && self.team === level.zombie_team )
    {
        var_bf189694 = getentarray( "drop_pod", "targetname" );
