...
function function_b735db01()
{
    ...
    level.player endon( #"death" );
    level notify( #"bunker_intro_guards_react" );
...
function function_68025c07()
{
    ...
    while ( true )
    {
        ...
        {
            level notify( #"disable_low_ready" );
            break;
        }
...
{
    level.player endon( #"death" );
    level waittill( #"disable_low_ready" );
...
function function_8279b9f2()
{
    ...
    level waittill( #"bunker_intro_guards_react", #"bunker_intro_security_cleared" );
...
{
    level waittill( #"start_guard_react" );
...
function function_25831409( a_ents )
{
    ...
    guy endon( #"death" );
    level endon( #"start_guard_react" );
    level waittill( #"bunker_intro_guard01_laugh" );
...
function function_97192259( a_ents )
{
    ...
    level waittill( #"bunker_intro_guard01_react" );
...
function function_c44b308e( a_ents )
{
    ...
    guy endon( #"death" );
    level endon( #"start_guard_react" );
    level waittill( #"bunker_intro_guard02_laugh" );
...
function function_1cb30cf6( a_ents )
{
    ...
    guy endon( #"death" );
    guy thread dialogue::function_47b06180();
    level waittill( #"bunker_intro_guard02_react" );
...
function function_65b9c362( a_ents )
{
    ...
    guy endon( #"death" );
    level endon( #"start_guard_react" );
    level waittill( #"bunker_intro_guard03_laugh" );
    guy thread dialogue::queue( "vox_cp_rkgb_03300_rms3_laugh_62" );
    level waittill( #"bunker_intro_guard03_joke" );
