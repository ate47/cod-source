...
{
    namespace_3aaa42f7::function_d1bc79a0( "adler_alley_door", a_ents[ #"jprop" ] );
}
...
{
    namespace_3aaa42f7::function_d1bc79a0( "adler_roof_door1", a_ents[ #"jprop" ] );
}
...
{
    level waittill( #"wall_stairs_park_radio" );
...
function checkpoint_scene( skipto )
{
    ...
    if ( !is_true( skipto ) )
    {
        ...
        level waittill( #"checkpoint_trunk_opening" );
        var_cbd9930a = getentarray( "checkpoint_trunk_props", "targetname" );
...
{
    level.var_1bacfdea = a_ents[ #"cp_guard1" ];
}
...
function function_aefb4fb1()
{
    ...
    waitresult = level waittill( #"start_rooftop_descend_alley", #"kraus_reached_bar" );
...
function function_e0855d12( a_ents )
{
    ...
    {
        level.var_74647f74 = a_ents[ #"bar_front_door_props" ];
    }
    
    if ( !isdefined( level.var_c49f9f4d ) )
    {
        level.var_c49f9f4d = a_ents[ #"kraus_bar_props" ];
...
function function_ba06bd3a( a_ents )
{
    ...
    level.var_c0e9c7c4 linkto( a_ents[ #"bar_front_door_props" ], "j_prop_1", ( 0, 0, 0 ), ( 0, 0, 0 ) );
}
...
function function_274a9831()
{
    ...
    self waittill( #"enter_camera_ads" );
