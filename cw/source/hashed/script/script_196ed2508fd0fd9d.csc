...
function event_handler[level_preinit] function_b489bb7b( *eventstruct )
{
    ...
    level.var_fcc804e[ #"outdoor_partial" ] = "partial";
    level.var_fcc804e[ #"outdoor_partial_small" ] = "partial";
    ...
    level.var_fcc804e[ #"train_car_int" ] = "interior";
    level.var_fcc804e[ #"hash_35fddf07b040ef25" ] = "interior";
    level.var_fcc804e[ #"train_tunnel_long" ] = "interior";
    level.var_fcc804e[ #"train_tunnel_med" ] = "interior";
    level.var_fcc804e[ #"train_tunnel_surveillance" ] = "interior";
    level.var_fcc804e[ #"train_tunnel_to_sewer" ] = "interior";
    level.var_fcc804e[ #"train_tunnel_sewer" ] = "interior";
    level.var_fcc804e[ #"train_tunnel_med" ] = "partial";
    level.var_fcc804e[ #"wall_interior" ] = "interior";
    level.var_fcc804e[ #"alley_mini_tunnel" ] = "partial";
    level.var_fcc804e[ #"bar_interior" ] = "interior";
    level.var_fcc804e[ #"bar_restroom" ] = "interior";
    level.var_fcc804e[ #"tailorshop_interior" ] = "interior";
    level.var_fcc804e[ #"alley_interior" ] = "interior";
    level.var_fcc804e[ #"alley_partial_cover" ] = "partial";
    level.var_fcc804e[ #"alley_partial_large" ] = "partial";
    level.var_fcc804e[ #"alley_garage" ] = "interior";
    level.var_fcc804e[ #"alley_bar" ] = "interior";
    level.var_fcc804e[ #"alley_basement" ] = "interior";
    level.var_fcc804e[ #"apartment_lobby" ] = "interior";
    level.var_fcc804e[ #"apartment_interior" ] = "interior";
    level.var_fcc804e[ #"warehouse_interior" ] = "interior";
    level.var_fcc804e[ #"warehouse_break_room" ] = "interior";
    level.var_fcc804e[ #"alley_ext_med_rain" ] = "exterior";
    level.var_fcc804e[ #"alley_ext_sml" ] = "exterior";
    level.var_fcc804e[ #"rooftop_ext_rain" ] = "exterior";
    level.var_fcc804e[ #"street_courtyard_ext_rain" ] = "exterior";
    level.var_fcc804e[ #"courtyard_electronics" ] = "exterior";
    level.var_fcc804e[ #"courtyard_electronics_alcove" ] = "exterior";
    level.var_fcc804e[ #"electronics_store" ] = "interior";
}
...
function private _trigger( player, trigger, *var_ec80d14b )
{
    ...
    switch ( trigger_name )
    {
        ...
        case #"train_car_int":
            snd::set_element( trigger, [] );
            break;
        case #"train_tunnel_surveillance":
        case #"train_tunnel_med":
        case #"train_tunnel_sewer":
        case #"train_tunnel_long":
            snd::set_element( trigger, "ghost_station" );
            level thread function_1a1fd87a();
            break;
        case #"interior":
            break;
        case #"alley_ext_med_rain":
            snd::set_element( trigger, [] );
        ...
        case #"wall_interior":
            level notify( #"hash_2712b72478766d1c" );
            break;
        case #"rooftop_ext_rain":
            function_1fb9d5d6();
            break;
        case #"street_courtyard_ext_rain":
            function_2794abbe();
            break;
        case #"bar_interior":
            level notify( #"hash_2712b72478766d1c" );
            ...
            break;
        case #"tailorshop_interior":
            break;
        case #"alley_partial_large":
        case #"alley_interior":
        case #"alley_partial_cover":
            break;
        case #"warehouse_interior":
            if ( isalive( trigger ) )
            {
...
function private function_f2a2832d( *player, msg )
{
    switch ( msg )
    {
        ...
        case #"hash_3f35a4573ca691d":
            ...
            break;
        case #"subway_car_door_open_1":
            thread function_a6b9fbbd();
            break;
        case #"subway_car_door_close_1":
            level notify( #"subway_car_door_close_1" );
            break;
        case #"subway_car_door_open_2":
            level notify( #"subway_car_door_open_2" );
            break;
        ...
        case #"prep_teleport_train_player":
            ...
            break;
        case #"player_jump_out_done":
            level notify( #"player_jump_out_done" );
            break;
        case #"hash_1fe344e4d4f0967c":
            level notify( #"hash_1fe344e4d4f0967c" );
            break;
        case #"duck_between_car_amb":
            level notify( #"duck_between_car_amb" );
            break;
        case #"subway_car_door_close_2":
            level notify( #"subway_car_door_close_2" );
            break;
...
/#
    ...
    function function_570acc94( door, pos, angle, var_9528975d, var_695f85a3 )
    {
        ...
        debugtext = "<dev string:xa9>" + snd::printdecimalcount( angle, 1 ) + "<dev string:xb4>" + snd::printdecimalcount( var_9528975d, 2 );
        ...
        snd::print3dplus( debugtext, pos + debugoffset, 0.25 * debugscale, "<dev string:xc5>", debugcolor, debugalpha, ( 0, 0, 0 ), debugalphasq, ( 1, 1, 1 ), debugalphasq, debugframes );
    }
...
function function_ab91c6bd( max_angle, var_172ec4a2, center, var_56dde451, var_edbba9 )
{
    ...
    while ( isdefined( door ) )
    {
        ...
        if ( isstring( var_56dde451 ) && !snd::function_a6779cbd( var_c5cdd961 ) && var_695f85a3 >= 0.01 )
        {
            ...
            snd::stop_on_ent_death( var_c5cdd961, door );
        }
        ...
        if ( isarray( var_edbba9 ) )
        {
            for ( i = 0; i < var_edbba9.size ; i++ )
            {
                ...
                if ( isstring( var_61524dce ) && !snd::function_a6779cbd( var_60e98817[ i ] ) && var_9528975d >= 0.01 )
                {
                    ...
                    snd::stop_on_ent_death( var_60e98817[ i ], door );
                }
...
function function_50e92688( ent )
{
    ...
    if ( snd::function_a6779cbd( var_305bf397 ) )
    {
        ...
        level waittill( #"player_jump_out_done" );
