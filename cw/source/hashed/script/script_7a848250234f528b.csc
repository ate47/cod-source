...
function private _trigger( player, trigger, *var_ec80d14b )
{
    ...
    switch ( trigger_name )
    {
        ...
        case #"rev_church":
            ...
            break;
        case #"rev_palace_main":
            thread function_1b4cd940();
            break;
        case #"rev_palace_lobby":
            break;
        case #"rev_palace_big_room":
            thread function_1b4cd940();
            break;
        case #"rev_palace_med_room":
            thread function_1b4cd940();
            break;
        case #"rev_palace_sml_room":
            thread function_1b4cd940();
            break;
        case #"rev_palace_hallway":
            thread function_1b4cd940();
            break;
        case #"rev_palace_stairwell":
            thread function_1b4cd940();
            break;
        case #"rev_palace_courtyard":
...
{
    level waittill( #"audio_outro_ambience_swap" );
...
{
    level waittill( #"audio_propane_tank_impact" );
    wait 2;
