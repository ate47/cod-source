...
function aileapgoalservice( entity )
{
    ...
    speedxy = distance2d / time;
    var_ef97a46c = ( goalpos[ 2 ] - startpos[ 2 ] + 0.5 * gravity * sqr( time ) ) / time;
    entity.var_862cb24b = { #time:1, #startpos:startpos, #nextpos:startpos, #goal:goalpos, #to_goal:goalpos - startpos, #vel:( dir[ 0 ] * speedxy, dir[ 1 ] * speedxy, var_ef97a46c ), #var_af225c86:isdefined( var_af225c86 ) };
