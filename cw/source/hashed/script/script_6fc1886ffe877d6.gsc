...
function event_handler[level_init] main( *eventstruct )
{
    ...
    clientfield::register( "scriptmover", "" + #"aether_pulse", 1, 1, "counter" );
...
function function_50a0c288( instance )
{
    ...
    instance.var_1c417c7e = instance.contentgroups[ #"aether_mass" ][ 0 ];
    ...
    if ( isdefined( instance.contentgroups[ #"ammo_cache_spawn" ] ) )
    {
        instance.s_ammo = instance.contentgroups[ #"ammo_cache_spawn" ][ 0 ];
...
function function_a55eccfe()
{
    ...
    while ( true )
    {
        ...
        wait n_delay;
        self.var_cf24b789 clientfield::increment( "" + #"aether_pulse" );
    }
}
...
function function_1387144c()
{
    ...
    {
        var_85b02bbf = struct::get_array( #"holdout_food_spawn" );
...
function function_b8df700f( s_loot )
{
    ...
    {
        self.var_55b8433b = [];
        var_5504b0b = s_loot.contentgroups[ #"pod_holdout_group" ];
...
function spawn_zombies()
{
    ...
    self thread function_34ac205( var_fd6a4001 + level.star_rating, 0 );
    self flag::wait_till( #"wave_start" );
    self thread function_34ac205( var_102fe58c + level.star_rating, 1 );
    self flag::wait_till( #"wave_start" );
    self thread function_34ac205( var_3b743c0c + level.star_rating, 2 );
}
...
function function_34ac205( n_active, n_wave )
{
    ...
    while ( true )
    {
        ...
        {
            str_aitype = get_aitype( self, level.star_rating );
            ...
            if ( str_aitype === #"spawner_bo5_zombie_dog_plague" || str_aitype === #"spawner_bo5_zombie_dog_molotov" )
            {
