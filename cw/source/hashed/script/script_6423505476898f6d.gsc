...
function private get_max_yaw( var_b6cc4c20 )
{
    ...
    if ( var_b6cc4c20 )
    {
        if ( isdefined( self.var_a2f96f78.script_door_forward_amount ) )
        {
            assert( self.var_a2f96f78.script_door_forward_amount > 0, "<dev string:x38>" + self.m_e_door.origin + "<dev string:x4b>" );
            self.var_15695d13 = self.var_a2f96f78.script_door_forward_amount * var_533884d6;
            return;
        }
    }
    else if ( isdefined( self.var_a2f96f78.script_door_reverse_amount ) )
    {
        assert( self.var_a2f96f78.script_door_reverse_amount > 0, "<dev string:x38>" + self.m_e_door.origin + "<dev string:x95>" );
        self.var_ca91d615 = self.var_a2f96f78.script_door_reverse_amount * var_533884d6 * -1;
        return;
    }
...
function private door_creak_sound( *scale_volume, *var_a09fee2c )
{
    ...
    if ( isentity( self.m_e_door ) && isdefined( alias ) && soundexists( alias ) )
    {
        ...
        self waittill( #"stop_door_creak", #"stop_push_open" );
