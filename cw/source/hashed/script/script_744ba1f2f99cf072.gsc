...
function function_cb6665bc()
{
    ...
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_vault_init_list" );
    namespace_6f1d35e1::function_5d2e6f6a( 1 );
    namespace_6f1d35e1::function_4951a2c8( 1, 1 );
    wait 2;
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_vault_bootup_list" );
    ...
    level waittill( #"typing_complete" );
    wait 1;
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_activation_schematic_auth" );
...
function function_ab498154( scene, speed = 10, content )
{
    ...
    {
        content = #"cp_rus_kgb_activation_authenticate_list";
    }
...
function function_4d361b8e()
{
    ...
    wait 1;
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_activation_schematic_denied" );
...
function function_28165600()
{
    ...
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_logout_list" );
...
{
    level endon( #"level_restarting" );
    namespace_6f1d35e1::function_487b4340( #"cp_rus_kgb_activation_keycard_info" );
