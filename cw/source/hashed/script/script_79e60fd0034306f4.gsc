...
function function_e807f2c6()
{
    ...
    level waittill( #"warehouse_give_gun" );
    clientfield::set( "cull_rear_warehouse", 1 );
...
function function_bae99775()
{
    ...
    level waittill( #"warehouse_chair_kick" );
...
function function_f23b762a()
{
    ...
    level.var_375ea1c1 waittill( #"dialog_tree_scene_response_complete" );
...
{
    level waittill( #"warehouse_intro_end_save" );
...
function function_b22fe3db()
{
    self endon( #"death" );
    player = getplayers()[ 0 ];
    level waittill( #"volkov_dropped_gun" );
...
function function_f038b760()
{
    ...
    level waittill( #"outro_volkov_nag_start" );
...
function function_da8622e6()
{
    ...
    level waittill( #"outro_volkov_kills_player" );
