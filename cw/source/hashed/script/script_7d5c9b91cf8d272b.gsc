...
function preinit()
{
    ...
    {
        level.var_1a4cc228[ #"spawner_bo5_zombie_sr" ] = [ #"hash_49adea61f71924bf", #"hash_1798ecca7f98873d", #"hash_26f6708ef92a0eae", #"hash_1c8805fec5806efe", #"hash_4d95f42b33499eba", #"hash_6799427e5e6c417c", #"hash_11e4908180a964c", #"hash_1340313347e93335" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_sr_alt" ] = [ #"hash_69143c727337ba1a", #"hash_299e8cfa6d75ffd4", #"hash_7d223eb036f4a31b", #"hash_11d7f39f088f3822", #"hash_5e074c09a3a31d97", #"hash_1c437f787033a2e5", #"hash_34d9e63476111b5d", #"hash_779daa809936d578" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_sr_armor_heavy" ] = [ #"hash_4729aed4cfa43476" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_sr_armor_medium" ] = [ #"hash_59e40ffcdcfbffa6" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_sr_female" ] = [ #"hash_149fa86a9c5d858c", #"hash_63e9d6f275dc720", #"hash_94674cb554826a9", #"hash_6b9e4c8e8e955c71", #"hash_75cfd69ce1d6f3dd", #"hash_33c0e923173d2b48", #"hash_53dbc62471a61f88", #"hash_4ece13caf46c00c7" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_sr_female_alt" ] = [ #"hash_5c0dcc3f9d9e1ea5", #"hash_e8b647bb58521c1", #"hash_23492308d6911444", #"hash_5616978b668f07dc", #"hash_31713e12a88def10", #"hash_3e647996c0a4d6b9", #"hash_b35b3dcb7417075", #"hash_53dbc62471a61f88" ];
        level.var_1a4cc228[ #"hash_78215fa79f5557dc" ] = [ #"hash_4814b7b3c67568e3" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_dog_plague" ] = level.var_1a4cc228[ #"hash_78215fa79f5557dc" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_dog_molotov" ] = [ #"hash_2cb37314243526ec" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_sr_ronnie_raygun" ] = [ #"hash_78238b400ae08c28" ];
    }
...
function function_209f64c3( entity, asmstatename )
{
    ...
    entity flag::clear( #"abom_bull_charge_hit" );
...
function function_132c087b( behaviortreeentity, *asmstatename )
{
    ...
    lookahead_dist = 0.2;
    lookahead_point = asmstatename.origin + velocity * lookahead_dist;
    
    /#
        if ( getdvarint( #"hash_4e47873b8bfbca14", 0 ) > 0 )
        {
            function_ae63c292( lookahead_point, "<dev string:x17a>", ( 0, 0, 1 ) );
        }
    #/
    
    function_2fe507a5( asmstatename, lookahead_point, undefined, 1 );
    function_e3ae0cb7( asmstatename, lookahead_point );
    var_11d22bae = function_849b329( asmstatename, lookahead_point );
    ...
    drop_height = 60;
    var_53b2da60 = zombie_utility::function_d446de65( asmstatename, lookahead_point, drop_height, 0.5 );
    ...
    trace_point = lookahead_point + vectornormalize( velocity ) * 30;
    trace_point = ( trace_point[ 0 ], trace_point[ 1 ], max( lookahead_point[ 2 ], asmstatename.origin[ 2 ] ) );
    ...
    if ( speed_sq * 4 <= var_875531fe )
    {
        ...
        asmstatename thread flag::set_for_time( 2.5, #"abom_bull_charge_hit" );
        return 4;
    }
    ...
    if ( !isdefined( var_53b2da60 ) )
    {
        /#
            if ( is_true( level.var_bb61089c ) )
            {
                println( "<dev string:x38>" + "<dev string:x26a>" + lookahead_point );
            }
        #/
...
// Size: 0x278
function private function_2fe507a5( entity, lookahead_point, radius = 48, var_3a5ecec1 = 0 )
{
    ...
    a_zombies = getentitiesinradius( lookahead_point, radius, 15 );
...
// Size: 0x288
function private function_849b329( entity, lookahead_point )
{
    players = getplayers();
    var_9ce867db = 1.6;
    var_89cc0335 = function_72d3bca6( players, lookahead_point, undefined, 0, 40 * var_9ce867db );
    ...
    /#
        if ( getdvarint( #"hash_4e47873b8bfbca14", 0 ) > 0 )
        {
            recordcircle( lookahead_point, 40 * var_9ce867db, ( 0.75, 0.75, 0.75 ) );
        }
    #/
    ...
    foreach ( player in var_89cc0335 )
    {
        if ( isalive( player ) )
        {
            if ( !player flag::get( #"abom_bull_charge_hit" ) )
            {
                player thread flag::set_for_time( 2, #"abom_bull_charge_hit" );
                ...
                function_a768119c( entity, player, lookahead_point );
                continue;
            }
...
function private function_bda6d3d7( *entity, player )
{
    ...
    self shellshock( #"abom_bull_charge_hit", wait_time );
    wait wait_time;
...
// Size: 0x2c8
function private function_e3ae0cb7( entity, lookahead_point )
{
    vehicles = getvehiclearray();
    var_9ce867db = 6;
    var_1378ec51 = function_72d3bca6( vehicles, lookahead_point, undefined, 0, 40 * var_9ce867db );
    var_9ce867db = 2;
    var_b208e4a6 = [];
    ...
    foreach ( vehicle in var_1378ec51 )
    {
        ...
        var_7215755b = math::function_fe4f9da3( lookahead_point, vehicle getboundsmidpoint() + vehicle.origin, vehicle getboundshalfsize(), vehicle.angles );
        dist_sq = distancesquared( var_7215755b, lookahead_point );
    ...
    foreach ( vehicle in var_b208e4a6 )
    {
        if ( isdefined( vehicle ) )
        {
            if ( !vehicle flag::get( #"abom_bull_charge_hit" ) )
            {
                vehicle thread flag::set_for_time( 2, #"abom_bull_charge_hit" );
                ...
                function_6ccdd373( entity, vehicle, lookahead_point );
            }
        }
    }
}
