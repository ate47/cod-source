...
function init()
{
    ...
    scene::add_scene_func( #"cin_zm_platinum_mid", &function_771ae7ab, "play" );
...
function function_ec198408( b_skipped, *var_19e802fa )
{
    ...
    if ( !var_19e802fa )
    {
        ...
        level thread scene::init_streamer( #"cin_zm_platinum_mid", getplayers(), 0, 0 );
        
        if ( isdefined( var_a12bf98c ) )
        {
            var_a12bf98c hidepart( "throne_hide_jnt", "", 1 );
            var_a12bf98c thread scene::play( #"p9_fxanim_zm_platinum_throne_bundle", "explode", var_a12bf98c );
        }
        ...
        if ( isdefined( var_b39864d6 ) )
        {
            ...
            var_c0b8a81 = struct::get( #"corrupted_end" );
        ...
        scene::add_scene_func( #"cin_zm_platinum_mid", &function_f81bfa93, "play" );
        level scene::play( #"cin_zm_platinum_mid", a_ents );
...
function function_23bd7b36( var_75a7d6, var_b39864d6 )
{
    ...
    scene::add_scene_func( #"aib_t9_zm_berlin_boss", &function_b1365812, "boss_defeat" );
    var_b39864d6 scene::play( #"aib_t9_zm_berlin_boss", "boss_defeat", var_b39864d6 );
    var_b39864d6 thread scene::play( #"aib_t9_zm_berlin_boss", "boss_defeat_loop", var_b39864d6 );
}
...
{
    scene::remove_scene_func( #"aib_t9_zm_berlin_boss", &function_b1365812, "boss_defeat" );
    var_75a7d6 = level.var_75a7d6;
    var_b39864d6 = var_75a7d6.var_b39864d6;
...
function function_1a3e352c()
{
    ...
    if ( isdefined( var_a83358f8 ) )
    {
        ...
        level waittill( #"mid_companion_speak" );
...
function function_4c4f2d71()
{
    ...
    if ( isdefined( mdl_conversion_machine ) )
    {
        ...
        level waittill( #"corrupted_shock_start" );
        mdl_conversion_machine clientfield::set( "" + #"hash_765ec7ef8a874f2a", 1 );
        level waittill( #"corrupted_shock_end" );
...
{
    scene::remove_scene_func( #"cin_zm_platinum_mid", &function_f81bfa93, "play" );
...
function function_79ae7b73()
{
    ...
    s_portal = struct::get( #"corrupted_appear" );
    ...
    var_75a7d6.var_25a3af6b = [ #"american_sector", #"east_berlin", #"apartment_roof" ];
    ...
    var_add9efd6 = struct::get( #"corrupted_sit" );
...
function function_de5d28c1( var_75a7d6, var_b39864d6, var_a12bf98c )
{
    ...
    scene::add_scene_func( #"p9_fxanim_zm_platinum_throne_bundle", &function_876d602, "rise" );
    a_ents = [];
    a_ents[ #"boss" ] = var_b39864d6;
    a_ents[ #"throne" ] = var_a12bf98c;
    var_a12bf98c scene::play( #"p9_fxanim_zm_platinum_throne_bundle", "rise", a_ents );
    var_b39864d6 scene::stop();
    var_a12bf98c scene::stop();
    var_b39864d6 thread scene::play( #"aib_t9_zm_berlin_boss", "boss_sit_idle", var_b39864d6 );
    var_a12bf98c thread scene::play( #"p9_fxanim_zm_platinum_throne_bundle", "loop", var_a12bf98c );
    waitframe( 1 );
...
{
    scene::remove_scene_func( #"p9_fxanim_zm_platinum_throne_bundle", &function_876d602, "rise" );
    var_75a7d6 = level.var_75a7d6;
...
function function_3a27a710( var_75a7d6, var_e236b5ff )
{
    ...
    var_e236b5ff waittilltimeout( 30, #"corrupted_step_hide" );
    var_e236b5ff hide();
}
...
function function_51be2da( var_75a7d6 )
{
    ...
    level endon( #"end_game" );
    var_75a7d6 endon( #"defeated" );
    a_s_spawns = struct::get_array( #"corrupted_flood" );
...
function function_73ef29bf( var_75a7d6, var_9161d39c = #"", var_b6ada9ed = 0 )
{
    ...
    if ( var_75a7d6 flag::get( #"hash_61acfc7a3e200ce3" ) && var_75a7d6.str_loc !== #"american_sector" && !var_75a7d6 flag::get( #"hash_3b3cca2339e6043d" ) && math::cointoss( 75 ) )
    {
...
function function_1db59d97( var_75a7d6 )
{
    ...
    var_b39864d6 scene::play( #"aib_t9_zm_berlin_boss", "phase_transition", var_b39864d6 );
    var_b39864d6 thread scene::play( #"aib_t9_zm_berlin_boss", "stand_idle", var_b39864d6 );
    function_761d8ea1( var_75a7d6, var_a12bf98c, 0 );
    var_75a7d6 flag::function_c58ecb49( #"shield_down" );
...
function function_b03f9b73( var_75a7d6, var_a12bf98c, var_b39864d6 )
{
    ...
    var_a12bf98c endon( #"death" );
    var_b39864d6 endon( #"death" );
    level waittill( #"corrupted_transition" );
...
function function_b2871ce6( var_75a7d6 )
{
    ...
    var_b39864d6 = var_75a7d6.var_b39864d6;
    var_b39864d6 thread scene::play( #"aib_t9_zm_berlin_boss", str_shot, var_b39864d6 );
    level waittilltimeout( 10, #"corrupted_teleport_in" );
...
function function_10ed1a0d( var_75a7d6, var_b39864d6 )
{
    ...
    var_b39864d6 scene::play( #"aib_t9_zm_berlin_boss", var_dee0396e, var_b39864d6 );
    var_b39864d6 thread scene::play( #"aib_t9_zm_berlin_boss", var_ec892790, var_b39864d6 );
    waitframe( 1 );
...
function function_a094b1fc( var_75a7d6 )
{
    ...
    var_b39864d6 = var_75a7d6.var_b39864d6;
    var_b39864d6 scene::play( #"aib_t9_zm_berlin_boss", var_504cdb19, var_b39864d6 );
    var_b39864d6 thread scene::play( #"aib_t9_zm_berlin_boss", var_70c303e9, var_b39864d6 );
    ...
    if ( !var_75a7d6 flag::get( #"hash_651c5658ad51d9a2" ) )
    {
        ...
        {
            scene::add_scene_func( #"zm_platinum_vacuum", &function_8b73a6d3, var_fdc796b6.str_idle );
        }
    ...
    while ( var_748cf9be.size > 0 )
    {
        ...
        if ( isalive( var_756c01dd ) )
        {
            ...
            {
                var_86cfd484 thread scene::play( #"zm_platinum_vacuum", var_6ab5a6dc, var_756c01dd );
            }
...
function function_cbdf02c2( ai_zombie, s_spawn, s_rise, var_fdc796b6 )
{
    ...
    {
        var_86cfd484 thread scene::play( #"zm_platinum_vacuum", var_fdc796b6.str_idle, ai_zombie );
    }
}
...
function function_5e042438( var_75a7d6, e_target )
{
    ...
    level waittilltimeout( 5, #"corrupted_strike_spawn" );
    var_1979248a = var_b39864d6.origin;
    a_s_spawns = [];
