...
function private function_32ab045( ent, name )
{
    switch ( name )
    {
        ...
        case #"af_flyover":
            ...
            snd::stop_on_ent_death( var_d776868d, plane, 9 );
            break;
        case #"cargo_plane":
        ...
        case #"af_enemy_chase_veh":
            ...
            ent waittill( #"death" );
            level.af_enemy_chase_veh = snd::varrayremove( level.af_enemy_chase_veh, ent );
            break;
        case #"skid_veh":
...
function private _trigger( *player, trigger, *var_ec80d14b )
{
    ...
    switch ( trigger_name )
    {
        case #"$default":
            break;
        case #"tkdn_amsterdam_ext_air":
            break;
        case #"tkdn_bar_ext_rear_alley":
        case #"tkdn_bar_main_int":
        case #"tkdn_bar_hallway_int":
            break;
        case #"tkdn_apt_int_1f_kitchen":
        case #"tkdn_apt_int_1f_tvroom":
        case #"tkdn_apt_int_stairs":
        case #"tkdn_apt_int_1f_billiards_room":
        case #"tkdn_apt_int_3f_rooftop_sm_hallway":
        case #"tkdn_apt_int_1f_hallway":
        case #"tkdn_apt_ext_courtyard":
        case #"tkdn_apt_int_3f_bedroom":
            break;
        case #"tkdn_streets_roof_interrogation":
        case #"tkdn_streets_roof":
            break;
        case #"tkdn_af_ext_air":
            break;
        default:
            /#
    ...
    function function_5f2fe011()
    {
        ...
        while ( true )
        {
            if ( snd::function_95c9af4b() >= 2 )
            {
                ...
                {
                    if ( isdefined( var_15df3e17 ) && isdefined( var_15df3e17.soundlinkedentity ) )
                    {
                        velocity = var_15df3e17.soundlinkedentity getvelocity();
                        
                        if ( isvec( velocity ) )
                        {
                            speed = length( velocity );
                            txt = "<dev string:xc7>" + snd::printdecimalcount( speed, 1 );
...
function function_b3fdcb06( ent, var_9e542947, var_e03252b9 )
{
    ...
    snd::stop_on_ent_death( ent.var_726d44d2, ent );
...
function function_244835ac( ent, var_7eaf9fa5 )
{
    ...
    foreach ( var_60213bf0 in var_1cafb128 )
    {
        ...
        snd::stop_on_ent_death( var_d3d66b01, ent );
...
function cargo_debris( ent )
{
    if ( !isdefined( ent.var_a107d844 ) )
    {
        ...
        snd::stop_on_ent_death( var_a107d844, ent );
    }
}
