...
function init( instance )
{
    ...
    if ( instance.targetname === #"objective_zoo_defend" )
    {
...
function function_34ac205( instance, n_active, var_559503f1, n_wave )
{
    ...
    while ( true )
    {
        ...
        if ( instance.n_active < n_active )
        {
            ...
            str_aitype = get_aitype( instance, level.star_rating );
...
function on_dog_killed( *params )
{
    ...
    if ( self.aitype === #"spawner_bo5_zombie_dog_molotov" && isdefined( mdl_console ) )
    {
