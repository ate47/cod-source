...
function function_a6b0904f()
{
    ...
    {
        case #"right_platform_guy_1":
            level.var_59b550c1 = self;
            self thread function_f2f99070();
            break;
        case #"right_platform_guy_2":
            level.var_9872ce3b = self;
            break;
        case #"right_platform_guy_3":
...
function function_7219a1eb()
{
    ...
    {
        case #"ghost_station_flashlight_enemy":
...
function function_a8b99b8d()
{
    ...
    level waittill( #"platform_scene_start_door_end" );
...
function function_c5a054db()
{
    ...
    level waittill( #"platform_scene_start_end" );
...
function function_48695888()
{
    ...
    var_116e3c5f[ #"vehicle 5" ] playrumbleonentity( #"hash_2df4857520a49abc" );
    var_116e3c5f[ #"vehicle 8" ] playrumbleonentity( #"hash_2df4857520a49abc" );
    ...
    var_44fda395[ #"vehicle 5" ] playrumbleonentity( #"hash_2df4857520a49abc" );
    var_44fda395[ #"vehicle 8" ] playrumbleonentity( #"hash_2df4857520a49abc" );
...
function function_78d10ca2()
{
    ...
    while ( true )
    {
        result = level waittill( #"play_train_tunnel_fxanim" );
