...
function init( instance )
{
    ...
    foreach ( s_instance in instance.contentgroups[ #"payload" ] )
    {
        ...
        s_instance.var_b8ca9d7.var_559503f1 = s_instance.contentgroups[ #"spawn_final_pt" ];
    ...
    if ( isdefined( instance.contentgroups[ #"coll_payload_ramp_door" ] ) )
    {
        instance.var_f2af10b2 = util::spawn_model( instance.contentgroups[ #"coll_payload_ramp_door" ][ 0 ].model, instance.contentgroups[ #"coll_payload_ramp_door" ][ 0 ].origin, instance.contentgroups[ #"coll_payload_ramp_door" ][ 0 ].angles );
        waitframe( 1 );
    ...
    if ( isdefined( instance.contentgroups[ #"coll_payload_container" ] ) )
    {
        var_3608e7a6 = instance.contentgroups[ #"coll_payload_container" ][ 0 ];
    ...
    if ( instance.targetname === #"objective_duga_payload_teleport" )
    {
        instance.var_b8ca9d7 thread function_753d6448( instance );
    }
    else if ( instance.targetname === #"objective_duga_payload_noteleport" )
    {
        instance thread function_68ec5e25();
    }
    else if ( instance.targetname === #"objective_zoo_payload_teleport" )
    {
...
function function_83e5a141()
{
    ...
    if ( isdefined( self.contentgroups[ #"collision_truck_ramp" ] ) )
    {
        self.var_bce10cdf = content_manager::spawn_script_model( self.contentgroups[ #"collision_truck_ramp" ][ 0 ], #"hash_6a83a06a639fcc6b", 1 );
...
function function_1c8e1b20()
{
    self endon( #"objective_ended" );
    self.var_b8ca9d7 endon( #"death" );
    self.var_b8ca9d7 waittill( #"rift_done" );
...
function function_753d6448( instance )
{
    ...
    instance endon( #"objective_ended" );
    self waittill( #"custom" );
    a_s_pts = struct::get_array( #"duga_teleport_custom_pt" );
...
function function_7d3ebd69( instance )
{
    ...
    str_aitype = function_899e4373( level.star_rating );
    ...
    {
        var_e4c6e64a = namespace_85745671::function_9d3ad056( #"spawner_bo5_raz_sr", v_pt, v_ang, "payload_zombie" );
    }
...
function function_899e4373( var_661691aa )
{
    switch ( var_661691aa )
    {
        case 1:
        case 2:
            var_de82b392 = [ #"spawner_bo5_raz_sr" ];
            break;
        case 3:
        case 4:
            var_de82b392 = [ #"spawner_bo5_raz_sr", #"spawner_bo5_avogadro_sr", #"spawner_bo5_soa" ];
            break;
        case 5:
            var_de82b392 = [ #"spawner_bo5_raz_sr", #"spawner_bo5_avogadro_sr", #"spawner_bo5_soa", #"spawner_zm_steiner" ];
            break;
        default:
            var_de82b392 = [ #"spawner_bo5_raz_sr", #"spawner_bo5_avogadro_sr", #"spawner_bo5_soa", #"spawner_bo5_mechz_sr", #"spawner_zm_steiner", #"spawner_bo5_abom" ];
            break;
    }
...
function function_dd9b1007( instance, v_spawnpt, v_ang )
{
    ...
    instance endon( #"objective_ended" );
    level flag::wait_till( "spawn_zombies" );
    str_aitype = function_aece4588( level.star_rating );
...
function function_22281e97( instance, n_players, var_559503f1 )
{
    ...
    instance endon( #"objective_ended" );
    var_de82b392 = [];
    instance.var_e00b0988 = min( randomintrangeinclusive( n_players + level.star_rating, n_players + level.star_rating * 2 ), 6 );
    
    if ( math::cointoss() )
    {
        var_6b2ccc6b = #"spawner_bo5_zombie_dog_molotov";
    }
    else if ( level.star_rating < 2 )
    {
        var_6b2ccc6b = #"spawner_bo5_zombie_dog_molotov";
    }
    else
    {
        var_6b2ccc6b = #"spawner_bo5_zombie_dog_plague";
    }
...
{
    if ( self.aitype === #"spawner_bo5_zombie_dog_molotov" && !is_true( self.b_exploded ) )
    {
        self.b_exploded = 1;
...
function payload_teleport( instance )
{
    ...
    while ( true )
    {
        ...
        if ( isdefined( self.currentnode.script_string ) )
        {
            ...
            {
                var_cdce8e6f = instance.contentgroups[ #"chopper_gunner_path_payload_teleport_2" ][ 0 ];
