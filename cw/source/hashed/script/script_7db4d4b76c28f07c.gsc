...
function function_d156bb26()
{
    ...
    while ( true )
    {
        ...
        s_waitresult = player waittill( #"enter_camera_ads", #"ability_deactivated_camera", #"stop_binoc_attack_prompt" );
        ...
        s_waitresult = player waittilltimeout( 4, #"end_camera_ads_begin", #"ability_deactivated_camera", #"stop_binoc_attack_prompt" );
