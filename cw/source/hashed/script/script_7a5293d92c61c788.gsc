                        ...
                        if ( isdefined( var_35d31714 ) && isdefined( var_9b05d455 ) )
                        {
                            if ( var_35d31714 === #"hash_1bce1d027595650f" )
                            {
                                ...
                                else
                                {
                                    ...
                                    rarity_color = function_137f88c6( item.itementry.rarity );
                                    ...
                                    if ( var_3069fe3 )
                                    {
                                        ...
                                        self zm_weapons::function_8fdfe5e4( weapon, item, item_weapon, rarity_color, clipsize, var_9839b3b1, var_7fa2b50b );
...
// Size: 0xe4
function function_f3ce6afc( newarmor )
{
    if ( isplayer( self ) )
    {
        var_bb1797ae = { #var_7ebcde3b:hash( newarmor ), #var_7d003586:function_f8d53445(), #var_159283d5:zm_utility::get_round_number(), #var_500db157:zm_utility::function_e3025ca5() };
        self function_678f57c8( #"dlog_event_zm_armor", var_bb1797ae );
    }
}
...
// Size: 0xea
function give_armor( newarmor )
{
    point = function_4ba8fde( newarmor );
    ...
    if ( isdefined( point ) && isdefined( point.itementry ) )
    {
        ...
        self function_f3ce6afc( newarmor );
    }
