...
function preinit()
{
    ...
    clientfield::register( "world", "" + #"key_jelly", 1, 1, "int" );
    ...
    if ( util::get_map_name() === "wz_forest" )
    {
        ...
        zm_utility_zsurvival::function_c1ced485( #"sr_ee_hulk_tombstone_backup" );
    }
    ...
    content_manager::register_script( #"applause", &function_abb99222 );
    ...
    if ( util::get_map_name() === "wz_forest" )
    {
        level.var_a1e775a6[ #"cin_zm_sr_outbreak_forest_mid" ][ #"shot 170" ] = 1;
        scene::add_scene_func( #"cin_zm_sr_outbreak_forest_outro", &function_a91c56fa, "shot_040" );
        scene::add_scene_func( #"cin_zm_sr_outbreak_forest_mid", &function_a09ec067, "play" );
        scene::add_scene_func( #"cin_zm_sr_outbreak_forest_mid", &function_234568a5, "done" );
        scene::add_scene_func( #"cin_zm_sr_outbreak_forest_outro", &function_a09ec067, "play" );
        scene::add_scene_func( #"cin_zm_sr_outbreak_forest_outro", &function_234568a5, "done" );
    }
...
function function_a91c56fa( *a_ents )
{
    ...
    level waittill( #"rocket_launch_fade" );
...
function function_7c583c30( s_instance )
{
    ...
    if ( isarray( a_s_locations ) )
    {
        ...
        {
            var_f9b7dc96 = s_location.instances[ #"jump_pads" ];
...
{
    level endon( #"end_game" );
    var_d15706ed = s_instance.contentgroups[ #"key_mimic" ][ 0 ];
    var_5f698d8a = isdefined( var_d15706ed.contentgroups[ #"eggshell" ] ) ? var_d15706ed.contentgroups[ #"eggshell" ] : [];
...
function function_b6b9b6e6( s_instance, e_player )
{
    ...
    level thread scene::play( #"aib_t9_zm_sr_vign_cust_tempest_missile_01" );
    level thread scene::init( #"cin_zm_sr_outbreak_forest_mid" );
    wait 1;
    ...
    if ( !var_2d52e927 )
    {
        level scene::init_streamer( #"cin_zm_sr_outbreak_forest_mid", getplayers(), 0, 0 );
        ...
        level scene::play( #"cin_zm_sr_outbreak_forest_mid" );
        level namespace_9b972177::function_9f5c2ff2( "hulk_continues" );
    }
    else
    {
        level scene::stop( #"cin_zm_sr_outbreak_forest_mid", 1 );
    }
...
function function_6b1df768()
{
    ...
    zm_utility_zsurvival::function_c1ced485( #"sr_ee_hulk_tombstone_backup_during" );
    zm_utility_zsurvival::function_78d9625d( "vol_sr_ee_hulk_restrict" );
    zm_utility_zsurvival::function_118215e2( #"sr_ee_hulk_tombstone_backup" );
}
...
function function_282ec8be()
{
    ...
    zm_utility_zsurvival::function_118215e2( #"sr_ee_hulk_tombstone_backup_during" );
}
...
function function_dcb31940( s_instance, var_72aa02d6 )
{
    ...
    if ( !s_instance flag::get( #"lockdown_ended" ) )
    {
        ...
        level thread function_c2a64e82( var_72aa02d6, #"d_ground_floor", 10, undefined, 0, #"golden_first" );
        level thread function_c2a64e82( var_72aa02d6, #"d_top_floor", 10, undefined, 0, #"golden_first" );
        level thread function_c2a64e82( var_72aa02d6, #"central", 6, #"golden_half", 0, undefined, #"golden_first" );
        level thread function_c2a64e82( var_72aa02d6, #"a_top_floor", 10, #"golden_half", 0, undefined, #"golden_first" );
        level thread function_c2a64e82( var_72aa02d6, #"a_ground_floor", 10, #"golden_half", 0, undefined, #"golden_first" );
    }
}
...
function function_35f83dc7( s_instance )
{
    ...
    foreach ( var_e145744b in isdefined( s_instance.contentgroups[ #"ammo_cache_spawn" ] ) ? s_instance.contentgroups[ #"ammo_cache_spawn" ] : [] )
    {
...
function function_89e9be54( var_72aa02d6 )
{
    ...
    var_3b1f8c3c = isdefined( var_72aa02d6.contentgroups[ #"business" ] ) ? var_72aa02d6.contentgroups[ #"business" ] : [];
...
{
    var_72aa02d6 = s_instance.contentgroups[ #"key_mimic" ][ 0 ];
    ...
    while ( true )
    {
        ...
        ai_mimic = namespace_85745671::function_9d3ad056( #"spawner_bo5_mimic_hvt", var_18fd369a.origin, v_angles, undefined, 0 );
...
function function_cf0fb035( var_72aa02d6, ai_mimic, var_9fe8c6e9, e_player )
{
    ...
    item_key playloopsound( #"hash_6979a0759dfa9cb3" );
    item_key.var_a84740ef = #"key_mimic";
    wait 1;
...
{
    var_72aa02d6 = s_instance.contentgroups[ #"key_jelly" ][ 0 ];
    ...
    level clientfield::set( "" + #"key_jelly", 1 );
...
function function_855284ee( var_72aa02d6, mdl_body, s_key )
{
    ...
    item_key.var_a84740ef = #"key_jelly";
...
function function_56644615( var_72aa02d6 )
{
    ...
    if ( isarray( var_a6d869eb.a_ai_spawned[ #"key_jelly" ] ) )
    {
        function_1eaaceab( var_a6d869eb.a_ai_spawned[ #"key_jelly" ] );
        
        if ( var_a6d869eb.a_ai_spawned[ #"key_jelly" ].size >= 32 )
        {
            return;
        }
    }
    ...
    if ( var_a6d869eb.a_ai_spawned[ #"all" ].size >= var_a6d869eb.var_de4a9f7a )
    {
        function_886e403b( var_a6d869eb, #"all", var_a6d869eb.a_ai_spawned[ #"key_jelly" ], 1 );
    }
    ...
    if ( isdefined( s_spawn ) )
    {
        ...
        if ( isdefined( var_397a719 ) )
        {
            ...
            if ( !isdefined( var_a6d869eb.a_ai_spawned[ #"key_jelly" ] ) )
            {
                var_a6d869eb.a_ai_spawned[ #"key_jelly" ] = [];
            }
            else if ( !isarray( var_a6d869eb.a_ai_spawned[ #"key_jelly" ] ) )
            {
                var_a6d869eb.a_ai_spawned[ #"key_jelly" ] = array( var_a6d869eb.a_ai_spawned[ #"key_jelly" ] );
            }
            
            var_a6d869eb.a_ai_spawned[ #"key_jelly" ][ var_a6d869eb.a_ai_spawned[ #"key_jelly" ].size ] = var_397a719;
...
function function_861f39db( s_instance, b_debug = 0 )
{
    ...
    scene::add_scene_func( #"p9_fxanim_sv_boss_prop_wood_stack_bundle", &function_6188d81a, "init" );
    scene::add_scene_func( #"p9_fxanim_sv_boss_prop_pallets_bundle", &function_6188d81a, "init" );
    var_841919e8 = [];
...
function beast_defeated( var_b4488d57, var_5beedbc3 )
{
    ...
    level thread scene::init_streamer( #"cin_zm_sr_outbreak_forest_outro", getplayers(), 0, 0 );
    wait 3;
    ...
    level scene::stop( #"aib_t9_zm_sr_vign_cust_tempest_missile_01", 1 );
    ...
    level thread scene::init( #"cin_zm_sr_outbreak_forest_outro" );
    wait 0.5;
    level namespace_9b972177::function_9f5c2ff2( "scene_outro" );
    scene::add_scene_func( #"cin_zm_sr_outbreak_forest_outro", &function_d55fcc73 );
    level scene::play( #"cin_zm_sr_outbreak_forest_outro" );
...
{
    scene::remove_scene_func( #"cin_zm_sr_outbreak_forest_outro", &function_d55fcc73 );
...
function function_8dba2029( var_b4488d57 )
{
    ...
    var_c5f342a7 = [];
    var_6782fa22 = [];
    var_e8ed4d48 = [ #"spawner_bo5_raz_sr", #"spawner_bo5_mimic", #"spawner_zm_steiner", #"spawner_bo5_mechz_sr" ];
