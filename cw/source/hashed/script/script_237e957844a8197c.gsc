...
function function_afa9528d( var_2250555 )
{
    ...
    {
        a_ents = [];
        a_ents[ #"table_flipped" ] = getent( "flip_table", "targetname" );
...
function function_b1f33833( var_541d697 )
{
    ...
    var_e189955e = self.scene_ents[ #"table_flipped" ];
...
{
    level endon( #"flg_panic_room_camera" );
...
function function_c9b603f3( var_57ef78ed )
{
    ...
    {
        level waittill( #"play_lazar_entrance" );
        level thread scene::play( "scene_rev_3040_fir_cctv_lazar", "enter" );
        level waittill( #"lazar_enter_complete" );
...
function function_e73fa40e( var_57ef78ed )
{
    ...
    level waittill( #"flg_lazar_open_door" );
...
{
    level.player endon( #"death" );
    level waittill( #"flg_remove_clip" );
...
function private function_fe6c4ca4()
{
    ...
    level waittill( #"flg_rifle_exit_done" );
    var_207ec521 hide();
    wait 1.5;
...
function function_9f83193()
{
    ...
    {
        var_a2ac77ba[ 1 ] thread civ_cower( "scene_rev_0000_ambient_cower13", 500 );
    }
    
    if ( isdefined( var_a2ac77ba[ 2 ] ) )
    {
        var_a2ac77ba[ 2 ] thread civ_cower( "scene_rev_0000_ambient_cower14", 500 );
    }
}
...
// Size: 0xec
function civ_cower( var_fa359e06, var_67b4e975 )
{
    self endon( #"death" );
    actors[ #"guy" ] = self;
