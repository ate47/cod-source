...
function preinit()
{
    ...
    level.var_ac22a760 = struct::get_array( #"content_fow", "content_key" );
...
function function_d4dec4e8( destination, str_targetname )
{
    ...
    if ( isdefined( destination.contentgroups[ #"content_fow" ] ) )
    {
        ...
        {
            foreach ( var_87e97a7a in destination.contentgroups[ #"content_fow" ] )
            {
        ...
        {
            var_6c486d1a = destination.contentgroups[ #"content_fow" ][ 0 ];
        }
