...
function function_82ca1565( spawnpoint, gametype )
{
    switch ( gametype )
    {
        ...
        case #"dom_flag_d":
            return ( isdefined( spawnpoint.domination_flag_d ) && spawnpoint.domination_flag_d );
        case #"dom_flag_e":
            return ( isdefined( spawnpoint.domination_flag_e ) && spawnpoint.domination_flag_e );
        case #"dom_flag_f":
            return ( isdefined( spawnpoint.domination_flag_f ) && spawnpoint.domination_flag_f );
