...
function private preinit()
{
    ...
    zm_perk_tombstone::function_7c589e7( "tactical", #"item_zmquest_klaus_command_device" );
...
function function_18140c5c( params )
{
    ...
    if ( !isdefined( item ) || item.itementry.name !== #"item_zmquest_klaus_command_device" )
    {
        return;
    }
...
function function_bad0c914( item )
{
    if ( item.itementry.itemtype === #"tactical" )
    {
        ...
        if ( tactical.itementry.name === #"item_zmquest_klaus_command_device" )
        {
            return false;
        }
    }
...
function function_e7136ed2( e_player )
{
    ...
    point = function_4ba8fde( #"item_zmquest_klaus_command_device" );
