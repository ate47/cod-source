...
function init()
{
    ...
    a_s_rewards = struct::get_array( #"s_assault_round_rewards" );
...
function function_d08cba34( var_32f76af8 )
{
    ...
    foreach ( e_player in getplayers() )
    {
        e_player luinotifyevent( #"hash_5159e35a62fb7083", 3, 0, 11, level.star_rating );
    }
...
function function_5e2a6358( var_afa8e919, n_players, var_2a69785e, var_1a6bb917 = #"normal" )
{
    ...
    a_spawns[ #"Manglers" ] = var_76a4ebeb;
    ...
    while ( !var_d58c8115 )
    {
        ...
        foreach ( i, var_f57c3dea in var_7464cd64 )
        {
            ...
            if ( n_total > 0 && level.var_8c8c8ffd + n_total <= level.zombie_ai_limit )
            {
                ...
                var_76a4ebeb = a_spawns[ #"Manglers" ];
...
function function_44361a8f( control_point, var_e1c95338, var_ab56660c )
{
    ...
    while ( var_a77909d4 < var_ab56660c && var_5fa4c84a.size )
    {
        ...
        {
            if ( var_868cb618 !== #"spawner_bo5_zombie_dog_molotov" || var_868cb618 !== #"spawner_bo5_raz_sr" )
            {
...
function function_debefaed( var_e1c95338 = undefined )
{
    ...
    if ( isdefined( var_e1c95338 ) )
    {
        ...
        switch ( var_e1c95338 )
        {
            case 0:
                ...
                {
                    a_zombies = [ #"spawner_bo5_zombie_dog_molotov" ];
                    return array::random( a_zombies );
                }
            case 1:
                if ( var_628d63d0 > 30 )
    ...
    a_zombies = [ #"spawner_bo5_raz_sr", #"spawner_bo5_zombie_dog_molotov" ];
    return array::random( a_zombies );
}
...
function function_7f4a72d3( my_target )
{
    ...
    while ( true )
    {
        level waittill( #"orda_cast_dog_launcher" );
...
function function_b3267a55()
{
    ...
    while ( true )
    {
        level waittill( #"orda_stomp_right" );
        var_bb13ffb2 = 1;
...
function function_46cbde38()
{
    ...
    while ( true )
    {
        level waittill( #"orda_stomp_left" );
        var_bb13ffb2 = 0;
        self namespace_cc727a3b::function_23e153fb( var_bb13ffb2 );
    }
}
...
function private function_59f665f9()
{
    ...
    while ( true )
    {
        level waittill( #"orda_spawn_swarm" );
...
function private function_e4462869()
{
    ...
    s_waitresult = level waittill( #"orda_spawn_swarm", #"hash_76814119df7d7c65" );
    
    if ( s_waitresult._notify == #"orda_spawn_swarm" )
    {
