...
function function_74c76da9( destination )
{
    ...
    zm_utility_zsurvival::function_7c97e961( level.star_rating + 1 );
...
function private function_f169181c( destination )
{
    ...
    function_66855ea6( destination, #"phase_rift" );
...
{
    if ( str_type === #"hulking_summoner" && level.star_rating < 2 && !getdvarint( #"hash_730311c63805303a", 0 ) && !is_true( getgametypesetting( #"hash_1e1a5ebefe2772ba" ) ) )
    {
        return 0;
    }
...
function private function_b3dda48( s_destination )
{
    ...
    foreach ( s_location in s_destination.locations )
    {
        ...
        if ( isdefined( s_location.instances[ #"applause" ] ) )
        {
            content_manager::spawn_instance( s_location.instances[ #"applause" ] );
        }
...
function function_a6f84bf( s_destination )
{
    ...
    foreach ( s_location in s_destination.locations )
    {
        if ( isdefined( s_location.instances[ #"sr_ee_mq4_step1" ] ) )
        {
            content_manager::spawn_instance( s_location.instances[ #"sr_ee_mq4_step1" ] );
        }
        
        if ( isdefined( s_location.instances[ #"sr_ee_mq4_step2" ] ) )
        {
            ...
            var_b96bbac7[ var_b96bbac7.size ] = s_location.instances[ #"sr_ee_mq4_step2" ];
        }
        
        if ( isdefined( s_location.instances[ #"sr_ee_mq4_step3" ] ) )
        {
            content_manager::spawn_instance( s_location.instances[ #"sr_ee_mq4_step3" ] );
        }
        
        if ( isdefined( s_location.instances[ #"sr_ee_mq4_step5" ] ) )
        {
            content_manager::spawn_instance( s_location.instances[ #"sr_ee_mq4_step5" ] );
        }
    }
...
function function_63b54d8c()
{
    ...
    if ( level.star_rating === 1 && level.contentmanager.var_407236bf.list[ 0 ] === #"hunt" )
    {
        if ( isdefined( level.contentmanager.var_9614b1d2[ #"hunt" ] ) )
        {
            ...
            arrayremovevalue( level.contentmanager.var_9614b1d2[ #"hunt" ].list, #"hunt_abom" );
    ...
    if ( level.star_rating === 2 && level.contentmanager.var_407236bf.list[ 1 ] === #"hunt" )
    {
        if ( isdefined( level.contentmanager.var_9614b1d2[ #"hunt" ] ) )
        {
            arrayremovevalue( level.contentmanager.var_9614b1d2[ #"hunt" ].list, #"hunt_mechz" );
    ...
    if ( level.star_rating === 1 && level.contentmanager.var_407236bf.list[ 0 ] === #"payload" )
    {
