...
{
    level endon( #"end_ghost_station_stealth_volume_check" );
...
function function_e9e94ff2( var_8964d1a4 )
{
    if ( isdefined( self.target ) )
    {
        ...
        if ( !level flag::get( "stop_" + var_435b4812 ) )
        {
            ...
            {
                scene_start_time = float( self.script_parameters );
                scene scene::play_from_time( "Shot 1", undefined, undefined, scene_start_time, 0 );
            }
            else
            {
...
{
    if ( isdefined( a_ents[ #"harass_check_papers_umbrella" ] ) )
    {
        a_ents[ #"harass_check_papers_umbrella" ] thread function_ca7fdd25();
    }
}
...
{
    level.var_b86d4e0 = a_ents[ #"enemy6" ];
...
function function_77fe8bb5( vo_guard, var_2020cd93, var_e1b2a82b, *var_6b1c6e7d )
{
    ...
    switch ( self.var_61d3da92.script_animation )
    {
        ...
        case #"harass_question_woman":
            ...
            var_f430b579[ var_f430b579.size ] = voline;
            break;
        case #"harass_question_man_apt_st":
            var_f430b579 = [];
            voline = spawnstruct();
            ...
            var_f430b579[ var_f430b579.size ] = voline;
            break;
        case #"harass_question_man_2_apt_st":
            var_f430b579 = [];
            voline = spawnstruct();
...
function function_d0551a1b( from_vol, retreat_vol, delay_min, delay_max )
{
    ...
    retreaters = checkvol ai::function_18c4ff86( "axis", "human" );
