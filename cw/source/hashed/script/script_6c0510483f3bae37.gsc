...
function cleanup( *name, *starting, *direct, *player )
{
    ...
    object_descriptions::remove_all();
...
function function_dbef1d1a()
{
    ...
    level waittill( #"player_gear_up_done" );
...
{
    level.player endon( #"death" );
    level waittill( #"elev_down_fade_out" );
    level.player thread lui::screen_fade_out( 0.5, "black" );
    level waittill( #"elev_down_model_swap" );
    ...
    level waittill( #"elev_down_fade_in" );
