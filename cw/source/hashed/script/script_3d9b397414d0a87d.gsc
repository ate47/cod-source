...
function private preinit()
{
    ...
    {
        case #"koth":
            level.var_ab8dd45a = { #var_284ea17f:#"dlog_event_esports_player_match_end_hardpoint", #data_function:&function_99b4929d };
            level.var_86d47028 = { #var_284ea17f:#"dlog_event_esports_player_round_end_hardpoint", #data_function:&function_6607b43f };
            level.var_8d67cbd8 = { #var_284ea17f:#"dlog_event_esports_hardpoint_objective_state_changed", #data_function:&function_712f816a };
            level.var_46fc4fdb = &function_4dc75f1b;
            level.var_e1206cfc = &function_f2282b8b;
            break;
        case #"sd":
            level.var_ab8dd45a = { #var_284ea17f:#"dlog_event_esports_player_match_end_snd", #data_function:&function_39e8afcf };
            level.var_86d47028 = { #var_284ea17f:#"dlog_event_esports_player_round_end_snd", #data_function:&function_9555b8d2 };
            level.var_8d67cbd8 = { #var_284ea17f:#"dlog_event_esports_snd_objective_state_changed", #data_function:&function_150786f3 };
            level.var_46fc4fdb = &function_86398c9c;
            level.var_e1206cfc = &function_ceb40ef4;
            break;
        case #"control":
            level.var_ab8dd45a = { #var_284ea17f:#"dlog_event_esports_player_match_end_control", #data_function:&function_91a0716f };
            level.var_86d47028 = { #var_284ea17f:#"dlog_event_esports_player_round_end_control", #data_function:&function_b16086a1 };
            level.var_8d67cbd8 = { #var_284ea17f:#"dlog_event_esports_control_objective_state_changed", #data_function:&function_cdce904b };
            level.var_88531f89 = { #var_284ea17f:#"dlog_event_esports_match_interval_info_control", #data_function:&function_2b1314ec };
...
function function_3651a831()
{
    ...
    var_284ea17f = #"dlog_event_esports_match_interval_info";
...
function function_a8ccfb6()
{
    ...
    foreach ( player_event in all_events )
    {
        ...
        player function_678f57c8( #"dlog_event_esports_player_interval_info", player_event.event );
        waitframe( 1 );
    }
}
...
function on_start_gametype()
{
    if ( util::isfirstround() )
    {
        ...
        function_92d1707f( #"dlog_event_esports_server_start", esports_event );
    }
}
...
{
    esports_event = { #game_type:level.gametype, #map_name:level.map_name, #var_53efd038:function_1674a96a( #"allies" ), #var_16d89ef:function_1674a96a( #"axis" ) };
    function_92d1707f( #"dlog_event_esports_match_start", esports_event );
}
...
function function_d519e318()
{
    ...
    function_92d1707f( #"dlog_event_esports_match_end", esports_event );
}
...
function on_player_spawned()
{
    ...
    self function_678f57c8( #"dlog_event_esports_player_spawned", esports_event );
}
...
function on_player_killed( data )
{
    ...
    victim function_678f57c8( #"dlog_event_esports_player_killed", #"info", kill_info, #"attacker", attacker_info, #"attacker_status", var_ebf88f4, #"victim", victim_info, #"victim_status", var_61e89f84, #"kill_context", kill_context );
}
...
function on_player_disconnect()
{
    ...
    self function_678f57c8( #"dlog_event_esports_player_disconnect", esports_event );
}
...
function function_e2162733()
{
    ...
    self function_678f57c8( #"dlog_event_esports_player_loadout_changed", esports_event );
}
...
function on_round_start()
{
    ...
    function_92d1707f( #"dlog_event_esports_round_start", esports_event );
}
...
function on_round_end()
{
    ...
    function_92d1707f( #"dlog_event_esports_round_end", esports_event );
}
...
function function_2d28a3b3()
{
    ...
    var_284ea17f = #"dlog_event_esports_player_round_end";
...
function function_d5aacfd7( credit_player )
{
    ...
    var_284ea17f = #"dlog_event_esports_objective_state_changed";
...
function function_f2282b8b()
{
    ...
    function_92d1707f( #"dlog_event_esports_objective_info_hardpoint", #"objective1_info", isdefined( var_e87e5141[ 0 ] ) ? var_e87e5141[ 0 ] : {}, #"objective2_info", isdefined( var_e87e5141[ 1 ] ) ? var_e87e5141[ 1 ] : {}, #"objective3_info", isdefined( var_e87e5141[ 2 ] ) ? var_e87e5141[ 2 ] : {}, #"hash_63c1781e1881c679", isdefined( var_e87e5141[ 3 ] ) ? var_e87e5141[ 3 ] : {}, #"hash_85376cdd236d6e4", isdefined( var_e87e5141[ 4 ] ) ? var_e87e5141[ 4 ] : {} );
}
...
function function_ceb40ef4()
{
    ...
    function_92d1707f( #"dlog_event_esports_objective_info_snd", #"objective1_info", isdefined( var_e87e5141[ 0 ] ) ? var_e87e5141[ 0 ] : {}, #"objective2_info", isdefined( var_e87e5141[ 1 ] ) ? var_e87e5141[ 1 ] : {} );
}
...
function function_a9b19a49()
{
    ...
    function_92d1707f( #"dlog_event_esports_objective_info_control", #"objective1_info", isdefined( var_e87e5141[ 0 ] ) ? var_e87e5141[ 0 ] : {}, #"objective2_info", isdefined( var_e87e5141[ 1 ] ) ? var_e87e5141[ 1 ] : {}, #"control_info", control_info );
}
