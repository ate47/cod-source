...
function function_3369f0c5()
{
    ...
    if ( usinggamepad )
    {
        namespace_c8e236da::addprompt( #"hash_4dbc4bd4b6006eed" );
        namespace_c8e236da::addprompt( #"hash_2b76a90fe9fa674f" );
    }
    else if ( var_eeccc49f )
    {
        namespace_c8e236da::addprompt( #"hash_728b7bdb1313421c" );
    }
    
    if ( var_c9ed28e4 )
    {
        namespace_c8e236da::addprompt( #"hash_70dd599464b0044" );
    }
    else
    {
        namespace_c8e236da::addprompt( #"hash_1632eeb11fb9d59" );
    }
    
    if ( !usinggamepad && !var_ce3139b1 )
    {
        namespace_c8e236da::addprompt( #"hash_1b8b60beb626fb8a" );
        return;
    }
    
    namespace_c8e236da::addprompt( #"hash_1f85b592c37f12f0" );
}
