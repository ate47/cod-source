...
function setup_objectives( var_567f1ddd )
{
    switch ( var_567f1ddd )
    {
        case #"tkdn_heli_intro":
            level waittill( #"hit1_add_objectives" );
...
{
    a_lights = getentarray( var_89b78ba7, "targetname" );
    ...
    if ( a_lights.size )
    {
        ...
        self thread function_c7a4bc11( { #parts:var_ad298278, #lights:a_lights, #var_5adc4dbd:var_18698d26, #var_ff97e2b9:var_2b0724ab } );
        return;
    }
