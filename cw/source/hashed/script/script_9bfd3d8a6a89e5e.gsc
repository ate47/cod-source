...
function function_e3e4c03c( action, body )
{
    ...
    self.takedown.body.takedown_live = 1;
...
function function_756e29bb( action, anim_name, var_c09e9b1c, var_d60fb210, var_2e7da7fb, var_7369af2b )
{
    ...
    self endoncallback( &function_d6fbc26, action.ender, #"player_body_shield_view_anims_end" );
...
function function_9c53ef0a()
{
    ...
    self notify( #"player_body_shield_view_anims_end" );
...
{
    self endon( #"player_body_shield_cleanup" );
    ...
    self notify( #"player_body_shield_cleanup" );
}
...
{
    self endon( action.ender, #"body_shield_drop" );
...
function function_c13ab5c7( action )
{
    ...
    while ( true )
    {
        ...
        {
            self notify( #"body_shield_drop_death" );
            return;
        }
...
function function_9fa1a484()
{
    ...
    self.takedown.body_shield.actor delete();
    self waittill( #"body_shield_finished" );
}
