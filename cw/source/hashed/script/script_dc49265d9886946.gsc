...
function private preinit()
{
    ...
    content_manager::register_script( #"zoo_next", &function_1cf80b5e );
    content_manager::register_script( #"final_quest_site", &function_5e5224f3 );
...
function function_a5ef96da( params )
{
    ...
    {
        instance = location.instances[ #"zoo_next" ];
    ...
    foreach ( location in a_locations )
    {
        var_8f82cb55 = location.instances[ #"final_quest_site" ];
...
function function_483192e9()
{
    ...
    if ( isdefined( player ) )
    {
        var_f7b289b6 = level.var_f1f2207c.contentgroups[ #"fq_altar_interact" ][ 0 ];
...
function function_b6b75a5c( params )
{
    ...
    s_teleport = level.var_f1f2207c.contentgroups[ #"fq_player_teleport" ][ 0 ];
    self setinvisibletoplayer( player, 1 );
