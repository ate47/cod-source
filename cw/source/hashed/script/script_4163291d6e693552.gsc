...
{
    switch ( level.star_rating )
    {
        case 1:
            var_5e36739b = undefined;
            break;
        case 2:
            var_5e36739b = [ #"spawner_bo5_mimic", #"spawner_bo5_raz_sr" ];
            break;
        case 3:
        case 4:
            var_5e36739b = [ #"spawner_bo5_avogadro_sr", #"spawner_bo5_mimic", #"spawner_bo5_raz_sr" ];
            break;
        case 5:
            var_5e36739b = [ #"spawner_bo5_avogadro_sr", #"spawner_bo5_mimic", #"spawner_bo5_raz_sr", #"spawner_zm_steiner" ];
            break;
        default:
            var_5e36739b = [ #"spawner_bo5_avogadro_sr", #"spawner_bo5_mechz_sr", #"spawner_bo5_mimic", #"spawner_bo5_raz_sr", #"spawner_zm_steiner", #"spawner_bo5_abom" ];
            break;
    }
...
{
    if ( str_aitype === #"spawner_bo5_avogadro_sr" || str_aitype === #"spawner_bo5_mechz_sr" || str_aitype === #"spawner_bo5_mimic" || str_aitype === #"spawner_bo5_raz_sr" || str_aitype === #"spawner_zm_steiner" || str_aitype === #"spawner_bo5_abom" )
    {
        return true;
    }
...
function function_b9e4c169()
{
    switch ( level.star_rating )
    {
        ...
        case 2:
            if ( math::cointoss() )
            {
                str_aitype = #"spawner_bo5_zombie_sr";
            }
            else
            {
                str_aitype = #"spawner_bo5_zombie_sr_female";
            }
            
            break;
        case 3:
        case 4:
            str_aitype = #"spawner_bo5_zombie_sr_armor_medium";
            break;
        default:
            str_aitype = #"spawner_bo5_zombie_sr_armor_heavy";
            break;
    }
...
function function_1b53cdc7()
{
    ...
    switch ( level.star_rating )
    {
        ...
        case 9:
            ...
            break;
        default:
            var_61c57c53 = min( level.star_rating, n_players + 7 );
            break;
    }
...
function function_56fa33d9()
{
    ...
    switch ( level.star_rating )
    {
        ...
        case 9:
            ...
            break;
        default:
            var_b803db9c = min( level.star_rating - 3, n_players + 4 );
            break;
    }
...
{
    n_cooldown = 120 / level.star_rating;
    return n_cooldown;
}
...
{
    var_c18c5f = isdefined( s_instance.contentgroups[ #"chopper_gunner_path" ] ) ? s_instance.contentgroups[ #"chopper_gunner_path" ] : [];
