...
{
    level thread player_swap_moment();
...
function player_swap_moment()
{
    ...
    level.adler = namespace_e77bf565::adler_spawn( "kgb_ins_rv" );
...
{
    level.player endon( #"death" );
    level waittill( #"player_swap_blur" );
...
function function_3209e378()
{
    ...
    level.adler waittill( #"start_hallway_talk" );
    namespace_353d803e::music( "8.2_cello_stingers_1" );
...
{
    level.adler waittill( #"start_stairs_duo" );
...
{
    a_ents[ #"prison_stairs_guard_1" ] thread function_c1e43496();
    a_ents[ #"prison_stairs_guard_2" ] thread function_c1e43496();
}
...
{
    var_8a3834d = a_ents[ #"charkov_prisoner" ];
...
function function_9b6d9815( off = 1 )
{
    ...
    if ( off )
    {
        ...
        level.player val::set( #"player_swap_moment", "allow_stand", 1 );
        level.player val::set( #"player_swap_moment", "allow_crouch", 0 );
