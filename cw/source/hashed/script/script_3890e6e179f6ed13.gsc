...
{
    a_ents[ #"pilot_1" ].script_friendname = "";
    a_ents[ #"pilot_2" ].script_friendname = "";
    a_ents[ #"pilot_3" ].script_friendname = "";
    a_ents[ #"pilot_4" ].script_friendname = "";
    a_ents[ #"ally_1" ].script_friendname = "";
    a_ents[ #"ally_2" ].script_friendname = "";
    level.var_5b74d56b = [ a_ents[ #"pilot_3" ], a_ents[ #"pilot_4" ], a_ents[ #"ally_1" ], a_ents[ #"ally_2" ] ];
}
...
{
    level waittill( #"anim_notify_convoy_enable_nodes" );
...
{
    self endon( #"death" );
    self waittill( #"anim_notify_seek_exit_path" );
...
{
    self waittill( #"intro_truck_stop" );
...
{
    self endon( #"death" );
    self waittill( #"anim_notify_convoy_enable_nodes" );
