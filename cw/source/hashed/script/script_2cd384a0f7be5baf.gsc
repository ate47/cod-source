...
function function_b9dad1c1()
{
    ...
    level waittill( #"str_excav_player_descent_done" );
...
{
    self endon( #"death" );
    self waittill( #"elevator_descent_player_on_cable" );
    self playrumbleonentity( #"jump_rumble_start" );
    self playrumblelooponentity( #"buzz_high" );
    self waittill( #"elevator_descent_player_off_cable" );
...
{
    level endon( #"flg_excavation_alpha_charger_2_spawn" );
    var_91347afc = 5;
...
{
    level endon( #"flg_excavation_alpha_right_exit_spawn" );
...
function function_5e8fd656()
{
    ...
    level thread breadcrumb::function_61037c6c( #"breadcrumb_excavation_charlie" );
}
...
{
    level thread breadcrumb::function_61037c6c( #"breadcrumb_excavation_start" );
}
...
{
    level waittill( #"excavation_charlie_chopper_start_vo" );
    wait 1;
