...
/#
    ...
    function private function_97c5cb9a( params )
    {
        ...
        if ( params.value )
        {
            mission_list = [ "<dev string:x6a>", "<dev string:x79>", "<dev string:x8a>", "<dev string:x9d>", "<dev string:xaf>", "<dev string:xc2>", "<dev string:xd0>", "<dev string:xe3>", "<dev string:xf8>", "<dev string:x108>", "<dev string:x117>", "<dev string:x132>" ];
            
            foreach ( mission_name in mission_list )
            {
...
function private function_5501ae88()
{
    ...
    if ( !savegame::function_2ee66e93( "ExamineEvidenceHintShown", 0 ) )
    {
        ...
        scripted_widgets::function_46df0bc7( #"hint_tutorial", 999 );
        scripted_widgets::function_d3c3e5c3( #"hint_tutorial", [ #"dialog_tree", #"computer" ] );
...
function private function_bdf71927( *params )
{
    ...
    foreach ( mapdata in blackboard.var_3cb3ede5 )
    {
        if ( isdefined( mapdata.var_8349c453 ) )
        {
            ...
            scripted_widgets::create( uid, #"hash_21d9a29850806057" );
            scripted_widgets::function_d3c3e5c3( uid, #"interactive_map" );
            scripted_widgets::set_state( uid, 0 );
            scripted_widgets::set_ent( uid, mapdata.var_8349c453 );
        ...
        if ( isdefined( mapdata.var_1a7f654 ) )
        {
            ...
            {
                scripted_widgets::set_state( uid, 2 );
            }
            else
            {
                scripted_widgets::set_state( uid, 1 );
            }
            
            scripted_widgets::set_ent( uid, mapdata.var_1a7f654 );
    ...
    namespace_c8e236da::addprompt( #"hash_70ea6473ebf66053" );
}
...
function private function_f77a1784( *params )
{
    ...
    player scripted_widgets::function_b0bad5ff( "eboard_state_change" );
...
{
    return !scripted_widgets::should_hide( #"interactive_map" );
}
...
function private function_5b9bb291( *params )
{
    ...
    assert( !scripted_widgets::exists( #"hash_3ccc1702bc979da8" ) );
    scripted_widgets::create( #"hash_3ccc1702bc979da8", #"hash_4130605c2e66825d" );
    scripted_widgets::function_d3c3e5c3( #"hash_3ccc1702bc979da8", #"interactive_map" );
    var_9f97b0c5 = isdefined( evidence.AlignRight ) && evidence.AlignRight == 1;
    scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "AlignRight", var_9f97b0c5 );
    scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "MapName", blackboard.var_c5bde695 );
    scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "Year", evidence.var_2200aced );
    scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "HasNewEvidence", is_true( evidence.var_1ca68c21 ) );
    var_6f3b6154 = function_1447e257( evidence );
    
    if ( var_6f3b6154 )
    {
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "CanPlayMission", 0 );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LevelName", isdefined( evidence.var_c4ac97e4 ) ? evidence.var_c4ac97e4 : evidence.levelname );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LevelDifficulty", "" );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LongDescription", isdefined( evidence.var_c8c2549a ) ? evidence.var_c8c2549a : evidence.var_47b1727b );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LevelPresence", isdefined( evidence.var_fcfeae68 ) ? evidence.var_fcfeae68 : evidence.LevelPresence );
    }
    else
    {
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "CanPlayMission", 1 );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LevelName", evidence.levelname );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LevelDifficulty", "" );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LongDescription", evidence.var_47b1727b );
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LevelPresence", evidence.LevelPresence );
    }
    ...
    if ( is_true( missiondata.complete ) && isdefined( missiondata.var_8757a567 ) )
    {
        ...
        scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LevelDifficulty", var_4a19e561 );
    }
    
    scripted_widgets::function_9ade1d9b( #"hash_3ccc1702bc979da8", "LastSelectedButton", isdefined( blackboard.var_bcb26d08 ) ? blackboard.var_bcb26d08 : -1 );
    ...
    if ( isdefined( evidence.var_4458275e ) )
    {
        ...
        for ( var_d871a85c = 0; var_d871a85c < evidence.var_4458275e.size ; var_d871a85c++ )
        {
            if ( player_decision::function_6efc0ff8( blackboard.var_c5bde695, var_d871a85c ) )
            {
                ...
                scripted_widgets::function_f2a9266( #"hash_3ccc1702bc979da8", displayindex, "IsPrimaryObjective", var_e8c1b531.IsPrimaryObjective === 1 );
                scripted_widgets::function_f2a9266( #"hash_3ccc1702bc979da8", displayindex, "IsEvilObjective", var_e8c1b531.IsEvilObjective === 1 );
                scripted_widgets::function_f2a9266( #"hash_3ccc1702bc979da8", displayindex, "Index", var_e8c1b531.itemindex );
                scripted_widgets::function_f2a9266( #"hash_3ccc1702bc979da8", displayindex, "Title", var_e8c1b531.title );
                displayindex++;
            }
        }
    }
    
    scripted_widgets::set_focus( #"hash_3ccc1702bc979da8", 0 );
    ...
    if ( player function_305352b5() )
    {
        ...
        scripted_widgets::hide_widgets( #"hash_3ccc1702bc979da8", [ #"interactive_map" ] );
    ...
    scripted_widgets::set_focus( #"hash_3ccc1702bc979da8", 1 );
    
    if ( var_5c5bb311 )
    {
        namespace_c8e236da::addprompt( #"hash_21282e1a3a54e697" );
...
function private function_c7ffe282( *params )
{
    ...
    while ( true )
    {
        ...
        if ( !scripted_widgets::exists( #"hash_3ccc1702bc979da8" ) )
        {
            continue;
        }
...
function private function_96e31558( *params )
{
    ...
    assert( scripted_widgets::exists( #"hash_3ccc1702bc979da8" ) );
    scripted_widgets::set_focus( #"hash_3ccc1702bc979da8", 0 );
    scripted_widgets::remove( #"hash_3ccc1702bc979da8" );
    statemachine = player function_1bb19090();
    ...
    if ( player function_a997529d() )
    {
        ...
        scripted_widgets::function_f96376c5( #"hash_3ccc1702bc979da8" );
    }
...
function private function_de709256( *params )
{
    ...
    assert( isdefined( blackboard.var_c5bde695 ) );
    evidence = blackboard.var_3cb3ede5[ blackboard.var_c5bde695 ];
    scripted_widgets::hide_widgets( #"hash_34f10865afcf9af7", [ #"interactive_map" ] );
    ...
    if ( !var_fc34020f )
    {
        namespace_c8e236da::addprompt( #"hash_7711aac8b3b77847" );
    }
    
    namespace_c8e236da::addprompt( #"hash_70ea6473ebf66053" );
    namespace_c8e236da::addprompt( #"hash_545a24d4a3a88817" );
    namespace_c8e236da::addprompt( #"hash_700b367af088c0c3" );
...
function private function_35a396ee( *params )
{
    ...
    while ( true )
    {
        ...
        if ( !scripted_widgets::exists( #"hash_34f10865afcf9af7" ) )
        {
            continue;
        }
...
function private function_3740b568()
{
    ...
    waitframe( 1 );
    scripted_widgets::function_f96376c5( #"hash_34f10865afcf9af7" );
    statemachine = player function_1bb19090();
    blackboard = statemachine.blackboard;
    assert( isdefined( blackboard.var_c5bde695 ) );
...
function private function_e6734894( *params )
{
    ...
    assert( !scripted_widgets::exists( #"hash_afc09dfd34bcde0" ) );
    scripted_widgets::create( #"hash_afc09dfd34bcde0", #"hash_102694e2bfda6f95" );
    scripted_widgets::function_d3c3e5c3( #"hash_afc09dfd34bcde0", #"interactive_map" );
    scripted_widgets::function_9ade1d9b( #"hash_afc09dfd34bcde0", "evidenceEarnedCount", 0 );
    scripted_widgets::function_9ade1d9b( #"hash_afc09dfd34bcde0", "evidenceTotalCount", 0 );
    var_625081d5 = 0;
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "Ref", var_7fb2f6df.name );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "Title", var_7fb2f6df.title );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "SubTitle", var_7fb2f6df.subtitle );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "Description", var_7fb2f6df.description );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "Thumbnail", var_7fb2f6df.thumbnail );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "IsUnlocked", 1 );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "UnlockType", var_7fb2f6df.UnlockType );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "UnlockMap", var_7fb2f6df.UnlockMap );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "Hint", hinttext );
    scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", var_625081d5, "IsCompleted", var_fc34020f || var_ccb596bd );
    player clientfield::set_to_player( "set_hub_dof", 1 );
    player clientfield::set_to_player( "set_hub_fov", 1 );
    ...
    blackboard.var_1bfff22b show();
    scripted_widgets::set_focus( #"hash_afc09dfd34bcde0", 1 );
    namespace_c8e236da::removelist();
    ...
    if ( blackboard.var_9b52b1bf )
    {
        if ( var_ccb596bd )
        {
            namespace_c8e236da::addprompt( #"hash_7f24e58a797a8ecb" );
        }
        else
        {
            namespace_c8e236da::addprompt( #"hash_1dcd987d46fd8a85" );
        }
    }
...
function private function_dd090dfe( *params )
{
    ...
    if ( player function_a997529d() )
    {
        ...
        player clientfield::set_to_player( "eboard_review_handle_viewmodel", 0 );
        assert( scripted_widgets::exists( #"hash_afc09dfd34bcde0" ) );
        scripted_widgets::remove( #"hash_afc09dfd34bcde0" );
        namespace_c8e236da::removelist();
        waitframe( 1 );
        return;
    }
    
    if ( scripted_widgets::exists( #"hash_afc09dfd34bcde0" ) )
    {
        scripted_widgets::remove( #"hash_afc09dfd34bcde0" );
    }
}
...
function private function_b00f82b( params )
{
    ...
    while ( player scripted_widgets::function_70217795() )
    {
        waitframe( 1 );
    }
...
function private function_e2e9758c( *params )
{
    ...
    if ( player function_305352b5() )
    {
        ...
        scripted_widgets::function_9ade1d9b( #"hash_afc09dfd34bcde0", "evidenceEarnedCount", var_2a015e7e );
        scripted_widgets::function_9ade1d9b( #"hash_afc09dfd34bcde0", "evidenceTotalCount", var_f8f020e3 );
        
        foreach ( index, collectible in evidence.var_dade7c7f )
        {
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "Ref", collectible.name );
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "Title", collectible.title );
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "SubTitle", collectible.subtitle );
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "UnlockType", collectible.UnlockType );
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "UnlockMap", collectible.UnlockMap );
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "Hint", #"" );
            var_779873c0 = isdefined( collectible.var_779873c0 ) ? collectible.var_779873c0 : 0;
            
            if ( var_779873c0 == 0 )
            {
                scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "Description", collectible.description );
            }
            else if ( var_779873c0 == 1 )
            {
                ...
                scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "Description", description );
            }
            
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "Thumbnail", collectible.thumbnail );
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "IsUnlocked", collectible.isunlocked );
            isnew = collectibles::function_ee216b9e( evidence.var_8ca1d4a, collectible.var_2a51713 );
            scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", index, "IsNew", isnew );
        }
        
        if ( function_1447e257( evidence ) )
        {
            scripted_widgets::function_9ade1d9b( #"hash_afc09dfd34bcde0", "text", isdefined( evidence.var_c4ac97e4 ) ? evidence.var_c4ac97e4 : evidence.levelname );
        }
        else
        {
            scripted_widgets::function_9ade1d9b( #"hash_afc09dfd34bcde0", "text", evidence.levelname );
        }
...
function private function_9019d1f0( oldindex, newindex )
{
    player = self;
    assert( isplayer( player ) );
    scripted_widgets::function_9ade1d9b( #"hash_afc09dfd34bcde0", "count", newindex );
    statemachine = player function_1bb19090();
    blackboard = statemachine.blackboard;
    assert( isdefined( blackboard.var_c5bde695 ) );
    evidence = blackboard.var_3cb3ede5[ blackboard.var_c5bde695 ];
    ...
    if ( is_true( var_38d97d58.isunlocked ) && collectibles::function_606a97af( var_38d97d58.callback ) )
    {
        if ( var_38d97d58.callback == #"hash_2bfb881b2d0ed7f7" )
        {
            ...
            {
                namespace_c8e236da::clearprompt( 0 );
            }
    ...
    if ( oldindex >= 0 )
    {
        scripted_widgets::function_f2a9266( #"hash_afc09dfd34bcde0", oldindex, "IsNew", 0 );
    }
...
function private function_3db40935( *params )
{
    ...
    if ( scripted_widgets::exists( #"hash_afc09dfd34bcde0" ) )
    {
        scripted_widgets::set_focus( #"hash_afc09dfd34bcde0", 0 );
    }
}
...
function private function_b3f7df56( var_38d97d58 )
{
    ...
    namespace_c8e236da::addprompt( #"hash_412ac8802ccc592d" );
    scripted_widgets::create( #"hash_2ee86a814f89b7c1", #"hash_6ad4f1126c3ec0e1" );
    scripted_widgets::function_d3c3e5c3( #"hash_2ee86a814f89b7c1", #"interactive_map" );
    scripted_widgets::function_9ade1d9b( #"hash_2ee86a814f89b7c1", "title", var_38d97d58.var_812bb4e9, 0 );
    scripted_widgets::function_9ade1d9b( #"hash_2ee86a814f89b7c1", "subtitle", var_38d97d58.var_305bd749, 0 );
    scripted_widgets::function_9ade1d9b( #"hash_2ee86a814f89b7c1", "text", var_38d97d58.var_5eeb1ad0, 0 );
    scripted_widgets::function_b0bad5ff();
    scripted_widgets::remove( #"hash_2ee86a814f89b7c1" );
}
...
function private function_e14ba795()
{
    ...
    while ( true )
    {
        ...
        player scripted_widgets::function_b0bad5ff( undefined, "flag_player_using_evidence_board" );
...
function function_5f8cfb0f( var_88e62a80 )
{
    ...
    {
        namespace_c8e236da::addprompt( #"hash_1bf05148cc28df3c" );
    }
...
function function_f1d97432( var_88e62a80 )
{
    ...
    while ( true )
    {
        ...
        if ( var_92e26cfc != isusinggamepad )
        {
            ...
            {
                namespace_c8e236da::clearprompt( var_88e62a80 );
            }
        }
