...
// Size: 0xf4
function function_e3ba2154( flg_endon )
{
    level flag::wait_till( "flg_amk_player_spawned" );
    level.player endon( #"death" );
    ...
    {
        level flag::wait_till( flg_endon );
    ...
    switch ( str_objective )
    {
        ...
        case #"apc_mall":
            if ( !level flag::get( "flg_apc_ride_apc_destroyed" ) )
            {
                ...
                var_59c98490[ #"enemy_apc1" ] = level.var_170f6d3b;
                var_59c98490[ #"enemy_apc2" ] = level.var_de187b4e;
                var_59c98490[ #"car1" ] = level.var_9bdc49b5;
                var_59c98490[ #"car2" ] = level.var_8d81ad00;
                var_59c98490[ #"car3" ] = level.var_8237966c;
                var_59c98490[ #"car4" ] = level.var_74f57be8;
...
{
    var_b623ad82 = array( #"flg_apc_ride_town_square_start", #"flg_apc_ride_town_square_enter", #"flg_apc_ride_town_square_crash", #"flg_apc_ride_town_square_steps", #"flg_apc_ride_town_square_midpoint", #"flg_apc_ride_town_square_see_exit", #"flg_apc_ride_town_square_near_exit", #"flg_apc_ride_town_square_curb", #"flg_apc_ride_town_square_exit", #"flg_apc_ride_mall_transition_start", #"flg_apc_ride_mall_transition_rpg", #"flg_apc_ride_mall_under_catwalk", #"flg_apc_ride_mall_turn_start", #"flg_apc_ride_mall_turn_end", #"flg_apc_ride_mall_transition_end", #"flg_apc_ride_mall_car_hit_1", #"flg_apc_ride_mall_car_hit_2", #"flg_apc_ride_mall_blockade_start", #"flg_apc_ride_mall_rpg_1", #"flg_apc_ride_mall_car_hit_3", #"flg_apc_ride_mall_blockade_midpoint", #"flg_apc_ride_mall_rpg_2", #"flg_apc_ride_mall_car_hit_4", #"flg_apc_ride_mall_rpg_3", #"flg_apc_ride_mall_blockade_smash", #"flg_apc_ride_mall_break_gate_1", #"flg_apc_ride_mall_at_booth", #"flg_apc_ride_mall_break_gate_2", #"flg_apc_ride_exit_up_ramp", #"flg_apc_ride_exit_jump_start", #"flg_apc_ride_exit_jump_end", #"flg_apc_ride_exit_outside", #"flg_apc_ride_exit_close_gate", #"flg_apc_ride_exit_fade_start", #"flg_apc_ride_end" );
