...
function init()
{
    ...
    array::run_all( var_8f2f30f5, &pingable );
...
function function_dac6c069( *var_a276c861 )
{
    ...
    scene::add_scene_func( #"aib_t9_vign_cust_zm_klaus_quest_pry_hand_male", &function_9f1d395, "init" );
    ...
    level flag::wait_till( #"klaus_quest_completed" );
}
...
function function_ea7dccdf( var_a276c861, var_19e802fa )
{
    if ( var_a276c861 || var_19e802fa )
    {
        ...
        level flag::set( #"klaus_quest_completed" );
...
function function_b1ac17cb()
{
    ...
    level.var_93f1848f thread scene::play( #"p9_zm_plat_board_broken_bundle1", level.var_93f1848f );
    ...
    level.var_93c6843d thread scene::play( #"p9_zm_plat_board_broken_bundle3", level.var_93c6843d );
    ...
    level.var_adabb803 thread scene::play( #"p9_zm_plat_board_broken_bundle2", level.var_adabb803 );
...
function private function_e9e410c2()
{
    ...
    level scene::init( #"aib_t9_vign_cust_zm_klaus_quest_pry_hand_male" );
    ...
    level scene::play( #"aib_t9_vign_cust_zm_klaus_quest_pry_hand_male", e_player );
...
{
    level.var_7f5dece9 = a_ents[ #"klaus hand" ];
    level.var_7f5dece9 pingable();
}
...
{
    var_40f19a2b = struct::get( #"kls_battery_slot", "targetname" );
    ...
    wait 1;
    level scene::play( #"p9_fxanim_zm_platinum_klaus", "close_hatch", level.klaus );
    level thread scene::play( #"p9_fxanim_zm_platinum_klaus", "sit_loop_with_hatch_closed", level.klaus );
    var_af3fc617 delete();
    level thread function_f0bfb4bb( var_ba86b46 );
}
...
function private function_c3447490()
{
    ...
    scene::add_scene_func( #"p9_fxanim_zm_platinum_klaus", &function_3691fd0b, "sit_loop_hatch_opened" );
    level thread scene::play( #"p9_fxanim_zm_platinum_klaus", "sit_loop_hatch_opened" );
...
function private function_8d5c5a84( var_a5839c5b, var_1e447653 = 0 )
{
    ...
    if ( var_1e447653 )
    {
        ...
        if ( isdefined( level.klaus ) )
        {
            ...
            level scene::play( #"p9_fxanim_zm_platinum_klaus", "stand_up_struggle", level.klaus );
    ...
    else if ( isdefined( level.klaus ) )
    {
        ...
        if ( isdefined( var_d15867da ) )
        {
            ...
            {
                level scene::play( #"p9_fxanim_zm_platinum_klaus", "stand_up", level.klaus );
                level scene::play( #"p9_fxanim_zm_platinum_klaus", "stand_up_intro_to_idle", level.klaus );
            }
            else
            {
                level scene::play( #"p9_fxanim_zm_platinum_klaus", "stand_up", level.klaus );
                level scene::play( #"p9_fxanim_zm_platinum_klaus", "walk_fly_out", level.klaus );
                ...
                level scene::play( #"p9_fxanim_zm_platinum_klaus", "fly_in", level.klaus );
            }
        }
...
function private function_5df1db76( var_ba86b46 )
{
    ...
    level waittill( #"klaus_give_command_device" );
    ...
    level scene::stop( #"p9_fxanim_zm_platinum_klaus" );
}
...
function function_c94afb95( var_eaf5148f = 0 )
{
    ...
    if ( var_8dd281be )
    {
        level scene::play( #"p9_fxanim_zm_platinum_klaus", "sit_down_with_turn", level.klaus );
    }
    else
    {
        level scene::play( #"p9_fxanim_zm_platinum_klaus", "fly_out", level.klaus );
        level scene::play( #"p9_fxanim_zm_platinum_klaus", "fly_in_walk", level.klaus );
        level scene::play( #"p9_fxanim_zm_platinum_klaus", "sit_down", level.klaus );
    }
    
    level thread scene::play( #"p9_fxanim_zm_platinum_klaus", "sit_loop", level.klaus );
}
...
/#
    ...
    function private function_8d8c6876()
    {
        ...
        while ( true )
        {
            if ( isdefined( level.klaus ) && level flag::get( #"klaus_quest_completed" ) )
            {
