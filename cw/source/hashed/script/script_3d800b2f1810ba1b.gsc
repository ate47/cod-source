...
function private _think()
{
    ...
    if ( !isdefined( self.augmented_impact_fx_bounds_fraction ) )
    {
        self.augmented_impact_fx_bounds_fraction = ( 0.75, 0.75, 0.75 );
    }
    else if ( !isvec( self.augmented_impact_fx_bounds_fraction ) )
    {
        self.augmented_impact_fx_bounds_fraction = ( self.augmented_impact_fx_bounds_fraction, self.augmented_impact_fx_bounds_fraction, self.augmented_impact_fx_bounds_fraction );
    }
    ...
    if ( isdefined( self.augmented_impact_fx_template ) && !isdefined( level.var_8a1c2b55.templates[ self.augmented_impact_fx_template ] ) )
    {
        var_4edf0398 = spawnstruct();
        var_4edf0398.var_1e4697f4 = getentarray( self.augmented_impact_fx_template, "targetname" );
        var_4edf0398.var_4ecc769d = ( 0, 0, 0 );
        var_4edf0398.var_5fabbca1 = ( 0, 0, 0 );
        level.var_8a1c2b55.templates[ self.augmented_impact_fx_template ] = var_4edf0398;
        waitframe( 1 );
...
function private function_8f050823()
{
    ...
    if ( ( isdefined( var_2cc6e886.var_d85a87b ) ? var_2cc6e886.var_d85a87b : 0 ) > 0 )
    {
        ...
        bounds *= self.augmented_impact_fx_bounds_fraction;
        ...
        while ( data.var_78e64a1a > var_2cc6e886.var_3efc3a35 || data.var_33c88c75.size > 0 )
        {
            ...
            /#
                ...
                {
                    if ( isdefined( self.augmented_impact_fx_z_offset_fraction ) )
                    {
                        z_offset = ( 0, 0, bounds[ 2 ] * self.augmented_impact_fx_z_offset_fraction );
                        box( self.origin, mins * self.augmented_impact_fx_bounds_fraction + z_offset, maxs * self.augmented_impact_fx_bounds_fraction + z_offset, self.angles[ 1 ] );
                    }
                    else
                    {
                        box( self.origin, mins * self.augmented_impact_fx_bounds_fraction, maxs * self.augmented_impact_fx_bounds_fraction, self.angles[ 1 ] );
                    }
                }
            #/
...
function private function_93b52d75( damage_data )
{
    ...
    if ( isdefined( data.var_141b25f ) )
    {
        ...
        height = ( maxs[ 2 ] - mins[ 2 ] ) * self.augmented_impact_fx_bounds_fraction[ 2 ];
        
        if ( isdefined( self.augmented_impact_fx_z_offset_fraction ) )
        {
            mins += ( 0, 0, height * self.augmented_impact_fx_z_offset_fraction );
        }
...
function private function_2138c62( augmented_impact_fx, damage_data, var_b33be77 )
{
    ...
    if ( data.var_33c88c75[ augmented_impact_fx ] < ( isdefined( var_2cc6e886.var_9d47943c ) ? var_2cc6e886.var_9d47943c : 1 ) && level.var_8a1c2b55.var_f782e821[ augmented_impact_fx ].size < ( isdefined( var_2cc6e886.var_404a7d1 ) ? var_2cc6e886.var_404a7d1 : 1 ) )
    {
        ...
        foreach ( parent_asset in var_b33be77 )
        {
            foreach ( var_7aa37d9f in level.var_8a1c2b55.var_f782e821[ parent_asset ] )
            {
        ...
        {
            var_f6bb7260 = self.augmented_impact_fx_bounds_fraction;
        ...
        if ( var_6175aa99 && isdefined( self.augmented_impact_fx_template ) )
        {
            var_4edf0398 = level.var_8a1c2b55.templates[ self.augmented_impact_fx_template ];
