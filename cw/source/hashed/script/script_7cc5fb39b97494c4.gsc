...
class class_9e71c1a2
{
    ...
    function function_70bcd27( s_minigame, s_bundle )
    {
        ...
        switch ( tolower( s_minigame.script_access_mode ) )
        {
            case #"open":
                var_8b53fab0 = 0;
                break;
        ...
        var_6dfc35a = isdefined( s_minigame.script_puzzle_index ) ? s_minigame.script_puzzle_index : 0;
        
        if ( is_true( s_minigame.script_objective_during_use ) )
        {
            var_fcc5a4dd = 1;
        }
        
        if ( isdefined( var_b5a03b21.script_minigame_weapon ) )
        {
            var_d411c5b6 = var_b5a03b21.script_minigame_weapon;
        }
    ...
    function function_422aeb75( e_player, interact_location, b_success )
    {
        if ( isdefined( e_player ) )
        {
            ...
            {
                if ( is_true( var_b5a03b21.script_thread_exit_scene ) )
                {
    ...
    function failure( var_f8d01c02, e_player )
    {
        ...
        if ( is_true( var_b5a03b21.script_delete_on_fail ) )
        {
...
function notify_progress( *oldval, newval )
{
    ...
    if ( is_true( e_player.var_f4f7edb2 ) && e_player == e_player.var_97c1c267.last_player )
    {
        ...
        s_minigame.var_ff3c99c5 notify( #"minigame_progress", { #e_player:e_player, #minigame:e_player.var_97c1c267, #percent_complete:var_847964c } );
    }
}
