...
function private preinit()
{
    ...
    if ( zm_utility::is_survival() )
    {
        ...
        level.var_1a4cc228[ #"spawner_zm_steiner_split_radiation_bomb_hvt" ] = [ #"hash_5eafd160d077670d" ];
        level.var_1a4cc228[ #"spawner_zm_steiner_split_radiation_blast_hvt" ] = [ #"hash_61df3be05096e9e2" ];
    ...
    if ( util::get_map_name() == "zm_gold" )
    {
        ...
        level.var_1a4cc228[ #"spawner_bo5_zombie_dog_molotov" ] = level.var_1a4cc228[ #"hash_78215fa79f5557dc" ];
    }
}
...
function function_a0ef7452()
{
    ...
    if ( !is_true( self.exploded ) )
    {
        ...
        if ( isplayer( player ) )
        {
            ...
            weapon3 = player.inventory.items[ 17 + 1 + 8 + 1 + 8 + 1 ];
            ...
            else if ( weapon3.var_627c698b.altweapon.rootweapon === damage_weapon.rootweapon )
            {
                damage_weapon = weapon3.var_627c698b.altweapon;
            }
        }
