...
function main( str_objective, *b_skipto )
{
    ...
    level waittill( #"anim_notify_enable_door_prompt" );
...
function function_45405080()
{
    ...
    level waittill( #"perseus_reveal_prompt" );
    ...
    {
        level waittill( #"radio_use_prompt" );
...
{
    level waittill( #"radio_response01" );
    wait 0.25;
    var_d7022772 = [];
...
function function_3babb313()
{
    ...
    while ( level.var_a9cc4859 > 0 )
    {
        ...
        level notify( #"struggle_loop", { #var_9b3e2106:var_9b3e2106 } );
        waitframe( 1 );
...
function function_a444d829()
{
    ...
    level waittill( #"anim_notify_enable_lighter_prompt" );
    level endon( #"flag_adler_killed_no_tappy" );
