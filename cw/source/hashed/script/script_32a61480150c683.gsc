...
function function_61c7a808( str_objective )
{
    ...
    if ( isdefined( level.var_708ccf64 ) )
    {
        ...
        getplayers()[ 0 ] waittill( #"look_down_first" );
        ...
        getplayers()[ 0 ] waittill( #"look_up_start" );
        ...
        getplayers()[ 0 ] waittill( #"look_down_second" );
        level thread function_cb906385( "intro_long_magicbullet_start_struct", "intro_long_magicbullet_end_2_struct" );
...
{
    level.player endon( #"death" );
    level.player waittill( #"start_rumble" );
...
function function_41380e1f()
{
    if ( isdefined( level.var_708ccf64 ) )
    {
        level waittill( #"notify_music_rice_paddies_long" );
    ...
    level waittill( #"notify_music_rice_paddies_short" );
...
function function_cc5291ff( a_ents )
{
    ...
    level.var_6c3ab26f = a_ents[ #"wounded_guy" ];
    level.var_b517b599 = a_ents[ #"pilot_1" ];
    level.var_ebf4a352 = a_ents[ #"pilot_2" ];
    level.var_b918d422 = a_ents[ #"dead_guy" ];
    level.var_2d5aba86 = a_ents[ #"soldier_1" ];
    level.var_80c622e = a_ents[ #"intro_enemy" ];
...
{
    level.var_f6c7fc3f = a_ents[ #"vc_running_enemy1" ];
    level.var_e0f9d0a3 = a_ents[ #"vc_running_enemy2" ];
    level.var_d3383520 = a_ents[ #"vc_running_enemy3" ];
