...
// Size: 0x8c4
function movecamera( vdir, tweentime, var_c69fe125, var_eebc8ec0, var_3cbc1198, var_d7e15204, var_f2499291, var_dda415f2, lookdir, var_a571008b, var_eea7b52e )
{
...
function function_feefffe4( *einflictor, *attacker, *idamage, *weapon, vdir, *shitloc )
{
    ...
    thread movecamera( shitloc, 0, var_c69fe125, var_eebc8ec0, var_3cbc1198, var_d7e15204, undefined, 60 * sign, undefined, undefined, 1 );
...
function function_f8c107( *einflictor, *attacker, *idamage, *weapon, vdir, *shitloc )
{
    ...
    sign = self function_e9de215e();
    self playrumbleonentity( "damage_heavy" );
    thread movecamera( shitloc, 0, var_c69fe125, var_eebc8ec0, var_3cbc1198, var_d7e15204, undefined, 60 * sign );
    wait var_7240f970;
    self notify( #"hash_eb0317ca3976bf9" );
}
...
function function_6b51f704( *einflictor, *attacker, *idamage, *weapon, *vdir, *shitloc )
{
    ...
    var_c69fe125 = getdvarfloat( #"hash_3a46da3b6f33171e", 50 );
    var_7240f970 = getdvarfloat( #"hash_6261c9b56ae2db5d", 2.75 );
    thread movecamera( undefined, 0, var_c69fe125, var_eebc8ec0, var_3cbc1198, var_d7e15204, undefined, 60 * sign, undefined, undefined, 1 );
    self playrumbleonentity( "damage_heavy" );
    wait var_7240f970;
    self notify( #"hash_eb0317ca3976bf9" );
}
...
function function_16679050( *einflictor, attacker, *idamage, *weapon, vdir, *shitloc )
{
    ...
    sign = self function_e9de215e();
    thread movecamera( shitloc, 0, var_c69fe125, var_eebc8ec0, var_3cbc1198, var_d7e15204, undefined, 60 * sign, lookdir, undefined, 1 );
    self playrumbleonentity( "damage_heavy" );
    wait var_c80c7a11;
    self notify( #"hash_eb0317ca3976bf9" );
}
...
function function_49f83e8a( *einflictor, *attacker, *idamage, *weapon, *vdir, *shitloc )
{
    ...
    sign = self function_e9de215e();
    thread movecamera( undefined, 0.2, 0, var_eebc8ec0, 0, var_d7e15204, undefined, 50 * sign, forwarddir );
    wait 2;
    self.var_f0f3daef = 1;
...
function function_f4d74d85( *einflictor, *attacker, *idamage, *weapon, *vdir, *shitloc )
{
    ...
    var_eebc8ec0 = getdvarfloat( #"hash_1a9f5eeb3f4a4361", 50 );
    var_d7e15204 = getdvarfloat( #"hash_30765f3cd8aff8ef", 10 );
    thread movecamera( undefined, 3, 0, var_eebc8ec0, 0, var_d7e15204, undefined, undefined, forwarddir );
...
function function_3f6f166( *einflictor, *attacker, *idamage, *weapon, *vdir, *shitloc )
{
    ...
    thread movecamera( undefined, 1, undefined, var_eebc8ec0, 0, var_d7e15204, -88, 1, undefined, 1, 1 );
    wait var_7240f970;
    self notify( #"hash_eb0317ca3976bf9" );
}
