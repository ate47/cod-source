...
function function_15741b86()
{
    self endon( #"death" );
    level endon( #"hash_51047505aeee86ad" );
    self scene::play( #"p9_zm_platinum_magic_box_bunny_bundle", "entry_1", self );
    ...
    while ( true )
    {
        ...
        self scene::play( #"p9_zm_platinum_magic_box_bunny_bundle", str_scene, self );
    }
}
...
function function_ef40fc60()
{
    ...
    level thread function_b6e1020( var_14043e22, var_61453888, #"spawner_bo5_raz_sr", 3 );
    ...
    wait 16;
    level notify( #"hash_5c03540b79cae9cf" );
    level thread function_b6e1020( var_abe26193, var_262fa864, #"spawner_zm_tormentor", 5 );
...
function function_23cef26a( var_a276c861, var_19e802fa )
{
    ...
    a_items = dropstruct namespace_65181344::function_fd87c780( #"zm_platinum_manhole_list", n_count, var_98d110e6 );
...
function function_af042db0( var_a276c861 )
{
    ...
    if ( level.round_number == var_69d81f37 && !level flag::get( "hvt_event_steiner_spawned" ) )
    {
        ...
        level.var_15a5fa7f = #"spawner_bo5_mimic_hvt";
...
function function_6b214340( var_d3329483 = 1 )
{
    ...
    for ( i = 1; i <= var_d3329483 ; i++ )
    {
        if ( var_71fc1453.size > 0 )
        {
            ...
            mdl_prop = mimic_prop_spawn::function_b309db61( var_ed94ce04, undefined, var_ed94ce04[ 0 ], #"zm_platinum_mimic_item_spawn_props" );
...
/#
    ...
    {
        self endon( #"death", #"on_entity_revealed" );
