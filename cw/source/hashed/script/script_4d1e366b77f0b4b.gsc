...
function private preinit()
{
    ...
    spawner::add_archetype_spawn_function( #"zombie_steiner", &function_7ec99c76 );
    spawner::function_89a2cd87( #"zombie_steiner", &function_cf0706a7 );
    ...
    zm_utility::function_d0f02e71( #"zombie_steiner" );
    zm_cleanup::function_cdf5a512( #"zombie_steiner", &function_99c14949 );
    zm_round_spawning::register_archetype( #"zombie_steiner", &function_f4788553, &round_spawn, undefined, 100 );
    zm_round_spawning::function_306ce518( #"zombie_steiner", &function_3ced6468 );
...
function function_7ec99c76()
{
    ...
    zm_score::function_e5d6e6dd( #"zombie_steiner", 60 );
...
/#
    ...
    {
        if ( isarchetypeloaded( #"zombie_steiner" ) )
        {
    ...
    function private function_15677aa0( cmd )
    {
        switch ( cmd )
        {
            ...
            case #"hash_7168487d1ca40ace":
                steiners = getaiarchetypearray( #"zombie_steiner" );
...
function function_3ced6468( *n_round_number )
{
    ...
    while ( true )
    {
        ...
        if ( zm_round_spawning::function_d0db51fc( #"zombie_steiner" ) )
        {
            level.var_b15745d6++;
            n_player_count = zm_utility::function_a2541519( getplayers().size );
...
{
    var_5a2d0d60 = getaiarchetypearray( #"zombie_steiner" );
...
{
    if ( self.archetype !== #"zombie_steiner" )
    {
        return;
    }
...
function function_bc9fe637( s_params )
{
    ...
    if ( isdefined( attacker ) && isdefined( attacker.archetype ) && attacker.archetype == #"zombie_steiner" && s_params.idamage > 0 )
    {
...
function private function_3aa93442( entity )
{
    ...
    while ( count < 3 )
    {
        ...
        if ( function_b860fc37( enemy ) )
        {
            ...
            target_origin += velocity * predict_time;
