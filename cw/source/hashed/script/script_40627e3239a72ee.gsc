...
function function_d68e0c71()
{
    ...
    scene::add_scene_func( #"p9_fxanim_zm_platinum_klaus_upgrade", &function_8707f5e6, "upgrade_outro_1" );
    scene::add_scene_func( #"p9_fxanim_zm_platinum_klaus_upgrade", &function_8707f5e6, "upgrade_outro_2" );
    level flag::wait_till( "klaus_helm_crafted" );
    scene::remove_scene_func( #"p9_fxanim_zm_platinum_klaus_upgrade", &function_8707f5e6, "upgrade_outro_1" );
    scene::remove_scene_func( #"p9_fxanim_zm_platinum_klaus_upgrade", &function_8707f5e6, "upgrade_outro_2" );
}
...
function function_47a1b8()
{
    ...
    {
        point = function_4ba8fde( #"item_zmquest_platinum_microwave_dish" );
...
function function_cefdd0d2()
{
    ...
    if ( level flag::get( #"klaus_quest_completed" ) )
    {
...
function function_54e9a43b( b_skipped, var_19e802fa )
{
    if ( b_skipped || var_19e802fa )
    {
        if ( level flag::get( #"hash_720384d338d58cf4" ) && isdefined( level.klaus ) )
        {
            ...
            if ( isdefined( level.klaus.current_scene ) && level.klaus.current_scene == #"p9_fxanim_zm_platinum_klaus" )
            {
                scene::remove_scene_func( #"p9_fxanim_zm_platinum_klaus", &namespace_6fb22263::function_3691fd0b, "sit_loop" );
                var_55033b92 thread scene::play( #"p9_fxanim_zm_platinum_klaus", "sit_loop", var_55033b92 );
            }
        }
...
function function_f0be2da6()
{
    ...
    if ( dis <= sqr( 200 ) )
    {
        ...
        if ( is_true( var_5a7117fb ) )
        {
            ...
            level.klaus scene::play( #"p9_fxanim_zm_platinum_klaus_upgrade", "upgrade_intro_" + level.var_7c745515, level.klaus );
            level.klaus thread scene::play( #"p9_fxanim_zm_platinum_klaus_upgrade", "upgrade_idle_" + level.var_7c745515, level.klaus );
            ...
            if ( !level flag::get( #"hash_30bd3fb769cba5e7" ) )
            {
                ...
                level.klaus thread scene::play( #"p9_fxanim_zm_platinum_klaus_upgrade", "upgrade_loop_" + level.var_7c745515, level.klaus );
                var_9039575a thread scene::play( #"p9_fxanim_zm_platinum_armor_station_bundle", "play1", var_9039575a );
            ...
            {
                level.klaus animation::stop();
                level.klaus scene::play( #"p9_fxanim_zm_platinum_klaus_upgrade", "upgrade_outro_" + level.var_7c745515, level.klaus );
    ...
    while ( true )
    {
        ...
        if ( !isplayer( result.attacker ) )
        {
            ...
            if ( var_f15d2e26 <= 0 )
            {
                ...
                self scene::stop( #"p9_fxanim_zm_platinum_armor_station_bundle" );
...
function function_b20e6cff()
{
    ...
    var_55033b92 = function_4a57e36( "spawner_zm_mannequin_ally_upgraded", origin, angles, #"p9_fxanim_zm_platinum_klaus_upgrade", "upgrade_loop_" + level.var_7c745515 );
    ...
    var_55033b92 function_a7642f50( #"p9_fxanim_zm_platinum_klaus_upgrade", "upgrade_outro_" + level.var_7c745515 );
...
function function_ed04cf0f( b_debug = 0 )
{
    ...
    switch ( self.index )
    {
        case 0:
            ...
            var_dc7e53b6 = #"item_zmquest_platinum_disk_new_wave";
            break;
        case 1:
            str_flag = #"hash_11d54d2ecf05cb2";
            var_dc7e53b6 = #"item_zmquest_platinum_disk_goth";
            break;
        case 2:
            str_flag = #"hash_2bd741137c515a48";
            var_dc7e53b6 = #"item_zmquest_platinum_disk_punk";
            break;
        default:
            break;
    }
    ...
    if ( b_debug )
    {
        point = function_4ba8fde( #"item_zmquest_platinum_disk_new_wave" );
...
function function_9d903a8e( index )
{
    ...
    var_9039575a thread scene::play( #"p9_fxanim_zm_platinum_armor_station_bundle", "play1", var_9039575a );
    wait 5;
    var_9039575a scene::stop( #"p9_fxanim_zm_platinum_armor_station_bundle" );
    ...
    level.var_459ddb9c = 0;
    var_55033b92 = function_4a57e36( "spawner_zm_mannequin_ally_upgraded_0" + index, origin, angles, #"p9_fxanim_zm_platinum_klaus_upgrade", "upgrade_loop_" + level.var_7c745515 );
    wait 0.5;
