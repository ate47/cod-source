...
{
    level waittill( #"audio_heli_dist" );
...
function function_7a945b02()
{
    ...
    if ( isdefined( level.player ) )
    {
        ...
        level waittill( #"audio_start_forest_crickets" );
...
function function_f40c094d()
{
    ...
    level waittill( #"audio_start_ducked_generator" );
    ...
    level waittill( #"audio_start_unducked_generator" );
    wait 0.25;
    audio::snd_set_snapshot( "" );
...
function function_7547ed65()
{
    ...
    level.var_28f2e8d6 = [];
    level waittill( #"audio_amk_arcade_emt_start" );
    wait 0.5;
...
function function_c0af2104()
{
    ...
    level waittill( #"audio_stop_muffled_door_music" );
...
{
    level waittill( #"flg_audio_apc_ignition" );
...
{
    level waittill( #"audio_apc_ride_door_klaxon" );
...
{
    level waittill( #"audio_apc_ride_door_01" );
...
{
    level waittill( #"audio_apc_ride_door_02" );
