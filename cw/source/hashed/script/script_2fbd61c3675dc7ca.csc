...
{
    var_5fe5469 = struct::get( #"corrupted_tunnel" );
...
function function_ab0de377( localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump )
{
    if ( bwasdemojump )
    {
        ...
        {
            case 1:
                var_3de77b5f = #"corrupted_space_west";
                break;
            case 2:
                var_3de77b5f = #"corrupted_space_east";
                break;
        }
    ...
    var_4263f449 = arraycombine( struct::get_array( #"corrupted_space_west" ), struct::get_array( #"corrupted_space_east" ) );
