...
function function_2ce126c4()
{
    ...
    if ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" )
    {
    ...
    {
        if ( is_true( level.var_e35c191f ) || util::get_game_type() === #"zonslaught_elite" )
        {
            level.var_7e2af8d5 = [ #"spawner_bo5_raz_sr_hvt", #"spawner_bo5_mimic_hvt", #"spawner_bo5_abom", #"spawner_zm_steiner_hvt", #"spawner_bo5_mechz_sr_hvt" ];
        }
        else
        {
            level.var_7e2af8d5 = [ #"spawner_zm_steiner", #"spawner_bo5_raz_sr_hvt", #"spawner_bo5_mimic_hvt" ];
        }
    }
    else
    {
        level.var_7e2af8d5 = [ #"spawner_zm_steiner", #"spawner_bo5_raz_sr", #"spawner_bo5_mimic" ];
    }
...
function function_ec2b3302()
{
    ...
    {
        if ( isdefined( level.var_70b6f044 ) && isdefined( level.var_70b6f044[ #"spawner_zm_zombie_onslaught" ] ) )
        {
            return level.var_70b6f044[ #"spawner_zm_zombie_onslaught" ];
        }
        
        return #"spawner_zm_zombie_onslaught";
    }
    ...
    {
        if ( isdefined( level.var_70b6f044 ) && isdefined( level.var_70b6f044[ #"spawner_bo5_zombie_dog_plague" ] ) )
        {
            return level.var_70b6f044[ #"spawner_bo5_zombie_dog_plague" ];
        }
        
        level.var_8f8a58c2++;
        return #"spawner_bo5_zombie_dog_plague";
    }
...
function function_3fd720cc()
{
    ...
    {
        if ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" || is_true( level.var_e35c191f ) || util::get_game_type() === #"zonslaught_elite" )
        {
...
function function_d6ad49c2( params )
{
    ...
    if ( ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" ) && is_true( self.var_d894caa2 ) && isplayer( attacker ) && !is_true( self.var_b70158b5 ) )
    {
    ...
    {
        if ( self.type == #"spawner_bo5_zombie_dog_plague" )
        {
...
function function_c08eb1c4()
{
    ...
    if ( self function_1e521615() )
    {
        ...
        {
            var_9f7c58e6 = #"spawner_zm_steiner_split_radiation_blast_hvt";
        }
        ...
        {
            var_a0024591 = #"spawner_zm_steiner_split_radiation_bomb_hvt";
        }
    }
...
function function_7f501c21()
{
    ...
    while ( level.var_bc2071f < 100 && ( level.var_df7b46d1.state == 1 || ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" ) && !level flag::get( "onslaught_accelerated_round_end" ) ) )
    {
...
function spawn_dog( *params )
{
    if ( isdefined( level.var_70b6f044 ) && isdefined( level.var_70b6f044[ #"spawner_bo5_zombie_dog_plague" ] ) )
    {
        var_a528603 = level.var_70b6f044[ #"spawner_bo5_zombie_dog_plague" ];
    }
    else
    {
        var_a528603 = #"spawner_bo5_zombie_dog_plague";
    }
...
function spawn_zombie( outer_radius, inner_radius, duration, var_d894caa2, var_8c4dd20c )
{
    ...
    if ( isdefined( var_d23463ac ) )
    {
        ...
        if ( isdefined( ai ) )
        {
            ...
            if ( isdefined( ai ) )
            {
                ...
                if ( isdefined( level.var_70b6f044 ) && isdefined( level.var_70b6f044[ #"spawner_zm_zombie_onslaught" ] ) && level.var_70b6f044[ #"spawner_zm_zombie_onslaught" ] === var_b434916b || var_b434916b === #"spawner_zm_zombie_onslaught" )
                {
    ...
    if ( var_d894caa2 === 1 )
    {
        ...
        {
            if ( ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" ) && ( level flag::get( "onslaught_round_logic_complete" ) || level flag::get( "onslaught_accelerated_round_end" ) ) )
            {
                break;
            }
    ...
    while ( true )
    {
        ...
        switch ( self.state )
        {
            case 0:
                ...
                else if ( is_true( level.var_e35c191f ) || util::get_game_type() === #"zonslaught_elite" )
                {
                    self.state = 5;
                }
                else
            ...
            case 3:
                if ( is_true( getgametypesetting( #"hash_3846b38f23c3d539" ) ) )
                {
                    ...
                    else if ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" )
                    {
                        level.var_df7b46d1.state = 3;
                    }
                    else
                        ...
                        if ( var_189f09c7 > level.var_679cf74b )
                        {
                            ...
                            if ( distancesquared( point2d, self.origin ) < sqr( 16 ) )
                            {
                                if ( level.var_679cf74b === var_189f09c7 - 1 )
                                {
                                    ...
                                    if ( !( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" ) || ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" ) && level.var_bc2071f >= 100 )
                                    {
                                        if ( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" )
                                        {
...
function function_86d134a1()
{
    ...
    if ( ( is_true( level.var_2d41db66 ) || util::get_game_type() === #"zonslaught_orb_shrink" ) && getdvarint( #"hash_d3df2c834aa1010", 1 ) )
    {
        var_bcce0e25 = 1;
    }
    ...
    while ( true )
    {
        if ( isdefined( level.var_aa36d14e ) )
        {
            ...
            else
            {
                ...
                if ( level.circle_radius <= var_bcce0e25 && ( is_true( level.var_2d41db66 ) || util::get_game_type() === #"zonslaught_orb_shrink" ) && getdvarint( #"hash_d3df2c834aa1010", 1 ) && level.var_bc2071f < 100 )
                {
        ...
        if ( isdefined( level.deathcircle.var_5c54ab33 ) )
        {
            ...
            /#
                if ( is_true( level.var_2d41db66 ) || util::get_game_type() === #"zonslaught_orb_shrink" )
                {
...
function function_3be471a2( var_78664f9a )
{
    ...
    if ( is_true( var_78664f9a ) )
    {
        ...
        {
            if ( level.var_df7b46d1.state !== 3 || is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" )
            {
                level.var_df7b46d1.state = 3;
                level.var_679cf74b = 1;
                level.var_75302c0e = undefined;
...
function function_f19e31a2()
{
    ...
    while ( true )
    {
        ...
        if ( level.var_2812b9f5 == #"spawner_zm_steiner" || level.var_2812b9f5 == #"spawner_zm_steiner_hvt" || level.var_2812b9f5 == #"hash_43b8d4f24851653e" || level.var_2812b9f5 == #"hash_156c697af81feaf9" )
        {
        ...
        if ( level.var_9b7bd0e8 > 0 || is_true( level.var_e35c191f ) || util::get_game_type() === #"zonslaught_elite" )
        {
...
function function_69e5b9b()
{
    ...
    while ( true )
    {
        ...
        if ( level.var_df7b46d1.state == 1 && !( is_true( level.var_612d6a21 ) || util::get_game_type() === #"zonslaught_accelerated" ) )
        {
            level thread function_46ff5efa();
        }
