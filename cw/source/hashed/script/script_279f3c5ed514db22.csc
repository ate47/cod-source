...
function private function_f2a2832d( *player, msg )
{
    switch ( msg )
    {
        ...
        case #"audio_level_begin_duck_stop":
            ...
            break;
        case #"audio_intro_triton_disable":
            function_b6407dd4( 0 );
            break;
        case #"evt_emp_blast_screenshake":
            thread evt_emp_blast_screenshake();
            break;
        case #"evt_emp_blast_shockwave":
            thread evt_emp_blast_shockwave();
            break;
...
{
    level waittill( #"audio_start_fav_drive" );
...
{
    level waittill( #"audio_start_fav_post_emp" );
    thread function_5271e091();
    thread function_34a0b2c1();
}
...
function function_34a0b2c1()
{
    ...
    level waittill( #"audio_idle_player_fav" );
...
function function_5271e091()
{
    ...
    level waittill( #"audio_stop_player_fav" );
    wait 1;
...
// Size: 0x1c
function evt_emp_blast_screenshake()
{
...
// Size: 0x5c
function evt_emp_blast_shockwave()
{
...
{
    level waittill( #"audio_mute_aa_gun" );
...
{
    level waittill( #"sfx_outro_sparks_mute_start" );
    function_5ea2c6e3( "cp_rus_siege_sparks_outro", 0.5 );
    level waittill( #"sfx_outro_sparks_mute_stop" );
...
{
    level waittill( #"flg_covered_audio_duck_start" );
    ...
    level waittill( #"flg_covered_audio_duck_stop" );
