...
function init()
{
    ...
    scene::add_scene_func( #"cin_zm_gold_mid", &function_56700eee, "play" );
    scene::add_scene_func( #"cin_zm_gold_mid_pt2", &function_56700eee, "play" );
    scene::add_scene_func( #"cin_zm_gold_mid_pt2", &function_2996c15f, "shot230" );
    scene::add_scene_func( #"cin_zm_gold_mid_pt2", &function_e9b849a7, "shot240" );
    scene::add_scene_func( #"cin_zm_gold_outro_pt1", &function_318f5bad, "play" );
    scene::add_scene_func( #"cin_zm_gold_outro", &function_324cf392, "play" );
    scene::add_scene_func( #"cin_zm_gold_epilogue", &function_324cf392, "play" );
    scene::add_scene_func( #"cin_zm_gold_mid_pt2", &function_e3c65980, "done" );
    scene::add_scene_func( #"cin_zm_gold_epilogue", &function_e3c65980, "done" );
...
function function_2f0a2ce2()
{
    ...
    level scene::init_streamer( #"cin_zm_gold_mid", getplayers(), 0, 0 );
    ...
    function_c9fd78e4( #"cin_zm_gold_mid", #"cin_zm_gold_mid_pt2" );
    level scene::play( #"cin_zm_gold_mid" );
    music::setmusicstate( "mid_igc_1" );
    level thread function_542224cc( 0.5, ( 1, 1, 1 ), "screen_fade_from_white", 1 );
    level scene::play( #"cin_zm_gold_mid_pt2" );
...
function function_318f5bad( a_ents )
{
    ...
    level clientfield::set( "" + #"hash_763dd8035e80f7c", 1 );
    level waittill( #"set_orda_boss_dissolve" );
...
function function_2baf9762()
{
    ...
    if ( isdefined( s_veh ) )
    {
        ...
        var_2560e451 thread scene::play( #"aib_t9_zm_cust_vign_rav_maxis_boss_fight" );
        level flag::wait_till( #"main_quest_completed" );
        var_2560e451 scene::stop( #"aib_t9_zm_cust_vign_rav_maxis_boss_fight", 1 );
...
function function_79ae7b73()
{
    ...
    level scene::add_scene_func( #"aib_t9_vign_cust_zm_gold_boss_fight", &function_32d60e81, "init" );
    level thread scene::play( #"aib_t9_vign_cust_zm_gold_boss_fight", "init" );
...
{
    level.var_d99f785b = ents[ #"prop orda" ];
    level.var_d99f785b pingable();
...
function function_dc466f4e()
{
    ...
    a_ents[ #"prop orda" ] = level.var_d99f785b;
    level scene::stop( #"aib_t9_vign_cust_zm_gold_boss_fight" );
    level scene::init_streamer( #"cin_zm_gold_outro_pt1", getplayers(), 0, 0 );
    ...
    function_c9fd78e4( #"cin_zm_gold_outro_pt1", #"cin_zm_gold_outro" );
    level scene::play( #"cin_zm_gold_outro_pt1", a_ents );
    music::setmusicstate( "outro_igc_2" );
    level thread function_542224cc( 1.5, ( 0, 0, 0 ), "screen_fade_in_black" );
    level thread function_abb25db( 0.15, ( 0, 0, 0 ), "screen_fade_to_black" );
    function_c9fd78e4( #"cin_zm_gold_outro", #"cin_zm_gold_epilogue" );
    level scene::play( #"cin_zm_gold_outro" );
    music::setmusicstate( "epilogue" );
    level thread function_542224cc( 1.5, ( 0, 0, 0 ), "screen_fade_in_black" );
    level thread function_abb25db( 0.15, ( 0, 0, 0 ), "screen_fade_to_black" );
    level scene::play( #"cin_zm_gold_epilogue" );
...
function function_9ad6d900()
{
    ...
    while ( true )
    {
        self waittill( #"weak_point_exposed" );
...
function function_133bf8a7()
{
    ...
    level scene::play( #"aib_t9_vign_cust_zm_gold_boss_fight", var_559c5c3e );
}
...
function function_c37dfa52( var_a013c644 )
{
    ...
    level scene::play( #"aib_t9_vign_cust_zm_gold_boss_fight", "arm_slam" );
}
...
function function_9fc0edc6()
{
    ...
    var_a347ab1 = struct::get_array( #"s_end_fight_arm_smash_teleport" );
...
function function_75edf7ba()
{
    ...
    level scene::play( #"aib_t9_vign_cust_zm_gold_boss_fight", "swarm_attack" );
}
...
function function_6afb3f4b()
{
    ...
    level scene::play( #"aib_t9_vign_cust_zm_gold_boss_fight", "hellhound_attack" );
...
function function_fee76e8f()
{
    ...
    level scene::play( #"aib_t9_vign_cust_zm_gold_boss_fight", var_541138b6 );
