...
{
    function_871649b9( instance, #"essence_spawn", #"sr_harvesting_zombie_essence", 5 );
}
...
{
    function_871649b9( instance, #"essence_spawn_small", #"sr_harvesting_zombie_essence_small", 25, ( 0, 0, -12 ) );
}
...
{
    function_871649b9( instance, #"scrap_spawn", #"sr_harvesting_scrap", 5 );
}
