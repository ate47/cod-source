...
function function_912776e6( var_f03e723e )
{
    ...
    if ( scripted_widgets::exists( #"hash_3b32288cc17c7c50" ) )
    {
        scripted_widgets::remove( #"hash_3b32288cc17c7c50" );
    }
    
    scripted_widgets::create( #"hash_3b32288cc17c7c50", #"hash_719a4d9188d68f7" );
    scripted_widgets::function_9ade1d9b( #"hash_3b32288cc17c7c50", "ActiveIndex", -1 );
    function_2c85ed08( 0 );
    ...
    for ( i = 0; i < var_272aa18c.size ; i++ )
    {
        ...
        scripted_widgets::function_9ade1d9b( #"hash_3b32288cc17c7c50", "Combo" + i, isdefined( item.initial_value ) ? item.initial_value : 0 );
    }
    
    function_2c85ed08();
    scripted_widgets::function_9ade1d9b( #"hash_3b32288cc17c7c50", "ActiveIndex", 0 );
    scripted_widgets::set_focus( #"hash_3b32288cc17c7c50", 1 );
...
function private function_7825ee37( var_31d7501a )
{
    ...
    var_b4ce0d8c = 0;
    var_16aebd94 = 250;
    player childthread scripted_widgets::block_kbm_pause_menu( [ #"exit", #"combination_correct" ] );
    
    while ( true )
    {
        if ( player scripted_widgets::function_70217795() )
        {
            function_838e9ba9();
            player notify( #"exit" );
        ...
        {
            left_stick = player scripted_widgets::function_9c365c3b();
            right_stick = player scripted_widgets::function_6cbc939b();
        ...
        if ( up_down >= 0 && ( player scripted_widgets::function_9975a94d() || player backbuttonpressed() || var_cf705cb2.y < 0 ) )
        {
            up_down = -1;
            var_b4ce0d8c = time;
        }
        else if ( up_down <= 0 && ( player scripted_widgets::function_aef1e8c3() || player forwardbuttonpressed() || var_cf705cb2.y > 0 ) )
        {
            up_down = 1;
            var_b4ce0d8c = time;
        }
        else if ( left_right >= 0 && ( player scripted_widgets::function_c2d8a326() || player moveleftbuttonpressed() || var_cf705cb2.x < 0 ) )
        {
            left_right = -1;
            var_2ce7727b = time;
        }
        else if ( left_right <= 0 && ( player scripted_widgets::function_3d680c10() || player moverightbuttonpressed() || var_cf705cb2.x > 0 ) )
        {
            left_right = 1;
            var_2ce7727b = time;
        }
        ...
        if ( var_b4ce0d8c == time )
        {
            ...
            scripted_widgets::function_9ade1d9b( #"hash_3b32288cc17c7c50", "Combo" + level.var_9cc7e850, var_ab89de9b );
        ...
        else if ( var_2ce7727b == time && selected + left_right >= 0 && selected + left_right < level.combination.size )
        {
            ...
            scripted_widgets::function_9ade1d9b( #"hash_3b32288cc17c7c50", "ActiveIndex", selected );
        }
...
{
    scripted_widgets::function_9ade1d9b( #"hash_3b32288cc17c7c50", "State", state );
}
...
function function_838e9ba9()
{
    if ( scripted_widgets::exists( #"hash_3b32288cc17c7c50" ) )
    {
        scripted_widgets::set_focus( #"hash_3b32288cc17c7c50", 0 );
        scripted_widgets::remove( #"hash_3b32288cc17c7c50" );
    }
