...
function stealth_enemy_updateeveryframe( behaviortreeentity )
{
    ...
    shouldupdatelightmeter = level flag::get( "react_to_dynolights" );
...
// Size: 0x152
function function_55c47950( stealthstate, *event )
{
...
// Size: 0x142
function enterstealthstate( stealthstate, event )
{
    exitstealthstate( self.stealth.bsmstate );
    
    if ( self.stealth.bsmstate !== stealthstate )
    {
        self.stealth.var_9b6cd53f = gettime();
    }
    
    self.stealth.bsmstate = stealthstate;
    self function_55c47950( stealthstate, event );
...
// Size: 0xc2
function exitstealthstate( stealthstate )
{
    switch ( stealthstate )
    {
        case 0:
...
function idle_updatecurious( *behaviortreeentity )
{
    ...
    threatsight = highestthreatsight;
    var_85153501 = 0.25;
...
function hunt_sidechecks( instancedata )
{
    ...
    {
        lookaheadpos = self getposonpath( clookaheaddist );
