...
// Size: 0xb4
function private function_2ea9419c( type, amount = 1, showreward = 1 )
{
    if ( zm_utility::function_1a01f2f7( self ) )
    {
        return;
...
// Size: 0xfc
function function_d59d7b74( amount = 1, showreward = 1 )
{
    ...
    function_2ea9419c( #"rare", amount, showreward );
}
...
// Size: 0xfc
function function_89a45cd4( amount = 1, showreward = 1 )
{
    ...
    function_2ea9419c( #"epic", amount, showreward );
}
...
// Size: 0xfc
function function_74f5b460( amount = 1, showreward = 1 )
{
    ...
    function_2ea9419c( #"legendary", amount, showreward );
}
...
// Size: 0x12a
function private function_3e6a3070( star_rating )
{
    switch ( star_rating )
    {
        case 1:
...
// Size: 0xfc
function function_9ab33c13( star_rating = 1 )
{
    switch ( star_rating )
    {
        case 1:
...
// Size: 0x104
function function_1cda88b8( star_rating = 1 )
{
    switch ( star_rating )
    {
        case 1:
...
// Size: 0x74, Type: bool
function function_15c36044( star_rating = 1 )
{
    switch ( star_rating )
    {
        case 1:
...
// Size: 0x42c
function function_e6a712db( showreward = 1 )
{
    ...
    {
        star_rating = zm_utility::function_e3025ca5();
        var_3bf72bdb = function_9ab33c13( star_rating );
        function_d59d7b74( var_3bf72bdb, showreward );
        
        if ( is_true( getgametypesetting( #"hash_534a70940dadf3e7" ) ) )
        {
            var_8f88887b = function_1cda88b8( star_rating );
            var_a1b51775 = function_15c36044( star_rating );
            
            if ( var_8f88887b > 0 )
            {
                function_89a45cd4( var_8f88887b, showreward );
            }
            
            if ( var_a1b51775 > 0 )
            {
                function_74f5b460( var_a1b51775, showreward );
            }
        }
    ...
    if ( is_true( getgametypesetting( #"hash_534a70940dadf3e7" ) ) )
    {
        ...
        if ( round >= 20 )
        {
            function_74f5b460( 1, showreward );
        }
    }
}
...
// Size: 0x35c
function function_3a2e46e0( showreward = 1 )
{
    if ( !is_true( level.onlinegame ) )
    {
        showreward = 0;
    ...
    {
        star_rating = zm_utility::function_e3025ca5();
        var_5937b8ee = function_3e6a3070( star_rating );
    ...
    {
        function_d59d7b74( var_32ea0039, showreward );
    }
...
// Size: 0x814
function function_73cddc69( showreward = 1 )
{
    ...
    if ( zm_utility::is_survival() )
    {
        ...
        star_rating = zm_utility::function_e3025ca5();
        self function_a2d61378( star_rating );
        self function_e32813ee( star_rating );
        var_64bd84cc = function_4f5dff62( star_rating, #"rare" );
        self function_d59d7b74( var_64bd84cc, showreward );
        
        if ( is_true( getgametypesetting( #"hash_534a70940dadf3e7" ) ) )
        {
            var_bc3885e0 = function_4f5dff62( star_rating, #"epic" );
            var_629196dd = function_4f5dff62( star_rating, #"legendary" );
            
            if ( star_rating <= 2 && var_bc3885e0 > 0 )
            {
                ...
                {
                    self function_89a45cd4( var_bc3885e0, showreward );
                }
            }
            else
            {
            ...
            if ( star_rating <= 3 && var_629196dd > 0 )
            {
                ...
                {
                    self function_74f5b460( var_629196dd, showreward );
                }
            }
            else
            {
    ...
    if ( round >= 10 )
    {
        ...
        self function_d59d7b74( amount, showreward );
    }
    else
    {
        self function_d59d7b74( 1, showreward );
    }
    ...
    if ( is_true( getgametypesetting( #"hash_534a70940dadf3e7" ) ) )
    {
        if ( round == 15 )
        {
            ...
            if ( is_true( level.var_e578d0db ) )
            {
                function_89a45cd4( 1, showreward );
            }
        }
        else if ( round > 15 )
        {
...
// Size: 0xe4
function function_a2d61378( star_rating, var_2993280f = 1 )
{
    if ( star_rating <= 1 )
    {
    ...
    score = 2500 * ( star_rating - 1 ) * var_2993280f;
...
// Size: 0x13c
function function_e32813ee( star_rating, var_eb3616b4 = 1, var_492ebc70 = 1 )
{
    var_36bda4b = function_ef580a0c( star_rating );
    ...
    var_1ac981fc = function_b03d7dd0( star_rating );
