...
function function_839b3d5a( s_exfil )
{
    ...
    else
    {
        ...
        var_69c8822d = s_exfil.parent.contentgroups[ #"chopper_gunner_path" ][ 0 ];
...
function function_385ab693( var_fda8dff8 )
{
    ...
    {
        var_5dc3d377 = max( var_6b68b20f * 60, 60 ) + 45 + max( -30, min( 30, 3 * level.star_rating ) );
    }
...
function function_31125f54()
{
    ...
    if ( b_success )
    {
        foreach ( player in function_a1ef346b() )
        {
            ...
            if ( zm_utility::is_survival() )
            {
                if ( ( isdefined( level.star_rating ) ? level.star_rating : 1 ) >= 3 )
                {
        ...
        else
        {
            ...
            foreach ( s_scene in a_s_scenes )
            {
                ...
                if ( isdefined( str_scene ) && isinarray( array( #"aib_t9_vign_cust_sr_outro_success_01", #"aib_t9_vign_cust_sr_outro_success_night_01" ), str_scene ) )
                {
    ...
    else
    {
        ...
        else
        {
            ...
            foreach ( s_scene in a_s_scenes )
            {
                ...
                if ( isdefined( str_scene ) && isinarray( array( #"aib_t9_vign_cust_sr_outro_fail_01", #"aib_t9_vign_cust_sr_outro_fail_night_01" ), str_scene ) )
                {
...
function function_17f88f7c( var_68cc0f1f )
{
    ...
    var_b538af19 = isdefined( level.var_fdcaf3a6.contentgroups[ #"exfil_spawns" ] ) ? level.var_fdcaf3a6.contentgroups[ #"exfil_spawns" ] : [];
...
{
    var_a789c878 = level.var_fdcaf3a6.contentgroups[ #"exfil_horde_trigger" ][ 0 ];
...
function function_64df57fc( v_spawn, var_ca838126 )
{
    ...
    while ( var_2eb61c8a.size && n_ai_count < var_ca838126 )
    {
        ...
        {
            var_4bf95f4c.aitype_name = #"spawner_bo5_zombie_sr";
        }
...
function function_9feae843( var_fda8dff8 )
{
    ...
    {
        realm = math::clamp( level.star_rating - 1, 1, 4 );
    ...
    var_d6c33c06 = level.var_fdcaf3a6.contentgroups[ #"exfil_horde_spawn_points" ][ 0 ];
    ...
    while ( n_ai_count < var_560dcc36 && a_s_points.size )
    {
        ...
        if ( is_true( s_spawn_point.var_8789040f ) && ( var_82706add == #"spawner_zm_steiner" || var_82706add == #"spawner_bo5_mechz_sr" || var_82706add == #"spawner_bo5_raz_sr" ) )
        {
        ...
        if ( zm_utility::is_classic() )
        {
            ...
            if ( getaiarray().size < level.zombie_ai_limit )
            {
                ...
                {
                    ai = namespace_85745671::function_9d3ad056( var_82706add, s_spawn_point.origin, ( 0, randomint( 360 ), 0 ), "exfil_ai", 0, s_spawn_point.spawn_anim_alias );
                }
            }
        }
        else
        {
            ai = namespace_85745671::function_9d3ad056( var_82706add, s_spawn_point.origin, ( 0, randomint( 360 ), 0 ), "exfil_ai", b_force_spawn, s_spawn_point.spawn_anim_alias );
        }
...
function function_9974f649( params )
{
    ...
    if ( zm_utility::is_classic() )
    {
        ...
        if ( !isdefined( params.eattacker ) && !is_true( self.var_8576e0be ) || isplayer( params.eattacker ) && params.eattacker.v_train_inbound_igc !== 1 && params.weapon !== getweapon( #"chopper_gunner_turret" ) )
        {
