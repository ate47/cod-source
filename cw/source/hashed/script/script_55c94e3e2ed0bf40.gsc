...
function function_709fd94e( str_objective, *var_50cc0d4f )
{
    ...
    level flag::wait_till( #"flg_lockpick_skipto_end" );
...
function function_70073b6b( *str_objective, var_50cc0d4f, *var_aa1a6455, *player )
{
    ...
    if ( player )
    {
        ...
        level thread scene::play( #"scene_amk_2020_sdr_takedown", "doors_loop", a_scene_ents );
    }
...
function function_b9596ad1()
{
    ...
    level.var_eea5b22[ #"soldier_door" ] = var_d1a24548;
    level.var_eea5b22[ #"soldier_desk" ] = var_12baf921;
    var_4c5366ee = doors::get_doors( "e_lockpick_door", "targetname" )[ 0 ];
    ...
    level scene::init( #"scene_amk_2020_sdr_takedown", level.var_eea5b22 );
...
function private function_bb9839d8()
{
    ...
    level.player.var_97c1c267.script_delete_on_fail = 1;
    ...
    var_2a16bfbe = level.var_eea5b22[ #"soldier_door" ];
    var_2a16bfbe notsolid();
    level.player thread function_ed97bf94();
    level scene::play( #"scene_amk_2020_sdr_takedown", "open_door_start", level.var_eea5b22 );
    level flag::set( #"hash_525a26a0b7957925" );
    level scene::play( #"scene_amk_2020_sdr_takedown", "weapon_aim", level.var_eea5b22 );
    level flag::set( #"hash_3dac34734cfb07f4" );
    
    if ( flag::get( #"hash_eff650e7e8aecc2" ) )
    {
        level scene::play( #"scene_amk_2020_sdr_takedown", "fail_woods_shoot", level.var_eea5b22 );
    }
    
    arrayremoveindex( level.var_eea5b22, #"soldier_desk", 1 );
    level scene::play( #"scene_amk_2020_sdr_takedown", "takedown_player_end", level.var_eea5b22 );
    level flag::set( #"hash_4939af0c2a6ea11d" );
}
...
{
    self endon( #"death" );
    level waittill( #"sdr_takedown_rumble" );
...
function private function_6fac81f3( *params )
{
    ...
    level waittill( #"lockpick_takedown_enable_weapons" );
    level.player.var_4d448bdb hide();
    ...
    level waittill( #"lockpick_takedown_disable_weapons" );
    level.player hideviewmodel();
    level.player val::set( #"hash_70f48a440e25a27c", "disable_weapons", 2 );
    ...
    level.player val::reset( #"hash_70f48a440e25a27c", "disable_weapons" );
    level.player showviewmodel();
    level waittill( #"lockpick_takedown_plr_anim_complete" );
...
function private function_29962dd8( *params )
{
    ...
    var_86514cc = level.var_eea5b22[ #"soldier_desk" ];
...
function function_ff20ab50()
{
    ...
    level scene::play( #"scene_amk_2030_tnl_platform", "approach" );
    level thread scene::play( #"scene_amk_2030_tnl_platform", "loop" );
    ...
    level scene::play( #"scene_amk_2030_tnl_platform", "exit" );
    level scene::play( #"scene_amk_2040_tnl_stairs", "stairs" );
