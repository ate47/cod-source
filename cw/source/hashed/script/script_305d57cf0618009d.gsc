...
// Size: 0x1c
function setfadeouttime( newtime )
{
...
// Size: 0x1c
function setfadeintime( newtime )
{
    ...
    /#
        if ( getdvarint( #"scr_insertion_debug", 0 ) == 1 )
        {
            ...
            if ( minimaporigins.size == 2 )
            {
                ...
                corner4 = ( minimaporigins[ 1 ].origin[ 0 ], minimaporigins[ 0 ].origin[ 1 ], maxheight );
                debug_sphere( corner1, 750, ( 0, 0, 1 ) );
                debug_sphere( corner2, 750, ( 0, 0, 1 ) );
                debug_line( corner1, corner3, ( 0, 0, 1 ) );
                debug_line( corner1, corner4, ( 0, 0, 1 ) );
                debug_line( corner2, corner3, ( 0, 0, 1 ) );
                debug_line( corner2, corner4, ( 0, 0, 1 ) );
            }
        }
    #/
