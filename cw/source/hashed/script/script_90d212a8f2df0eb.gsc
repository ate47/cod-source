...
function village_heli()
{
    ...
    a_ents[ #"target_prop" ] = var_d8bef009;
...
function function_94850755()
{
    ...
    level waittill( #"village_heli_fire" );
    ...
    level waittill( #"village_heli_destroy_right_tower" );
...
{
    level endon( #"village_heli_stop_firing" );
...
{
    level waittill( #"village_heli_kill_barrel" );
...
{
    level waittill( #"village_heli_stop_firing" );
...
function function_10575162()
{
    ...
    level waittill( #"village_observe_adler_open_door" );
    ...
    level waittill( #"village_observe_adler_close_door" );
