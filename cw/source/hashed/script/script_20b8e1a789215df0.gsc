...
function function_9de162de( *str_objective )
{
    ...
    getent( "tgt_apt_front_door", "targetname" ).script_lockpick = 0;
}
...
{
    level.var_7d6bf2d4 = a_ents[ #"jprop" ];
...
function function_328da7d3()
{
    ...
    level.player thread flashback_tv::function_15eaa2db( undefined, undefined, "flag_player_approached_flashback_TV", "flag_player_not_near_living_room", "flashback_tv_lookat", undefined, "lgt_exp_flashback_tv", #"hash_58df9478d677bb38", struct::get( "flashback_tv_lookat" ) );
...
function function_3cbcb275()
{
    ...
    level notify( #"note_receiver_lifted" );
    level notify( #"phone_picked_up" );
...
{
    level waittill( #"notify_stop_steam" );
...
function function_4b86eb01()
{
    ...
    self waittill( #"kraus_kneel_start" );
...
function function_1f314257()
{
    ...
    self waittill( #"master_bedroom_target_enter_end" );
...
function function_af031d54()
{
    ...
    if ( !isdefined( objectives::function_285e460( #"obj_exit_apt" ) ) )
    {
        objectives::scripted( #"obj_exit_apt", undefined, #"hash_12b7bf71c03d97a9" );
    }
}
...
function function_d07f9e90()
{
    ...
    {
        case #"1f_living_room_vent":
            self thread function_db844d6d();
            break;
        case #"2f_office_drawer":
...
function function_34ee80b8( str_objective, var_50cc0d4f )
{
    ...
    level callback::function_95ba5345( &function_92d5be3e );
    objectives::remove( #"obj_exit_apt" );
...
{
    level waittill( #"play_knockout_rumble" );
    player = getplayers()[ 0 ];
...
{
    level waittill( #"check_darkroom_light" );
...
{
    level.var_4f36147a = a_ents[ #"tracking_briefcase" ];
}
...
{
    level waittill( #"start_greta_struggle_vo" );
