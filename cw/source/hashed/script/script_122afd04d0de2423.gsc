...
function main( var_d3440450, *var_50cc0d4f )
{
    ...
    level flag::wait_till( #"flag_hotel_breach_complete" );
...
function function_6f9e6949()
{
    ...
    level waittill( #"anim_notify_door_kicked" );
    ...
    level waittill( #"anim_notify_door_breached" );
...
{
    self endon( #"death" );
    self waittill( #"ok_to_do_scripted_death" );
    self.health = 999;
...
{
    self endon( #"death" );
    self waittill( #"breach_01_guy_in_loop" );
    self.skipdeath = 0;
}
...
{
    self endon( #"chair_move_no_stop", #"death" );
...
function function_c182078c()
{
    ...
    level flag::set( #"flag_hotel_breach_complete" );
...
function function_73a5b42a()
{
    ...
    while ( true )
    {
        ...
        s_waitresult = player waittill( #"enter_camera_ads", #"ability_deactivated_camera" );
        ...
        s_waitresult = player waittilltimeout( 4, #"end_camera_ads_begin", #"ability_deactivated_camera", #"take_picture" );
