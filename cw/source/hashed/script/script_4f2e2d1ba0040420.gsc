...
{
    scene::add_scene_func( #"zm_sr_outbreak_exfil_outro", &function_dd0d40c4, "play", 1 );
    scene::add_scene_func( #"zm_sr_outbreak_exfil_outro", &function_dd0d40c4, "done", 0 );
    scene::add_scene_func( #"zm_sr_outbreak_exfil_outro", &function_dd0d40c4, "stop", 0 );
    scene::add_scene_func( #"zm_sr_outbreak_exfil_outro", &function_29430f26, "Sh010", 0 );
    scene::add_scene_func( #"zm_sr_outbreak_exfil_outro", &function_29430f26, "Sh030", 1 );
    scene::add_scene_func( #"zm_sr_outbreak_exfil_outro", &function_f0e44578, "play" );
    scene::add_scene_func( #"zm_sr_outbreak_exfil_outro", &function_7b6f4f8b, "sh060" );
    level flag::wait_till_all( array( #"gameplay_started", #"hash_1558183088c6ccff" ) );
    
    if ( getdvarint( #"hash_292db25b2be947f", 0 ) )
    {
        var_841d9acf = isdefined( instance.contentgroups[ #"step5_skip_spawn_points" ] ) ? instance.contentgroups[ #"step5_skip_spawn_points" ] : [];
    ...
    namespace_d0ab5955::function_d4dec4e8( instance.location.destination, #"fow_tile_sanatorium_mq" );
    namespace_d0ab5955::function_f1ad7968( instance.location.destination, #"fow_tile_sanatorium" );
...
{
    level.var_8bb7479c = #"zm_sr_outbreak_exfil_outro";
    level.var_aaf7505f = min( 540, 270 + 10 * level.star_rating + 10 * getplayers().size );
    ...
    var_e2062f3 = struct::get( #"exfil_sanatorium_mq4_exfil_1", "targetname" );
    content_manager::spawn_instance( var_e2062f3 );
    level notify( #"hash_3e765c26047c9f54" );
    var_f6fe9c95 = level.var_fdcaf3a6.contentgroups[ #"exfil_orda_spawn_point" ][ 0 ];
    ...
    while ( true )
    {
        level.var_570f49c5 = namespace_85745671::function_9d3ad056( #"spawner_bo5_hulk", var_f6fe9c95.origin, var_f6fe9c95.angles, "exfil_ai", 0 );
    ...
    level thread scene::play( #"aib_t9_sr_small_orda_spawn_01", level.var_570f49c5 );
...
function function_382aed42( instance )
{
    ...
    level flag::wait_till( #"near_exfil_heli_arrived" );
    var_f6fe9c95 = level.var_fdcaf3a6.contentgroups[ #"exfil_orda_spawn_point" ][ 0 ];
...
function function_f0e44578( a_ents )
{
    ...
    vh_heli waittill( #"helicopter_hit_by_missile" );
...
function private function_7b6f4f8b( *a_ents )
{
    ...
    level flag::wait_till( #"zm_sr_outbreak_exfil_outro" + "_scene_done" );
    waitframe( 1 );
