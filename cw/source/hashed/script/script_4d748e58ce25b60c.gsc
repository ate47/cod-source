...
function function_2858dd5a()
{
    ...
    if ( isdefined( var_9a24b67c ) )
    {
        ...
        if ( isdefined( var_9a24b67c.lastscore ) && var_9a24b67c.lastscore > self.doa.score.var_1397c196 )
        {
            ...
            self.doa.score.var_5eac81d0 = var_9a24b67c.nextlife;
        }
    ...
    var_46460109 = { #roundnumber:self.var_248bd83, #var_484cc88b:self.doa.var_484cc88b, #var_87c1cd32:self.doa.var_87c1cd32, #lastscore:self.doa.score.var_1397c196, #var_5229d36f:self.doa.score.var_a928c52e, #nextlife:self.doa.score.var_5eac81d0 };
...
function function_7310b24f()
{
    ...
    if ( is_true( self.doa.blockinput ) )
    {
        profilestop();
        return;
    }
