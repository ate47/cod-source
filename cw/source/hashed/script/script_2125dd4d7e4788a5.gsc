...
function init( instance )
{
    ...
    foreach ( s_instance in instance.contentgroups[ #"retrieval" ] )
    {
        ...
        if ( isdefined( s_instance.contentgroups[ #"truck_flatbed" ] ) )
        {
            s_instance.var_1ac40948 = content_manager::spawn_script_model( s_instance.contentgroups[ #"truck_flatbed" ][ 0 ], #"hash_2dc80625b5b6627a", 1 );
        }
...
function function_fd68cae4()
{
    if ( self.archetype == #"zombie" )
    {
        ...
        if ( isdefined( self.var_b4e37a30 ) && level.star_rating > 4 )
        {
...
function retrieval_start( instance, activator )
{
    if ( isplayer( activator ) )
    {
        ...
        if ( instance.targetname === #"objective_golova_retrieval" || instance.targetname === #"objective_sanatorium_retrieval" || instance.targetname === #"objective_ski_retrieval_summit" || instance.targetname === #"objective_golova_retrieval_train" || instance.targetname === #"objective_duga_retrieval" || instance.targetname === #"objective_zoo_retrieval" || instance.targetname === #"objective_dune_retrieval" )
        {
            var_cdce8e6f = instance.contentgroups[ #"chopper_gunner_path" ][ 0 ];
