...
function function_6ad1ac64( var_d3440450, var_50cc0d4f )
{
    ...
    level thread scene::init( #"p9_fxanim_cp_armada_mortar_bld_dest_02_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_court_01_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_court_02_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_bldg_06_01_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_bldg_06_02_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_bldg_06_03_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_bldg_14_01_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_bldg_14_02_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_bldg_14_03_bundle" );
    level thread scene::init( #"p9_fxanim_cp_armada_town_bldg_14_04_bundle" );
    callback::on_ai_spawned( &function_e59c6d2a );
    level scene::function_27f5972e( #"p9_fxanim_cp_armada_mortar_bld_dest_02_bundle" );
...
function function_e1c02ad2()
{
    ...
    level scene::init( #"p9_fxanim_cp_armada_town_sign_explode_bundle" );
    var_d231fd39 hide();
    level waittill( #"destory_courtyard_sign" );
    level thread scene::play( #"p9_fxanim_cp_armada_town_sign_explode_bundle" );
    radiusdamage( s_target.origin - ( 0, 0, 200 ), 512, 500, 500 );
    earthquake( 0.25, 1, s_target.origin, 2500 );
    level.player playrumbleonentity( "damage_heavy" );
    level waittill( #"show_courtyard_sign_model" );
    var_d231fd39 show();
}
...
function function_2c4d7184()
{
    ...
    level.player playrumbleonentity( "damage_heavy" );
    level thread scene::play( #"p9_fxanim_cp_armada_mortar_bld_dest_02_bundle" );
    level waittill( #"show_bell_tower_model" );
    showmiscmodels( "bell_tower_final" );
    level scene::function_f81475ae( #"p9_fxanim_cp_armada_mortar_bld_dest_02_bundle" );
...
function function_19288a46()
{
    ...
    self thread scene::play( #"armada_chopper_gunner_door_open", a_ents );
...
function function_6cce8b8e()
{
    ...
    self setspeed( 60 );
    self waittill( #"mortar_orbit_approach_speed_1" );
    self setspeed( 20, 30, 30 );
    self waittill( #"mortar_orbit_approach_speed_2" );
...
function function_97a20289()
{
    ...
    level scene::init( #"armada_mortar_village_chopper_landing", a_ents );
}
...
function function_6acbfbb1( var_50cc0d4f = 0 )
{
    ...
    level scene::add_scene_func( #"armada_mortar_village_chopper_landing", &function_4ca07f70, "play" );
    a_ents = [];
    a_ents[ #"player" ] = self;
    a_ents[ #"buddy" ] = level.buddy;
    a_ents[ #"pilot" ] = level.pilot;
    ...
    level scene::play( #"armada_mortar_village_chopper_landing", a_ents );
    ...
    level.var_7466d419 scene::stop( #"p9_fxanim_cp_armada_dice_hanging_bundle", 1 );
}
...
{
    self endon( #"death" );
    self waittill( #"mortar_landing_scene_cam_lerp_to_open" );
    self setviewclamp( 25, 15, 5, 5, 0, 0, 1 );
    self waittill( #"mortar_landing_scene_cam_lerp_to_zero" );
...
{
    self endon( #"death" );
    self waittill( #"landing_scene_done" );
    self.drivepath = 1;
...
{
    level endon( #"flag_mortar_orbit_complete" );
    level flag::wait_till( #"flag_mortar_play_landing_vo" );
...
function function_94a21d8b( var_d3440450, var_50cc0d4f )
{
    ...
    level scene::stop( #"p9_fxanim_cp_armada_mortar_bld_dest_02_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_court_01_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_court_02_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_bldg_06_01_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_bldg_06_02_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_bldg_06_03_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_bldg_14_01_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_bldg_14_02_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_bldg_14_03_bundle", 1 );
    level scene::stop( #"p9_fxanim_cp_armada_town_bldg_14_04_bundle", 1 );
    function_92d60a9d();
...
function function_82ba400e( s_target )
{
    ...
    self waittill( #"start_adler_chopper_attack_1" );
...
function function_c6c2c276()
{
    ...
    wait 4;
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_ammo_cache", &function_469dbbc4, "init" );
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_jump_out_window_01", &function_ecf10386, "init" );
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_jump_out_window_01", &function_b6a33802, "play" );
    level scene::init( #"aib_t9_vign_cust_arm_ammo_cache" );
    waitframe( 1 );
    level scene::init( #"aib_t9_vign_cust_arm_jump_out_window_01" );
}
...
function function_469dbbc4( a_ents )
{
    ...
    level scene::remove_scene_func( #"aib_t9_vign_cust_arm_ammo_cache", &function_469dbbc4, "init" );
    ...
    if ( level scene::is_playing( #"aib_t9_vign_cust_arm_ammo_cache", "if_not_shot_go_to_crc_shoot" ) || level scene::is_playing( #"aib_t9_vign_cust_arm_ammo_cache", "shoot_loop" ) )
    {
        level scene::play( #"aib_t9_vign_cust_arm_ammo_cache", "if_shot_in_crc_exposed" );
    }
    else
    {
        level scene::play( #"aib_t9_vign_cust_arm_ammo_cache", "if_shot_right_away" );
    }
...
function function_aad3f658()
{
    ...
    level scene::play( #"aib_t9_vign_cust_arm_ammo_cache", "react" );
    level scene::play( #"aib_t9_vign_cust_arm_ammo_cache", "if_not_shot_go_to_crc_shoot" );
    level thread scene::play( #"aib_t9_vign_cust_arm_ammo_cache", "shoot_loop" );
    level flag::wait_till_timeout( 0.5, "flag_stop_ammo_cache_scene" );
    level notify( #"flag_stop_ammo_cache_scene" );
    level thread scene::stop( #"aib_t9_vign_cust_arm_ammo_cache" );
...
function function_77ff9ff2()
{
    ...
    level scene::stop( #"aib_t9_vign_cust_arm_jump_out_window_01", 1 );
    level scene::stop( #"aib_t9_vign_cust_arm_ammo_cache", 1 );
}
...
{
    level scene::remove_scene_func( #"aib_t9_vign_cust_arm_jump_out_window_01", &function_ecf10386, "init" );
    enemy = a_ents[ #"actor 1" ];
    enemy endon( #"death" );
    level flag::wait_till( "flag_aib_t9_vign_cust_arm_ammo_cache_play" );
    wait 0.5;
    level scene::play( #"aib_t9_vign_cust_arm_jump_out_window_01", "react", enemy );
}
...
function function_b6a33802( a_ents )
{
    ...
    level scene::remove_scene_func( #"aib_t9_vign_cust_arm_jump_out_window_01", &function_b6a33802, "play" );
}
...
function function_ce14c867()
{
    ...
    self endon( #"death" );
    self scene::init( #"aib_t9_vign_cust_arm_peaking_window", self );
    ...
    self scene::play( #"aib_t9_vign_cust_arm_peaking_window", "react", self );
...
function function_ded00ef3()
{
    ...
    self endon( #"death" );
    self scene::play( #"aib_t9_vign_cust_arm_peaking_window", "intro", self );
    self thread scene::play( #"aib_t9_vign_cust_arm_peaking_window", "loop", self );
    wait 1.5;
...
function function_fd33933d()
{
    ...
    level scene::stop( #"aib_t9_vign_cust_arm_peaking_window", 1 );
}
...
function function_291146ea()
{
    ...
    self thread function_119bac80( waitresult.attacker );
    self scene::play( #"aib_vign_tplt_dth_fall_over_railing_f_01", "Shot 1", self );
...
{
    self endon( #"death" );
    self thread scene::play( #"aib_t9_vign_tplt_ent_sldr_brks_wndw_1_base_1", "break_glass", self );
...
function function_d64dcfe2()
{
    ...
    level thread scene::play( #"aib_t9_vign_cust_arm_scan_for_heli_balcony", "loop", self );
    level util::waittill_any_ents( level, "flag_start_vign_scan_for_heli_balcony", self, "damage" );
    self notify( #"play_scene" );
    level thread scene::play( #"aib_t9_vign_cust_arm_scan_for_heli_balcony", "react", self );
    self setpersonalthreatbias( level.player, 2000 );
...
function function_2136dc79()
{
    ...
    self scene::stop( #"aib_t9_vign_cust_arm_scan_for_heli_balcony", 1 );
...
{
    self endon( #"death" );
    level scene::play( #"aib_t9_vign_cust_arm_startled_ent_balcony_death", "intro", self );
    level thread scene::play( #"aib_t9_vign_cust_arm_startled_ent_balcony_death", "loop", self );
    waitresult = self waittilltimeout( 1.3, #"damage" );
    self thread function_119bac80( waitresult.attacker );
    
    if ( waitresult._notify == "damage" )
    {
        level thread scene::play( #"aib_t9_vign_cust_arm_startled_ent_balcony_death", "death", self );
        return;
    }
    
    level thread scene::stop( #"aib_t9_vign_cust_arm_startled_ent_balcony_death" );
...
function function_558f59db( var_cc827aa1 )
{
    ...
    if ( isdefined( self ) && isdefined( waitresult.attacker ) )
    {
        if ( isdefined( waitresult.weapon ) && waitresult.weapon.weapclass != "spread" && distance2d( self.origin, var_cc827aa1.origin ) < 41 )
        {
            ...
            self.a.nodeath = 1;
            self.skipdeath = 1;
            self scene::play( #"aib_t9_vign_cust_arm_dth_against_wall_2_stairs_01", "death", self );
        }
    }
...
function function_d250e19f()
{
    ...
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_grp_react_surprise_doorway", &function_28a8f735, "init" );
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_grp_react_surprise_doorway", &function_e9a58f7a, "done" );
    level flag::wait_till( "flag_reached_tea_house_upper_floor" );
    level thread scene::play( #"aib_t9_vign_cust_arm_grp_react_surprise_doorway", "init" );
    level flag::wait_till( "start_vignette_react_surprise_doorway" );
    level scene::play( #"aib_t9_vign_cust_arm_grp_react_surprise_doorway", "play" );
}
...
{
    level endon( #"flag_mortar_reached_red_door" );
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_engage_2_wall_death_01", &function_6c337113, "init" );
    level flag::wait_till( "flag_mortar_upper_mortar_building_reached" );
    level scene::play( #"aib_t9_vign_cust_arm_engage_2_wall_death_01", "init" );
    level scene::remove_scene_func( #"aib_t9_vign_cust_arm_engage_2_wall_death_01", &function_6c337113, "init" );
}
...
function function_6c337113( a_ents )
{
    ...
    enemy scene::play( #"aib_t9_vign_cust_arm_engage_2_wall_death_01", "start", enemy );
    
    if ( !isdefined( enemy.var_724e738 ) )
    {
        enemy scene::play( #"aib_t9_vign_cust_arm_engage_2_wall_death_01", "loop", enemy );
    }
}
...
function function_be0c7630()
{
    ...
    if ( isalive( self ) )
    {
        ...
        {
            self scene::stop( #"aib_t9_vign_cust_arm_engage_2_wall_death_01" );
...
function function_566d3929()
{
    ...
    self thread scene::play( #"aib_t9_vign_cust_arm_engage_2_wall_death_01", "start", self );
    wait 0.5;
    level scene::stop( #"aib_t9_vign_cust_arm_engage_2_wall_death_01" );
...
function function_e12e064f()
{
    ...
    if ( isdefined( waitresult.weapon ) && isdefined( waitresult.attacker ) )
    {
        if ( waitresult.weapon.weapclass === "spread" && distance2dsquared( self.origin, waitresult.attacker.origin ) < sqr( 300 ) && !isdefined( self.var_724e738 ) )
        {
            ...
            self.skipdeath = 1;
            self.var_b0587b14 = 1;
            self thread scene::play( #"aib_t9_vign_cust_arm_engage_2_wall_death_01", "death", self );
            self waittill( #"physicsexplosion" );
...
function function_5e509636()
{
    ...
    level.player endon( #"death" );
    level scene::init( #"aib_t9_vign_cust_arm_door_roll_entr_01", self );
    ...
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_door_roll_entr_01", &function_a3bea266, "play" );
    level scene::play( #"aib_t9_vign_cust_arm_door_roll_entr_01", self );
}
...
function function_a3bea266( a_ents )
{
    ...
    level scene::remove_scene_func( #"aib_t9_vign_cust_arm_door_roll_entr_01", &function_a3bea266, "play" );
}
...
function function_ebdd60f9()
{
    ...
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_alley_entries", &function_cbca12b3, "play" );
    ...
    {
        level scene::play( #"aib_t9_vign_cust_arm_alley_entries" );
    }
    
    level scene::remove_scene_func( #"aib_t9_vign_cust_arm_alley_entries", &function_cbca12b3, "play" );
}
...
function function_3d691322()
{
    ...
    level waittilltimeout( 23, #"mortar_pickup_intel" );
    ...
    level waittill( #"mortar_intel_player_done" );
...
function function_110866d( b_init = 0 )
{
    ...
    if ( b_init )
    {
        level scene::init( #"t9_arm_mv_open_door", a_ents );
        return;
    }
    
    level thread scene::play( #"t9_arm_mv_open_door", "open_door", a_ents );
    level waittill( #"player_open_red_door_anim_done" );
...
function function_766af271()
{
    a_ents = [];
    a_ents[ #"buddy" ] = level.buddy;
    level scene::add_scene_func( #"armada_mv_intel_collect", &function_e8f2d444, "play" );
    level scene::add_scene_func( #"armada_mv_intel_collect", &function_ce1faca, "stop" );
    level thread scene::play( #"armada_mv_intel_collect", a_ents );
}
...
function function_a1de7ea2( b_init = 0 )
{
    ...
    a_ents[ #"player" ] = level.player;
    a_ents[ #"buddy" ] = level.buddy;
    a_ents[ #"exfildoorright" ] = getent( "mortar_door_exfil_right", "targetname" );
    a_ents[ #"exfildoorleft" ] = getent( "mortar_door_exfil_left", "targetname" );
    
    if ( b_init )
    {
        level scene::add_scene_func( #"armada_mv_intell_collect_player", &function_cd1dcfed, "sims_exit" );
        level scene::init( #"armada_mv_intell_collect_player", a_ents );
        return;
    }
    
    level scene::stop( #"armada_mv_intel_collect" );
    level flag::set( "flag_start_mv_intell_collect_scene" );
    level flag::set( "flag_enable_mortar_exfil_color_chain" );
    level thread scene::play( #"armada_mv_intell_collect_player", "sims_exit", a_ents );
    level waittill( #"sims_open_door_after_intel" );
...
function function_e8f2d444( a_ents )
{
    ...
    level scene::remove_scene_func( #"armada_mv_intel_collect", &function_e8f2d444, "play" );
}
...
function function_ce1faca( a_ents )
{
    ...
    level scene::remove_scene_func( #"armada_mv_intel_collect", &function_ce1faca, "stop" );
}
...
function function_262e8906( var_50cc0d4f )
{
    ...
    {
        level scene::play( #"armada_mv_intell_collect_player", "sims_stairs", a_ents );
    }
    
    level thread scene::play( #"armada_mv_intell_collect_player", "sims_stairs_idle", a_ents );
    level flag::wait_till( "flag_sims_moveto_stairs_cover" );
    level thread scene::play( #"armada_mv_intell_collect_player", "sims_stairs_exit", a_ents );
}
...
function function_cd1dcfed( ents )
{
    ...
    if ( isdefined( var_fe4a8480 ) )
    {
        ...
        level waittill( #"hide_dossier" );
        var_fe4a8480 hide();
    }
    
    level scene::remove_scene_func( #"armada_mv_intell_collect_player", &function_cd1dcfed, "sims_exit" );
}
...
{
    self val::set( #"aib_t9_vign_cust_arm_run_2_cover", "ignoreme", 1 );
    self thread scene::play( #"aib_t9_vign_cust_arm_run_2_cover", "Shot 1", self );
    ...
    self scene::play( #"aib_t9_vign_cust_arm_run_2_cover", "Shot 2", self );
    self val::reset( #"aib_t9_vign_cust_arm_run_2_cover", "ignoreme" );
}
...
{
    level scene::add_scene_func( #"aib_t9_vign_cust_arm_last_room_react", &function_9c91c0b5, "done" );
    level flag::wait_till( "flag_exfil_exit_guards" );
    level thread scene::play( #"aib_t9_vign_cust_arm_last_room_react" );
    level flag::wait_till( "flag_spawn_exfil_courtyard_enemies" );
    
    if ( level scene::is_active( #"aib_t9_vign_cust_arm_last_room_react" ) )
    {
        level scene::stop( #"aib_t9_vign_cust_arm_last_room_react" );
    }
}
...
function function_9c91c0b5( a_ents )
{
    ...
    level scene::remove_scene_func( #"aib_t9_vign_cust_arm_last_room_react", &function_9c91c0b5, "done" );
}
...
function function_79299255()
{
    ...
    level scene::play( #"armada_village_chopper_sims_exfil", self );
}
...
function function_58771ad7()
{
    ...
    level scene::init( #"armada_village_chopper_exfil", a_ents );
    level flag::wait_till( #"exfil_flyby_go" );
    ...
    level scene::play( #"armada_village_chopper_exfil", "arrival", a_ents );
    level scene::play( #"armada_village_chopper_exfil", "in", a_ents );
    ...
    level thread scene::play( #"armada_village_chopper_exfil", "loop", a_ents );
    ...
    level scene::stop( #"armada_village_chopper_sims_exfil" );
    level.var_7466d419 turretsettargetangles( 1, ( 0, 0, 0 ) );
    level scene::play( #"armada_village_chopper_exfil", "out", a_ents );
...
function function_e9339cdf()
{
    if ( !level flag::get( #"hash_53c7d32dc75bd3ea" ) )
    {
        ...
        a_ents[ #"gunner" ] = level.gunner;
        a_ents[ #"playerchopper" ] = level.var_7466d419;
        level.var_7466d419 thread scene::play( #"armada_gunner_turret_idle", a_ents );
...
function function_9290ebb3()
{
    ...
    level.var_7466d419 scene::play( #"armada_mortar_end", a_ents );
    level.player hide();
}
...
function function_6b5096fe()
{
    ...
    if ( level.var_52874eb2.vehicletype != #"vehicle_t9_mil_us_helicopter_large_cp_armada_ai" )
    {
        level.var_52874eb2 setvehicletype( #"vehicle_t9_mil_us_helicopter_large_cp_armada_ai" );
    }
...
function function_1df2273d( *destructible_event, attacker, *weapon, *piece_index, *point, *dir, *mod )
{
    ...
    {
        case #"mortar_orbit_barrel_bldg_06_01":
            level scene::play( #"p9_fxanim_cp_armada_town_bldg_06_01_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_bldg_06_01_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_bldg_06_01_bundle" );
            break;
        case #"mortar_orbit_barrel_bldg_06_02":
            level scene::play( #"p9_fxanim_cp_armada_town_bldg_06_02_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_bldg_06_02_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_bldg_06_02_bundle" );
            break;
        case #"mortar_orbit_barrel_bldg_06_03":
            level scene::play( #"p9_fxanim_cp_armada_town_bldg_06_03_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_bldg_06_03_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_bldg_06_03_bundle" );
            break;
        case #"mortar_orbit_barrel_bldg_14_01":
            level scene::play( #"p9_fxanim_cp_armada_town_bldg_14_01_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_bldg_14_01_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_bldg_14_01_bundle" );
            break;
        case #"mortar_orbit_barrel_bldg_14_02":
            level scene::play( #"p9_fxanim_cp_armada_town_bldg_14_02_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_bldg_14_02_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_bldg_14_02_bundle" );
            break;
        case #"mortar_orbit_barrel_bldg_14_03":
            level scene::play( #"p9_fxanim_cp_armada_town_bldg_14_03_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_bldg_14_03_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_bldg_14_03_bundle" );
            break;
        case #"mortar_orbit_barrel_bldg_14_04":
            level scene::play( #"p9_fxanim_cp_armada_town_bldg_14_04_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_bldg_14_04_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_bldg_14_04_bundle" );
            break;
        case #"mortar_orbit_barrel_court_01":
            level scene::play( #"p9_fxanim_cp_armada_town_court_01_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_court_01_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_court_01_bundle" );
            break;
        case #"mortar_orbit_barrel_court_02":
            level scene::play( #"p9_fxanim_cp_armada_town_court_02_bundle" );
            showmiscmodels( "p9_fxanim_cp_armada_town_court_02_static_mod" );
            level function_97bcc0e9( #"p9_fxanim_cp_armada_town_court_02_bundle" );
            break;
    }
}
