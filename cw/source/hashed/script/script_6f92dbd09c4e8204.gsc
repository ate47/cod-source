...
function function_40900e7c()
{
    ...
    level waittill( #"activate_find_contact_obj" );
...
{
    level waittill( #"stair_descend_radio_response" );
...
function function_bd064da5( a_ents )
{
    ...
    level.var_47fb3484 = a_ents[ #"rooftop_descend_door_01" ];
    ...
    level.var_a23ce906 = a_ents[ #"rooftop_descend_door_02" ];
...
function function_93407046( a_ents )
{
    ...
    level.var_fb6f2b39 = a_ents[ #"bar_contact_lighter" ];
    level.var_1922a1f3 = a_ents[ #"bar_contact_props" ];
    ...
    level.var_ee1e1434 = a_ents[ #"bar_contact_napkin" ];
    level.var_ee1e1434 hide();
    level.var_bff9a427 = a_ents[ #"bar_player_hidden_mic" ];
    level.var_bff9a427 hide();
    level.var_d3081b95 = a_ents[ #"bar_player_props" ];
...
{
    level.var_dd43ea07 = a_ents[ #"bar_bartender" ];
    a_ents[ #"bar_bartender" ] setmodel( #"hash_322f0af6c1be1b88" );
    level.var_90258347 = a_ents[ #"bar_server" ];
    a_ents[ #"bar_server" ] setmodel( #"hash_1d1f55abc907ac00" );
    level.var_90258347 thread function_37d7e316();
    level.var_9de42dec = a_ents[ #"bar_guy01" ];
    a_ents[ #"bar_guy01" ] setmodel( #"hash_322f0bf6c1be1d3b" );
    level.var_f4b6db4c = a_ents[ #"bar_guy02" ];
    a_ents[ #"bar_guy02" ] setmodel( #"hash_322f0df6c1be20a1" );
    level.var_77534a72 = a_ents[ #"bar_lady01" ];
    a_ents[ #"bar_lady01" ] setmodel( #"hash_1d1f5cabc907b7e5" );
    level.var_899eef09 = a_ents[ #"bar_lady02" ];
    a_ents[ #"bar_lady02" ] setmodel( #"hash_1d1f56abc907adb3" );
    waitframe( 1 );
    level.var_b20c744c = a_ents[ #"bar_bartender_props" ];
    level.var_b20c744c attach( "par_glassware_01", "j_prop_1", 1 );
    level.var_9add4841 = a_ents[ #"bar_server_props" ];
    level.var_9add4841 attach( "stk_serving_tray_01", "j_prop_1", 1 );
    level.var_9add4841 attach( "par_glassware_03", "j_prop_2", 1 );
    level.var_5f8afdc7 = a_ents[ #"bar_guy02_props" ];
    level.var_5f8afdc7 attach( "par_glassware_01", "j_prop_2", 1 );
    level.var_ae6a9219 = a_ents[ #"bar_lady02_book" ];
    level.var_6bd49be4 = a_ents[ #"bar_lady02_props" ];
    level.var_6bd49be4 attach( "aac_kitchen_chair_01", "j_prop_1", 1 );
    level.var_6bd49be4 attach( "par_glassware_01", "j_prop_2", 1 );
    waitframe( 1 );
    level.var_7bd40b4f = a_ents[ #"bar_couple_props" ];
    ...
    var_cdec639c = a_ents[ #"bar_bartender" ];
    var_906b811d = a_ents[ #"bar_guy02" ];
    level.var_f249468f = a_ents[ #"bar_guy01" ];
    level.var_5b216319 = a_ents[ #"bar_lady01" ];
...
{
    level waittill( #"delete_bar_server" );
...
{
    level waittill( #"bar_finish_bartender_vo" );
    wait 2;
...
{
    level.var_a31721f9 = a_ents[ #"bar_lady03" ];
    a_ents[ #"bar_lady03" ] setmodel( #"hash_1d1f57abc907af66" );
    level.var_5f04560a = a_ents[ #"bar_lady03_props" ];
...
function function_a8b581af( a_ents )
{
    ...
    level.var_5abddee0 = a_ents[ #"bar_guy07_props" ];
...
{
    level.var_221cd219 = a_ents[ #"bar_guy_08" ];
    a_ents[ #"bar_guy_08" ] setmodel( #"hash_322f08f6c1be1822" );
    level.var_305cee99 = a_ents[ #"bar_guy_09" ];
}
...
function function_bf0b5031()
{
    ...
    player waittill( #"player_stand_lerp_view" );
...
function function_394fb635()
{
    ...
    getplayers()[ 0 ] waittill( #"player_stand_lerp_view" );
