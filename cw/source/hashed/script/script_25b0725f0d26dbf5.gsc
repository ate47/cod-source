...
function function_27e76b4c( var_39a61773, var_c027e5d, var_8703bf11 = 1 )
{
    if ( !isdefined( level.var_7466d419 ) )
    {
        ...
        if ( var_39a61773 === "heli_spawn_airbase" )
        {
            level.var_7466d419 thread scene::play( #"p9_fxanim_cp_armada_dice_hanging_bundle", "Shot 1" );
        }
    ...
    if ( isdefined( var_c027e5d ) )
    {
        ...
        if ( var_c027e5d == 0 )
        {
            if ( level.var_7466d419.vehicletype != #"vehicle_t9_mil_us_helicopter_large_cp_armada_player_gunship" )
            {
                level.var_7466d419 setvehicletype( #"vehicle_t9_mil_us_helicopter_large_cp_armada_player_gunship" );
            }
        }
...
function function_d777fe61( var_b54b1d1d )
{
    ...
    current_seat = chopper getoccupantseat( level.player );
    
    if ( var_b54b1d1d === current_seat )
    {
        return;
    }
    ...
    if ( var_b54b1d1d === 0 )
    {
        if ( chopper.vehicletype != #"vehicle_t9_mil_us_helicopter_large_cp_armada_player_gunship" )
        {
            chopper setvehicletype( #"vehicle_t9_mil_us_helicopter_large_cp_armada_player_gunship" );
            chopper player_large_helicopter_armada::function_38ae4287();
        }
    }
    
    if ( !isdefined( current_seat ) || current_seat === -1 )
    {
    ...
    else
    {
        ...
        chopper setseatoccupied( current_seat, 1 );
        chopper makevehicleunusable();
    }
...
function function_6a03d24d( var_d3440450 )
{
    switch ( var_d3440450 )
    {
        ...
        case #"armada_flyin":
            ...
            break;
        case #"armada_flyin_beach":
            function_27e76b4c( "heli_spawn_airbase", 2 );
            function_14a42357( 1 );
            function_e1635dfe( 1 );
            function_ed68628c( 1 );
            break;
        case #"armada_flyin_firebase":
            function_27e76b4c( "heli_spawn_airbase", 2 );
            function_d5d40694();
            function_ed68628c( 1 );
            break;
        case #"armada_firebase_checkin":
            function_27e76b4c( "heli_spawn_firebase_checkin", 2 );
            function_d5d40694();
            function_ed68628c( 0, struct::get( "spawn_vip_intro", "targetname" ) );
            break;
        case #"armada_fly_to_branch":
            function_27e76b4c( "heli_spawn_fly_to_branch", 0 );
            function_d5d40694();
            function_ed68628c( 1 );
            break;
        case #"armada_fly_to_branch_reached":
        ...
        case #"hash_5beb082ca4e77486":
            ...
            function_ed68628c( 1 );
            break;
        case #"armada_fly_bamboo_to_mortar":
        ...
        case #"armada_bamboo_orbit":
            ...
            function_ed68628c( 1 );
            break;
        case #"armada_bamboo_crash":
        case #"armada_bamboo_start_1":
            function_27e76b4c( "heli_spawn_bamboo" );
            function_d5d40694();
            function_ed68628c( 0 );
            function_882e6973( 0 );
            break;
        case #"armada_bamboo_end":
            function_27e76b4c( "heli_spawn_bamboo" );
            function_d5d40694();
        ...
        case #"hash_d9f7dbd88b82743":
            ...
            function_882e6973( 1 );
            break;
        case #"armada_fly_bamboo_to_firebase":
            function_27e76b4c( "heli_spawn_bamboo_exit", 0 );
            function_d5d40694();
            function_ed68628c( 1 );
            function_882e6973( 1 );
...
function function_b50b1da4( helicopter, position, var_f37b2ff0 )
{
    ...
    switch ( position )
    {
        case 0:
            ...
            str_model = #"spawner_bo5_human_allies_us_army_chopper_pilot_1_pistol";
            break;
        case 1:
            if ( !isdefined( var_ef41a687 ) )
            {
            ...
            str_model = #"spawner_bo5_human_allies_us_army_chopper_pilot_2_pistol";
            break;
        case 6:
            if ( !isdefined( var_ef41a687 ) )
            {
...
{
    level endon( #"flag_intro_player_boarded_chopper", #"flag_increase_player_intro_movement_speed" );
