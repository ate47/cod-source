...
function preinit()
{
    ...
    content_manager::register_script( #"jump_pads", &function_e7e5c90d );
...
function function_4317fa79( destination )
{
    ...
    foreach ( s_location in destination.locations )
    {
        ...
        {
            content_manager::spawn_instance( s_location.instances[ #"jump_pads" ] );
            break;
        }
    }
}
...
function private function_e7e5c90d( s_instance )
{
    ...
    var_193b9763 = array::randomize( isdefined( s_instance.contentgroups[ #"jump_pad_loc" ] ) ? s_instance.contentgroups[ #"jump_pad_loc" ] : [] );
...
function private function_1b543d55()
{
    ...
    foreach ( var_5207017 in isdefined( self.contentgroups[ #"jump_pad_loc" ] ) ? self.contentgroups[ #"jump_pad_loc" ] : [] )
    {
