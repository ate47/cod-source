...
function function_4fdccb97()
{
    ...
    level waittill( #"intro_show_weapon" );
    ...
    level waittill( #"intro_allow_player_movement" );
    ...
    level.player waittill( #"plr_forest_branch_anim_trigger" );
...
function function_e25ef0de()
{
    ...
    var_175962cd[ #"ai_soldier01" ] = var_595b3c05[ 0 ];
    var_175962cd[ #"ai_soldier02" ] = var_595b3c05[ 1 ];
    var_175962cd[ #"ai_soldier03" ] = var_595b3c05[ 2 ];
