...
function event_handler[level_init] main( *eventstruct )
{
    ...
    objective_manager::register_script( #"kill_hvt", &spawn_func, &start_callback, #"hunt", #"hash_59cd8f2a488c0201", #"hash_23331c459fc1fe23", 5, #"hash_5a76d5e2fa7e03c0" );
}
...
function function_ccaf09a( instance )
{
    ...
    while ( true )
    {
        ...
        if ( self.aitype === #"spawner_bo5_raz_sr_hvt" )
        {
...
function private start_callback( instance, activator )
{
    ...
    foreach ( var_109708e0 in isdefined( instance.contentgroups[ #"hvt" ] ) ? instance.contentgroups[ #"hvt" ] : [] )
    {
        ...
        if ( !is_true( instance.var_9ef060ec ) && var_109708e0.ai_type === "raz" && level.star_rating > 1 && n_players >= 3 )
        {
            var_109708e0.count++;
        }
...
function private function_cf54aadd( *var_f5064815, s_instance, *var_e905c444 )
{
    ...
    switch ( function_a1ef346b().size )
    {
        case 1:
        default:
            if ( level.var_1f73a372.aitype === #"spawner_bo5_mechz_sr_hvt" )
            {
                n_to_spawn = 12;
            }
            ...
            else if ( level.var_1f73a372.aitype === #"spawner_bo5_mimic_hvt" )
            {
                n_to_spawn = 14;
            }
    ...
    self.num_spawn_points = 64;
    self.spawn_points = namespace_85745671::function_e4791424( self.origin, self.num_spawn_points, self.spawn_height, self.spawn_radius, int( self.spawn_radius * 0.5 ), 0, 1, 0 );
...
function private function_dd27cb14( *var_f5064815, s_instance, var_559503f1 )
{
    ...
    while ( true )
    {
        ...
        foreach ( s_spawnpt in var_559503f1 )
        {
            ...
            s_spawnpt.num_spawn_points = n_to_spawn;
            spawn_points = namespace_85745671::function_e4791424( s_spawnpt.origin, s_spawnpt.num_spawn_points, s_spawnpt.spawn_height, s_spawnpt.spawn_radius, undefined, undefined, 1, 0 );
...
function private function_15bda870( s_spawn, var_109708e0, s_instance )
{
    ...
    if ( isalive( level.var_1f73a372 ) )
    {
        ...
        var_e79dabce = isdefined( s_spawn.contentgroups[ #"rushers" ] ) ? s_spawn.contentgroups[ #"rushers" ] : [];
        ...
        if ( isdefined( level.var_1f73a372 ) )
        {
            ...
            if ( level.var_1f73a372.aitype === #"spawner_bo5_raz_sr_hvt" || level.var_1f73a372.aitype === #"hash_acac3fe7a341329" )
            {
...
function function_630a01ee()
{
    self endon( #"objective_ended" );
    wait 2;
    var_5f59f064 = getaiarchetypearray( #"zombie_steiner" );
...
function function_d20a3932( s_instance, *var_f5064815, var_6a4ec994 )
{
    ...
    switch ( self.aitype )
    {
        case #"spawner_bo5_raz_sr_hvt":
            str_aitype = #"spawner_bo5_zombie_dog_molotov";
            break;
        case #"hash_acac3fe7a341329":
            str_aitype = #"spawner_bo5_zombie_dog_plague";
            break;
...
function private function_90591f67( var_f5064815, var_109708e0, s_instance )
{
    ...
    if ( isdefined( self.mdl_trail ) )
    {
        ...
        if ( s_instance.targetname === #"objective_sanatorium_hunt_raz" )
        {
            var_bd04a254 = struct::get( #"sanatorium_teleport_pt" );
...
function function_42fbf5d9( s_dest, s_instance, var_f5064815 )
{
    ...
    var_e79dabce = isdefined( s_dest.contentgroups[ #"rushers" ] ) ? s_dest.contentgroups[ #"rushers" ] : [];
...
function private function_b42b5f72()
{
    if ( self.current_state.name == #"chase" )
    {
        if ( self.archetype == #"zombie" )
        {
            ...
            if ( var_481bf1b8 > 1 && level.star_rating > 4 )
            {
                self namespace_85745671::function_9758722( "super_sprint" );
                return;
            }
...
function private function_a96eb06b( var_f5064815, var_6cd7585c, s_instance )
{
    ...
    if ( n_players <= 2 )
    {
        ...
        if ( level.star_rating <= 1 && var_6cd7585c.ai_type == "hellhound" )
        {
            var_428f5c67--;
        }
...
function private get_spawner( var_82706add = "" )
{
    ...
    {
        default:
            return #"spawner_bo5_zombie_sr";
        case #"spawner_bo5_mimic":
            return #"spawner_bo5_mimic";
        case #"spawner_bo5_zombie_sr_armor_medium":
        case #"zombie_lv2":
            return #"spawner_bo5_zombie_sr_armor_medium";
        case #"spawner_bo5_zombie_sr_armor_heavy":
        case #"zombie_lv3":
            return #"spawner_bo5_zombie_sr_armor_heavy";
        case #"spawner_bo5_avogadro_sr":
        case #"avogadro":
            return #"spawner_bo5_avogadro_sr";
        case #"mechz":
        case #"spawner_bo5_mechz_sr_hvt":
            return #"spawner_bo5_mechz_sr_hvt";
        case #"hash_469e4baceeaf38f5":
        case #"abom":
            return #"hash_469e4baceeaf38f5";
        case #"mimic":
        case #"spawner_bo5_mimic_hvt":
            return #"spawner_bo5_mimic_hvt";
        case #"steiner":
        case #"hash_acac3fe7a341329":
            return #"hash_acac3fe7a341329";
        case #"spawner_bo5_zombie_dog_plague":
        case #"plaguehound":
            return #"spawner_bo5_zombie_dog_plague";
        case #"hellhound":
        case #"spawner_bo5_zombie_dog_molotov":
            return #"spawner_bo5_zombie_dog_molotov";
        case #"raz":
        case #"spawner_bo5_raz_sr_hvt":
            return #"spawner_bo5_raz_sr_hvt";
    }
}
...
function function_3ef1d58a( instance, n_path )
{
    ...
    {
        case #"objective_sanatorium_hunt_raz":
        case #"objective_zoo_hunt_raz":
        case #"objective_dune_hunt_raz":
        case #"objective_black_sea_hunt_raz":
        case #"objective_golova_hunt_raz":
        case #"objective_duga_hunt_raz":
            var_cdce8e6f = instance.contentgroups[ #"hash_4eb8a42b7c1e2150" + n_path ][ 0 ];
            break;
        case #"objective_dune_hunt_steiner":
        case #"objective_black_sea_hunt_steiner":
        case #"objective_duga_hunt_steiner":
        case #"objective_golova_hunt_steiner":
        case #"objective_zoo_hunt_steiner":
        case #"objective_sanatorium_hunt_steiner":
            var_cdce8e6f = instance.contentgroups[ #"hash_5e2a8afd063b9a25" + n_path ][ 0 ];
            break;
        case #"objective_zoo_hunt_mechz":
        case #"objective_black_sea_hunt_mechz":
        case #"objective_sanatorium_hunt_mechz":
        case #"objective_golova_hunt_mechz":
        case #"objective_dune_hunt_mechz":
        case #"objective_duga_hunt_mechz":
            var_cdce8e6f = instance.contentgroups[ #"hash_2ae7f97350a2368" + n_path ][ 0 ];
            break;
        case #"objective_sanatorium_hunt_mimic":
        case #"objective_golova_hunt_mimic":
        case #"objective_duga_hunt_mimic":
        case #"objective_zoo_hunt_mimic":
        case #"objective_ski_hunt_mimic":
        case #"objective_black_sea_hunt_mimic":
        case #"objective_forest_hunt_mimic":
        case #"objective_dune_hunt_mimic":
            var_cdce8e6f = instance.contentgroups[ #"hash_4ddc22d85b89603c" + n_path ][ 0 ];
            break;
        case #"objective_black_sea_hunt_abom":
        case #"objective_ski_hunt_abom":
        case #"objective_zoo_hunt_abom":
        case #"objective_forest_hunt_abom":
        case #"objective_golova_hunt_abom":
        case #"objective_dune_hunt_abom":
        case #"objective_duga_hunt_abom":
        case #"objective_sanatorium_hunt_abom":
