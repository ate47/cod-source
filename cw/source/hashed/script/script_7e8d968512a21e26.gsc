...
{
    level.var_7f69cef1 = a_ents[ #"jprop" ];
...
function function_ffe1ec0d( a_ents )
{
    ...
    level.var_85b94361 linkto( a_ents[ #"jprop2" ], "j_prop_2", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    level.var_657b5876 = a_ents[ #"jprop2" ];
    level.var_4c0e9fb8 = util::spawn_model( #"com_flashlight_on_xforward", level.adler.origin );
    level.var_4c0e9fb8 linkto( a_ents[ #"jprop2" ], "j_prop_1", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    level.var_4c0e9fb8 thread function_c439c1a( a_ents[ #"jprop2" ] );
    level.var_527ee575 = util::spawn_model( #"weapon_vm_ar_akilo47_brprop", level.adler.origin );
    level.var_527ee575 linkto( a_ents[ #"jprop2" ], "j_prop_3", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
function function_c439c1a( var_b3ea46c )
{
    ...
    var_b3ea46c waittill( #"flashlight_hit" );
    self clientfield::set( "sewer_exit_flashlight_fx", 0 );
    wait 0.1;
    self clientfield::set( "sewer_exit_flashlight_fx", 1 );
    var_b3ea46c waittill( #"single anim", #"flashlight_die" );
    self clientfield::set( "sewer_exit_flashlight_fx", 0 );
    wait 0.1;
    self clientfield::set( "sewer_exit_flashlight_fx", 1 );
    wait 0.4;
...
function function_8931e2a4()
{
    ...
    if ( var_926c54bf )
    {
        ...
        player waittill( #"grab_gun_finish" );
    }
    else
    {
    ...
    level waittill( #"sewer_kill_done" );
...
{
    self endon( #"death" );
    self waittill( #"player_ladder_done" );
...
function function_7d2c6c13()
{
    level.player endon( #"death" );
    level.adler endon( #"death" );
    level.adler waittill( #"show_corpse_objective" );
