...
function main( *str_objective, var_50cc0d4f )
{
    ...
    level waittill( #"flg_emp_obj_end" );
...
{
    level.player endon( #"death" );
    level waittill( #"rumble_veer_right" );
    level.player val::set( #"hash_2d28107834c48f84", "allowdeath", 0 );
    level waittill( #"flg_rubble_park" );
...
{
    level waittill( #"flg_cleanup_emp_group" );
    a_ai = spawner::get_ai_group_ai( "emp_group" );
    array::run_all( a_ai, &deletedelay );
    level waittill( #"flg_cleanup_town_group" );
    ...
    level waittill( #"flg_cleanup_guard_station_group" );
...
{
    level waittill( #"flg_emp_rpg_miss" );
    ...
    level waittill( #"flg_emp_rpg_miss_2" );
...
function function_5b0b935c()
{
    ...
    level waittill( #"rumble_enemy_hit" );
    level.player playrumbleonentity( "damage_heavy" );
    level waittill( #"rumble_shore_crash" );
    level.player playrumbleonentity( "riotshield_impact" );
    level waittill( #"rumble_shore_crest" );
    level.player playrumbleonentity( "damage_heavy" );
    level waittill( #"rumble_player_jump_out" );
