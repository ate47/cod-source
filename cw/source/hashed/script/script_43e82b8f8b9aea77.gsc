...
function function_ab329090( str_shotname )
{
    ...
    level waittill( #"notify_start_fade" );
...
{
    level waittill( #"notify_swap_dossier" );
...
function function_f406d0f4()
{
    ...
    level waittill( #"notify_do_damage" );
...
function function_8c5e0f4f()
{
    ...
    level function_55851873( #"cp_safehouse_8_finding_bell" );
    level thread scene::play( level.str_scene_name, "dt_03_waiting_idle", level.var_58ccee4 );
...
function function_4f7ea045()
{
    ...
    level function_55851873( #"cp_safehouse_8_hacking" );
...
function function_af645aa()
{
    ...
    wait 1;
    level thread scene::play( level.str_scene_name, "dt_04_waiting_idle", level.var_58ccee4 );
    level function_55851873( #"cp_safehouse_8_vietnam_missions" );
    level thread namespace_31c67f6d::pstfx_teleport( 0.25, 1, 1, 1 );
    wait 0.25;
}
...
{
    wait 0.25;
    level function_55851873( #"cp_safehouse_8_trigger_phrase" );
...
function function_8c6c6957()
{
    ...
    wait 0.25;
    wait 1;
    level function_55851873( #"cp_safehouse_8_red_door" );
    level thread namespace_31c67f6d::pstfx_teleport( 0.25, 1, 1, 1 );
    wait 0.05;
}
...
function function_855165f7()
{
    ...
    level function_55851873( #"cp_safehouse_8_perseus_plan" );
    level thread namespace_31c67f6d::pstfx_teleport( 0.25, 1, 1, 1 );
}
...
{
    level waittill( #"notify_start_adlers_dialog" );
...
{
    level waittill( #"safehouse_flame_office" );
...
{
    level waittill( #"safehouse_flame_stairwell" );
