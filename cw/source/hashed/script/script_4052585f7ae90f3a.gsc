...
{
    level waittill( #"music_ambient_takedown" );
...
{
    level waittill( #"music_ambient_armada" );
    level thread function_7edafa59( "ambient" );
}
...
{
    level waittill( #"music_ambient_yamantau" );
    level thread function_7edafa59( "ambient" );
}
...
{
    level waittill( #"music_ambient_kgb" );
    level thread function_7edafa59( "ambient" );
}
