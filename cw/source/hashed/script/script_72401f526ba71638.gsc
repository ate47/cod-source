...
function private preinit()
{
    ...
    function_134fcf4b( #"frenzied_guard", #"hash_43e326396554e18c", #"hash_43e329396554e6a5", #"hash_43e328396554e4f2", #"hash_43e323396554dc73", #"hash_43e322396554dac0" );
...
function function_5f81a103( weapon, b_killed = 0 )
{
    if ( isplayer( self ) )
    {
        ...
        self function_678f57c8( #"dlog_event_zm_field_upgrade", var_49058ab );
    }
}
...
function function_53ca9662( item_name )
{
    foreach ( i, value in level.var_5b46d961 )
    {
        if ( value == item_name )
        {
            ...
            if ( isinarray( level.var_d98fc25e[ #"frenzied_guard" ], i ) )
            {
                return #"frenzied_guard";
            }
