...
function private function_4ba28b7e( s_instance )
{
    ...
    if ( ( level.star_rating < 2 || !isdefined( s_instance.targetname ) ) && !getdvarint( #"hash_730311c63805303a", 0 ) )
    {
        return;
    }
    ...
    while ( !isdefined( level.var_41dd92fd[ #"spawner_bo5_zombie_sr" ] ) )
    {
        wait 1;
    }
    
    s_spawn = s_instance.contentgroups[ #"echo_spawn" ][ 0 ];
    ...
    var_3d014474 = level.var_41dd92fd[ #"spawner_bo5_zombie_sr" ].health;
...
function private function_6003bca8( var_55e11aa9, v_player )
{
    ...
    self linkto( var_55e11aa9 );
    var_1c408bb3 = self.instance.contentgroups[ #"echo_awake" ][ 0 ];
