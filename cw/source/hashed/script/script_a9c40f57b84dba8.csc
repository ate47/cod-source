...
function preinit()
{
    ...
    clientfield::register( "world", "" + #"key_jelly", 1, 1, "int", &function_f23a642e, 0, 0 );
...
{
    var_c75c14fb = struct::get( #"s_hulk_jelly" );
...
{
    var_a258e9ff = struct::get_array( #"sr_ee_hulk_beast_boom" );
