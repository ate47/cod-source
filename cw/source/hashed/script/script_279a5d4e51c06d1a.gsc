...
{
    level.var_d171f280 = a_ents[ #"stasi1" ];
    level.var_c338560d = a_ents[ #"stasi2" ];
...
function function_1b5a6cdf()
{
    ...
    player waittill( #"enter_camera_ads" );
...
function function_51bd3310()
{
    ...
    while ( true )
    {
        ...
        level.player note_display::function_97c69304( #"cp_ger_stakeout_note_list", 1, 2, undefined, undefined, 2 );
...
function function_4c53321a()
{
    ...
    level endon( #"dialog_tree_active", #"informant_enemies_stealth_spotted", #"informant_enemies_cleared" );
    doors::waittill_door_opened( "informant_door" );
    wait 0.8;
...
{
    level.var_3c0c4db = a_ents[ #"lazar_courtyard_door_r" ];
    level.var_94a0e669 = a_ents[ #"lazar_courtyard_door_l" ];
}
...
function function_26f625c()
{
    ...
    level waittill( #"alley_3_clear_stealth" );
    namespace_979752dc::function_740dbf99();
    wait 0.5;
...
{
    level waittill( #"lazar_alley_3_meetup" );
