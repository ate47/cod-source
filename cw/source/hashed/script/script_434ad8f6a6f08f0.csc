...
function snipercam()
{
    while ( true )
    {
        ...
        if ( isentity( victim ) && ishash( victim.aitype ) )
        {
            ...
            if ( victim.aitype == #"spawner_bo5_human_hero_park_infil" )
            {
                alias = "vox_duga_park_sniperdeath";
            }
            else if ( victim.aitype == #"spawner_bo5_human_hero_lazar_duga" )
            {
                alias = "vox_duga_lazr_sniperdeath";
            }
            else if ( victim.aitype == #"spawner_bo5_human_hero_mason_infil_siege" )
            {
                alias = "vox_duga_masn_sniperdeath";
            }
            else if ( victim.aitype == #"spawner_bo5_human_hero_woods" )
            {
...
function function_fe5617ab()
{
    ...
    level waittill( #"sfx_ambush_wakeup" );
