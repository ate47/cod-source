...
function function_58ef8b05( *str_objective, var_50cc0d4f )
{
    ...
    level scene::init( #"armada_crash_gunner" );
    level function_3dda2db1( var_50cc0d4f );
    namespace_72b0499b::music( "12.0_turret" );
    level thread scene::play( #"armada_crash_gunner", "intro" );
...
function function_cd3c6f53( *str_objective, var_50cc0d4f )
{
    ...
    scene::add_scene_func( #"armada_crash_gunner", &function_151b3bc9, "transition" );
    scene::add_scene_func( #"armada_crash_gunner", &function_151b3bc9, "outro" );
    
    if ( !var_50cc0d4f && isinarray( scene::get_all_shot_names( #"armada_crash_gunner" ), "transition" ) )
    {
        level scene::play( #"armada_crash_gunner", "transition" );
    }
    
    level thread scene::play( #"armada_crash_gunner", "outro" );
    level.player takeallweapons();
    level.player waittill( #"gun_up" );
    level.player util::function_5f1df718( #"cinematicmotion_body_shield" );
    ...
    level.player takeallweapons();
    level.player scene::play( #"cin_finale_player_exploded" );
    ...
    level scene::play( #"armada_crash_gunner", "ending" );
...
{
    level waittill( #"napalmslowdownend" );
...
{
    level waittill( #"napalm_fade_to_white" );
    namespace_b7cfe907::pstfx_teleport( 1, 0 );
    wait 1.5;
