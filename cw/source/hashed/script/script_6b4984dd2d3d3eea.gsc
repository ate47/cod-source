...
function init()
{
    ...
    level.var_1a4fbac2 = #"scorestreak_uav_t9_item_spy";
...
function private function_92d262c6( angle_offset )
{
    ...
    dropstruct namespace_65181344::function_fd87c780( #"t9_spy_deaddrop", count, 3 );
}
...
function function_70b57ee6()
{
    ...
    var_57e06aea = item_supply_drop::function_47ec98c4( startpoint, endpoint, heli_drop_goal, 0, undefined, undefined, undefined, #"t9_spy_airdrop" );
...
function function_96b85abd( state, player )
{
    ...
    if ( state == 2 )
    {
        ...
        player function_20fdcbf2( player.var_94cae451, #"decoding" );
    }
