...
{
    if ( !scripted_widgets::exists( #"scripted_timer" ) )
    {
        scripted_widgets::create( #"scripted_timer", #"hash_16d65500e6bdc837" );
        scripted_widgets::set_text( #"scripted_timer", var_efccf092 );
        
        if ( isdefined( var_b04adac9 ) )
        {
            scripted_widgets::function_309bf7c2( #"scripted_timer", var_b04adac9 );
        }
...
function function_9c8d2a44( var_1723b73d )
{
    if ( scripted_widgets::exists( #"scripted_timer" ) )
    {
        scripted_widgets::set_text( #"scripted_timer", var_1723b73d );
    }
}
...
function private function_e782b221( start_time, var_8ab7d27b, var_c1c8f1d, var_ef1623ea )
{
    ...
    scripted_widgets::set_time( #"scripted_timer", run_time );
    start_time = run_time;
    var_da7e097b = -1;
    var_469ff952 = 0;
    ...
    while ( run_time >= 0 )
    {
        ...
        if ( var_8ab7d27b )
        {
            ...
            {
                var_469ff952 = 1;
                scripted_widgets::set_text( #"scripted_timer", var_c1c8f1d );
            }
            ...
            if ( var_da7e097b != quarter )
            {
                ...
                {
                    scripted_widgets::set_state( #"scripted_timer", quarter );
                }
                else
                {
                    scripted_widgets::set_state( #"scripted_timer", 0 );
                }
            }
        }
...
function function_5e3101b2()
{
    ...
    if ( scripted_widgets::exists( #"scripted_timer" ) )
    {
        scripted_widgets::remove( #"scripted_timer" );
    }
}
