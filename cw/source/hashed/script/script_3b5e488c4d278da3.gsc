...
function init()
{
    if ( ( is_true( getgametypesetting( #"hash_7e8e34cc69a77e0b" ) ) || getdvarint( #"hash_40bd34b35079cf2e", 0 ) > 0 ) && ( zm_utility::is_classic() || util::get_game_type() === #"zholiday" ) )
    {
        ...
        level.var_8f576c00 = [ #"hash_5214ebcccbd95a36":#"spawner_zm_zombie_ndu_xmas", #"hash_19ef16d1ba01a5":#"spawner_bo5_zombie_zm_silver_armor_heavy_xmas", #"spawner_bo5_zombie_dog_plague":#"spawner_bo5_zombie_dog_plague_xmas", #"spawner_zm_steiner_hvt_zm_silver":#"spawner_zm_steiner_hvt_zm_silver_xmas", #"spawner_zm_steiner":#"spawner_zm_steiner_xmas", #"spawner_zm_steiner_split_radiation_blast_hvt":#"spawner_zm_steiner_split_radiation_blast_hvt_xmas", #"spawner_zm_steiner_split_radiation_blast":#"spawner_zm_steiner_split_radiation_blast_xmas", #"spawner_zm_steiner_split_radiation_bomb_hvt":#"spawner_zm_steiner_split_radiation_bomb_hvt_xmas", #"spawner_zm_steiner_split_radiation_bomb":#"spawner_zm_steiner_split_radiation_bomb_xmas" ];
        level.overridezombiespawn = &function_767a6a84;
        level.var_9d098364 = #"spawner_zm_steiner_xmas";
        level.var_c42bdd1b = #"spawner_zm_steiner_split_radiation_blast_xmas";
        level.var_dc38daf = #"spawner_zm_steiner_split_radiation_bomb_xmas";
        level.var_d3d40dcb = #"spawner_zm_steiner_hvt_zm_silver_xmas";
        level.var_68b26ea = #"spawner_zm_steiner_split_radiation_blast_xmas";
        level.var_887c5017 = #"spawner_zm_steiner_split_radiation_bomb_xmas";
        level.var_9e513533 = #"c_t9_zmb_zombie_heavy_helmet_xmas";
        level.var_eea9f85a = #"c_t9_zmb_zombie_heavy_torso_armor_xmas";
        level.var_1a4cc228[ #"spawner_zm_zombie_ndu_xmas" ] = [ #"hash_7f5ab1dc6cfb5e8b", #"hash_7d3fe2134df8b974", #"hash_7808152e8467362f", #"hash_50645fbb1e049528", #"hash_4cc6bea1049efc55", #"hash_9c9737cf22069a5", #"hash_55cd178e8d6db2aa" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_dog_plague_xmas" ] = [ #"hash_7247a6e723dbd7ab" ];
        level.var_1a4cc228[ #"spawner_zm_steiner_split_radiation_blast_xmas" ] = [ #"hash_78bcaad275fa3c26" ];
        level.var_1a4cc228[ #"spawner_zm_steiner_split_radiation_bomb_xmas" ] = [ #"hash_5392a8401b0e3133" ];
        level.var_1a4cc228[ #"spawner_bo5_zombie_zm_silver_armor_heavy_xmas" ] = [ #"hash_4062a2032d2c9a34" ];
...
function function_83cb84d3( var_20287981, var_3798631c, var_b9012667, var_63942b62, var_6ff6be61 )
{
    ...
    if ( var_3798631c === 1 && is_true( level.var_72182681 ) && !is_true( var_6ff6be61 ) )
    {
        ...
        reward_list = "ltm_chest_item_list";
    }
    ...
    {
        reward_list = namespace_58949729::function_fd5e77fa( var_20287981 );
    }
    else if ( var_b9012667 === 1 )
    {
        ...
        reward_list = namespace_58949729::function_257d7203( var_20287981, var_59364773 );
    }
    else
    {
        reward_list = namespace_58949729::function_257d7203( var_20287981 );
    }
    
    if ( var_b9012667 === 1 )
    {
        level thread namespace_58949729::function_f82f361c( var_7580ce3e, reward_list, 0, 1 );
    }
    else
    {
        level thread namespace_58949729::function_f82f361c( var_7580ce3e, reward_list, 2, 1 );
    }
