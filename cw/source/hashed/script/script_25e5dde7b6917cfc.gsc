...
function intro_flow( *var_d3440450, *var_50cc0d4f )
{
    ...
    level thread function_f62c89bf( #"armada_intro_running_guys", "run", "flag_intro_running_guys_go" );
...
{
    level flag::wait_till( "flag_intro_player_vm_done" );
    level util::delay( 0.35, undefined, &scene::init, #"armada_intro_pt2_idling_choppers" );
    level util::delay( 0.5, undefined, &function_42f61091 );
    level util::delay( 0.75, undefined, &scene::play, #"p9_fxanim_cp_armada_haskins_chopper_01_idle_bundle" );
    level flag::wait_till( "flag_intro_player_boarded_chopper" );
    level util::delay( 0.25, undefined, &scene::init, #"armada_intro_pt2_boats" );
    level util::delay( 0.5, undefined, &scene::init, #"armada_intro_pt2_choppers2" );
}
...
function function_42f61091()
{
    ...
    if ( isdefined( level.gunner ) )
    {
        ...
        a_ents[ #"crew_chopper_adler_minigun" ] = level.gunner;
    }
    
    level scene::init( #"armada_intro_pt2_choppers1", a_ents );
}
...
function function_2549ca47()
{
    ...
    self endon( #"death" );
    self waittill( #"armada_intro_huey_cam_lerp_to_open" );
    self setviewclamp( 20, 20, 15, 15, 0, 0, 1 );
    self waittill( #"armada_intro_huey_cam_lerp_to_zero" );
    self setviewclamp( 0, 0, 0, 0, 0, 1, 1 );
    self waittill( #"player_heli_ride_headset_on" );
    self setviewclamp( 20, 20, 15, 15, 0, 0, 1 );
    self waittill( #"armada_intro_start_cam_lerp" );
...
{
    self endon( #"death" );
    level waittill( #"armada_intro_huey_start_liftoff_rumble" );
    self playrumblelooponentity( #"chopper_gunner_rumble_intro" );
    level waittill( #"armada_intro_fade_out" );
    wait 1.5;
...
function function_efd3381d( var_a3ad3414, var_646aad9f = 1 )
{
    ...
    if ( !var_646aad9f || self.aitype === #"spawner_bo5_human_allies_us_army_chopper_pilot_1_pistol" || self.aitype === #"spawner_bo5_human_allies_us_army_chopper_pilot_2_pistol" )
    {
        self ai::gun_remove();
    }
...
function function_d697a743()
{
    ...
    wait 0.5;
    level thread scene::play( #"armada_intro_player", "intro", var_c5e9076a );
...
{
    level scene::init( #"armada_intro_mixed_flyover" );
    wait 1;
    level flag::wait_till( "flag_intro_mixed_flyover_guys_go" );
    level thread scene::play( #"armada_intro_mixed_flyover", "in" );
    wait 13;
    level flag::wait_till( "flag_intro_hueys_take_off" );
    level scene::play( #"armada_intro_mixed_flyover", "out" );
}
...
function function_3f7b5c03()
{
    ...
    level thread scene::init( #"armada_intro_cobra_flyover" );
    level thread scene::play( #"armada_intro_raven_barrel", "Shot 1" );
    level thread scene::play( #"armada_intro_raven_roof", "Shot 1" );
    level flag::wait_till( "flag_intro_player_vm_done" );
    level thread scene::play( #"armada_intro_cobra_flyover", "hover" );
    level thread scene::play( #"armada_intro_crow_02" );
    level thread scene::play( #"armada_intro_crow_03" );
    ...
    level thread scene::play( #"armada_intro_cobra_flyover", "flyout" );
    level scene::play( #"armada_intro_raven_barrel", "Shot 2" );
    level thread scene::play( #"armada_intro_raven_barrel", "Shot 3" );
    wait 2.8;
    level scene::play( #"armada_intro_raven_roof", "Shot 2" );
    level thread scene::play( #"armada_intro_raven_roof", "Shot 3" );
    level flag::wait_till( "flag_intro_base_cleanup" );
    level thread scene::stop( #"hash_2978a9b1c68ba898", 1 );
    level thread scene::stop( #"armada_intro_raven_takeoff_and_circle", 1 );
}
...
function function_c9f69e1b( a_ents )
{
    ...
    level waittill( #"butcher_answer_to_adler" );
...
{
    waitframe( 1 );
    level thread scene::play( #"armada_intro_inventory_guy", "idle" );
    waitframe( 1 );
    
    if ( function_72a9e321() )
    {
        level thread scene::play( #"armada_intro_ambient_tent_guys", "idle" );
        waitframe( 1 );
    }
    
    level thread scene::play( #"armada_intro_ambient_arm_wrestling", "idle" );
    waitframe( 1 );
    level thread scene::play( #"armada_intro_ambient_arm_guys_sitting", "idle" );
    waitframe( 1 );
    level thread scene::play( #"armada_intro_mechanics", "idle" );
    waitframe( 1 );
    level thread scene::play( #"armada_intro_radio_room", "idle" );
    waitframe( 1 );
    level thread scene::play( #"armada_intro_jeep_guys", "idle" );
    waitframe( 1 );
    level thread scene::play( #"armada_intro_football_guys", "idle" );
    level flag::wait_till( "flag_intro_player_boarded_chopper" );
    level scene::stop( #"armada_intro_ambient_tent_guys", 1 );
    level scene::stop( #"armada_intro_inventory_guy", 1 );
    level scene::stop( #"armada_intro_mechanics", 1 );
    level scene::stop( #"armada_intro_radio_room", 1 );
    level thread function_b803eeb0( #"armada_intro_jeep_guys" );
    level thread function_b803eeb0( #"armada_intro_football_guys" );
    level thread function_b803eeb0( #"armada_intro_ambient_arm_wrestling" );
    level thread function_b803eeb0( #"armada_intro_ambient_arm_guys_sitting" );
    level flag::wait_till( "flag_intro_base_cleanup" );
    level scene::stop( #"armada_intro_jeep_guys", 1 );
    level scene::stop( #"armada_intro_football_guys", 1 );
    level scene::stop( #"armada_intro_ambient_arm_wrestling", 1 );
    level scene::stop( #"armada_intro_ambient_arm_guys_sitting", 1 );
}
...
function function_48b95055()
{
    ...
    level thread scene::play( #"armada_intro_air_marshall", "idle_relax" );
    level flag::wait_till( "flag_intro_air_marshall_relax_to_ready" );
    level scene::play( #"armada_intro_air_marshall", "relax_to_ready" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_ready" );
    level flag::wait_till( "flag_intro_air_marshall_ready_to_revup" );
    level scene::play( #"armada_intro_air_marshall", "ready_to_revup" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_revup" );
    level flag::wait_till( "flag_intro_air_marshall_revup_to_liftoff" );
    level scene::play( #"armada_intro_air_marshall", "revup_to_liftoff" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_liftoff" );
    level flag::wait_till( "flag_intro_hueys_take_off" );
    level scene::play( #"armada_intro_air_marshall", "liftoff_to_turn" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_turn" );
    wait 5;
    level scene::play( #"armada_intro_air_marshall", "signal_and_walk_left" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_relax_02" );
...
function function_4ce9d8f6()
{
    ...
    level scene::play( #"armada_intro_air_marshall", "relax_to_ready_02" );
    level scene::play( #"armada_intro_air_marshall", "ready_to_revup_02" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_revup_02" );
    level waittilltimeout( 5, #"intro_player_chopper_liftoff" );
    level.var_7466d419 setrotorspeed( 1 );
    level scene::play( #"armada_intro_air_marshall", "revup_to_liftoff_02" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_liftoff_02" );
    wait 5;
    level scene::play( #"armada_intro_air_marshall", "liftoff_to_turn_02" );
    level thread scene::play( #"armada_intro_air_marshall", "idle_turn_02" );
    level flag::wait_till( "flag_intro_base_cleanup" );
    level thread scene::stop( #"armada_intro_air_marshall", 1 );
}
...
function function_7675bb9d( var_e8e79806, var_4a5a95d5, var_e3b80211, var_87b63437 )
{
    ...
    switch ( var_e8e79806 )
    {
        case 1:
            ...
            a_scene_ents[ #"vehicle 4" ] = a_ents[ 2 ];
            break;
        case 2:
            a_scene_ents[ #"vehicle 1" ] = a_ents[ 0 ];
            a_scene_ents[ #"vehicle 3" ] = a_ents[ 1 ];
            a_scene_ents[ #"vehicle 4" ] = a_ents[ 2 ];
            a_scene_ents[ #"vehicle 5" ] = a_ents[ 3 ];
            break;
        case 3:
            a_scene_ents[ #"vehicle 4" ] = a_ents[ 0 ];
            a_scene_ents[ #"vehicle 5" ] = a_ents[ 1 ];
            a_scene_ents[ #"vehicle 6" ] = a_ents[ 2 ];
            break;
    }
    ...
    self scene::stop( #"armada_fake_m35_driver", 1 );
...
function function_4fa68c0a()
{
    ...
    var_2c4dfb60 = array( #"vehicle_t9_mil_us_truck_m35_canvas_cp", #"vehicle_t9_mil_us_m151_cp", #"vehicle_t9_mil_us_truck_m35_tanker_cp", #"vehicle_t9_mil_us_truck_m35_cargo_cp" );
...
function function_a515aac6( var_7e49f78c = 1 )
{
    ...
    if ( var_7e49f78c )
    {
        ...
        {
            self thread scene::play( #"armada_fake_m35_driver" );
            return;
        }
        
        if ( self.vehicletype === #"vehicle_t9_mil_us_m151_cp" )
        {
            if ( math::cointoss() )
            {
                str_scene = #"armada_fake_jeep_crew_1";
            }
            else
            {
                str_scene = #"armada_fake_jeep_crew_2";
            }
...
{
    scene::add_scene_func( #"armada_intro_ambient_tent_guys", &function_b34d0584, "init" );
    scene::add_scene_func( #"armada_intro_jeep_guys", &function_1b50aed2, "init" );
    scene::add_scene_func( #"armada_intro_mechanics", &function_c9f69e1b, "init" );
    scene::add_scene_func( #"armada_intro_drinking_guys", &function_50941fc1, "init" );
    scene::add_scene_func( #"armada_intro_cobra_flyover", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::add_scene_func( #"armada_intro_mixed_flyover", &function_8f9d1155, "init" );
    scene::add_scene_func( #"armada_intro_mixed_flyover", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::add_scene_func( #"armada_intro_mixed_flyover", &function_c4b6673f, "done" );
    scene::add_scene_func( #"armada_intro_pt2_boats", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::add_scene_func( #"armada_intro_pt2_idling_choppers", &function_ea6224e, "init" );
    scene::add_scene_func( #"armada_intro_pt2_idling_choppers", &namespace_b7cfe907::function_1eff410c, "init" );
    scene::add_scene_func( #"armada_intro_pt2_choppers1", &function_ea6224e, "init" );
    scene::add_scene_func( #"armada_intro_pt2_choppers1", &namespace_b7cfe907::function_1eff410c, "init" );
    scene::add_scene_func( #"armada_intro_pt2_choppers2", &function_ea6224e, "init" );
    scene::add_scene_func( #"armada_intro_pt2_choppers2", &namespace_b7cfe907::function_1eff410c, "init" );
    scene::add_scene_func( #"armada_intro_pt2_boats", &function_ea6224e, "gear_up_pt02" );
    scene::add_scene_func( #"armada_intro_pt2_choppers1", &function_b281d751, "gear_up_pt02" );
    scene::add_scene_func( #"armada_intro_pt2_choppers1", &namespace_b7cfe907::function_a641ac8b, "gear_up_pt02" );
    scene::add_scene_func( #"armada_intro_pt2_choppers2", &function_b281d751, "gear_up_pt02" );
    scene::add_scene_func( #"armada_intro_pt2_choppers2", &namespace_b7cfe907::function_a641ac8b, "gear_up_pt02" );
    scene::add_scene_func( #"armada_intro_player_chopper_npc_idle", &function_88216172, "init" );
    scene::add_scene_func( #"armada_intro_pt2", &function_7429a059, "precheck" );
    scene::function_d8a83a50( #"armada_intro_pt2", &function_d4337a8d, "approaching_firebase" );
}
...
function function_70c35833( a_ents )
{
    foreach ( index, ent in a_ents )
    {
        ...
        if ( index === #"pilot1" || index === #"pilot2" || index === #"redshirt01" || index === #"redshirt02" || index === #"redshirt03" || index === #"redshirt04" )
        {
...
function function_9222bf72( guy1, guy2 )
{
    ...
    level flag::wait_till( "flag_butcher_done_talking" );
    guy1 waittill( #"play_vox_cp_armd_00002_ars7_sohotdontthinki_11" );
    guy1 thread dialogue::queue( "vox_cp_armd_00002_ars7_sohotdontthinki_11" );
    guy2 waittill( #"play_vox_cp_armd_00002_ars8_noshitnorthdako_b6" );
...
{
    str_model = #"spawner_bo5_human_allies_us_marine_ar";
    weapon = getweapon( #"hash_4ff481a4f55ed901" );
    var_129f138 = #"spawner_bo5_human_allies_us_army_chopper_pilot_1_pistol";
    var_a61227dc = #"spawner_bo5_human_allies_us_army_chopper_pilot_2_pistol";
...
function function_a8db30d2( scene, chopper, var_45514840 )
{
    ...
    var_45514840 waittill( #"on_board_chopper" );
    ...
    foreach ( index, ent in a_ents )
    {
        ...
        switch ( index )
        {
            ...
            case #"introboat1":
                ...
                break;
            case #"idlingchopper01":
                ent thread namespace_b7cfe907::function_9ac0bc90( [ 0, 1 ] );
                ent thread function_e0c430cb( "flag_intro_player_boarded_chopper" );
                break;
            case #"idlingchopper02":
                ent thread namespace_b7cfe907::function_9ac0bc90( [ 0, 1, 7, 9, 10 ] );
                ent thread function_e0c430cb( "flag_intro_player_boarded_chopper" );
                break;
            case #"idlingchopper03":
                ent thread namespace_b7cfe907::function_9ac0bc90( [ 0, 1, 7, 9, 10 ] );
                ent thread function_e0c430cb( "flag_play_gear_up_pt02" );
                break;
            case #"idlingchopper05":
            case #"idlingchopper04":
                ent thread function_e0c430cb( "flag_intro_player_boarded_chopper" );
                break;
            case #"introhuey10_player_group_mid_column_1":
                break;
            case #"introhuey11_player_group_mid_column_3":
                ent thread namespace_b7cfe907::function_9ac0bc90( [ 0, 1, 9, 10 ] );
                break;
            case #"introhuey12_player_group_mid_column_4":
                ent thread namespace_b7cfe907::function_9ac0bc90( [ 0, 1 ] );
                break;
            case #"introhuey13_player_group_mid_column_5":
...
function function_7429a059( a_ents )
{
    ...
    if ( isdefined( a_ents[ #"runningguy1" ] ) )
    {
        a_ents[ #"runningguy1" ] delete();
    }
    
    if ( isdefined( a_ents[ #"runningguy2" ] ) )
    {
        a_ents[ #"runningguy2" ] delete();
    }
}
...
function function_50d6beb5( *var_d3440450, *var_50cc0d4f )
{
    ...
    level scene::stop( #"armada_intro_player_chopper_npc_idle" );
    level scene::play( #"armada_intro_pt2", "precheck", a_ents );
    var_d0e0aa50 = [];
    var_5010a8d6 = [];
    
    if ( isdefined( level.var_52874eb2 ) )
    {
        var_5010a8d6[ #"adlerchopper" ] = level.var_52874eb2;
    }
    
    if ( isdefined( level.var_da19489d ) )
    {
        var_5010a8d6[ #"crashingchopper" ] = level.var_da19489d;
    }
    ...
    if ( isdefined( level.gunner ) )
    {
        var_d0e0aa50[ #"crew_chopper_adler_minigun" ] = level.gunner;
    }
    
    level scene::stop( #"armada_intro_pt2_idling_choppers" );
    level thread scene::play( #"armada_intro_pt2_choppers1", "gear_up_pt02", var_d0e0aa50 );
    level thread scene::play( #"armada_intro_pt2_choppers2", "gear_up_pt02", var_5010a8d6 );
    level thread scene::play( #"armada_intro_pt2_boats", "gear_up_pt02" );
    ...
    level.var_7466d419 thread scene::play( #"p9_fxanim_cp_armada_dice_hanging_bundle", "Shot 2" );
    level scene::play( #"armada_intro_pt2", "gear_up_pt02", a_ents );
    level thread function_ecf2431c( 0 );
    level flag::set( "flag_intro_base_cleanup" );
    level scene::stop( #"armada_intro_pt2" );
    level scene::stop( #"p9_fxanim_cp_armada_haskins_chopper_01_idle_bundle", 1 );
...
function function_3d2235e0()
{
    ...
    scene::remove_scene_func( #"armada_intro_ambient_tent_guys", &function_b34d0584, "init" );
    scene::remove_scene_func( #"armada_intro_jeep_guys", &function_1b50aed2, "init" );
    scene::remove_scene_func( #"armada_intro_mechanics", &function_c9f69e1b, "init" );
    scene::remove_scene_func( #"armada_intro_cobra_flyover", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::remove_scene_func( #"armada_intro_mixed_flyover", &function_8f9d1155, "init" );
    scene::remove_scene_func( #"armada_intro_mixed_flyover", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::remove_scene_func( #"armada_intro_mixed_flyover", &function_c4b6673f, "done" );
    scene::remove_scene_func( #"armada_intro_pt2_boats", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::remove_scene_func( #"armada_intro_pt2_idling_choppers", &function_ea6224e, "init" );
    scene::remove_scene_func( #"armada_intro_pt2_idling_choppers", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers1", &function_ea6224e, "init" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers1", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers2", &function_ea6224e, "init" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers2", &namespace_b7cfe907::function_a641ac8b, "init" );
    scene::remove_scene_func( #"armada_intro_pt2_boats", &function_ea6224e, "gear_up_pt02" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers1", &function_b281d751, "gear_up_pt02" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers1", &namespace_b7cfe907::function_a641ac8b, "gear_up_pt02" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers2", &function_b281d751, "gear_up_pt02" );
    scene::remove_scene_func( #"armada_intro_pt2_choppers2", &namespace_b7cfe907::function_a641ac8b, "gear_up_pt02" );
    scene::remove_scene_func( #"armada_intro_pt2", &function_d4337a8d, "approaching_firebase" );
    scene::remove_scene_func( #"armada_intro_pt2", &function_7429a059, "precheck" );
    scene::remove_scene_func( #"armada_intro_player_chopper_npc_idle", &function_88216172, "init" );
}
...
function function_ebd340e1()
{
    ...
    level waittill( #"start_flying_last_haskins_convoy" );
    self vehicle::lights_on();
    self vehicle::toggle_force_driver_taillights( 1 );
    self vehicle::toggle_sounds( 1 );
    self vehicle::toggle_exhaust_fx( 1 );
...
function function_3a4f35e8()
{
    ...
    self thread vehicle::go_path();
    self vehicle::pause_path();
    level waittill( #"start_flying_last_boats" );
    self vehicle::lights_on();
    self vehicle::toggle_force_driver_taillights( 1 );
    self vehicle::toggle_sounds( 1 );
    self vehicle::toggle_exhaust_fx( 1 );
...
function function_c81e0f3f( *var_d3440450, *var_50cc0d4f )
{
    ...
    if ( isdefined( level.var_52874eb2 ) )
    {
        a_ents[ #"adlerchopper" ] = level.var_52874eb2;
    }
    
    if ( isdefined( level.var_da19489d ) )
    {
        a_ents[ #"crashingchopper" ] = level.var_da19489d;
    }
    
    level thread scene::play( #"armada_intro_pt2_choppers", "approaching_firebase", a_ents );
    ...
    level scene::play( #"armada_intro_pt2", "approaching_firebase", a_ents );
...
function function_67f53057( *var_d3440450, *var_50cc0d4f )
{
    ...
    level thread scene::play( #"armada_intro_pt2_choppers", "approaching_firebase_pt2" );
    a_ents = [];
    a_ents[ #"vip" ] = level.vip;
    a_ents[ #"buddy" ] = level.buddy;
    a_ents[ #"playerchopper" ] = level.var_7466d419;
    level scene::play( #"armada_intro_pt2", "approaching_firebase_pt2", a_ents );
    namespace_b7cfe907::function_1c2abcda();
...
function function_90b53888( *var_d3440450, *var_50cc0d4f )
{
    ...
    level thread scene::play( #"armada_firebase_arrival_nonplayer", a_ents );
    a_ents = [];
    a_ents[ #"buddy" ] = level.buddy;
    a_ents[ #"playerchopper" ] = level.var_7466d419;
    level scene::play( #"armada_firebase_arrival_player", a_ents );
    level scene::play( #"armada_firebase_arrival_pt2_player", a_ents );
