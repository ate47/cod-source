...
function event_handler[level_init] main( *eventstruct )
{
    ...
    zm_intel::function_88645994( #"zmintel_list_zm_platinum_document_drops", #"zmintel_list_zm_platinum_darkaether_computer", undefined, undefined, #"zmintel_list_zm_platinum_radio_transmissions_omega" );
    load::main();
        ...
        case 2:
            foreach ( var_bb21be70 in var_8cbaf960 )
            {
                if ( var_bb21be70.script_noteworthy === "rooftop" )
                {
                    ...
                    var_bb21be70.var_cc1c5020 pingable();
                }
            }
