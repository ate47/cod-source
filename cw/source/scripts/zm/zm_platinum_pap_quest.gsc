...
function function_bf1953a()
{
    ...
    level flag::wait_till( #"pap_quest_awaken_zombies" );
...
function function_f8cbb582()
{
    ...
    {
        level scene::add_scene_func( #"scene_ai_t9_zm_soo_zombie_buff", &function_5fc5de3e, "play" );
        level scene::add_scene_func( #"scene_ai_t9_zm_soo_zombie_buff", &function_ffe0f421, "done" );
        level scene::play( #"scene_ai_t9_zm_soo_zombie_buff" );
        level flag::set( #"pap_quest_awaken_zombies" );
        var_84a3b2fc++;
        wait randomfloatrange( 5, 6 );
    }
    
    level scene::remove_scene_func( #"scene_ai_t9_zm_soo_zombie_buff", &function_5fc5de3e, "play" );
    level scene::remove_scene_func( #"scene_ai_t9_zm_soo_zombie_buff", &function_ffe0f421, "done" );
...
function function_af722d1c()
{
    ...
    s_pap_machine = struct::get( "pap_machine_pos" );
    level flag::wait_till_any( [ "power_on", #"flag_obj_pap_quest_rappel_done", #"hash_434bc775e67b7233", #"hash_20afa38b1f1c339e" ] );
    wait 3.5;
    zm_sq::objective_set( #"hash_5c597e863c8de1c8", var_8b3ab8b4, undefined, #"hash_466bc6bf903c0d79", undefined, 96 );
    level flag::wait_till_any( [ #"flag_obj_pap_quest_rappel_done", #"hash_434bc775e67b7233", #"hash_20afa38b1f1c339e" ] );
