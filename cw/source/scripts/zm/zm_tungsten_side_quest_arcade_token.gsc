...
function init()
{
    ...
    level.var_2ab5eeb7 = struct::get( #"tungsten_soul_capture_1", "targetname" );
    level.var_b4f716df = &function_b370e26e;
    level.var_91f71aa[ #"item_zmquest_tungsten_arcade_token" ] = &function_a9291db2;
    ...
    if ( isplayer( params.eattacker ) )
    {
        ...
        if ( isinarray( level.var_afc50b14, ai_zone ) )
        {
            ...
            if ( math::cointoss( 5 ) && level.var_d3bc5b54 < function_a1ef346b().size * 1 && params.eattacker.var_a3210d75 <= 0 )
            {
                ...
                var_bba58955 = function_4ba8fde( #"item_zmquest_tungsten_arcade_token" );
...
function on_item_pickup( params )
{
    ...
    if ( isplayer( self ) && item.itementry.name === #"item_zmquest_tungsten_arcade_token" )
    {
...
function function_65ff42b0()
{
    if ( !isdefined( level.rcxd ) )
    {
        ...
        level.rcxd = spawnvehicle( #"vehicle_t9_rcxd_arcade_enduro", rcxd_spawner.origin, rcxd_spawner.angles );
...
function function_c0f95bf4( var_e503dc79 )
{
    ...
    switch ( var_e503dc79 )
    {
        ...
        case 2:
            wait 1;
            var_8c54d57c = struct::get( #"powerup_loc_01", "targetname" );
            var_47314b36 = struct::get( #"powerup_loc_02", "targetname" );
            var_77b72c41 = struct::get( #"powerup_loc_03", "targetname" );
...
function function_ec736a99()
{
    ...
    var_37e14db3 = { #armor:self.armor, #var_6032cf15:self.armortier, #scorestreak:var_16f12c31, #tactical:tacticalitem, #lethal:lethalitem, #weapon1:var_61bf1830, #weapon2:var_c6dd36cf, #weapon3:var_6a59c435, #fieldupgrade:var_4ffaff67 };
...
function function_1438349c()
{
    ...
    if ( tacticalitem.networkid != 32767 )
    {
        self item_inventory::remove_inventory_item( tacticalitem.networkid );
    }
    
    lethalitem = structcopy( self.inventory.items[ 7 ] );
    
    if ( lethalitem.networkid != 32767 )
    {
        self item_inventory::remove_inventory_item( lethalitem.networkid );
    }
