...
function autoexec opt_in()
{
    ...
    zm_intel::function_88645994( #"zmintel_list_gold_document_drops", #"zmintel_list_gold_dark_aether_computer", #"zmintel_list_gold_radio_transmissions_requiem", #"zmintel_list_gold_radio_transmissions_maxis", #"zmintel_list_gold_radio_transmissions_omega" );
}
