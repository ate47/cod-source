...
function autoexec opt_in()
{
    ...
    level.var_8bb7479c = #"aib_t9_vign_cust_zm_silver_outro_success_01";
    ...
    zm_intel::function_88645994( #"zmintel_list_gold_document_drops", #"zmintel_list_gold_dark_aether_computer", #"zmintel_list_gold_radio_transmissions_requiem", #"zmintel_list_gold_radio_transmissions_maxis", #"zmintel_list_gold_radio_transmissions_omega", #"zmintel_list_gold_omega_intel_all", #"zmintel_list_gold_darkaether_intel_all", #"zmintel_list_gold_maxis_intel_all", #"zmintel_list_gold_requiem_intel_all" );
}
...
{
    level.var_dfee7fc2 = #"cin_zm_gold_intro";
    zm::init_fx();
    ...
    zm_perks::function_9760a58b( #"talent_tombstone" );
    ...
    level.var_e2f95698 = #"zm_gold_dialogue";
    ...
    level scene::add_scene_func( #"cin_t9_firebase_z_peck_intro", &function_f3c4fbd9, "play" );
    level scene::add_scene_func( #"cin_t9_firebase_z_ravanov_intro", &function_abd6be92, "play" );
...
{
    level scene::init( #"p9_fxanim_zm_gold_drawer_flat_bundle" );
}
