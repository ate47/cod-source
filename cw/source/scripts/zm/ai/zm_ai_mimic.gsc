...
function postinit()
{
    if ( zm_utility::is_classic() )
    {
        ...
        callback::add_callback( #"on_mimic_player_grab_end", &function_59042f87 );
...
function function_76433e31()
{
    ...
    self callback::function_d8abfc3d( #"on_entity_revealed", &function_7c591227 );
...
function function_8afb304d()
{
    ...
    self.stub.machine notify( #"mimic_prop_activated", { #activator:player } );
}
