...
function function_4a9e112c()
{
    ...
    {
        ai = zm_utility::function_cce73165( "dog_location", #"spawner_bo5_zombie_dog_molotov", #"zone_field_hospital" );
...
function function_9a978ce6()
{
    ...
    level thread util::delay( #"play_mixer_shattered_vo", "end_game", &zm_gold_vo::function_a71f7322 );
...
{
    level waittill( #"key_card_is_given" );
    var_254ceca7 = struct::get( "ac_pos", "targetname" );
    level scene::play( #"p9_fxanim_zm_gold_drawer_flat_bundle" );
...
{
    level endon( #"chemical_mixer_rumble_end" );
    level waittill( #"chemical_mixer_rumble_start" );
...
function function_ad7dbaa3()
{
    ...
    var_13e92fe1 = struct::get( #"aac_pos", "targetname" );
    var_44a8a9e4 = struct::get( #"ac_trg", "targetname" );
    ...
    level scene::play( #"p9_fxanim_zm_gold_gas_delivery_device_set_bundle" );
    function_b3524864();
    function_31b6fa5b();
...
{
    level endon( #"ac_rumble_end" );
    level waittill( #"ac_rumble_start" );
...
function function_b509640()
{
    ...
    point = function_4ba8fde( #"item_zmquest_gold_fd" );
...
function function_aa3414cb( a_pos, var_753342a3, str_zone_name )
{
    ...
    if ( isdefined( var_b6246671 ) )
    {
        ...
        if ( isdefined( level.spawn_mimic ) )
        {
            ...
            level.spawn_mimic callback::function_d8abfc3d( #"on_entity_hidden_in_prop", &zm_gold::function_b7bf6e96 );
            level.spawn_mimic callback::function_d8abfc3d( #"on_entity_revealed", &zm_gold::function_64515cbe );
        }
    }
}
...
function function_9e39dad3( var_b555f02e )
{
    switch ( var_b555f02e )
    {
        ...
        case 2:
            ...
            var_d19e0f1f thread scene::play( #"p9_fxanim_zm_gold_essence_trap_machine_02_bundle", "play", var_d19e0f1f );
        ...
        case 3:
            mdl_mts = getent( "mdl_mts", "targetname" );
            mdl_mts thread scene::play( #"p9_fxanim_zm_gold_essence_trap_machine_01_bundle", "play", mdl_mts );
...
function function_1621782d( var_b555f02e )
{
    switch ( var_b555f02e )
    {
        ...
        case 2:
            var_d19e0f1f = getent( "zd_01", "targetname" );
            var_d19e0f1f thread scene::stop( #"p9_fxanim_zm_gold_essence_trap_machine_02_bundle" );
        ...
        case 3:
            mdl_mts = getent( "mdl_mts", "targetname" );
            mdl_mts thread scene::stop( #"p9_fxanim_zm_gold_essence_trap_machine_01_bundle" );
...
function function_520b958d()
{
    ...
    {
        zm_gold_ww_quest::function_ade87eb5( #"item_zmquest_gold_shovel", var_ca1193a6, 0 );
        var_ca1193a6 delete();
    }
}
        ...
        if ( isdefined( item.itementry.name ) )
        {
            switch ( item.itementry.name )
            {
                ...
                case #"item_zmintel_gold_omega_artifact_2":
                    ...
                    break;
                case #"item_zmquest_gold_compound_36":
                    ...
                    break;
                case #"item_zmquest_gold_compound_p65":
                    if ( !level flag::get_any( [ #"hash_29d5efd7e75d2cef", #"hash_49f375553940bfed", #"hash_6a27b5e2ac791e2a" ] ) )
                    {
                        level thread zm_gold_vo::function_68c6149e();
                    }
                    ...
                    break;
                case #"item_zmquest_gold_compound_s16":
...
function function_3a3ca419()
{
    ...
    s_fx = struct::get( #"s_cry_dust_shape" );
    ...
    if ( !isarray( var_d2ee34ea ) )
    {
        ...
        for ( i = 0; i < 20 ; i++ )
        {
            if ( !var_4cfcaaf5 )
            {
                ...
                spawn_pos[ i ].mdl thread scene::play( #"ch_p9_zm_gold_aetherium_container_bundle", "play", spawn_pos[ i ].mdl );
                var_4cfcaaf5 = 1;
...
function function_531dcaa4()
{
    ...
    s_fx = struct::get( #"s_cry_dust_telep" );
    ...
    while ( !level flag::get( #"hash_384b665200ca31eb" ) )
    {
        ...
        if ( isdefined( dis ) && dis < 256 && !var_d2ee34ea.mdl flag::get( #"canister_trapped" ) )
        {
            ...
            var_d2ee34ea.mdl thread scene::play( #"ch_p9_zm_gold_aetherium_container_bundle", "shake", var_d2ee34ea.mdl );
            var_d2ee34ea.mdl thread function_4924bc79( 1 );
            var_d2ee34ea.mdl waittill( #"hash_7d2daba7fc66764c" );
            var_d2ee34ea.mdl thread scene::stop( #"ch_p9_zm_gold_aetherium_container_bundle" );
...
function function_73141752( var_d2ee34ea )
{
    ...
    while ( true )
    {
        ...
        self scene::stop( #"ch_p9_zm_gold_aetherium_container_bundle" );
...
function function_6b76cd80( s_container )
{
    ...
    if ( !s_container flag::get( #"canister_defeated" ) )
    {
        ...
        if ( !s_container flag::get( #"canister_revealed" ) )
        {
            ...
            s_fx = struct::get( #"s_cry_dust_rad" );
...
function function_c5a09ae3( var_18ceba08 )
{
    ...
    while ( i < var_4b56616b )
    {
        ...
        if ( isdefined( s_pos ) )
        {
            ai = spawnactor( #"spawner_bo5_raz_sr", s_pos.origin, s_pos.angles, "defend_zombie", 1 );
    ...
    while ( i < var_2eb22136 )
    {
        ...
        if ( isdefined( s_pos ) )
        {
            ai = spawnactor( #"spawner_bo5_zombie_dog_molotov", s_pos.origin, s_pos.angles, "defend_zombie", 1 );
...
function private function_80b4d925()
{
    ...
    str_scene = array::random( [ #"aib_t9_zm_vign_cust_frbz_peck_vignette_01_alt_01", #"aib_t9_zm_vign_cust_frbz_peck_vignette_01_alt_02", #"aib_t9_zm_vign_cust_frbz_peck_vignette_01_alt_03" ] );
    
    switch ( str_scene )
    {
        case #"aib_t9_zm_vign_cust_frbz_peck_vignette_01_alt_01":
            level thread zm_vo::function_7622cb70( #"hash_671b8f1b6215a73b", undefined, undefined, undefined, 1 );
            break;
        case #"aib_t9_zm_vign_cust_frbz_peck_vignette_01_alt_02":
            level thread zm_vo::function_7622cb70( #"hash_671b901b6215a8ee", undefined, undefined, undefined, 1 );
            break;
        case #"aib_t9_zm_vign_cust_frbz_peck_vignette_01_alt_03":
...
function private function_31b6fa5b()
{
    ...
    level flag::set( #"dr_peck_mq_vignette_talking" );
    level.var_90655717 zm_unitrigger::unregister_unitrigger( level.var_90655717.s_unitrigger );
    level waittill( #"enable_dance_loop_narrative_interact" );
    ...
    {
        s_waitresult = level.var_9a81036b waittill( #"out_of_dance_1", #"out_of_dance_2", #"out_of_dance_3", #"out_of_dance_4", #"out_of_dance_5", #"hash_7fd5f29cf67a2e57", #"scriptedanim" );
        level scene::stop( level.var_9a81036b.current_scene );
    ...
    {
        level.var_9a81036b waittill( #"out_of_dance_loop" );
    }
    ...
    level waittill( #"continue_to_step_4" );
    zm_utility::function_d729de6a( 0, [ #"zone_napalm_strike2" ] );
}
...
{
    level.var_9a81036b waittill( #"vox_fbz_mq3_peck_vig2_interog_weav_0" );
...
function function_b8091725( mdl_mts )
{
    ...
    {
        level waittill( #"peck_out_of_dance_complete" );
        level scene::stop( level.var_9a81036b.current_scene );
    }
