...
function init()
{
    ...
    scene::add_scene_func( #"aib_t9_zm_abom_spawning_from_portal", &function_54dd8e5d );
...
function function_5a72edf0()
{
    ...
    playsoundatposition( #"hash_4e9f052116a0cb95", portal_fx.origin );
    level thread scene::play( #"scene_teleporter_helipads2", "targetname" );
...
function function_d6912122( b_skipped )
{
    ...
    var_b75e4db1 = struct::get_array( #"helipads_teleporter_console" );
...
function function_901d4808( *b_skipped, var_19e802fa )
{
    ...
    playsoundatposition( #"hash_4e9f052116a0cb95", portal_fx.origin );
    level thread scene::play( #"scene_teleporter_helipads", "targetname" );
}
...
function function_ae76d66e( *b_skipped, var_19e802fa )
{
    ...
    level flag::set( #"enable_helipads_teleporter" );
...
function function_4a137892( b_skipped )
{
    ...
    level flag::wait_till( #"pap_quest_teleport_to_main_street" );
...
function function_b6f68914( b_skipped )
{
    ...
    var_b75e4db1 = struct::get_array( #"main_street_door", "targetname" );
    ...
    level flag::wait_till( #"pap_quest_teleport_to_anytown_usa" );
...
function function_c754a36a( b_skipped )
{
    ...
    var_b75e4db1 = array();
    array::add( var_b75e4db1, struct::get( #"anytown_usa_rooftops_door", "targetname" ) );
    array::add( var_b75e4db1, struct::get( #"tv_repair_door", "targetname" ) );
    array::add( var_b75e4db1, struct::get( #"cinema_door", "targetname" ) );
    ...
    level flag::wait_till( #"pap_quest_go_to_anytown_usa_teleporter" );
}
...
{
    if ( self.blueprint.name === #"ztable_tungsten_damaged_teleporter" )
    {
...
function function_f826b3d( b_skipped )
{
    ...
    if ( !level flag::get( #"hash_419cb6aea3c6771e" ) )
    {
        ...
        level thread function_73ab4038( #"teleporter_part_a_zone", #"hash_51a0015904debd03", #"hash_5053d00c73ada9ef", level.var_ef6bb204 );
        level thread function_73ab4038( #"teleporter_part_b_zone", #"hash_51a0025904debeb6", #"hash_5053d10c73adaba2", level.var_e1ef8bc7 );
        level thread function_73ab4038( #"teleporter_part_c_zone", #"hash_51a0035904dec069", #"hash_5053d20c73adad55", level.var_8e3ebebd );
        level thread function_73ab4038( #"teleporter_part_d_zone", #"hash_51a0045904dec21c", #"hash_5053cb0c73ada170", level.var_3174da65 );
    }
...
function private function_48fb2ed5()
{
    if ( getdvarint( #"hash_7db4fc2e427dab4", 0 ) == 1 )
    {
        for ( i = 0; i < 3 ; i++ )
        {
            ...
            level thread function_6badca5( hash( var_3aa83917 ), #"item_zmquest_tungsten_pap_quest_part_a" );
            level thread function_6badca5( hash( var_d4d5e62 ), #"item_zmquest_tungsten_pap_quest_part_b" );
            level thread function_6badca5( hash( var_e00503d2 ), #"item_zmquest_tungsten_pap_quest_part_c" );
            level thread function_6badca5( hash( var_d6d47185 ), #"item_zmquest_tungsten_pap_quest_part_d" );
        }
...
function function_57c1663d( b_skipped )
{
    ...
    var_b75e4db1 = struct::get_array( #"anytown_usa_teleporter_console" );
    ...
    zm_crafting::function_d1f16587( #"ztable_tungsten_damaged_teleporter", &function_2a795365 );
    level thread function_1446ef30();
    level flag::wait_till( #"hash_219a3f198a6aa63" );
    zm_crafting::function_ca244624( #"ztable_tungsten_damaged_teleporter" );
    ...
    playsoundatposition( #"hash_4e9f052116a0cb95", portal_fx.origin );
    level thread scene::play( #"scene_teleporter_anytown_usa", "targetname" );
    level clientfield::set( "" + #"hash_27308a7dd991ce8d", 0 );
    level function_891d8fc( #"enable_anytown_usa_teleporter" );
}
...
function function_80f4c05c( b_skipped, var_19e802fa )
{
    if ( var_19e802fa )
    {
        ...
        level thread scene::play( #"scene_teleporter_anytown_usa", "targetname" );
        level clientfield::set( "" + #"hash_27308a7dd991ce8d", 0 );
        level flag::set( #"enable_anytown_usa_teleporter" );
    }
    else if ( b_skipped )
    {
        zm_crafting::function_ca244624( #"ztable_tungsten_damaged_teleporter" );
...
function function_71d12bb( b_skipped )
{
    ...
    level flag::wait_till( #"pap_quest_teleport_to_bunker" );
}
...
function function_5dd183b3( b_skipped )
{
    ...
    var_b75e4db1 = struct::get_array( #"service_tunnels_door", "targetname" );
    ...
    level flag::wait_till( #"pap_quest_go_to_bunker_teleporter" );
}
...
function function_4710b248( b_skipped )
{
    ...
    level scene::init( #"scene_abom_intro", "targetname" );
    wait 0.5;
    level scene::play( #"scene_abom_intro", "targetname" );
...
{
    level endon( #"end_game", #"hash_19c523c64529d390", #"pap_quest_teleport_to_observation" );
    ...
    s_spawn_loc = struct::get( #"pap_quest_bunker_teleporter_spawns", "targetname" );
    n_wait_time = 5;
    n_countdown = 5;
    var_d9439ea = 0;
...
function function_a5034a1( *b_skipped, var_19e802fa )
{
    ...
    level flag::set( #"enable_bunker_teleporter" );
...
function function_f4301c94( b_skipped )
{
    ...
    level flag::wait_till( #"pap_quest_teleport_to_observation" );
...
function function_8ad7a0a7( *b_skipped, var_19e802fa )
{
    ...
    playsoundatposition( #"hash_4e9f052116a0cb95", portal_fx.origin );
    level thread scene::play( #"scene_teleporter_observation", "targetname" );
    level thread function_891d8fc( #"enable_observation_teleporter" );
}
...
/#
    ...
    function function_8ac7a154()
    {
        ...
        playsoundatposition( #"hash_4e9f052116a0cb95", portal_fx.origin );
        level thread scene::play( #"scene_teleporter_helipads", "<dev string:x61>" );
        level flag::set( #"enable_anytown_usa_teleporter" );
        ...
        level thread scene::play( #"scene_teleporter_anytown_usa", "<dev string:x61>" );
        ...
        playsoundatposition( #"hash_4e9f052116a0cb95", portal_fx.origin );
        level thread scene::play( #"scene_teleporter_observation", "<dev string:x61>" );
        level thread scene::play( #"scene_teleporter_helipads2", "<dev string:x61>" );
        level flag::set( #"enable_bunker_teleporter" );
        level flag::set( #"enable_observation_teleporter" );
        zm_tungsten_zones::function_990a7f89();
        zm_tungsten_zones::function_4f804075();
        zm_tungsten_zones::function_5c0aa258();
        zm_tungsten_zones::function_904e469e();
