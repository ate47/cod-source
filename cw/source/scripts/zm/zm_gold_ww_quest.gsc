...
function function_2b26d68b()
{
    ...
    level scene::init( #"aib_t9_zm_firebase_ww_burned_scientist" );
...
function function_c2088edf( b_skipped )
{
    ...
    var_535d61f8 scene::play( #"p9_fxanim_zm_gold_retinal_scanner_bundle", "up", var_535d61f8 );
    var_535d61f8 clientfield::set( "" + #"hash_438f8800ecce6fba", 1 );
    wait 4;
    var_535d61f8 scene::stop( #"p9_fxanim_zm_gold_retinal_scanner_bundle" );
    var_535d61f8 thread scene::play( #"p9_fxanim_zm_gold_retinal_scanner_bundle", "down", var_535d61f8 );
...
function function_fd185787()
{
    ...
    var_5d7d58f2 = function_ade87eb5( #"item_zmquest_gold_rifle_converter", var_79bb44c5, 0 );
...
function function_4ef5947( b_skipped )
{
    ...
    var_4f28f4ee = function_ade87eb5( #"item_zmquest_gold_locker_key", locker_key_pos, 0 );
...
function function_2d9c01e4()
{
    ...
    waitframe( 5 );
    power_cell delete();
    function_ade87eb5( #"item_zmquest_gold_power_cell", power_cell_pos, 0 );
}
...
function function_6128f9d0()
{
    ...
    if ( isdefined( ai ) )
    {
        function_ade87eb5( #"item_zmquest_gold_unpower_cell", ai, 2 );
...
function function_a458979c( entity )
{
    ...
    {
        function_ade87eb5( #"item_zmquest_gold_barrel", entity, 2 );
        ...
        if ( isdefined( item.itementry.name ) )
        {
            switch ( item.itementry.name )
            {
                case #"item_zmintel_gold_requiem_artifact_1":
                    ...
                    break;
                case #"item_zmquest_gold_locker_key":
                ...
                case #"item_zmintel_gold_requiem_artifact_4":
                    ...
                    break;
                case #"item_zmquest_gold_rifle_converter":
                    ...
                    break;
                case #"item_zmquest_gold_power_cell":
                    ...
                    break;
                case #"item_zmquest_gold_unpower_cell":
...
function private function_cf884a61()
{
    ...
    level scene::play( #"aib_t9_zm_firebase_ww_burned_scientist", self );
}
...
/#
    ...
    function spawn_mangler()
    {
        ...
        spawn_mangler = spawnactor( #"spawner_bo5_raz_sr", var_b6246671.origin, var_b6246671.angles, "<dev string:x30c>", 1 );
