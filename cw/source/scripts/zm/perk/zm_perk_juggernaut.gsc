...
function function_485b89e9()
{
    ...
    zm_perks::register_perk_machine( #"talent_juggernog", &function_1ff28887, &init_juggernaut );
...
function function_166eeafc()
{
    ...
    level.machine_assets[ #"talent_juggernog" ].off_model = "p9_sur_machine_juggernog_off";
    level.machine_assets[ #"talent_juggernog" ].on_model = "p9_sur_machine_juggernog";
}
