...
{
    zm_perks::register_perk_clientfields( #"talent_tombstone", &client_field_func, &callback_func );
    zm_perks::register_perk_effects( #"talent_tombstone", "tombstone_light" );
    zm_perks::register_perk_init_thread( #"talent_tombstone", &init_staminup );
