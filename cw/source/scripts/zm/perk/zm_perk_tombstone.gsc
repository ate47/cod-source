...
{
    zm_perks::register_perk_basic_info( #"talent_tombstone", #"perk_tombstone", 2000, #"hash_30c002174ad27054", getweapon( "zombie_perk_bottle_tombstone" ), undefined, #"hash_46862a73c93d9338" );
    zm_perks::register_perk_precache_func( #"talent_tombstone", &precache );
    zm_perks::register_perk_clientfields( #"talent_tombstone", &register_clientfield, &set_clientfield );
    zm_perks::register_perk_machine( #"talent_tombstone", &perk_machine_setup );
    zm_perks::register_perk_threads( #"talent_tombstone", &perk_give, &function_6df7ba74 );
    zm_perks::register_perk_host_migration_params( #"talent_tombstone", "vending_tombstone", "tombstone_light" );
...
function precache()
{
    ...
    level.machine_assets[ #"talent_tombstone" ] = spawnstruct();
    level.machine_assets[ #"talent_tombstone" ].weapon = getweapon( "zombie_perk_bottle_tombstone" );
    level.machine_assets[ #"talent_tombstone" ].off_model = "p9_sur_machine_tombstone_off";
    level.machine_assets[ #"talent_tombstone" ].on_model = "p9_sur_machine_tombstone";
}
    ...
    if ( self namespace_e86ffa8::function_33d837e4() )
    {
        ...
        if ( !is_true( self.var_b895a3ff ) )
        {
            ...
            if ( self.var_2f2bf1ea )
            {
                ...
                tacticalitem = structcopy( self.inventory.items[ 13 ] );
                lethalitem = structcopy( self.inventory.items[ 7 ] );
                ...
                var_42045b62 = { #armor:self.armor, #var_6032cf15:self.armortier, #scrap:isdefined( self.var_595a11bc ) ? self.var_595a11bc : 0, #var_c7f20631:isdefined( self.var_72d64cfd ) ? self.var_72d64cfd : 0, #scorestreak:var_16f12c31, #tactical:tacticalitem, #lethal:lethalitem, #weapon1:var_61bf1830, #weapon2:var_c6dd36cf };
