...
function autoexec opt_in()
{
    ...
    level.var_e2f95698 = #"zm_platinum_dialogue";
...
{
    level.var_dfee7fc2 = #"cin_zm_platinum_intro";
    level.var_775a83a7 = 1;
    namespace_1fd59e39::function_1376ec37( undefined, undefined, "tunnel_boundary_damage_volume" );
    zm_intel::function_88645994( #"zmintel_list_zm_platinum_document_drops", #"zmintel_list_zm_platinum_darkaether_computer", undefined, undefined, #"zmintel_list_zm_platinum_radio_transmissions_omega", #"zmintel_list_zm_platinum_omega_intel_all", #"zmintel_list_zm_platinum_darkaether_intel_all", undefined, #"zmintel_list_zm_platinum_requiem_intel_all" );
    zm::init_fx();
    ...
    scene::function_497689f6( #"cin_zm_platinum_intro", "helicopter", "tag_probe_attach", "prb_mil_ru_heli_trans" );
    scene::add_scene_func( #"cin_zm_platinum_intro", &function_a0f98b8b, "sh010", "sh010" );
    scene::add_scene_func( #"cin_zm_platinum_intro", &function_a0f98b8b, "sh020", "sh020" );
    scene::add_scene_func( #"cin_zm_platinum_intro", &function_a0f98b8b, "stop" );
    load::main();
    ...
    level.var_8bb7479c = #"aib_t9_vign_cust_zm_platinum_outro_success_01";
    level.var_72a3d8bc = #"aib_t9_vign_cust_zm_platinum_outro_fail_01";
...
function function_bf14bffe()
{
    ...
    while ( true )
    {
        ...
        if ( var_1e8cb595 && !self flag::get( #"player_in_rain" ) && !is_true( self.var_16735873 ) )
        {
            self flag::set( #"player_in_rain" );
            self clientfield::set_to_player( "" + #"pstfx_sprite_rain_loop", 1 );
        }
        else if ( !var_1e8cb595 && self flag::get( #"player_in_rain" ) )
        {
            self flag::clear( #"player_in_rain" );
...
function function_4af68b()
{
    foreach ( player in getplayers() )
    {
        ...
        player flag::clear( #"player_in_rain" );
        ...
        switch ( self.var_19f4406e )
        {
            ...
            case 1:
                if ( !self flag::get( #"hash_8b791c5e5b0b269" ) && !self flag::get( #"hash_7fb35d12e64cf793" ) )
                {
                    ...
                    self clientfield::set_to_player( "" + #"toggle_blacklight", 0 );
                }
                else
                {
            ...
            case 2:
                if ( !self flag::get( #"hash_8b791c5e5b0b269" ) && !self flag::get( #"hash_7fb35d12e64cf793" ) )
                {
                    ...
                    self clientfield::set_to_player( "" + #"toggle_blacklight", 1 );
                }
                else
                {
                    self clientfield::set( "" + #"hash_63af42145e260fb5", 0 );
...
function function_92d44ee0()
{
    level endon( #"end_game" );
    level flag::wait_till( "start_zombie_round_logic" );
    level scene::play( #"p9_fxanim_civ_ru_sedan_80s_dest_police_wet_low_bundle" );
}
...
function function_e803401a( var_4a8bf1a3 = 1 )
{
    ...
    if ( var_4a8bf1a3 )
    {
        level endon( #"ghost_train_south_rumble_stop", #"end_game", #"end_train_rumble" );
    }
    else
    {
        level endon( #"ghost_train_north_rumble_stop", #"end_game", #"end_train_rumble" );
    }
...
function private function_825111ad( var_4a8bf1a3 = 1 )
{
    if ( var_4a8bf1a3 )
    {
        level endon( #"ghost_train_south_rumble_stop", #"end_game" );
    }
    else
    {
        level endon( #"ghost_train_north_rumble_stop", #"end_game" );
    }
    
    level waittill( #"start_hvy_rumble" );
...
function function_5e09fe1( var_4a8bf1a3 = 1, var_d15e3ab = 1 )
{
    if ( var_4a8bf1a3 )
    {
        level endon( #"ghost_train_south_rumble_stop" );
        var_8179aee4 = struct::get( "spawn_klaus_south", "targetname" );
    }
    else
    {
        level endon( #"ghost_train_north_rumble_stop" );
        ...
        foreach ( zombie in a_zombies )
        {
            if ( isdefined( zombie ) && zombie.health > 0 )
            {
                if ( zombie istouching( self ) )
                {
                    ...
                    if ( zombie.archetype === #"zombie_steiner" )
                    {
...
/#
    ...
    function function_e6b581e7( var_9ff20235 )
    {
        ...
        self function_749d2cfc( hash( str_weapon_name ), hash( str_weapon_name + var_7625b6cc ), n_pap_level );
        ...
        self thread zm_perks::function_29387491( #"talent_juggernog" );
        self thread zm_perks::function_29387491( #"talent_tombstone" );
    ...
    // Size: 0x266, Type: dev
    function function_749d2cfc( *str_weapon_name, str_item_name, n_pap_level )
    {
        self endon( #"disconnect" );
        ...
        if ( isdefined( str_item_name ) )
        {
            ...
            if ( isdefined( point ) && isdefined( n_pap_level ) && isdefined( level.var_fee1eaaf ) )
            {
