...
function function_e324aad2()
{
    ...
    foreach ( struct in struct::get_array( level.var_75a7d6.target ) )
    {
        if ( struct.var_fdd68e6f === #"capture" )
        {
            ...
            level.var_75a7d6.var_b9f89aa6 scene::init( #"p9_fxanim_zm_tungsten_capture_cage_bundle", a_ents );
            break;
        }
    }
}
...
function boss_spawn( s_spawn )
{
    ...
    s_spawn thread scene::play( #"aib_t9_zm_tung_boss_fight", "idle_both_arms", a_ents );
    a_ents = [];
    a_ents[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_boss_fight_face", "idle", a_ents );
}
...
function weakpoint_destroyed( var_a07ea3db )
{
    ...
    if ( isdefined( str_shot ) )
    {
        ...
        a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
        level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", str_shot, a_ents );
...
function function_a39582f9( n_level = 1 )
{
    ...
    while ( true )
    {
        ...
        var_433eb1d7 scene::play( #"p9_fxanim_zm_tungsten_capture_cage_bundle", str_shot, a_ents );
    }
}
...
function function_fee3db9( str_shot, var_a78cf3d4 = 0 )
{
    ...
    a_ents[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor scene::play( #"aib_t9_zm_tung_boss_fight_face", str_shot, a_ents );
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_boss_fight_face", "idle", a_ents );
    waitframe( 1 );
...
function function_3d5eabf( str_shot )
{
    ...
    wait 0.5;
    a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
    level.var_75a7d6.s_boss thread scene::play( #"aib_t9_zm_tung_boss_fight", "beam_intro", a_ents );
    wait 1.5;
...
function function_a3a141fe()
{
    ...
    {
        a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
        level.var_75a7d6.s_boss thread scene::play( #"aib_t9_zm_tung_boss_fight", str_idle, a_ents );
    }
}
...
function function_9042d18c()
{
    ...
    level.var_75a7d6 endon( #"defeated", #"weakpoint_destroyed" );
    a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
    level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", "frost_intro", a_ents );
    level.var_75a7d6.s_boss thread scene::play( #"aib_t9_zm_tung_boss_fight", "frost_loop", a_ents );
}
...
function function_6c54dff5()
{
    ...
    level.var_75a7d6 endon( #"defeated", #"weakpoint_destroyed" );
    a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
    level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", "frost_outro", a_ents );
    level thread function_a3a141fe();
}
...
function function_3ac42e92()
{
    ...
    level.var_75a7d6 endon( #"defeated", #"weakpoint_destroyed" );
    a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
    level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", "mine_intro", a_ents );
    level.var_75a7d6.s_boss thread scene::play( #"aib_t9_zm_tung_boss_fight", "mine_loop", a_ents );
    wait 1;
    level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", "mine_outro", a_ents );
    level thread function_a3a141fe();
}
...
function function_f68fc7a0( e_target, b_play_vo = 1 )
{
    ...
    a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
    level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", "beam_intro", a_ents );
    level.var_75a7d6.s_boss thread scene::play( #"aib_t9_zm_tung_boss_fight", "beam_loop", a_ents );
    level.var_75a7d6 flag::set( #"hash_30c93e279eb03e9c" );
    wait 5;
    level thread function_b852652a();
    level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", "beam_outro", a_ents );
    level thread function_a3a141fe();
...
function function_bb7202a2()
{
    ...
    foreach ( struct in struct::get_array( level.var_75a7d6.target ) )
    {
        if ( struct.var_fdd68e6f === #"float" && struct.script_int === 0 )
        {
            ...
            level.var_75a7d6.var_c20e460e.mdl_anchor thread scene::play( #"t9_zm_tung_maxis_boss_bundle", "charging_loop", a_ents );
            break;
        }
    }
}
...
function maxis_move( v_dest, v_angles, var_135e3159, var_2dba142c = 0, n_speed = 300, var_bad95e69 = 1, var_58a45754 = 1 )
{
    ...
    {
        mdl_anchor scene::play( #"t9_zm_tung_maxis_boss_bundle", "charging_out", a_ents );
    }
    ...
    mdl_anchor thread scene::play( #"t9_zm_tung_maxis_boss_bundle", "move_in", a_ents );
    ...
    if ( n_move_time > 0 )
    {
        ...
        if ( var_818c24ea > 0 )
        {
            mdl_anchor thread scene::play( #"t9_zm_tung_maxis_boss_bundle", "move_loop", a_ents );
        }
    ...
    mdl_anchor thread scene::play( #"t9_zm_tung_maxis_boss_bundle", "move_out", a_ents );
    ...
    if ( var_58a45754 )
    {
        if ( !var_2dba142c )
        {
            mdl_anchor scene::play( #"t9_zm_tung_maxis_boss_bundle", "charging_in", a_ents );
            mdl_anchor thread scene::play( #"t9_zm_tung_maxis_boss_bundle", "charging_loop", a_ents );
        }
        else
        {
            mdl_anchor thread scene::play( #"t9_zm_tung_maxis_boss_bundle", "charged_loop", a_ents );
            wait 0.5;
        }
    }
...
function function_1c6d2370()
{
    ...
    level.var_75a7d6.var_c20e460e.mdl_anchor scene::play( #"t9_zm_tung_maxis_boss_bundle", "cannon_in", a_ents );
    level.var_75a7d6.var_c20e460e.mdl_anchor thread scene::play( #"t9_zm_tung_maxis_boss_bundle", "cannon_loop", a_ents );
    ...
    level.var_75a7d6.var_c20e460e.mdl_anchor scene::play( #"t9_zm_tung_maxis_boss_bundle", "cannon_out", a_ents );
...
function boss_outro()
{
    ...
    a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
    level.var_75a7d6.s_boss scene::play( #"aib_t9_zm_tung_boss_fight", "head_break", a_ents );
    music::setmusicstate( "boss_outro" );
    level thread function_64a4bf62();
    scene::add_scene_func( #"aib_t9_zm_tung_maxis_boss_death_vignette", &function_4d5c5f2, "vignette_start" );
    scene::add_scene_func( #"aib_t9_zm_tung_maxis_boss_death_vignette", &function_38c740f4, "shot_01" );
    scene::add_scene_func( #"aib_t9_zm_tung_maxis_boss_death_vignette", &function_2f062d72, "shot_02" );
    scene::add_scene_func( #"aib_t9_zm_tung_maxis_boss_death_vignette", &function_1d4489ef, "shot_03" );
    scene::add_scene_func( #"aib_t9_zm_tung_maxis_boss_death_vignette", &function_3585613, "shot_04" );
    scene::add_scene_func( #"aib_t9_zm_tung_maxis_boss_death_vignette", &function_f199b296, "shot_05" );
    scene::add_scene_func( #"aib_t9_zm_tung_maxis_boss_death_vignette", &function_f1261395, "vignette_end" );
    a_ents = [];
    a_ents[ #"boss" ] = level.var_75a7d6.mdl_body;
    a_ents[ #"maxis" ] = level.var_75a7d6.var_c20e460e.var_2644aca3;
    level scene::play( #"aib_t9_zm_tung_maxis_boss_death_vignette", a_ents );
...
function function_4d5c5f2( *a_ents )
{
    ...
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_death_vign_forsaken_face", "vignette_start", var_da05d30e );
    level waittill( #"end_fight_outro_vo_01" );
    level clientfield::set( "" + #"hash_5a36f05cbdf2580", 10 );
    level thread zm_vo::function_7622cb70( #"hash_b4555c0ad322fb" );
    level waittill( #"end_fight_outro_vo_02" );
    level thread zm_vo::function_7622cb70( #"hash_b4565c0ad324ae" );
    level waittill( #"end_fight_outro_vo_03" );
...
function function_38c740f4( *a_ents )
{
    ...
    var_da05d30e[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_death_vign_forsaken_face", "shot_01", var_da05d30e );
...
{
    var_da05d30e[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_death_vign_forsaken_face", "shot_02", var_da05d30e );
}
...
{
    var_da05d30e[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_death_vign_forsaken_face", "shot_03", var_da05d30e );
}
...
{
    var_da05d30e[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_death_vign_forsaken_face", "shot_04", var_da05d30e );
}
...
{
    var_da05d30e[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_death_vign_forsaken_face", "shot_05", var_da05d30e );
}
...
{
    var_da05d30e[ #"head" ] = level.var_75a7d6.mdl_head;
    level.var_75a7d6.mdl_anchor thread scene::play( #"aib_t9_zm_tung_death_vign_forsaken_face", "vignette_end", var_da05d30e );
    ...
    level thread zm_utility::function_9ad5aeb1( 0, 1, 0, 0 );
    level waittill( #"end_fight_outro_death_fx_start" );
    ...
    level waittill( #"end_fight_outro_death_fx_end" );
...
function function_c835e3c4( *einflictor, *eattacker, *idamage, *smeansofdeath, *weapon, *var_fd90b0bb, *vdir, *shitloc, *psoffsettime, *deathanimduration )
{
    ...
    var_c84f9a30 = [ #"talent_tombstone", #"talent_tombstone_1", #"talent_tombstone_2", #"talent_tombstone_3", #"talent_tombstone_4", #"talent_tombstone_5" ];
...
function function_eb4af590()
{
    ...
    foreach ( mdl_crystal in level.var_75a7d6.var_9f7af8ca )
    {
        if ( isdefined( mdl_crystal ) )
        {
            ...
            mdl_crystal thread scene::play( #"p9_fxanim_zm_tungsten_dark_aether_crystal_bundle", mdl_crystal );
            wait 0.5;
        }
    }
}
...
/#
    ...
    function function_14a35d6f()
    {
        ...
        var_a347ab1 = struct::get_array( #"end_fight_teleport" );
