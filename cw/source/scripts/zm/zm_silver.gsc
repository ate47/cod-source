...
function autoexec opt_in()
{
    ...
    level.var_e2f95698 = #"zm_silver_dialogue";
    ...
    zm_intel::function_88645994( #"zmintel_list_silver_document_drops", #"zmintel_list_silver_dark_aether_computer", #"zmintel_list_silver_radio_transmissions_requiem", #"zmintel_list_silver_radio_transmissions_maxis", #"zmintel_list_silver_radio_transmissions_omega", #"zmintel_list_silver_omega_intel_all", #"zmintel_list_silver_darkaether_intel_all", #"zmintel_list_silver_maxis_intel_all", #"zmintel_list_silver_requiem_intel_all" );
...
function event_handler[level_init] main( *eventstruct )
{
    ...
    zm_perks::function_9760a58b( #"talent_juggernog" );
    ...
    level._effect[ #"explosion_fx_01" ] = #"hash_28bb64d8996beecf";
...
function private function_a95110c( n_round )
{
    ...
    zm_round_spawning::function_cc103b38( #"zombie_steiner", level.var_ad49daf9 );
...
function function_85bd89cb()
{
    ...
    level thread scene::init( #"p9_fxanim_zm_ndu_cob_toy_horse_fall_bundle" );
    toy_horse_trigger waittill( #"trigger" );
    level thread scene::play( #"p9_fxanim_zm_ndu_cob_toy_horse_fall_bundle" );
