...
{
    if ( self.archetype === #"zombie_steiner" && !isdefined( self.subarchetype ) && self.team === level.zombie_team )
    {
    ...
    if ( self.aitype === #"spawner_zm_steiner_hvt_zm_silver" && self.team === level.zombie_team )
    {
...
function private match_start_vo()
{
    ...
    {
        level thread scene::play_from_time( #"aib_t9_vign_cust_zm_xmas_bundle_01", undefined, undefined, 0.33 );
...
function function_c7ca9f21()
{
    while ( true )
    {
        ...
        if ( waitresult.aitype === #"spawner_zm_steiner_hvt_zm_silver" )
        {
