...
function autoexec opt_in()
{
    ...
    level.var_e2f95698 = #"zm_tungsten_dialogue";
...
{
    level.var_dfee7fc2 = #"cin_zm_tungsten_infil";
    level.var_f937a06e = 1;
    zm_intel::function_88645994( #"zmintel_list_zm_tungsten_document_drops", undefined, undefined, undefined, undefined, #"zmintel_list_zm_tungsten_omega_intel_all", #"zmintel_list_zm_tungsten_darkaether_intel_all", #"zmintel_list_zm_tungsten_maxis_intel_all", #"zmintel_list_zm_tungsten_requiem_intel_all" );
    ...
    level.var_8bb7479c = #"aib_t9_vign_tungsten_outro_success_01";
    level.var_72a3d8bc = #"aib_t9_vign_tungsten_outro_fail_01";
...
{
    self callback::function_d8abfc3d( #"on_entity_hidden_in_prop", &function_b7bf6e96 );
    self callback::function_d8abfc3d( #"on_entity_revealed", &function_64515cbe );
}
...
function function_bf14bffe()
{
    ...
    while ( true )
    {
        ...
        if ( is_true( var_1e8cb595 ) && !self flag::get( #"player_in_rain" ) && !is_true( self.var_16735873 ) )
        {
            self flag::set( #"player_in_rain" );
            self clientfield::set_to_player( "" + #"pstfx_sprite_rain_loop", 1 );
        }
        else if ( !is_true( var_1e8cb595 ) && self flag::get( #"player_in_rain" ) )
        {
...
/#
    ...
    function function_e6b581e7( var_9ff20235 )
    {
        ...
        self function_749d2cfc( hash( str_weapon_name + var_7625b6cc ), n_pap_level );
    ...
    // Size: 0x284, Type: dev
    function function_749d2cfc( str_item_name, n_pap_level )
    {
        self endon( #"disconnect" );
