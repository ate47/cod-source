...
function init()
{
    ...
    clientfield::register( "toplayer", "" + #"exfil_failure", 1, 1, "int" );
...
function function_f4ac09f8()
{
    ...
    level thread scene::init( #"p9_fxanim_zm_ndu_lrg_snow_tree_bundle" );
    level thread scene::init( #"aib_t9_zm_silver_tank_zombie_f" );
}
...
function function_829dde5f()
{
    ...
    {
        ai = zm_utility::function_cce73165( "dog_location", #"spawner_bo5_zombie_dog_plague", zone_name );
...
function function_58e278a1( t_override = undefined )
{
    if ( !isdefined( self.mdl_gameobject ) )
    {
        ...
        self gameobjects::init_game_objects( #"gameobject_zm_silver_dark_aether_anomaly", undefined, undefined, t_override );
...
function init_purifier()
{
    ...
    level.var_3a734155 = util::spawn_model( #"p9_zm_ndu_computer_screen_medical_horizontal_02", level.var_b2371398.origin, level.var_b2371398.angles );
    ...
    level.var_50356cd9 = util::spawn_model( #"p9_zm_ndu_computer_screen_medical_horizontal_03", level.var_b2371398.origin, level.var_b2371398.angles );
...
function recover_container()
{
    ...
    scene::add_scene_func( #"aib_t9_zm_silver_tank_zombie_f", &function_c491aefd, "intro" );
    level thread scene::play( #"aib_t9_zm_silver_tank_zombie_f", "intro" );
    level waittill( #"hash_4bfee280acdb622f" );
    scene::remove_scene_func( #"aib_t9_zm_silver_tank_zombie_f", &function_c491aefd, "intro" );
    ...
    tank scene::play( #"p9_fxanim_zm_ndu_mil_tank_tiger_shoot_bundle", tank );
    
    /#
        iprintlnbold( "<dev string:x166>" );
    #/
    
    scene::add_scene_func( #"p9_fxanim_zm_ndu_lrg_snow_tree_bundle", &function_a1dbe3ea, "play" );
    level thread scene::play( #"p9_fxanim_zm_ndu_lrg_snow_tree_bundle", "play" );
    level waittill( #"hash_3806f80cc5171e62" );
    scene::remove_scene_func( #"p9_fxanim_zm_ndu_lrg_snow_tree_bundle", &function_a1dbe3ea, "play" );
    function_460881cd();
...
function function_e0960594()
{
    ...
    if ( zm_utility::is_player_valid( waitresult.activator ) )
    {
        ...
        {
            zm_utility::function_cce73165( "dog_location", #"spawner_bo5_zombie_dog_plague", waitresult.activator.zone_name );
        }
...
function function_41e8018f()
{
    ...
    var_32c3c05c = getaiarchetypearray( #"zombie_steiner" );
    ...
    while ( var_2eb22136 > 0 )
    {
        zm_utility::function_cce73165( "dog_location", #"spawner_bo5_zombie_dog_plague", "zone_trans_north" );
        var_2eb22136--;
    }
...
function function_3b4a24e2()
{
    ...
    level thread function_31125f54( #"aib_t9_vign_cust_zm_silver_ee_outro" );
}
...
{
    self endon( #"disconnect" );
    self clientfield::set_to_player( "" + #"exfil_failure", 1 );
    wait 2;
...
function function_d6ff31d6( var_ee4872c1, var_7928fb3d )
{
    ...
    while ( true )
    {
        ...
        if ( gettime() >= level.var_c7557d2f )
        {
            ...
            {
                ai = zm_utility::function_cce73165( "dog_location", #"spawner_bo5_zombie_dog_plague", "zone_center_upper" );
...
{
    level.var_704c79ef = zm_utility::function_cce73165( "steiner_location", #"spawner_zm_steiner_hvt_zm_silver", "zone_center_upper" );
...
function function_5a6268b8( n_interval, var_f0d05ee7, var_2c1b9289 )
{
    ...
    while ( true )
    {
        ...
        if ( gettime() >= var_c666969c )
        {
            if ( level.var_e2d64235.size < var_f0d05ee7 - 1 && level.var_bf3f1109 < level.var_581a776e )
            {
                var_93700de7 = zm_utility::function_cce73165( "steiner_location", #"spawner_zm_steiner_split_radiation_blast_hvt", "zone_center_upper" );
                var_7ffcff59 = zm_utility::function_cce73165( "steiner_location", #"spawner_zm_steiner_split_radiation_bomb_hvt", "zone_center_lower" );
...
function on_item_pickup( params )
{
    ...
    if ( isplayer( self ) )
    {
        if ( isdefined( item.itementry.name ) )
        {
            ...
            {
                case #"item_zmquest_silver_mq_aetherscope_1":
                    ...
                    break;
                case #"item_zmquest_silver_mq_aetherscope_2":
                    level zm_ui_inventory::function_7df6bb60( #"hash_1f87180a0632f931", 1 );
                    level notify( #"manage_to_find_aetherscope_part", { #player:self } );
                    self clientfield::increment_to_player( "" + #"interact_rumble_small" );
                    break;
                case #"item_zmquest_silver_mq_aetherscope_3":
...
{
    level waittill( #"orlov_hit_surface_1" );
    a_players = function_a1ef346b();
    ...
    level waittill( #"orlov_hit_surface_2" );
    a_players = function_a1ef346b();
    ...
    level waittill( #"orlov_hit_surface_3" );
    a_players = function_a1ef346b();
    ...
    level waittill( #"orlov_hit_surface_4" );
    a_players = function_a1ef346b();
