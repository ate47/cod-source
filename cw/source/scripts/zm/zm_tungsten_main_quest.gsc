...
function init()
{
    ...
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_a45c2bfd, "play" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_b15240c9, "done" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_644d04d5, "Shot 3" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_4b60049c, "Shot 10" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_49f3ccf, "Shot 13" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_1f2a6275, "Shot 14" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_938275a4, "Shot 15" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_b91176b1, "Shot 19" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_7a47935c, "Shot 23" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_c8622ee6, "Shot 31" );
    scene::add_scene_func( #"cin_t9_zm_amerika_mid", &function_9946b234, "skip_started" );
...
function function_d7f67c90()
{
    ...
    var_57b44c1c = struct::get( #"workbench_neutralizer" );
...
function on_item_pickup( params )
{
    ...
    switch ( name )
    {
        ...
        case #"item_zmquest_tungsten_mq_quest_part_shard":
            ...
            self.var_c8f9547a = 1;
            self thread namespace_1cc7b406::give_equipment( #"crystal_t9_item_sr", 1 );
...
function function_2f0a2ce2()
{
    ...
    level thread scene::init( #"cin_t9_zm_amerika_mid" );
    level scene::init_streamer( #"cin_t9_zm_amerika_mid", getplayers() );
    ...
    a_ents[ #"Forsaken" ] = var_aeb8a47d;
    level scene::play( #"cin_t9_zm_amerika_mid", a_ents );
...
function function_a45c2bfd( *a_ents )
{
    ...
    level thread scene::play( #"p9_fxanim_zm_tungsten_shutter_bundle", "Shot 1" );
...
{
    level endon( #"hash_264e763f3fa44810" );
    level waittill( #"mid_scene_shutter_close" );
    level thread scene::play( #"p9_fxanim_zm_tungsten_shutter_bundle", "Shot 2" );
}
...
function function_644d04d5( a_ents )
{
    ...
    var_8edd2e3a waittill( #"mid_igc_zykov_dissolve" );
...
function function_49f3ccf( a_ents )
{
    if ( isdefined( level.var_5092bb0e ) && isdefined( level.var_cc996567 ) )
    {
        ...
        level.var_5092bb0e thread scene::play( #"cin_zm_amerika_mid_forsaken_facial", "Shot 13", a_ents );
    }
}
...
function function_1f2a6275( a_ents )
{
    if ( isdefined( level.var_5092bb0e ) && isdefined( level.var_cc996567 ) )
    {
        a_ents = [];
        a_ents[ #"head" ] = level.var_cc996567;
        level.var_5092bb0e thread scene::play( #"cin_zm_amerika_mid_forsaken_facial", "Shot 14", a_ents );
    }
}
...
function function_938275a4( a_ents )
{
    if ( isdefined( level.var_5092bb0e ) && isdefined( level.var_cc996567 ) )
    {
        a_ents = [];
        a_ents[ #"head" ] = level.var_cc996567;
        level.var_5092bb0e thread scene::play( #"cin_zm_amerika_mid_forsaken_facial", "Shot 15", a_ents );
    }
}
...
function function_b91176b1( a_ents )
{
    if ( isdefined( level.var_5092bb0e ) && isdefined( level.var_cc996567 ) )
    {
        a_ents = [];
        a_ents[ #"head" ] = level.var_cc996567;
        level.var_5092bb0e thread scene::play( #"cin_zm_amerika_mid_forsaken_facial", "Shot 19", a_ents );
    }
}
...
function function_7a47935c( a_ents )
{
    if ( isdefined( level.var_5092bb0e ) && isdefined( level.var_cc996567 ) )
    {
        a_ents = [];
        a_ents[ #"head" ] = level.var_cc996567;
        level.var_5092bb0e thread scene::play( #"cin_zm_amerika_mid_forsaken_facial", "Shot 23", a_ents );
    }
}
...
function function_9946b234( a_ents )
{
    ...
    level thread scene::play( #"p9_fxanim_zm_tungsten_shutter_bundle", "Shot 3" );
    level thread function_dfedba73();
...
function function_5414ee31()
{
    ...
    level waittill( #"stop_force_streaming_mid_igc_portal_fx" );
...
function function_4907b660()
{
    level endon( #"end_game" );
    level flag::wait_till( "all_players_spawned" );
    level thread scene::play( #"aib_t9_vign_cust_tung_krav_peck_tower" );
    level flag::wait_till( #"hash_57b9473a38039ff0" );
    level thread scene::stop( #"aib_t9_vign_cust_tung_krav_peck_tower" );
}
...
function function_f309f0fc()
{
    ...
    var_ceed8935 = struct::get( #"wall_smash_fx" );
...
function function_8fc5e1ba()
{
    ...
    var_b5a64394 thread scene::play( #"p9_fxanim_zm_tungsten_satellite_falling_bundle", var_b5a64394 );
...
function function_8687b0f2()
{
    ...
    var_62b058e7 thread scene::play( #"p9_fxanim_zm_tungsten_fuel_tank_spawning_bundle", var_62b058e7 );
    waitframe( 1 );
...
{
    vol_backroom = getent( "vol_tv_backroom", "targetname" );
    b_success = 0;
    
    if ( self istouching( vol_backroom ) && !b_success )
    {
        b_success = 1;
    ...
    foreach ( zone in self.a_zones )
    {
        foreach ( node in zone.nodes )
        {
            ...
            foreach ( s_spawn in a_s_spawns )
            {
                ...
                if ( s_spawn.script_noteworthy === #"soa_location" )
                {
...
function function_c821a64a()
{
    ...
    switch ( self.n_id )
    {
        case 0:
            ...
            self thread scene::play( #"p9_fxanim_zm_tungsten_dark_aether_crystal_bundle", self );
            break;
        case 1:
            self setmodel( "p9_fxanim_zm_tungsten_dark_aether_crystal_street" );
            self thread scene::play( #"p9_fxanim_zm_tungsten_dark_aether_crystal_street_bundle", self );
            break;
        case 2:
            self setmodel( "p9_fxanim_zm_tungsten_dark_aether_crystal_tunnel" );
            self thread scene::play( #"p9_fxanim_zm_tungsten_dark_aether_crystal_tunnel_bundle", self );
            break;
    }
}
...
function function_8c6858aa()
{
    ...
    while ( true )
    {
        ...
        {
            s_waitresult.activator namespace_1cc7b406::give_equipment( #"crystal_t9_item_sr", 1 );
...
function function_c02f8acc()
{
    ...
    mdl_debris thread scene::play( #"p9_zm_tungsten_metal_shelf_broken_bundle", mdl_debris );
...
{
    var_d56fdb6 = struct::get_array( #"catalyzed_da_crystal" );
    level.var_99018b7a = [];
...
{
    var_c1f80780 = struct::get_array( #"phase_main_street" );
    var_7594f81c = struct::get_array( #"phase_town_square" );
    ...
    var_e74b3eec = struct::get( #"phase_cap_main_street" );
    var_a450be6b = struct::get( #"phase_cap_town_square" );
...
function function_197d500b( b_skipped )
{
    ...
    n_start_time = gettime();
    level scene::init_streamer( #"cin_zm_amerika_s6_outro", getplayers() );
    ...
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_d55fcc73, "play" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_cf3ede8a, "Shot 010" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_b78ba960, "Shot 010" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_dc9b74df, "Shot 050" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_3d0889e3, "Shot 060" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_6644db7b, "Shot 070" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_35fc7d2f, "Shot 090" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_3276c278, "Shot 150" );
    scene::add_scene_func( #"cin_zm_amerika_s6_outro", &function_a0ceaf8e, "Shot 170" );
    level scene::play( #"cin_zm_amerika_s6_outro" );
}
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_d55fcc73, "play" );
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_cf3ede8a, "Shot 010" );
    level waittill( #"outro_shot_010_hide_rings" );
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_b78ba960, "Shot 020" );
    level clientfield::set( "" + #"hash_7b50097ac4242bc9", 0 );
    vh_heli = a_ents[ #"raptor_heli" ];
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_dc9b74df, "Shot 050" );
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_3d0889e3, "Shot 060" );
    level waittill( #"outro_shot_060_fade_out" );
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_6644db7b, "Shot 070" );
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_35fc7d2f, "Shot 090" );
    level clientfield::set( "" + #"hash_7b50097ac4242bc9", 0 );
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_3276c278, "Shot 150" );
    level clientfield::set( "" + #"hash_7b50097ac4242bc9", 3 );
    level waittill( #"outro_shot_150_fade_out" );
    level thread lui::screen_fade_out( 1, ( 1, 1, 1 ) );
    wait 2.6;
    level thread lui::screen_fade_in( 1, ( 1, 1, 1 ) );
}
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_outro", &function_a0ceaf8e, "Shot 170" );
    level clientfield::set( "" + #"hash_7b50097ac4242bc9", 0 );
}
...
function function_756178a( *b_skipped )
{
    ...
    scene::add_scene_func( #"cin_zm_amerika_s6_boat", &function_7f7899bf, "play" );
    level scene::play( #"cin_zm_amerika_s6_boat" );
    level lui::screen_fade_out( 0, ( 0, 0, 0 ) );
...
{
    level endon( #"end_game" );
    level scene::init_streamer( #"cin_zm_amerika_s6_boat", getplayers() );
...
{
    scene::remove_scene_func( #"cin_zm_amerika_s6_boat", &function_7f7899bf, "play" );
    ...
    function cmd( cmd )
    {
        ...
        switch ( cmd )
        {
            case #"hash_390016349056b819":
                ...
                level thread function_a4c80826( struct::get_array( #"post_igc_pos" ) );
                break;
            ...
            case #"hash_32de2812b8f91f4c":
                ...
                level flag::set( #"hash_717f6f193982a127" );
                level flag::set( #"hash_45d1ea5a016b7916" );
                level thread function_a4c80826( struct::get_array( #"step4_player_pos" ) );
