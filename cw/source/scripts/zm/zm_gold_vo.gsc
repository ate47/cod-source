...
function function_20df51b5()
{
    ...
    while ( true )
    {
        s_waitresult = self waittill( #"seated_loop_interrupt_p1", #"seated_loop_interrupt_p2", #"seated_loop_interrupt_p3", #"seated_loop_interrupt_p4" );
        
        switch ( s_waitresult._notify )
        {
            case #"seated_loop_interrupt_p1":
                self.var_c92e501c = "interrupt_p1";
                break;
            case #"seated_loop_interrupt_p2":
                self.var_c92e501c = "interrupt_p2";
                break;
            case #"seated_loop_interrupt_p3":
                self.var_c92e501c = "interrupt_p3";
                break;
            case #"seated_loop_interrupt_p4":
            default:
