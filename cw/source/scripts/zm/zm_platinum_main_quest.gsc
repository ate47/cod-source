...
function init()
{
    ...
    scene::add_scene_func( #"cin_zm_berlin_outro", &function_cfd1ef61, "play" );
    scene::add_scene_func( #"cin_zm_berlin_outro", &function_872c860c, "done" );
    scene::add_scene_func( #"cin_zm_berlin_outro", &function_3d64af06, "Shot 210", 1 );
    scene::add_scene_func( #"cin_zm_berlin_outro", &function_3d64af06, "Shot 230", 0 );
    scene::add_scene_func( #"p9_fxanim_zm_platinum_card_reader_bundle", &function_fa357bb3, "init" );
    level thread scene::init( #"p9_fxanim_zm_platinum_card_reader_bundle" );
...
function function_f33969bc( *params )
{
    ...
    if ( dis <= 200 )
    {
        ...
        if ( isdefined( level.klaus ) )
        {
            level.klaus thread scene::play( #"p9_fxanim_zm_platinum_klaus_break_door", "breakdoor", level.klaus );
        ...
        level waittill( #"klaus_break_door_hit" );
        ...
        level waittill( #"klaus_break_door_done" );
...
function function_1bba593c( canister, b_debug = 0 )
{
    ...
    while ( true )
    {
        ...
        {
            spawn_ai = spawn_zombie( #"spawner_bo5_raz_sr", self );
...
function function_78368ca1( b_skipped )
{
    ...
    scene::add_scene_func( #"p9_fxanim_zm_platinum_klaus_stop_train_5", &function_41ae49d5, "train_5_in" );
    level scene::init( #"p9_fxanim_zm_platinum_klaus_stop_train_5" );
...
function function_e97a3826( *params )
{
    ...
    if ( istouching( self.origin, var_3c6ab678 ) )
    {
        ...
        if ( isdefined( level.klaus ) )
        {
            ...
            level.klaus scene::play( #"p9_fxanim_zm_platinum_klaus_stop", "stop_train_5_in", level.klaus );
            
            /#
                iprintlnbold( "<dev string:x1e0>" );
            #/
            
            level.klaus thread scene::play( #"p9_fxanim_zm_platinum_klaus_stop", "stop_train_5_in_idle", level.klaus );
        }
    }
}
...
function function_c015b2c1( var_205b8171 = undefined, var_9d372cc4 = 0 )
{
    ...
    level scene::play( #"p9_fxanim_zm_platinum_klaus_stop_train_5", "train_5_in" );
    ...
    if ( level flag::get( #"hash_6499c1679ecbefef" ) || var_9d372cc4 )
    {
        ...
        if ( isdefined( level.klaus ) )
        {
            level.klaus thread scene::play( #"p9_fxanim_zm_platinum_klaus_stop", "stop_train_5_start", level.klaus );
            level.klaus clientfield::set( "" + #"hash_3db79576e67b8cbd", 1 );
        }
        
        level.var_48d07d1f.var_ec0d861e[ #"train" ] scene::play( #"p9_fxanim_zm_platinum_klaus_stop_train_5", "train_5_stop_in", level.var_48d07d1f.var_ec0d861e[ #"train" ] );
        level.var_48d07d1f.var_ec0d861e[ #"train" ] playloopsound( #"hash_561d360cfbf29c5e" );
        
        if ( isdefined( level.klaus ) )
        {
            level.klaus thread scene::play( #"p9_fxanim_zm_platinum_klaus_stop", "stop_train_5_loop", level.klaus );
        }
        
        level.var_4308c048 = #"light";
        level.var_48d07d1f.var_ec0d861e[ #"train" ] thread scene::play( #"p9_fxanim_zm_platinum_klaus_stop_train_5", "train_5_stop_loop", level.var_48d07d1f.var_ec0d861e[ #"train" ] );
        ...
        if ( isdefined( level.klaus ) )
        {
            level.klaus thread scene::play( #"p9_fxanim_zm_platinum_klaus_stop", "stop_train_5_out", level.klaus );
        ...
        level.var_48d07d1f.var_ec0d861e[ #"train" ] scene::play( #"p9_fxanim_zm_platinum_klaus_stop_train_5", "train_5_stop_out", level.var_48d07d1f.var_ec0d861e[ #"train" ] );
    ...
    {
        level thread function_675838da();
        level.var_48d07d1f.var_ec0d861e[ #"train" ] scene::play( #"p9_fxanim_zm_platinum_klaus_stop_train_5", "train_5_out", level.var_48d07d1f.var_ec0d861e[ #"train" ] );
    }
...
function function_bb082beb( var_e7b30689 = 0, var_cfea0f34 = 0 )
{
    ...
    var_4fde3b0b = getent( "train_5_hit_proxy", "targetname" );
    level waittill( #"start_damage_check" );
...
{
    var_ef506289 = a_ents[ #"card_reader" ];
...
function function_16053431()
{
    ...
    scene::remove_scene_func( #"p9_fxanim_zm_platinum_card_reader_bundle", &function_fa357bb3, "init" );
    scene::add_scene_func( #"p9_fxanim_zm_platinum_card_reader_bundle", &function_dcc4f974, "play" );
    level scene::play( #"p9_fxanim_zm_platinum_card_reader_bundle" );
...
function function_17200d08()
{
    ...
    var_176eb57d scene::play( #"p9_fxanim_zm_ndu_antenna_radar_tower_bundle", "play", var_176eb57d );
}
...
function function_6d259253()
{
    ...
    level.var_55a99841[ #"zombie_steiner" ] = &function_721e6a52;
    ...
    var_95ef7819 = [ #"spawner_zm_steiner_hvt", #"spawner_bo5_mimic_hvt", #"spawner_bo5_zombie_zm_platinum", #"spawner_bo5_zombie_zm_platinum_armor_heavy" ];
    ...
    level.var_55a99841[ #"zombie_steiner" ] = &namespace_88795f45::function_99c14949;
}
...
function function_5f4e9df8()
{
    ...
    if ( var_6017f33e === #"spawner_bo5_zombie_zm_platinum_armor_heavy" )
    {
...
function function_5ab0856( var_8fd8f36c, var_d2df0e57, e_portal )
{
    ...
    for ( i = 0; i < var_52ae392c ; i++ )
    {
        while ( var_8fd8f36c[ i ] )
        {
            ...
            if ( var_d2df0e57[ i ] === #"spawner_zm_steiner_hvt" )
            {
...
{
    if ( self.aitype === #"spawner_bo5_mimic_hvt" )
    {
...
function function_70647a4f( b_skipped )
{
    ...
    level flag::set( #"enable_klaus_enter_portal_trigger" );
...
function function_24b3acaf( b_skipped, var_19e802fa )
{
    ...
    level scene::init_streamer( #"cin_zm_berlin_outro", getplayers(), 0, 0 );
    ...
    level scene::play( #"cin_zm_berlin_outro" );
...
{
    level endon( #"hash_152b0c9d34d5c670", #"klaus_enters_portal_tunnel" );
...
function function_d8b93021()
{
    ...
    level flag::wait_till( #"klaus_enters_portal_tunnel" );
    ...
    level.klaus thread scene::play( #"aib_t9_vign_cust_zm_klaus_bomb_carry", level.klaus );
...
{
    level endon( #"end_game", #"hash_152b0c9d34d5c670", #"klaus_enters_portal_tunnel" );
    wait 1;
    n_players = zm_utility::get_number_of_valid_players();
    a_s_spawns = struct::get_array( "mq_lab_enemy_portal_spawns" );
    n_round = level.round_number;
...
{
    level scene::init( #"p9_fxanim_zm_platinum_outro_phone_bundle" );
    level waittill( #"berlin_outro_blowup_vehicle" );
    level scene::play( #"p9_fxanim_zm_platinum_outro_phone_bundle" );
}
        ...
        switch ( cmd )
        {
            case #"hash_738c5e6d53b6b2c5":
                if ( !isdefined( level.var_48d07d1f.var_ec0d861e[ #"train" ] ) )
                {
                    ...
                    scene::add_scene_func( #"p9_fxanim_zm_platinum_klaus_stop_train_5", &function_41ae49d5, "<dev string:x5d5>" );
