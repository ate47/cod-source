...
function function_d48d77f2( s_point )
{
    ...
    e_vehicle = spawnvehicle( #"vehicle_t9_rcxd_racing_zm_side_quest", s_point.origin, s_point.angles );
...
function function_c9658564()
{
    ...
    while ( true )
    {
        ...
        if ( isplayer( player ) && waitresult.mod === "MOD_EXPLOSIVE" && player namespace_e86ffa8::function_582d36be( 5 ) && isdefined( damage ) && damage >= 35 )
        {
            ...
            {
                point = function_4ba8fde( #"item_zmquest_tungsten_bunny" );
            ...
            if ( isdefined( var_ca57b8dd ) )
            {
                ...
                if ( isvec( var_2077a964 ) && isdefined( mdl_reward ) )
                {
                    ...
                    playsoundatposition( #"zmb_tungsten_papq_item_drop", var_ca57b8dd.origin );
                    wait drop_time;
...
function function_8f75cb6a( *var_a276c861 )
{
    ...
    var_d0426a23 thread scene::play( #"p9_zm_tungsten_mascot_body_bundle", "play", var_d0426a23 );
    level thread function_ef77607f();
    level flag::clear( "spawn_zombies" );
    level waittill( #"hash_405fb18663eebcb4" );
    var_d0426a23 thread scene::stop( #"p9_zm_tungsten_mascot_body_bundle" );
...
function function_7c6752c8()
{
    ...
    wait 5;
    point = function_4ba8fde( #"item_zmquest_sr_cassette_tape_sam" );
        ...
        if ( isdefined( item.itementry.name ) )
        {
            switch ( item.itementry.name )
            {
                case #"item_zmquest_sr_ltm_food_burger":
                    ...
                    break;
                case #"item_zmquest_tungsten_bunny":
                    level flag::set( #"hash_60a7df7afef780c8" );
                    break;
                case #"item_zmquest_sr_cassette_tape_sam":
