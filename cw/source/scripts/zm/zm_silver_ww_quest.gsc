...
function function_284b43aa()
{
    ...
    while ( true )
    {
        ...
        {
            point = function_4ba8fde( #"item_zmquest_silver_ww_keycard" );
...
function function_eb0fb7fc( duration, cooldown )
{
    ...
    while ( true )
    {
        ...
        if ( var_7ee5c5e3 == 1 )
        {
            var_2f3cc38 thread scene::play( #"p9_fxanim_zm_ndu_door_m_rusted_glass_bundle", var_2f3cc38 );
        }
...
function function_67144513()
{
    ...
    var_410e2bb5 thread scene::play( #"p9_fxanim_zm_ndu_door_m_rusted_doorblast_bundle", var_410e2bb5 );
    wait 1.2;
...
function function_c436fc75()
{
    ...
    while ( true )
    {
        ...
        if ( isdefined( waitresult.attacker ) && waitresult.attacker.archetype === #"zombie_steiner" )
        {
    ...
    var_f98507ef thread scene::play( #"p9_fxanim_zm_ndu_fungus_death_bundle", var_127d143e );
    var_4db6fabc delete();
    point = function_4ba8fde( #"item_zmquest_silver_ww_flask_filled" );
    ...
    while ( true )
    {
        ...
        if ( isplayer( waitresult.attacker ) && !is_true( waitresult.var_98e101b0 ) )
        {
            if ( isdefined( waitresult.weapon ) && namespace_b376a999::function_7c292369( waitresult.weapon ) )
            {
                ...
                var_6dad8de0 thread scene::play( #"p9_fxanim_zm_ndu_crate_wood_01_bundle", var_6dad8de0 );
                wait 1;
                ...
                point = function_4ba8fde( #"item_zmquest_silver_ww_flask" );
...
function function_dc2acb90()
{
    ...
    point = function_4ba8fde( #"item_zmquest_silver_ww_canister_gasless" );
...
function function_3ca2b2c1( var_fd6475b5, end_notify, var_93bdf906 )
{
    ...
    while ( true )
    {
        if ( !isdefined( var_f2484ed9.mdl_gameobject ) )
        {
            ...
            var_f2484ed9 gameobjects::init_game_objects( #"gameobject_zm_silver_dark_aether_anomaly" );
...
function function_78d3b53b()
{
    ...
    scene::add_scene_func( #"p9_fxanim_zm_ndu_fuse_box_bundle", &function_59642e27, "init" );
    level thread function_f308268d();
    level scene::init( #"p9_fxanim_zm_ndu_fuse_box_bundle" );
...
function function_ead1edac( cutter )
{
    ...
    wait 1;
    cutter scene::play( #"p9_fxanim_zm_ndu_plasma_button_bundle", cutter );
    wait 1;
    cutter scene::play( #"p9_fxanim_zm_ndu_plasma_cut_bundle", cutter );
...
function function_59642e27( a_ents )
{
    ...
    while ( true )
    {
        ...
        {
            point = function_4ba8fde( #"item_zmquest_silver_ww_fuse" );
...
function function_f308268d()
{
    ...
    scene::remove_scene_func( #"p9_fxanim_zm_ndu_fuse_box_bundle", &function_59642e27, "init" );
    wait 0.2;
    level scene::play( #"p9_fxanim_zm_ndu_fuse_box_bundle", "play" );
}
        ...
        if ( isdefined( item.itementry ) )
        {
            switch ( item.itementry.name )
            {
                case #"item_zmintel_silver_requiem_artifact_2":
                    ...
                    break;
                case #"item_zmquest_silver_ww_keycard":
    ...
    function private function_98af2074( cmd )
    {
        switch ( cmd )
        {
            ...
            case #"hash_1c88a4f3e72d4479":
                ...
                {
                    var_410e2bb5 scene::play( #"p9_fxanim_zm_ndu_door_m_rusted_doorblast_bundle", var_410e2bb5 );
                }
