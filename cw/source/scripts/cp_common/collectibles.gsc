...
// Size: 0x15c
function function_316c48a3( var_d13a0347, var_28c9f917, is_earned = 1 )
{
    ...
    if ( is_earned == function_1fe63475( var_d13a0347, var_28c9f917 ) )
    {
        return;
    }
    
    player stats::set_stat( #"mapdata", var_d13a0347, #"evidence", var_28c9f917, is_earned );
    player stats::set_stat( #"mapdata", var_d13a0347, #"hash_42b984266100b32", var_28c9f917, is_earned );
    uploadstats( player );
}
...
function function_6cd091d2( var_2a51713, var_c05d6 )
{
    ...
    var_4bf53b01 = collectible.unlocktext;
