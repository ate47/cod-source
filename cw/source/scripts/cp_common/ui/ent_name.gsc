...
function private _think()
{
    ...
    scripted_widgets::create( #"entname", #"hash_1624d8814bab0c71" );
    name = #"";
    team = 0;
    scripted_widgets::set_text( #"entname", name );
    scripted_widgets::set_state( #"entname", team );
    ...
    scripted_widgets::remove( #"entname" );
    _cleanup();
}
