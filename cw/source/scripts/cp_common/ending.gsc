...
function function_b029aa08()
{
    ...
    level thread function_7c927add( #"cp_ending_qasim" );
...
function function_a3694b1c()
{
    ...
    level thread function_7c927add( #"cp_ending_volkov" );
...
function function_eeb15395()
{
    ...
    {
        case 0:
            level thread function_7c927add( #"cp_ending_lazar" );
            level flag::clear( "flag_video_finished" );
            break;
        case 1:
            level thread function_7c927add( #"cp_ending_park" );
            level flag::clear( "flag_video_finished" );
            break;
        case 2:
...
{
    level function_7c927add( #"cp_ending_lazar" );
    level flag::clear( "flag_video_finished" );
    waitframe( 1 );
    level thread function_7c927add( #"cp_ending_park" );
    level flag::clear( "flag_video_finished" );
...
function function_52e90476()
{
    ...
    level thread function_7c927add( #"cp_ending_chaos" );
    level flag::clear( "flag_video_finished" );
...
{
    level thread function_7c927add( #"cp_ending_red_circus" );
    level flag::clear( "flag_video_finished" );
