...
function function_4c2d4fc4( message, title = #"", var_9696a2d = 0, var_db331a85 = #"", type = 0, var_c18a5a8b, var_9763e3fa, var_ad825676 = 1, var_572eedec )
{
    ...
    if ( scripted_widgets::exists( #"hint_tutorial" ) )
    {
    ...
    if ( !scripted_widgets::exists( #"hint_tutorial" ) )
    {
        ...
        scripted_widgets::create( #"hint_tutorial", var_48bf6e66 );
        scripted_widgets::function_46df0bc7( #"hint_tutorial", 100 );
    }
    ...
    scripted_widgets::function_9ade1d9b( #"hint_tutorial", "description", message );
    scripted_widgets::function_9ade1d9b( #"hint_tutorial", "title", title );
    scripted_widgets::function_9ade1d9b( #"hint_tutorial", "demoWidgeType", var_9696a2d );
    scripted_widgets::function_9ade1d9b( #"hint_tutorial", "callToAction", var_db331a85 );
    scripted_widgets::function_9ade1d9b( #"hint_tutorial", "type", type );
    scripted_widgets::function_9ade1d9b( #"hint_tutorial", "delayAndFadeTime", -1 );
    scripted_widgets::function_9ade1d9b( #"hint_tutorial", "pause", 0 );
    ...
    scripted_widgets::function_d3c3e5c3( #"hint_tutorial", [ #"interactive_map", #"dialog_tree", #"computer" ] );
...
function private function_142b2d59( var_572eedec )
{
    ...
    for ( line_num = 0; line_num < var_572eedec.size ; line_num++ )
    {
        ...
        scripted_widgets::function_f2a9266( #"hint_tutorial", line_num, "text", title );
        
        if ( !player flag::get( var_cb93cf14 ) || !isdefined( var_88c2ece ) )
        {
            scripted_widgets::function_f2a9266( #"hint_tutorial", line_num, "button_text", options );
        }
        else
        {
            scripted_widgets::function_f2a9266( #"hint_tutorial", line_num, "button_text", var_88c2ece );
        }
...
function private function_feebc7c2( data, line_num )
{
    ...
    while ( scripted_widgets::exists( #"hint_tutorial" ) )
    {
        if ( var_6d381b22 )
        {
        ...
        if ( var_6d381b22 )
        {
            scripted_widgets::function_f2a9266( #"hint_tutorial", line_num, "button_text", data.var_88c2ece );
            continue;
        }
        
        scripted_widgets::function_f2a9266( #"hint_tutorial", line_num, "button_text", data.options );
    }
}
...
function function_df08d48( var_72b185dd = 0 )
{
    if ( scripted_widgets::exists( #"hint_tutorial" ) )
    {
        scripted_widgets::function_9ade1d9b( #"hint_tutorial", "worldBlurAmount", var_72b185dd, 1 );
    }
}
...
function pause( var_1d470cc4 = #"ui_cancel", var_63d0d48f = #"hash_3f87d00d07eb799e", var_29fa9286 = 2, var_f191bdbc, var_37e3f2b0, var_415dea5d = 1 )
{
    ...
    if ( scripted_widgets::exists( #"hint_tutorial" ) )
    {
        ...
        scripted_widgets::set_focus( #"hint_tutorial", 1 );
        scripted_widgets::function_9ade1d9b( #"hint_tutorial", "pausePromptCancelMessage", var_63d0d48f );
        scripted_widgets::function_9ade1d9b( #"hint_tutorial", "input", var_1d470cc4 );
        scripted_widgets::function_24e5fa63( #"hint_tutorial", var_1d470cc4, 1 );
        player thread clientfield::set_to_player( "hint_pause_state", 1 );
        waitframe( 2 );
        scripted_widgets::function_9ade1d9b( #"hint_tutorial", "pause", var_29fa9286 );
...
function function_9f427d88( var_67df10fb = 1, var_f191bdbc )
{
    ...
    if ( scripted_widgets::exists( #"hint_tutorial" ) )
    {
        scripted_widgets::function_9ade1d9b( #"hint_tutorial", "delayAndFadeTime", var_67df10fb );
    }
    ...
    if ( scripted_widgets::exists( #"hint_tutorial" ) )
    {
        scripted_widgets::set_focus( #"hint_tutorial", 0 );
        scripted_widgets::remove( #"hint_tutorial" );
    }
...
function function_57a24ab5( visible )
{
    if ( scripted_widgets::exists( #"hint_tutorial" ) )
    {
        if ( is_true( visible ) )
        {
            scripted_widgets::function_f96376c5( #"hash_4672994c342b7571" );
            return;
        }
        
        scripted_widgets::hide_widgets( #"hash_4672994c342b7571", #"hint_tutorial" );
    }
}
