...
function private function_65b0a754()
{
    ...
    while ( level.var_464843f.size > 0 )
    {
        ...
        if ( scripted_widgets::exists( #"challengesplash" ) )
        {
            scripted_widgets::remove( #"challengesplash" );
        }
        
        scripted_widgets::create( #"challengesplash", #"hash_367f58e18cde1c9e" );
        scripted_widgets::function_d3c3e5c3( #"challengesplash", [ #"dialog_tree", #"interactive_map", #"computer" ] );
        scripted_widgets::function_9ade1d9b( #"challengesplash", "text", hash( var_21e736f9 ) );
        scripted_widgets::function_9ade1d9b( #"challengesplash", "desc", hash( challengedesc ) );
        scripted_widgets::function_9ade1d9b( #"challengesplash", "count", challengexp );
        player = getplayers()[ 0 ];
...
function function_18b65152()
{
    ...
    if ( var_80b995df > 0 )
    {
        ...
        {
            challenge_data = tablelookuprow( #"gamedata/stats/cp/statsmilestones1.csv", i );
