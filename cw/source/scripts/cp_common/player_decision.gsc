...
// Size: 0x122
function function_6efc0ff8( mission_ref, var_2b7725a )
{
    assert( var_2b7725a >= 0 && var_2b7725a < 10 );
    current_mission = savegame::function_8136eb5a();
    
    if ( mission_ref == current_mission )
    {
        var_6c8b1954 = savegame::function_6440b06b( #"transient" );
    ...
    player = getplayers()[ 0 ];
    return player stats::get_stat( #"mapdata", mission_ref, #"hash_43a738b893199779", var_2b7725a );
}
