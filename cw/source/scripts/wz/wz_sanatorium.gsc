...
function function_a387f4f5()
{
    if ( level.basegametype == #"fireteam_dirty_bomb" || level.basegametype == #"fireteam_elimination" || level.basegametype == #"fireteam_koth" || level.basegametype == #"fireteam_satlink" )
    {
        ...
        {
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_dacha", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_bathhouse", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_richhouse", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_islands", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_sanatorium", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_rentals", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_monument", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_restaurants", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_support", level.var_b9f31e66 );
        }
    }
}
...
/#
    ...
    {
        a_str_types = array( #"veh_quad_player_wz_blk", #"hash_232abda4e81275f4", #"veh_quad_player_wz_grn", #"hash_2f8d60a5381870ee", #"veh_quad_player_wz_tan", #"veh_mil_ru_fav_heavy", #"vehicle_t9_mil_fav_light", #"hash_42b91f3544c1a9e1", #"vehicle_t9_mil_ru_heli_gunship_hind", #"hash_17e868e0ebf3c1d6", #"vehicle_motorcycle_mil_us_offroad", #"vehicle_t9_mil_us_boat_pgb_double_gun", #"vehicle_t9_mil_snowmobile", #"vehicle_t9_mil_ru_tank_t72", #"hash_2d32c08b862baa46", #"vehicle_t9_mil_ru_truck_light_player", #"vehicle_t9_mil_boat_tactical_raft", #"vehicle_t8_soviet_civ_sedan_midsize", #"vehicle_t9_mil_boat_jetski" );
    ...
    function function_b2775b52()
    {
        switch ( self.vehicletype )
        {
            ...
            case #"hash_17e868e0ebf3c1d6":
                return ( 1, 0, 0 );
            case #"vehicle_t9_mil_us_boat_pgb_double_gun":
                return ( 1, 0, 0 );
            case #"vehicle_t9_mil_boat_jetski":
            case #"vehicle_t9_mil_boat_tactical_raft":
                return ( 1, 1, 1 );
            ...
            case #"hash_42b91f3544c1a9e1":
                return ( 0, 1, 1 );
            case #"vehicle_t8_soviet_civ_sedan_midsize":
