...
function function_a387f4f5()
{
    if ( level.basegametype == #"fireteam_dirty_bomb" || level.basegametype == #"fireteam_elimination" || level.basegametype == #"fireteam_koth" || level.basegametype == #"fireteam_satlink" )
    {
        ...
        {
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_gorge", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_icbm", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_bootcamp", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_silos", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_farm", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_cargo", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_trestle", level.var_b9f31e66 );
        }
    }
}
