...
function function_a387f4f5()
{
    if ( level.basegametype == #"fireteam_dirty_bomb" || level.basegametype == #"fireteam_elimination" || level.basegametype == #"fireteam_koth" || level.basegametype == #"fireteam_satlink" )
    {
        ...
        {
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_lodge", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_medevac", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_maintenance", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_hilltop", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_bathhouse", level.var_b9f31e66 );
            level thread [[ level.var_574cc797 ]]( #"dirty_bomb_stash_ski_slopes", level.var_b9f31e66 );
        }
    }
}
