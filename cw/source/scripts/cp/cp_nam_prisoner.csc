...
function postload()
{
    level._effect[ #"player_flashlight" ] = #"hash_194e390fb626282e";
    function_bdab05e9();
}
...
function function_70723e25( localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump )
{
    if ( bwastimejump )
    {
        ...
        {
            self.var_d392b4d1 = playfxoncamera( fieldname, level._effect[ #"player_flashlight" ], ( 4, 6, 8 ), ( 1, -0.05, -0.1 ), ( 0, 0, 1 ) );
            waitframe( 1 );
...
function force_stream_weapons( localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump )
{
    ...
    switch ( bwasdemojump )
    {
        case 1:
            ...
            break;
        case 2:
            weapons[ weapons.size ] = getweapon( #"special_recurvebow_t9" );
