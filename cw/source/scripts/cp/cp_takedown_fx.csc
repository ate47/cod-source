...
{
    vehicle::add_vehicletype_callback( #"vehicle_t9_civ_truck_4x4_cp_nophysics", &function_54f94439 );
    vehicle::add_vehicletype_callback( #"vehicle_t9_drone_recon_sp", &function_5f6bf482 );
    vehicle::add_vehicletype_callback( #"vehicle_t9_mil_air_transport", &function_d7fc17ab );
}
