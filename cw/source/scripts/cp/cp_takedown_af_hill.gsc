...
function main( var_d3440450, *var_50cc0d4f )
{
    ...
    level waittill( #"start_sniping", #"unload_badguy" );
...
function function_32398bfb( player )
{
    ...
    var_ca71a1c8 = "black";
    thread scripted_widgets::function_28027c42( #"hash_4fe4ea6c5e05ffb7" );
    ...
    scripted_widgets::function_4279fd02( #"hash_4fe4ea6c5e05ffb7" );
    waitframe( 1 );
}
...
{
    thread function_94c3f34a( #"crate_large_01", a_ents );
    thread function_94c3f34a( #"crate_small_01", a_ents );
}
...
{
    level.var_2124e12b = a_ents[ #"crate_small_02" ];
...
{
    level endon( #"af_car_stopped" );
    targ = getent( "car_look_point", "targetname" );
    level waittill( #"start_look_for_car" );
    thread function_d75e55a1( targ, "looked_at_car", 15 );
    level waittill( #"stop_look_for_car" );
