...
function function_243c9d46( player )
{
    ...
    level waittill( #"truck_lights_off" );
    waitframe( 1 );
    ...
    level waittill( #"plane_crash_anim_done" );
    wait 3;
...
{
    level waittill( #"start_plane_crash_sounds" );
    level notify( #"hash_6f65948492627624" );
    snd::client_msg( #"start_plane_crash_sounds" );
}
...
function function_e99dbb58( player )
{
    ...
    level waittill( #"plane_kill_player" );
