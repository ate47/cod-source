...
function main( var_d3440450, *var_50cc0d4f )
{
    ...
    level thread lui::play_movie( #"cp_takedown_zippo_flame", "fullscreen", 1, 0, 0 );
    wait 0.5;
    ...
    level waittill( #"player_intro_bar_done" );
...
{
    level waittill( #"hand_slam_rumble" );
...
{
    var_72a058bb = a_ents[ #"player_photo_01" ];
    var_9868a44f = a_ents[ #"player_photo_02" ];
...
function function_ac208f44()
{
    ...
    level waittill( #"adler_part_1_done" );
    ...
    else
    {
        ...
        level waittill( #"adler_wait_enter_finished" );
    ...
    level waittill( #"adler_part_2_done" );
...
function function_e2d2754d( a_ents )
{
    ...
    if ( isdefined( a_ents[ #"meet_table" ] ) )
    {
        a_ents[ #"meet_table" ] sethighdetail( 1 );
    }
    ...
    if ( isdefined( a_ents[ #"waitress" ] ) )
    {
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"waitress" ];
        a_ents[ #"waitress" ] sethighdetail( 1 );
    }
    ...
    {
        a_ents[ #"civ1" ] setmodel( #"c_t9_net_civ_male_urban_06" );
    ...
    {
        a_ents[ #"civ2" ] setmodel( #"c_t9_net_civ_female_urban_04b" );
    ...
    {
        a_ents[ #"civ3" ] setmodel( #"c_t9_net_civ_male_urban_01" );
        level.civ3 = a_ents[ #"civ3" ];
        level.civ3 notsolid();
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ3" ];
    }
    
    if ( isdefined( a_ents[ #"civ4" ] ) )
    {
        a_ents[ #"civ4" ] setmodel( #"c_t9_net_civ_male_urban_04b" );
        level.civ4 = a_ents[ #"civ4" ];
        level.civ4 notsolid();
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ4" ];
    }
    
    if ( isdefined( a_ents[ #"civ5" ] ) )
    {
        a_ents[ #"civ5" ] setmodel( #"c_t9_net_civ_male_urban_bartender_01" );
        level.civ5 = a_ents[ #"civ5" ];
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ5" ];
    }
    
    if ( isdefined( a_ents[ #"civ6" ] ) )
    {
        a_ents[ #"civ6" ] setmodel( #"c_t9_net_civ_female_urban_05" );
        level.var_41376757 = a_ents[ #"civ6" ];
        level.var_41376757 notsolid();
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ6" ];
    }
    
    if ( isdefined( a_ents[ #"civ7" ] ) )
    {
        a_ents[ #"civ7" ] setmodel( #"c_t9_net_civ_female_urban_03" );
        level.var_33884bf9 = a_ents[ #"civ7" ];
        level.var_33884bf9 notsolid();
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ7" ];
    }
    
    if ( isdefined( a_ents[ #"civ8" ] ) )
    {
        a_ents[ #"civ8" ] setmodel( #"c_t9_net_civ_female_urban_02c" );
        level.var_2cb2be4e = a_ents[ #"civ8" ];
        level.var_2cb2be4e notsolid();
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ8" ];
    }
    
    if ( isdefined( a_ents[ #"civ9" ] ) )
    {
        a_ents[ #"civ9" ] setmodel( #"c_t9_net_civ_male_urban_07" );
        level.var_f0282ee = a_ents[ #"civ9" ];
        level.var_f0282ee notsolid();
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ9" ];
    }
    
    if ( isdefined( a_ents[ #"civ10" ] ) )
    {
        a_ents[ #"civ10" ] setmodel( #"c_t9_net_civ_male_urban_08" );
        level.var_65f41fdf = a_ents[ #"civ10" ];
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ10" ];
    }
    
    if ( isdefined( a_ents[ #"civ11" ] ) )
    {
        a_ents[ #"civ11" ] setmodel( #"c_t9_net_civ_female_urban_06" );
        level.var_37c2c37d = a_ents[ #"civ11" ];
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ11" ];
    }
    
    if ( isdefined( a_ents[ #"civ12" ] ) )
    {
        a_ents[ #"civ12" ] setmodel( #"c_t9_net_civ_male_urban_09" );
        level.var_8166d6c4 = a_ents[ #"civ12" ];
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ12" ];
    }
    
    if ( isdefined( a_ents[ #"civ13" ] ) )
    {
        a_ents[ #"civ13" ] setmodel( #"hash_426c766ef4c2475d" );
        level.var_9330fa58 = a_ents[ #"civ13" ];
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ13" ];
    }
    
    if ( isdefined( a_ents[ #"civ14" ] ) )
    {
        level.var_9c278c41 = a_ents[ #"civ14" ];
        level.var_66d27402[ level.var_66d27402.size ] = a_ents[ #"civ14" ];
    }
    ...
    level thread function_fa84c01d( level.civ5 );
