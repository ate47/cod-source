...
function main( var_d3440450, var_50cc0d4f )
{
    ...
    level waittill( #"capture_fade_out" );
...
{
    level waittill( #"slam_qasim_rumble" );
...
function function_86b6bafa()
{
    ...
    self waittill( #"dialog_tree_scene_response_complete" );
