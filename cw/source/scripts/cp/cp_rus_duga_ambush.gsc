...
function ambush_vehicles()
{
    ...
    snd::stop_on_ent_death( obj, gunship );
}
...
function function_9ea2e3bb( ents )
{
    ...
    if ( isdefined( ents[ #"enemy05" ] ) )
    {
        util::magic_bullet_shield( ents[ #"enemy05" ] );
        ents[ #"enemy05" ] setteam( #"allies" );
        ents[ #"enemy05" ] colors::set_force_color( "y" );
    }
...
{
    self endon( #"death" );
    self waittill( #"ambush_damage_player" );
    ...
    self waittill( #"ambush_damage_on_your_feet" );
...
function function_e8412d98( a_ents )
{
    ...
    var_1b36c4d5 = spawnweapon( w, a_ents[ #"player_ak" ].origin, a_ents[ #"player_ak" ].angles, 0 );
    a_ents[ #"player_ak" ] hide();
    a_ents[ #"player_ak" ] setcontents( 0 );
    var_1b36c4d5 linkto( a_ents[ #"player_ak" ] );
}
