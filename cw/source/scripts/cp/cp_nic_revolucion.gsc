...
function function_47b8b88()
{
    ...
    self thread flashback_tv::function_15eaa2db( undefined, undefined, "flg_player_approach_flashback_tv", "flg_player_not_near_flashback_tv", "flashback_tv_lookat", "flashback_tv_screen", "flashback_tv_light", #"hash_1dbc4e0cabb8c63f" );
...
{
    self endon( #"death" );
    level endon( #"flg_rifle_exit_done" );
