...
function main( var_d3440450, *var_50cc0d4f )
{
    ...
    level lui::play_movie( #"cp_takedown_transition_to_airfield", "fullscreen", 1, 0, 0, #"", 20 );
    ...
    level waittill( #"start_scale_player_speed" );
...
{
    level waittill( #"start_follow_obj" );
...
{
    player = getplayers()[ 0 ];
    level waittill( #"swap_body_blood1" );
}
