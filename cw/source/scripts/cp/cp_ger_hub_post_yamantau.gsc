...
{
    level.adler waittill( #"dialog_tree_vo_response_complete", #"dialog_tree_scene_response_complete" );
...
{
    if ( level.player flashback_tv::function_e538e340( "tv_flashback_safehouse_video" ) )
    {
...
{
    level.park waittill( #"dialog_tree_vo_response_complete", #"dialog_tree_scene_response_complete" );
...
function function_708ca96d()
{
    ...
    level.lazar waittill( #"dialog_tree_vo_response_complete", #"dialog_tree_scene_response_complete" );
    level dialog_tree::function_21780fc5( level.var_b91aa91b, self.var_ba1eee16.var_30dc5656 );
