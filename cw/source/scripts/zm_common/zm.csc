...
function private function_21a32a4d( localclientnum, player )
{
    ...
    if ( isdefined( self.districts_on ) && !isdefined( self.var_378658bb ) )
    {
        self.var_378658bb = strtok( self.districts_on, "," );
    }
    
    if ( isdefined( self.districts_off ) && !isdefined( self.var_8c564d0c ) )
    {
        self.var_8c564d0c = strtok( self.districts_off, "," );
    }
    ...
    while ( true )
    {
        ...
        else if ( player === level.var_bb4264e3 && is_true( self.b_chopper_gunner_force_districts ) )
        {
            function_96330020( self.var_8c564d0c );
            var_5571852a = 0;
...
// Size: 0x1d0
function private function_96330020( districts_on, districts_off )
{
    if ( !isdefined( districts_on ) )
    {
        districts_on = [];
    }
    else if ( !isarray( districts_on ) )
    {
        districts_on = array( districts_on );
    }
    
    if ( !isdefined( districts_off ) )
    {
        districts_off = [];
    }
    else if ( !isarray( districts_off ) )
    {
        districts_off = array( districts_off );
    }
    
    foreach ( district in districts_on )
    {
        function_e8f072a1( district, 1 );
        function_3cfb0b1d( district, 1 );
    }
    
    foreach ( district in districts_off )
    {
