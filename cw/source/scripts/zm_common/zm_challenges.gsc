...
function function_f807c679( e_attacker, e_inflictor )
{
    ...
    var_bbfa9bda = { #weapon_item:weapon_item, #var_7c9dadeb:e_attacker zm_perks::function_9a0e9d65(), #var_611eda49:e_attacker zm_perks::function_80514167(), #instakill_active:e_attacker zm_powerups::is_insta_kill_active() };
    ...
    if ( zm_utility::is_player_valid( e_attacker, 0, 0 ) )
    {
        ...
        {
            e_attacker zm_stats::increment_challenge_stat( #"distracted_kills" );
...
function function_4281b2f1( *params )
{
    ...
    item2 = self.inventory.items[ 17 + 1 + 8 + 1 ];
    weapon1 = item_inventory_util::function_2b83d3ff( item1 );
    weapon2 = item_inventory_util::function_2b83d3ff( item2 );
    
    if ( isdefined( item1 ) && isdefined( weapon1 ) && isdefined( item2 ) && isdefined( weapon2 ) )
    {
        if ( item1.paplv === 3 && isdefined( item1.aat ) && item2.paplv === 3 && isdefined( item2.aat ) )
        {
    ...
    while ( true )
    {
        ...
        switch ( s_result.var_16c042b8 )
        {
            ...
            case #"talent_juggernog":
                self.var_bd0352a9[ #"talent_juggernog" ] = 1;
            ...
            case #"talent_tombstone_3":
                self.var_bd0352a9[ #"talent_tombstone" ] = 1;
        ...
        if ( var_fff94a73 === 1 && self.var_bd0352a9[ #"talent_elemental_pop" ] === 1 || var_317c380d === 1 && self.var_bd0352a9[ #"talent_staminup" ] === 1 || var_a47cc4dd === 1 && self.var_bd0352a9[ #"talent_juggernog" ] === 1 || var_325628d7 === 1 && self.var_bd0352a9[ #"talent_doubletap" ] === 1 || var_32feae61 === 1 && self.var_bd0352a9[ #"talent_deadshot" ] === 1 || var_6d1d99a3 === 1 && self.var_bd0352a9[ #"talent_quickrevive" ] === 1 || var_1a8aaae7 === 1 && self.var_bd0352a9[ #"talent_speedcola" ] === 1 || var_169c7afa === 1 && self.var_bd0352a9[ #"talent_tombstone" ] === 1 )
        {
...
function function_c8cf642e()
{
    ...
    if ( isplayer( player ) && !is_true( player.var_b9ff264c ) )
    {
        ...
        if ( is_true( level.is_survival ) && isdefined( level.star_rating ) && level.star_rating >= 10 )
        {
...
function t9_tu5_zm_hunter_mastery_fixup()
{
    ...
    if ( var_845ac04e != 1 )
    {
        ...
        var_c92e42cb = self stats::get_stat( #"playerstatslist", #"elite_kills", #"challengetier" );
        ...
        var_a391451e = self stats::get_stat( #"playerstatslist", #"distracted_kills", #"challengetier" );
...
function function_4e5de0a2()
{
    ...
    if ( !is_true( var_d585ec85 ) )
    {
        ...
        if ( var_3c362b22 > 0 )
        {
            self stats::function_622feb0d( #"frenzied_guard", #"uses", var_3c362b22 );
        }
