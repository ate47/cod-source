...
function function_9dd8ba0b( weapon_name )
{
    switch ( weapon_name )
    {
        ...
        case #"energy_mine_3":
        case #"energy_mine_1":
            self zm_stats::increment_challenge_stat( #"field_upgrade_kills" );
            break;
    }
}
...
{
    outcome = { #var_c1e98979:0, #var_68c25772:1, #var_7d5c2c5f:0, #var_277c7d47:1, #title_text:game.strings[ #"defeat" ], #team:#"axis", #players:[] };
    
    if ( isdefined( winner ) && winner == #"allies" )
    {
        outcome.title_text = game.strings[ #"victory" ];
        outcome.team = #"allies";
    }
