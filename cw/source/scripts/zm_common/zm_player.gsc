...
function function_3799b373( var_fb6fa3e1, var_bbbf9a69 = 0 )
{
    ...
    foreach ( e_player in a_e_players )
    {
        ...
        if ( e_player laststand::player_is_in_laststand() && e_player zm_laststand::function_618fd37e() <= 0 && !e_player namespace_791d0451::function_56cedda7( #"talent_quickrevive_5" ) && !is_true( e_player.var_5f465b1 ) && !is_true( e_player.var_1399a943 ) && !is_true( e_player.var_b895a3ff ) && !is_true( e_player.var_4db2872c ) )
        {
            var_2af2f14d = 1;
            continue;
        }
...
function player_damage_override( einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, var_fd90b0bb, vpoint, vdir, shitloc, psoffsettime )
{
    ...
    if ( self zm_laststand::function_618fd37e() > 0 || is_true( self.var_5f465b1 ) || self namespace_791d0451::function_56cedda7( #"talent_quickrevive_5" ) || self namespace_e86ffa8::function_33d837e4() || is_true( self.var_b895a3ff ) || is_true( self.var_4db2872c ) )
    {
        var_228d944 = 1;
    }
    else
