...
function function_b20199e0( var_57ade5da )
{
    ...
    if ( var_57ade5da === #"spawner_bo5_raz_sr_hvt" || var_57ade5da === #"spawner_bo5_mimic_hvt" || var_57ade5da === #"spawner_bo5_mechz_sr_hvt" )
    {
...
function onstartgametype()
{
    ...
    if ( util::get_game_type() === #"zonslaught_accelerated" || level.script === #"mp_dune" )
    {
        zm_cleanup::preinit();
        zm_cleanup::postinit();
...
{
    if ( util::get_game_type() === #"zonslaught" || util::get_game_type() === #"zonslaught_containment" )
    {
        return true;
    }
...
function function_82ca1565( spawnpoint, gametype )
{
    switch ( gametype )
    {
        ...
        case #"tdm_12v12":
            return is_true( spawnpoint.tdm_12v12 );
        case #"dom_12v12":
            return is_true( spawnpoint.dom_12v12 );
        case #"koth_12v12":
            return is_true( spawnpoint.koth_12v12 );
        default:
