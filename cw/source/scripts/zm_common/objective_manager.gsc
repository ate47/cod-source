...
function function_b06af8e3( destination, var_2923cf48, category, variant )
{
    ...
    if ( is_true( getdvarint( #"hash_c05968dc8f1a0f", 0 ) ) && category === #"hunt" && level.var_cf558bf < 1 )
    {
        ...
        {
            if ( s_instance.variant === #"hunt_abom" )
            {
                instance = s_instance;
                break;
            }
    ...
    else if ( !var_2923cf48 && level.var_cf558bf < 1 && ( category === #"hunt" || category === #"payload" ) )
    {
        foreach ( s_instance in instances )
        {
            if ( s_instance.variant !== #"hunt_abom" && s_instance.variant !== #"hunt_steiner" && s_instance.variant !== #"hunt_mechz" && s_instance.variant !== #"payload_teleport" )
            {
                instance = s_instance;
                break;
            }
...
function function_a8ad6895( destination, var_2923cf48 = 0 )
{
    foreach ( category in level.var_aaa6544c )
    {
        ...
        else if ( category === #"hunt_abom" || category === #"hunt_steiner" || category === #"hunt_mechz" || category === #"hunt_raz" || category === #"hunt_mimic" )
        {
            variant = category;
            category = #"hunt";
        }
        ...
        else if ( category === #"holdout_alt" || category === #"holdout_prime" )
        {
            variant = category;
            category = #"holdout";
        }
...
{
    a_s_models = [];
    a_s_models = instance.contentgroups[ #"interact_dressing" ];
...
function private function_fa47c63e( scriptname )
{
    ...
    {
        player luinotifyevent( #"hash_5159e35a62fb7083", 3, 0, var_5fc990bf, level.star_rating );
    }
}
...
function function_9d4e6125( scriptname )
{
    ...
    foreach ( player in players )
    {
        player luinotifyevent( #"hash_5159e35a62fb7083", 3, 2, var_5fc990bf, level.star_rating );
    }
}
    ...
    function function_7a7ab1a2( params )
    {
        ...
        switch ( tokens[ 0 ] )
        {
            case #"hash_f6faed38fbaaaa5":
                ...
                foreach ( player in getplayers() )
                {
                    player luinotifyevent( #"hash_5b1ff06d07e9002a", 3, 2, level.star_rating, 0 );
                }
