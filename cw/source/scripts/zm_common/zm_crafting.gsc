...
function setup_tables()
{
    ...
    foreach ( trigger in var_c443493d )
    {
        ...
        if ( !isdefined( level.var_4fe2f84d[ blueprint_list ] ) )
        {
            level.var_4fe2f84d[ blueprint_list ] = [];
        }
        ...
        else if ( !isarray( level.var_4fe2f84d[ blueprint_list ] ) )
        {
            level.var_4fe2f84d[ blueprint_list ] = array( level.var_4fe2f84d[ blueprint_list ] );
        }
        
        if ( !isinarray( level.var_4fe2f84d[ blueprint_list ], unitrigger ) )
        {
            level.var_4fe2f84d[ blueprint_list ][ level.var_4fe2f84d[ blueprint_list ].size ] = unitrigger;
        }
    ...
    if ( !isdefined( level.crafting_components[ component.name ] ) )
    {
        if ( component == level.weaponnone )
        {
            /#
                ...
                if ( isdefined( blueprint_name ) )
                {
                    blueprint_name = function_9e72a96( blueprint_name );
                }
            #/
            
            assertmsg( "<dev string:xc3>" + ( isdefined( component_name ) ? component_name : "<dev string:xe3>" ) + "<dev string:xf0>" + ( isdefined( blueprint_name ) ? blueprint_name : "<dev string:xe3>" ) );
        }
