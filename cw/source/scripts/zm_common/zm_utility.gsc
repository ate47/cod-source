...
function get_closest_valid_player( origin, ignore_player = array(), var_b106b254 = 0 )
{
    ...
    if ( !( isdefined( player.last_valid_position ) && isdefined( var_3bd0e427 ) ) || !isdefined( player getgroundent() ) && !player isonladder() && var_3d3d6684 != 0 || distancesquared( player.last_valid_position, player.origin ) < ( isdefined( self.var_154478e3 ) ? self.var_154478e3 : sqr( var_3d3d6684 + 45 ) ) && abs( var_3bd0e427 - player.origin[ 2 ] ) < ( isdefined( self.var_737e8510 ) ? self.var_737e8510 : level.var_376e688 ) && ( is_true( level.var_9f01688e ) || !is_true( player.cached_zone_volume.is_unreachable_area ) ) )
    {
...
function function_ff902863( var_6cc77d4e = level.var_e63703cd[ n_obj_id ].var_6cc77d4e, n_obj_id, var_3a9f00e9 = 1 )
{
    ...
    function_92d1707f( #"dlog_event_zm_objectives", s_objective );
}
...
function function_e3025ca5()
{
    if ( is_survival() )
    {
        var_3afe334f = level.star_rating;
    }
    else if ( function_c200446c() )
    {
        ...
        if ( util::get_game_type() === #"zonslaught_elite" )
        {
...
function get_round_number( var_ec585b8 = 0 )
{
    if ( is_survival() )
    {
        ...
        else if ( level.star_rating - 1 >= var_88710b09.size )
        {
            n_round_number = isdefined( var_88710b09[ var_88710b09.size - 1 ].round ) ? var_88710b09[ var_88710b09.size - 1 ].round : 100;
        }
        else
        {
            n_round_number = isdefined( var_88710b09[ level.star_rating - 1 ].round ) ? var_88710b09[ level.star_rating - 1 ].round : 0;
        }
    }
    else if ( function_c200446c() )
    {
...
function function_5d356609( aat_name, n_tier )
{
    if ( isplayer( self ) && isdefined( aat_name ) )
    {
        ...
        self function_678f57c8( #"dlog_event_zm_ammo_mod_proc", var_f35f3f4b );
    }
}
