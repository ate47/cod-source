    ...
    while ( true )
    {
        ...
        if ( zoom_frac != 0 && ( zoom_frac < 0 && var_cbcfc238 > 14.64 || zoom_frac > 0 && var_cbcfc238 < 200 ) )
        {
            ...
            if ( !var_c846ce25 && abs( var_546112ef[ 1 ] ) > 0 )
            {
                ...
                if ( !level.var_14094ff8.var_c5c03b2 )
                {
                    self playsound( localclientnum, #"gdt_spy_camera_zoom_start" );
                }
                else
                {
            ...
            if ( isdefined( self.var_1523fda0 ) )
            {
                ...
                zoom_min = snd::scalerp( var_cbcfc238, 15, 30, 0.3, 1 );
                zoom_max = snd::scalerp( var_cbcfc238, 150, 200, 1, 0.2 );
                var_a44cc3b9 *= min( zoom_min, zoom_max );
                var_28bd232a *= min( zoom_min, zoom_max );
        ...
        else if ( var_c846ce25 )
        {
            ...
            if ( !level.var_14094ff8.var_c5c03b2 )
            {
                self playsound( localclientnum, #"gdt_spy_camera_zoom_stop" );
            }
            else
            {
