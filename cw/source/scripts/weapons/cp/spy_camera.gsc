            ...
            else if ( self isgestureplaying( ads_gesture ) && gettime() > var_4308b3d8 )
            {
                ...
                if ( var_a05f9c5f != 1 )
                {
                    ...
                    if ( var_c5c03b2 )
                    {
                        ...
                        scripted_widgets::create( #"binoculars", #"hash_1703896731dc6998" );
                    }
        ...
        else if ( was_ads )
        {
            ...
            if ( var_a05f9c5f != 0 )
            {
                ...
                if ( var_c5c03b2 )
                {
                    ...
                    scripted_widgets::remove( #"binoculars" );
                }
            ...
            self notify( #"end_camera_ads_begin" );
...
{
    self endon( #"end_camera_ads_begin", #"ability_deactivated_camera", #"death" );
...
function private function_d704edcd( *var_c5c03b2 )
{
    ...
    if ( scripted_widgets::exists( #"binoculars" ) )
    {
        self clientfield::set_to_player( "binoculars_overlay", 0 );
        scripted_widgets::remove( #"binoculars" );
    }
...
function private function_2d8ba5c4()
{
    ...
    while ( true )
    {
        ...
        if ( is_true( level.var_e3f5eafc.var_f91a82ef ) && var_496bb3bc >= level.var_e3f5eafc.var_3a0d6cd6 && !self scene::function_c935c42() && !self flag::get( #"lockpicking" ) )
        {
            ...
            self waittill( #"begin_camera_ads" );
