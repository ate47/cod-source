...
function function_2d00376()
{
    ...
    if ( isdefined( vehicle.session ) )
    {
        ...
        function_92d1707f( #"dlog_event_match_data_warzone_vehicle", vehicle.session );
...
function private function_f442b1c()
{
    ...
    foreach ( vehicle in level.vehicle_tracking )
    {
        ...
        {
            function_92d1707f( #"dlog_event_match_data_warzone_vehicle_spawn", #"entries", var_e61d6eb0 );
            var_e61d6eb0 = [];
            wait 0.1;
        }
    }
...
// Size: 0x54
function private function_b5220c3c( hornname )
{
    if ( isdefined( self.var_f04b2790 ) && self.var_f04b2790 == hornname )
    {
        return;
    }
    
    self.var_f04b2790 = hornname;
    self function_3e79d199( hornname );
}
...
function private function_92bb5a6f( vehicle, oldseatindex )
{
    ...
    hornname = self function_9497b7cb( vehicle.vehicleassembly );
    
    if ( isdefined( hornname ) && hornname != #"" )
    {
        vehicle function_b5220c3c( hornname );
    }
}
