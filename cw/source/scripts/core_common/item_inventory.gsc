...
function function_bef83dc6()
{
    ...
    function_92d1707f( #"dlog_event_match_data_warzone_armor", self.var_3f1410dd );
...
function function_c4468806( player, item )
{
    ...
    function_92d1707f( #"dlog_event_match_data_warzone_consumable", data );
}
...
// Size: 0x34c
function function_d92c6b5b( currentweapon, var_b681f360, n_pap_level, item )
{
    self endon( #"death" );
