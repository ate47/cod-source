...
function function_2798ed66()
{
    ...
    if ( !isdefined( self.var_77b06e7a ) && isdefined( self.script_vehiclecovernode ) )
    {
        ...
        {
            assert( isdefined( node.script_vehiclecovernodetag ), "<dev string:x3b8>" + node.origin + "<dev string:x3d7>" );
            array::add( self.var_77b06e7a, node, 0 );
            tag_origin = self gettagorigin( node.script_vehiclecovernodetag );
            tag_angles = self gettagangles( node.script_vehiclecovernodetag );
