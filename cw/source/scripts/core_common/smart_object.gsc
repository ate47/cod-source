...
function private function_b3ec7529()
{
    ...
    foreach ( obj in smartobjectpoints )
    {
        ...
        if ( !isdefined( obj.script_valid_demeanor ) )
        {
            obj.script_valid_demeanor = "patrol";
        }
        
        if ( !isdefined( obj.script_use_flashlight ) )
        {
            obj.script_use_flashlight = 0;
        }
...
function private function_27844fc( debounce )
{
    ...
    if ( !isdefined( self.script_debounce ) )
    {
        self.script_debounce = -1;
    }
    
    self.nextusetime = isdefined( debounce ) ? debounce : self.script_debounce;
...
function function_5e77c231( ai )
{
    ...
    if ( !is_true( self.script_no_reach ) && isdefined( intro ) && distancesquared( intro.origin, ai.origin ) > sqr( 4 + 1 ) )
    {
...
function can_use( obj )
{
    ...
    if ( isai( self ) && obj.script_valid_demeanor != self ai::get_behavior_attribute( "demeanor" ) )
    {
        return false;
    }
...
function function_ab981ed( desiredpos, volume, var_ce60cc2e, var_2889f642 = 0 )
{
    ...
    allsmartobjects = arraysortclosest( level.smartobjectpoints, desiredpos );
...
function function_a49ba261( startpos, endpos, region, volume, var_9da4df29, var_aea7aa5b, var_a3a26744 )
{
    ...
    /#
        drawtime = 40;
        bdrawdebug = getdvarint( #"hash_6c470450dd7dffd2", -1 ) == self getentitynumber();
    ...
    foreach ( obj in region.smart_objects )
    {
        ...
        distdownline = vectordot( starttoenddir, var_5c084b53 );
        
        if ( distdownline < var_9da4df29 )
        {
            /#
                if ( bdrawdebug )
                {
        ...
        if ( distdownline > linelen + var_d01a742 )
        {
            /#
                if ( bdrawdebug )
                {
        ...
        distfromline = abs( vectordot( starttoendnormal, var_5c084b53 ) );
        
        if ( distfromline * distfromline > obj.var_2edb5d76 )
        {
            /#
                if ( bdrawdebug )
                {
        ...
        adjustedlinelen = linelen - var_9da4df29;
        var_1f6e7bb3 = distdownline - var_9da4df29;
        ...
        {
            adjustedlinelen = linelen - var_aea7aa5b + var_d01a742;
            var_1f6e7bb3 = distdownline - var_aea7aa5b;
            score = var_fafda79b + var_c7d9d665 * ( adjustedlinelen - var_1f6e7bb3 ) / adjustedlinelen;
        }
        
        if ( distfromline > var_26653e4b )
        {
            distfrompreferred = distfromline - var_26653e4b;
            score *= var_b11744c0 + ( 1 - distfrompreferred / ( var_fbf46d73 - var_26653e4b ) ) * ( 1 - var_b11744c0 );
        }
...
function function_2677ed08( smartobj )
{
    ...
    self.flashlightoverride = smartobj.script_use_flashlight;
    self.var_3ed929ba = smartobj.script_use_flashlight;
