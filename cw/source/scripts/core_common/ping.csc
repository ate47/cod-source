...
function private function_78827e7f( params )
{
    ...
    callouttext = params.callouttext;
    ...
    switch ( event_type )
    {
        ...
        case 12:
            ...
            break;
        case 17:
            function_4b08d302( local_client_num, var_56bcf423, callouttext );
            break;
        case 15:
            if ( 0 || !var_df55840 )
            {
...
function private function_effa0b37( local_client_num, unique_id, event_type, location, var_56bcf423, var_ec31db0f, var_d4f0ac6e, var_d09a35d4 )
{
    ...
    else
    {
        ...
        image = dynent.itemlistbundle.pingimage;
