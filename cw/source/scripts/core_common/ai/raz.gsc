...
// Size: 0x106
function private function_ca603f82( forward_dir, torpedo_pos, var_5107adf5, max_angle )
{
    vec_to_enemy = var_5107adf5 - torpedo_pos;
...
// Size: 0x234
function private function_4860f26d( torpedo_target, var_e6e4425 )
{
    torpedo_pos = self gettagorigin( "tag_weapon_right" );
    var_5107adf5 = torpedo_target.origin + var_e6e4425;
    var_36dbf72a = spawn( "script_model", torpedo_pos );
    ...
    vec_to_enemy = function_ca603f82( anglestoforward( self.angles ), torpedo_pos, var_5107adf5, 0.7 );
    ...
    var_36dbf72a thread function_8e224906( torpedo_target );
    var_36dbf72a thread function_265f547e( torpedo_target );
    var_36dbf72a thread function_328c7269( torpedo_target, var_e6e4425 );
}
...
function private function_8e224906( torpedo_target )
{
    ...
    {
        if ( !isdefined( torpedo_target ) || var_36dbf72a.var_90d59738 >= max_trail_iterations )
        {
            var_36dbf72a thread function_ddf221f2( 0 );
        }
        else
        {
            var_36dbf72a function_edb8ac3f( torpedo_target );
...
// Size: 0xbe
function private function_328c7269( torpedo_target, var_e6e4425 )
{
    self endon( #"death", #"detonated" );
    var_36dbf72a = self;
    
    while ( isdefined( var_36dbf72a ) && isdefined( torpedo_target ) )
    {
        var_5107adf5 = torpedo_target.origin + var_e6e4425;
...
// Size: 0x404
function private function_edb8ac3f( torpedo_target )
{
    self endon( #"death" );
    ...
    {
        var_30c2c6c3 = function_3848e282( torpedo_target );
...
// Size: 0x44
function private function_265f547e( torpedo_target )
{
    self endon( #"death" );
    self endon( #"detonated" );
    function_f95c27a2( torpedo_target );
}
...
// Size: 0x23c
function private function_a90fe496( torpedo_origin )
{
    players = getplayers();
    v_length = sqr( 100 );
