...
function function_9e93acd1()
{
    ...
    self callback::function_d8abfc3d( #"on_entity_revealed", &function_1ef44bfb );
    self.var_6f5b56f6 = 0;
    self.var_6467a1c = 0;
...
function private function_224f342a( player_anim, mimic, origin, angles )
{
    ...
    callback::callback( #"on_mimic_player_grab_start", { #player:player } );
    player val::set( #"ai_mimic_grab", "ignoreme", 1 );
    ...
    if ( isdefined( player ) )
    {
        callback::callback( #"on_mimic_player_grab_end", { #player:player } );
        ...
        player val::reset( #"ai_mimic_grab", "ignoreme" );
...
/#
    ...
    function function_bc75224c()
    {
        ...
        refresh_timer = int( 5 * 1000 );
        var_88f244b8 = 0;
        spawn_points = [];
        
        while ( true )
        {
            if ( gettime() >= var_88f244b8 + refresh_timer )
            {
    ...
    function private function_5ef9a937( point )
    {
        ...
        while ( i < 180 )
        {
            ...
            var_ed56107c = { #passed:passed, #mimic_pos:var_feb3dda6.origin, #var_dc11f544:var_f60dbcf6, #var_20f2bd48:var_d26e393f };
    ...
    function private function_ccc08aea( validation_info )
    {
        foreach ( var_ed56107c in validation_info.var_ed56107c )
        {
            ...
            line( var_ed56107c.mimic_pos, var_ed56107c.var_dc11f544, ( 1, 0, 1 ), 1, 0, 5 );
        }
    }
