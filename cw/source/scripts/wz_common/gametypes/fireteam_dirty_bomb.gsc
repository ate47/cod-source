...
function function_5757c66f()
{
    ...
    foreach ( bomb in level.dirtybombs )
    {
        ...
        if ( bomb.script_objective_set == var_2a0f16b1 )
        {
...
function function_18b08e66()
{
    ...
    foreach ( bomb in level.dirtybombs )
    {
        if ( !isdefined( level.var_d83e193a[ bomb.script_objective_set ] ) )
        {
            level.var_d83e193a[ bomb.script_objective_set ] = bomb.script_objective_set;
        }
    }
}
