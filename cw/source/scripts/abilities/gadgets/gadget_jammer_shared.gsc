...
function function_af165064()
{
    ...
    foreach ( key in var_5306fc83 )
    {
        ...
        hidecount = level.var_578f7c6d.var_5c3f49c1[ key ];
        entity clientfield::set( "isHiddenByFriendlyJammer", hidecount < 0 ? 0 : 1 );
    }
...
function function_2e6238c0( weapon, owner )
{
    ...
    {
        owner thread killstreak_dialog::play_taacom_dialog( taacomdialog );
    }
}
