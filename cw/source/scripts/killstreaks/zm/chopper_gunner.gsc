...
{
    if ( isdefined( level.chopper_gunner ) && level.chopper_gunner.owner === params.eattacker && params.weapon === getweapon( #"chopper_gunner_turret" ) )
    {
...
{
    if ( shitloc === self && psoffsettime == getweapon( #"chopper_gunner_turret" ) )
    {
        return 0;
    }
