        ...
        if ( damage_taken >= ( isdefined( bundle.kshealth ) ? bundle.kshealth : 100 ) )
        {
            ...
            if ( self.owner util::isenemyplayer( attacker ) )
            {
                ...
                if ( var_d63ac213 )
                {
                    ...
                    self killstreak_dialog::play_destroyed_dialog_on_owner( "straferun", self.killstreakid );
                }
            }
    ...
    for ( ;; )
    {
        ...
        if ( noteworthy == "wave_start" )
        {
            if ( isdefined( self ) && self.var_14494df9 === 1 && !is_true( self.leavenexttime ) )
            {
                ...
                {
                    self killstreak_dialog::play_pilot_dialog_on_owner( "waveStartFinal", "straferun", self.killstreakid );
                    continue;
                }
                
                self killstreak_dialog::play_pilot_dialog_on_owner( "waveStart", "straferun", self.killstreakid );
            }
        }
    }
}
...
function function_d4896942()
{
    ...
    while ( true )
    {
        ...
        {
            self killstreak_dialog::play_pilot_dialog_on_owner( "damageEvaded", "straferun", self.killstreakid );
        }
    }
}
...
function function_1fb394ba( owner )
{
    ...
    {
        self killstreak_dialog::play_pilot_dialog_on_owner( bdadialog, "straferun", self.killstreakid );
    }
...
function function_51f5c557( owner )
{
    ...
    killstreak_dialog::play_pilot_dialog_on_owner( "arrive", "straferun", self.killstreakid );
}
...
function leavemap( hardpointtype )
{
    ...
    if ( self.var_14494df9 === 1 )
    {
        self killstreak_dialog::play_taacom_dialog_response_on_owner( "timeoutConfirmed", "straferun", self.killstreakid );
    }
