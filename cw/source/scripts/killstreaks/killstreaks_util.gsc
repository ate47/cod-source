...
function function_16a1f9b6()
{
    ...
    {
        var_8756d70f = #"dlog_event_zmscorestreaks";
    }
    else
    {
        var_8756d70f = #"dlog_event_mpscorestreaks";
    }
...
function function_cb0594d5()
{
    if ( sessionmodeiszombiesgame() )
    {
        var_8756d70f = #"dlog_event_zmkillstreakuses";
    }
    else
    {
        var_8756d70f = #"dlog_event_mpkillstreakuses";
    }
