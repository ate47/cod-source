...
function private function_a4b36d9a()
{
    ...
    scripted_widgets::function_28027c42( #"ac130", [ #"hash_72cc4740fa4d3da3" ] );
    namespace_c8e236da::removelist();
    namespace_c8e236da::addprompt( #"hash_c7d583ff53f896" );
    namespace_c8e236da::addprompt( #"hash_6fca5ea0f3afc2a7" );
    namespace_c8e236da::addprompt( #"hash_5c839d11282c4b14" );
    
    if ( level.var_dab73f4a !== 1 )
    {
        namespace_c8e236da::addprompt( #"hash_43348d9c60568d3a" );
    }
    
    util::waittill_any_ents( level, "game_ended", player, "disconnect", player, "death", player, "gunner_left" );
    namespace_c8e236da::removelist();
    scripted_widgets::function_4279fd02( #"ac130" );
}
