...
function function_30e98aee()
{
    ...
    level.var_36f90a41 = [];
    level.var_65977c6 = 1;
    events = getscriptbundle( #"spy_credit_event" );
    ...
    if ( spy::function_3d83e588( 1 ) )
    {
        ...
        function_c329fcd3( #"counter_spy_plane", undefined, undefined, undefined, undefined, undefined, undefined, &function_9deb70f );
...
function private function_8764fdff( var_952fc2b4, role, var_229cbfe0, var_8bf10510, var_6cf359b7 )
{
    ...
    skill.var_3e32dc53 = isdefined( var_6669664.validtime ) ? var_6669664.validtime : 0;
...
function function_ec01c4ec( var_ada67e63 )
{
    ...
    self function_678f57c8( #"dlog_event_mp_spy_use_skill", var_9921e529 );
}
