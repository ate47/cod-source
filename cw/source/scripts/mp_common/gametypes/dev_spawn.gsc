...
/#
    ...
    function function_f084faed()
    {
        if ( !isdefined( level.var_2f11d3e5 ) )
        {
            ...
            level.var_2f11d3e5[ #"domination_flag_d" ] = "<dev string:x114>";
            level.var_2f11d3e5[ #"domination_flag_e" ] = "<dev string:x122>";
            level.var_2f11d3e5[ #"domination_flag_f" ] = "<dev string:x130>";
