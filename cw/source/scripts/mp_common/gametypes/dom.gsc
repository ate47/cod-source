                ...
                if ( defendedflag )
                {
                    ...
                    if ( level.playeroffensivemax >= attacker.dom_offends )
                    {
                        if ( var_1cfdf798 )
                        {
                            ...
                            level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:attacker, #eventtype:#"return" } );
...
function function_1609a882( var_c1e98979 )
{
    ...
    for ( var_268d0315 = 0; var_268d0315 < level.domflags.size ; var_268d0315++ )
    {
        ...
        function_92d1707f( #"dlog_event_flagcapturedata", var_93746b40 );
    }
}
