...
function onpickup( player )
{
    ...
    if ( isdefined( player ) && player.pers[ #"team" ] == team )
    {
        ...
        level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:player, #eventtype:#"return" } );
...
function onplayerkilled( *einflictor, attacker, *idamage, *smeansofdeath, weapon, *vdir, *shitloc, *psoffsettime, *deathanimduration )
{
    ...
    if ( isdefined( psoffsettime ) && isplayer( psoffsettime ) && psoffsettime.pers[ #"team" ] != self.pers[ #"team" ] )
    {
        ...
        level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:psoffsettime, #eventtype:#"kill_carrier" } );
