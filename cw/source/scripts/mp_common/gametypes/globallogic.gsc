...
function private function_e4335431()
{
    ...
    foreach ( stash in level.item_spawn_stashes )
    {
        ...
        {
            function_92d1707f( #"dlog_event_match_data_warzone_stash_spawn", #"entries", var_726f6c6 );
            var_726f6c6 = [];
            wait 0.1;
        }
    }
                ...
                if ( isdefined( category.items ) )
                {
                    foreach ( item_name, item in category.items )
                    {
                        ...
                        if ( item_data.size >= 100 )
                        {
                            ...
                            function_92d1707f( #"dlog_event_match_data_warzone_item_spawn", #"summary", var_cae7fe15, #"entries", item_data );
                            item_data = [];
                            wait 0.1;
                        }
                    }
...
function private function_54987b67()
{
    ...
    function_92d1707f( #"dlog_event_match_data_prematch", data );
}
