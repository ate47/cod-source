...
{
    loadouts = getscriptbundle( #"gungameloadouts" );
    
    if ( level.gametype === #"gun_rambo" )
    {
        loadouts = getscriptbundle( #"gungameloadoutsrambo" );
    }
...
// Size: 0x19c
function addguntoprogression( weaponname, attachmentslist, blueprintindex = 0, camoindex )
{
    ...
    {
        attachments = strtok( attachmentslist, " " );
...
function demoteplayer( attacker )
{
    ...
    if ( isdefined( attacker ) )
    {
        ...
        level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:attacker, #eventtype:#"capture" } );
    }
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:self, #eventtype:#"return" } );
