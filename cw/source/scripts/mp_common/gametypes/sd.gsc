...
function function_610d3790( einflictor, victim, *idamage, weapon )
{
    ...
    if ( isplayer( attacker ) && attacker.pers[ #"team" ] != idamage.pers[ #"team" ] && isdefined( idamage.isbombcarrier ) && idamage.isbombcarrier == 1 )
    {
        ...
        level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:attacker, #eventtype:#"kill_carrier" } );
...
function onuseplantobject( player )
{
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:player, #eventtype:#"plant" } );
    thread function_d45df32e();
}
...
function onusedefuseobject( player )
{
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:player, #eventtype:#"defuse" } );
}
...
function onpickup( player )
{
    ...
    level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:player, #eventtype:#"pickup" } );
...
function bombplanted( destroyedobj, player )
{
    ...
    if ( isdefined( destroyedobj.visuals[ 0 ] ) )
    {
        if ( isdefined( player ) )
        {
            ...
            level thread telemetry::function_18135b72( #"callback_on_game_event", { #player:player, #eventtype:#"destroy" } );
        }
        else
        {
