...
function private function_1f551f49()
{
    ...
    primaryitem = isdefined( game.var_96a8ff4a[ game.var_b6beb735 ].primary ) ? getitemindexfromref( game.var_96a8ff4a[ game.var_b6beb735 ].primary ) : -1;
    secondaryitem = isdefined( game.var_96a8ff4a[ game.var_b6beb735 ].secondary ) ? getitemindexfromref( game.var_96a8ff4a[ game.var_b6beb735 ].secondary ) : -1;
    ...
    tacticalitem = isdefined( game.var_96a8ff4a[ game.var_b6beb735 ].secondarygrenade ) ? getitemindexfromref( game.var_96a8ff4a[ game.var_b6beb735 ].secondarygrenade ) : -1;
    lethalitem = isdefined( game.var_96a8ff4a[ game.var_b6beb735 ].primarygrenade ) ? getitemindexfromref( game.var_96a8ff4a[ game.var_b6beb735 ].primarygrenade ) : -1;
    ...
    if ( isdefined( self ) )
    {
        self luinotifyevent( #"hash_76e8cddd9789122c", 6, primaryitem, var_26b5c8ef + 1, secondaryitem, var_4c0d0c4b + 1, tacticalitem, lethalitem );
    }
}
...
function givetalents( talents, var_1c89585f, var_285151c1 )
{
    ...
    if ( var_1c89585f === 1 )
    {
        talents[ talents.size ] = { #talent:#"talent_extraequipment" };
    }
    
    if ( var_285151c1 === 1 )
    {
        talents[ talents.size ] = { #talent:#"talent_extrasecondarygrenade" };
    }
...
function function_c4915ac()
{
    ...
    {
        axis_health += player.health;
    }
    
    if ( var_3a22d07b > axis_health )
    {
        endround( #"allies", 1 );
        return;
    }
