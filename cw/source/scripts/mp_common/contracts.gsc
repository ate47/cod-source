...
function contract_kills( data )
{
    ...
    switch ( weaponclass )
    {
        ...
        case #"weapon_grenade":
            ...
            if ( attacker function_db654c9( attacker.class_num, #"bonuscard_gearhound" ) )
            {
...
function on_ekia( weapon, victim )
{
    ...
    if ( isdefined( loadout_secondary_weapon ) && attacker function_db654c9( attacker.class_num, #"bonuscard_lawbreaker" ) )
    {
    ...
    if ( attacker hastalent( #"talent_espionage" ) )
    {
