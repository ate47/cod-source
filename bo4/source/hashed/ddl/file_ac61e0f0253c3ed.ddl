...
version 9 {
    ...
    int baselinepassedvaliditycheck;
    // offset 0x4e0, size 0x20
    int baselinebytesdifferenttotal;
    // offset 0x500, size 0x20
    float baselinepercentagecorrect;
    // offset 0x520, size 0xc0
    client_header client;
    // offset 0x5e0, size 0x20
    int baselinefilemissing;
    // offset 0x600, size 0x20
    int entitiesinbaseline;
