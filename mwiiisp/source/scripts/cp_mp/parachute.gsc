...
function startfreefall( falltime, popinstant, var_32dcb143b4eb723a, startingvelocity, isgulagrespawn, takeweapons )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::isbrstylegametype() && ( !istrue( isgulagrespawn ) || getdvar( @"scr_br_gametype", "" ) == "dmz" || getdvar( @"scr_br_gametype", "" ) == "exgm" || getdvar( @"scr_br_gametype", "" ) == "plunder" || getdvar( @"scr_br_gametype", "" ) == "risk" || getdvar( @"scr_br_gametype", "" ) == "resurgence" ) && getdvarint( @"hash_b99e3b3c6154ced8", 1 ) )
    {
        thread infilparachutevfx( getdvarint( @"hash_96e4167dd77b8cee", 1 ) == 1 && ( getdvar( @"scr_br_gametype", "" ) == "dmz" || getdvar( @"scr_br_gametype", "" ) == "exgm" || getdvar( @"scr_br_gametype", "" ) == "plunder" || getdvar( @"scr_br_gametype", "" ) == "risk" || getdvar( @"scr_br_gametype", "" ) == "resurgence" ) );
    }
...
function ffsm_introsetup( falltime, popinstant, var_32dcb143b4eb723a, startingvelocity, takeweapons )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::isbrstylegametype() && ( !istrue( self.ffsm_isgulagrespawn ) || getdvar( @"scr_br_gametype", "" ) == "dmz" || getdvar( @"scr_br_gametype", "" ) == "exgm" ) || getdvar( @"scr_br_gametype", "" ) == "plunder" || getdvar( @"scr_br_gametype", "" ) == "risk" || getdvar( @"scr_br_gametype", "" ) == "resurgence" )
    {
        thread infilparachutevfx( getdvarint( @"hash_96e4167dd77b8cee", 1 ) == 1 && ( getdvar( @"scr_br_gametype", "" ) == "dmz" || getdvar( @"scr_br_gametype", "" ) == "exgm" || getdvar( @"scr_br_gametype", "" ) == "plunder" || getdvar( @"scr_br_gametype", "" ) == "risk" || getdvar( @"scr_br_gametype", "" ) == "resurgence" ) );
    }
