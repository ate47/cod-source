...
function clampstepdamage( var_be4285b26ed99ab1, weapon, stepclamp )
{
    ...
    if ( stepclamp == 4 )
    {
        clampeddamage = weapon getmid3damage();
    }
    else if ( stepclamp == 3 )
    {
        clampeddamage = weapon getmid2damage();
    }
    else if ( stepclamp == 2 )
    {
        clampeddamage = weapon getmid1damage();
    }
    
    if ( clampeddamage <= 0 )
    {
        clampeddamage = weapon.mindamage;
    }
    
    if ( stepclamp == 1 || clampeddamage <= 0 )
    {
        clampeddamage = weapon.maxdamage;
    }
...
// Size: 0x68, Type: bool
function function_75c4f7172e4ef3f5( attacker, victim, lightarmordamage )
{
    return isdefined( victim ) && isdefined( victim.platecarrierlevel ) && victim.platecarrierlevel >= 2 && lightarmordamage > 0 && isdefined( victim.armorhealth ) && victim.armorhealth > 50;
}
...
// Size: 0x72, Type: bool
function function_3f09a25cb8c206ff( attacker, victim, lightarmordamage )
{
    return isdefined( victim ) && isdefined( victim.platecarrierlevel ) && isdefined( level.armorplateamount ) && victim.platecarrierlevel >= 3 && lightarmordamage > 0 && victim.armorhealth + lightarmordamage > level.armorplateamount * 2;
}
...
// Size: 0x6e, Type: bool
function function_78ea9ac6c9ab7305( attacker, victim, idamage, lightarmordamage )
{
    return isdefined( victim ) && isdefined( victim.platecarrierlevel ) && victim.platecarrierlevel >= 3 && armorvest_wasbroke( attacker ) && idamage == victim.maxhealth - 10 && lightarmordamage > 100;
}
