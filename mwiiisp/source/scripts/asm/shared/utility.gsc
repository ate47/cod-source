...
/#
    ...
    function function_d6919795e4b24d3a( asmname, statename, xanim, note )
    {
        ...
        {
            print( "<dev string:x1c>" + note + "<dev string:x64>" + asmname + "<dev string:x6d>" + statename + "<dev string:x76>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x7e>" );
    ...
    function function_37064c5f2a8f68ef( asmname, statename, xanim, note )
    {
        if ( animhasnotetrack( xanim, note ) )
        {
            print( "<dev string:x81>" + note + "<dev string:x64>" + asmname + "<dev string:x6d>" + statename + "<dev string:x76>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x7e>" );
            level.var_e941151b3a81c996 = 0;
        }
    }
    ...
    function function_6893c43c1838f552( asmname, statename, xanim, note1, note2 )
    {
        ...
        {
            print( "<dev string:xc9>" + note1 + "<dev string:x109>" + note2 + "<dev string:x64>" + asmname + "<dev string:x6d>" + statename + "<dev string:x76>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x7e>" );
            level.var_e941151b3a81c996 = 0;
        }
    }
    ...
    function function_3474c2003e05a5e0( asmname, statename, xanim, min_translation )
    {
        ...
        if ( d < min_translation )
        {
            ...
            level.var_e941151b3a81c996 = 0;
            println( "<dev string:x190>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x192>" + d );
        }
    }
    ...
    function function_7329f095ddbdb229( asmname, statename, xanim, notetrack, max_translation )
    {
        ...
        if ( animhasnotetrack( xanim, "<dev string:x19e>" ) )
        {
            ...
            {
                println( "<dev string:x1ff>" + asmname + "<dev string:x186>" + statename + "<dev string:x248>" + getxhashsourcename( getanimname( xanim ) ) );
            }
        ...
        if ( animhasnotetrack( xanim, "<dev string:x1a8>" ) )
        {
            ...
            {
                println( "<dev string:x24b>" + asmname + "<dev string:x186>" + statename + "<dev string:x248>" + getxhashsourcename( getanimname( xanim ) ) );
            }
        ...
        if ( animhasnotetrack( xanim, notetrack ) )
        {
            ...
            if ( notes.size != 1 )
            {
                println( "<dev string:x291>" + notetrack + "<dev string:x2c1>" + asmname + "<dev string:x186>" + statename + "<dev string:x248>" + getxhashsourcename( getanimname( xanim ) ) );
            }
        ...
        foreach ( xanim in xanims )
        {
            ...
            while ( t < 1 )
            {
                ...
                if ( d > tolerance )
                {
                    ...
                    level.var_e941151b3a81c996 = 0;
                    println( "<dev string:x190>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x192>" + d + "<dev string:x3a8>" + t );
                    break;
                }
            }
        }
            ...
            if ( isdefined( var_a401bfc2f3617031 ) )
            {
                ...
                foreach ( xanim in xanims )
                {
                    ...
                    if ( shoottimes.size < var_a401bfc2f3617031 )
                    {
                        ...
                        level.var_e941151b3a81c996 = 0;
                        println( "<dev string:x43e>" + alias + "<dev string:x445>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x447>" + shoottimes.size + "<dev string:x452>" + var_a401bfc2f3617031 );
                    }
                }
            }
        }
        ...
        foreach ( alias in aliases )
        {
            ...
            if ( isdefined( anims ) )
            {
                foreach ( xanim in anims )
                {
                    ...
                    {
                        print( "<dev string:x535>" + asmname + "<dev string:x6d>" + statename + "<dev string:x76>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x7e>" );
                        level.var_e941151b3a81c996 = 0;
                    }
                    
                    if ( !animhasnotetrack( xanim, "<dev string:x4ec>" ) && !animhasnotetrack( xanim, "<dev string:x4fa>" ) )
                    {
                        print( "<dev string:x5c9>" + asmname + "<dev string:x6d>" + statename + "<dev string:x76>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x7e>" );
                        level.var_e941151b3a81c996 = 0;
                    }
                }
            }
                ...
                foreach ( xanim in anims )
                {
                    ...
                    if ( animhasnotetrack( xanim, "<dev string:x65b>" ) )
                    {
                        ...
                        foreach ( note in ragdoll_times )
                        {
                            ...
                            {
                                print( "<dev string:x669>" + asmname + "<dev string:x6d>" + statename + "<dev string:x76>" + getxhashsourcename( getanimname( xanim ) ) + "<dev string:x7e>" );
                                level.var_e941151b3a81c996 = 0;
                            }
                        }
                    }
