...
{
    assertex( islinkedlist( self ), "This function requires that 'self' is a Linked List struct as defined in 'linked_list.gsc'" );
    linkedlist = self;
...
/#
    ...
    {
        assertex( islinkedlist( self ), "<dev string:x58>" );
