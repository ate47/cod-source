...
#namespace jup_enemy_rus_pmc_shotgun_tundra;

// Namespace jup_enemy_rus_pmc_shotgun_tundra / namespace_3298b8e1d9f2a39c
// Params 0
// Checksum 0x0, Offset: 0x238
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_shotgun_tundra" );
