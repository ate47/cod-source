...
#namespace c_jup_civ_russian_female_flashback;

// Namespace c_jup_civ_russian_female_flashback / namespace_2583a03a9e2022e8
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x13f
// Size: 0xb3
function private autoexec init()
{
    character = #"c_jup_civ_russian_female_flashback";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"c_jup_civ_russian_female_flashback" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "c_jup_civilian_russian_female_body_flashback", xmodelalias\c_jup_civilian_russian_female_body_flashback::main() );
