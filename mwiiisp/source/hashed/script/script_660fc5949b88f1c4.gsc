...
#namespace jup_ally_hero_tier0_rook;

// Namespace jup_ally_hero_tier0_rook / namespace_9e2613267d0b5324
// Params 0
// Checksum 0x0, Offset: 0x19a
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_tier0_rook" );
