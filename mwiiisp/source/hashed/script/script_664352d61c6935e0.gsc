...
#namespace jup_enemy_rus_pmc_smg_surge_plain;

// Namespace jup_enemy_rus_pmc_smg_surge_plain / namespace_2047004fd50fc072
// Params 0
// Checksum 0x0, Offset: 0x254
// Size: 0x1a4
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_smg_surge_plain" );
