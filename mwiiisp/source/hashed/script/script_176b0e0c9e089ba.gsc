...
#namespace jup_enemy_rus_pmc_smg;

// Namespace jup_enemy_rus_pmc_smg / namespace_ffdb81c7c912718c
// Params 0
// Checksum 0x0, Offset: 0x254
// Size: 0x1a4
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_smg" );
