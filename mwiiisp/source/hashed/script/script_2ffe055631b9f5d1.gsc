...
#namespace iw9_ally_frogman_smg;

// Namespace iw9_ally_frogman_smg / namespace_8ff1f03ff3deaa4d
// Params 0
// Checksum 0x0, Offset: 0x193
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"iw9_ally_frogman_smg" );
