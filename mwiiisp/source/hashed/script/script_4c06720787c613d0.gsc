...
#namespace jup_ally_hero_tier0_jumper02;

// Namespace jup_ally_hero_tier0_jumper02 / namespace_adc1ad64b1e3579c
// Params 0
// Checksum 0x0, Offset: 0x19a
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_tier0_jumper02" );
