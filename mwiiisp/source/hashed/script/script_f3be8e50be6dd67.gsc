...
#namespace jup_ally_hero_tier0_jumper03;

// Namespace jup_ally_hero_tier0_jumper03 / namespace_adc1ae64b1e359cf
// Params 0
// Checksum 0x0, Offset: 0x19a
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_tier0_jumper03" );
