...
#namespace jup_ally_prisoner_ar;

// Namespace jup_ally_prisoner_ar / namespace_e6e9c456557fa4c7
// Params 0
// Checksum 0x0, Offset: 0x248
// Size: 0x19e
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_prisoner_ar" );
