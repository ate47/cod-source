...
#namespace character_civilian_uk_girl_surge_2;

// Namespace character_civilian_uk_girl_surge_2 / namespace_fcc79a64792a590
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x123
// Size: 0xb3
function private autoexec init()
{
    character = #"character_civilian_uk_girl_surge_2";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_civilian_uk_girl_surge_2" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "bodies_civilian_uk_girl_surge_2", xmodelalias\bodies_civilian_uk_girl_surge_2::main() );
