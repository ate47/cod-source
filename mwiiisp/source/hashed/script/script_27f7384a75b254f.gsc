...
#namespace jup_enemy_paramedic_pistol;

// Namespace jup_enemy_paramedic_pistol / namespace_20ce016ccead3a63
// Params 0
// Checksum 0x0, Offset: 0x21f
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_paramedic_pistol" );
