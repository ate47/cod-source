...
#namespace character_civilian_uk_female_surge_1;

// Namespace character_civilian_uk_female_surge_1 / namespace_45725634a3b46597
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x129
// Size: 0xb3
function private autoexec init()
{
    character = #"character_civilian_uk_female_surge_1";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_civilian_uk_female_surge_1" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "bodies_civilian_uk_female_surge_1", xmodelalias\bodies_civilian_uk_female_surge_1::main() );
