...
#namespace jup_enemy_gulag_guard_shotgun_outdoor;

// Namespace jup_enemy_gulag_guard_shotgun_outdoor / namespace_d59b936cb48cd56f
// Params 0
// Checksum 0x0, Offset: 0x229
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_shotgun_outdoor" );
