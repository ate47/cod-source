...
#namespace jup_enemy_rus_kas_smg;

// Namespace jup_enemy_rus_kas_smg / namespace_5617ae2ef12904f5
// Params 0
// Checksum 0x0, Offset: 0x247
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_kas_smg" );
