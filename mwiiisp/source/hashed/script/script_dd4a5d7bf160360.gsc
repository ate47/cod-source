...
#namespace jup_enemy_hijack_pistol_01_jump;

// Namespace jup_enemy_hijack_pistol_01_jump / namespace_10a2eed382a85f62
// Params 0
// Checksum 0x0, Offset: 0x200
// Size: 0x17d
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_hijack_pistol_01_jump" );
