...
#namespace jup_ally_hero_shepherd_tundra;

// Namespace jup_ally_hero_shepherd_tundra / namespace_cfc02a16035e3a3c
// Params 0
// Checksum 0x0, Offset: 0x192
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_shepherd_tundra" );
