...
#namespace jup_civilian_hero_whiskey_surge;

// Namespace jup_civilian_hero_whiskey_surge / namespace_3f291ac74ec9eeb2
// Params 0
// Checksum 0x0, Offset: 0x1f5
// Size: 0x178
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_civilian_hero_whiskey_surge" );
