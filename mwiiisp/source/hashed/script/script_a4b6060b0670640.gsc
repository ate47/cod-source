...
#namespace jup_enemy_hijack_male_flight_attendant;

// Namespace jup_enemy_hijack_male_flight_attendant / namespace_c42d68991c04fa70
// Params 0
// Checksum 0x0, Offset: 0x17b
// Size: 0x17d
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_hijack_male_flight_attendant" );
