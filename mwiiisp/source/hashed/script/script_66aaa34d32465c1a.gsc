...
#namespace jup_enemy_gulag_guard_pistol_outdoor;

// Namespace jup_enemy_gulag_guard_pistol_outdoor / namespace_15a072d144523812
// Params 0
// Checksum 0x0, Offset: 0x217
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_pistol_outdoor" );
