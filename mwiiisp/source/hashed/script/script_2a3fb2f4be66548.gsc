...
#namespace jup_enemy_rus_pmc_jugg;

// Namespace jup_enemy_rus_pmc_jugg / namespace_bbb030b8600d169c
// Params 0
// Checksum 0x0, Offset: 0x179
// Size: 0x1b5
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_jugg" );
