...
#namespace jup_enemy_hijack_neighbor;

// Namespace jup_enemy_hijack_neighbor / namespace_9c713664b674cd1c
// Params 0
// Checksum 0x0, Offset: 0x183
// Size: 0x17d
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_hijack_neighbor" );
