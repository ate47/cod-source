...
#namespace jup_enemy_tier3_rus_pmc_ar;

// Namespace jup_enemy_tier3_rus_pmc_ar / namespace_d604183e2a7dc806
// Params 0
// Checksum 0x0, Offset: 0x289
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_tier3_rus_pmc_ar" );
