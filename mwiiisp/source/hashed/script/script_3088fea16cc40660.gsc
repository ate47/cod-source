...
#namespace jup_enemy_tier3_rus_pmc_lmg_tundra;

// Namespace jup_enemy_tier3_rus_pmc_lmg_tundra / namespace_6018446977cf5834
// Params 0
// Checksum 0x0, Offset: 0x277
// Size: 0x1d7
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_tier3_rus_pmc_lmg_tundra" );
