...
#namespace jup_enemy_gulag_guard_lmg;

// Namespace jup_enemy_gulag_guard_lmg / namespace_83e159c7a00a6b6e
// Params 0
// Checksum 0x0, Offset: 0x25a
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_lmg" );
