...
#namespace jup_enemy_rus_pmc_ar;

// Namespace jup_enemy_rus_pmc_ar / namespace_3782c28d501dd500
// Params 0
// Checksum 0x0, Offset: 0x269
// Size: 0x1ad
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_ar" );
