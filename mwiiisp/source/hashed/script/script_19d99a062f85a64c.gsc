...
#namespace jup_enemy_rus_pmc_shotgun_surge;

// Namespace jup_enemy_rus_pmc_shotgun_surge / namespace_50d8e2e45205a852
// Params 0
// Checksum 0x0, Offset: 0x240
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_shotgun_surge" );
