...
#namespace jup_enemy_rus_pmc_dmr;

// Namespace jup_enemy_rus_pmc_dmr / namespace_831ebc713267faa
// Params 0
// Checksum 0x0, Offset: 0x21c
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_dmr" );
