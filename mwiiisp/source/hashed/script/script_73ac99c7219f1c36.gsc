...
#namespace jup_enemy_gulag_guard_sniper_outdoor;

// Namespace jup_enemy_gulag_guard_sniper_outdoor / namespace_6acc88a90249ace2
// Params 0
// Checksum 0x0, Offset: 0x228
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_sniper_outdoor" );
