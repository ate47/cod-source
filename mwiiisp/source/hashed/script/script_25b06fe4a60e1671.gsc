...
#namespace jup_enemy_gulag_guard_smg;

// Namespace jup_enemy_gulag_guard_smg / namespace_c80b34c716a1990f
// Params 0
// Checksum 0x0, Offset: 0x25c
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_smg" );
