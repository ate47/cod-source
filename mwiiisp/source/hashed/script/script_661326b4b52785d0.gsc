...
#namespace jup_enemy_gulag_guard_dmr_outdoor;

// Namespace jup_enemy_gulag_guard_dmr_outdoor / namespace_ee3cbf395a7332e
// Params 0
// Checksum 0x0, Offset: 0x215
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_dmr_outdoor" );
