...
#namespace jup_enemy_villain_nolan_cp;

// Namespace jup_enemy_villain_nolan_cp / namespace_d2ef289f02992941
// Params 0
// Checksum 0x0, Offset: 0x1d9
// Size: 0x1ac
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_villain_nolan_cp" );
    self.health = 150;
    self.maxhealth = 150;
    ...
    sidearmweaponhash = "iw9_pi_golf18_sp, [ none, none, none, none, none, none ], none, none";
...
{
    return namespace_b5b898f27d57be99::main();
}
...
function precache()
{
    agent_type = "actor_jup_enemy_villain_nolan_cp";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        namespace_b5b898f27d57be99::precache_cpmp();
    }
...
function setup_weapons()
{
    ...
    {
        level.var_67b54180a55f70e1[ sidearmweaponhash ] = scripts\cp\cp_weapon::function_e83615f8a92e4378( "iw9_pi_golf18_sp", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
    }
