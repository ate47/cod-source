...
#namespace jup_ally_hero_tier0_rook_dive;

// Namespace jup_ally_hero_tier0_rook_dive / namespace_4fb7816211a801b
// Params 0
// Checksum 0x0, Offset: 0x19a
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_tier0_rook_dive" );
