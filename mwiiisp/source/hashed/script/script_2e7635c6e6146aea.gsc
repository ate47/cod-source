...
#namespace jup_enemy_rus_pmc_ar_surge_plain;

// Namespace jup_enemy_rus_pmc_ar_surge_plain / namespace_6a65963aa73528fe
// Params 0
// Checksum 0x0, Offset: 0x269
// Size: 0x1ad
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_ar_surge_plain" );
