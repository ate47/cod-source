...
#namespace jup_ally_hero_kyle_gunship;

// Namespace jup_ally_hero_kyle_gunship / namespace_e2e5bafb8bbadbf4
// Params 0
// Checksum 0x0, Offset: 0x1b9
// Size: 0x187
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_kyle_gunship" );
