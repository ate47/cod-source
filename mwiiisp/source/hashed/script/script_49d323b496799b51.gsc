...
#namespace jup_enemy_rus_pmc_rpg_surge;

// Namespace jup_enemy_rus_pmc_rpg_surge / namespace_e4e80e79c11972bf
// Params 0
// Checksum 0x0, Offset: 0x21e
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_rpg_surge" );
