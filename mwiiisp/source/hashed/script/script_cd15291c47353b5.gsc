...
#namespace jup_enemy_rus_pmc_smg_tundra;

// Namespace jup_enemy_rus_pmc_smg_tundra / namespace_6d15c7ba9b3a4519
// Params 0
// Checksum 0x0, Offset: 0x23c
// Size: 0x1a4
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_smg_tundra" );
