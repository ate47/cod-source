...
#namespace character_civilian_ams_female_1_sitting;

// Namespace character_civilian_ams_female_1_sitting / namespace_9d12fb931bb289c6
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x127
// Size: 0xb3
function private autoexec init()
{
    character = #"character_civilian_ams_female_1_sitting";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_civilian_ams_female_1_sitting" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "bodies_civilian_asm_female_1", xmodelalias\bodies_civilian_asm_female_1::main() );
