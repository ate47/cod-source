...
#namespace jup_civilian_prisoner;

// Namespace jup_civilian_prisoner / namespace_569f383cf98df722
// Params 0
// Checksum 0x0, Offset: 0x1f5
// Size: 0x178
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_civilian_prisoner" );
