...
#namespace c_jup_sp_hero_ghost_jump;

// Namespace c_jup_sp_hero_ghost_jump / namespace_cbc80e186b60e36a
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0xc0
// Size: 0x9a
function private autoexec init()
{
    character = #"c_jup_sp_hero_ghost_jump";
...
function main()
{
    ...
    self setmodel( "body_c_jup_sp_hero_ghost_jump" );
...
{
    precache();
    precachemodel( "body_c_jup_sp_hero_ghost_jump" );
