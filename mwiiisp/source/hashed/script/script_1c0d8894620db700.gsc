...
#namespace jup_civilian_uk_girl_surge;

// Namespace jup_civilian_uk_girl_surge / namespace_11ab61f433bdce18
// Params 0
// Checksum 0x0, Offset: 0x1fd
// Size: 0x178
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_civilian_uk_girl_surge" );
