...
#namespace jup_enemy_tier3_rus_pmc_smg_surge;

// Namespace jup_enemy_tier3_rus_pmc_smg_surge / namespace_267d26d3f2dbcd03
// Params 0
// Checksum 0x0, Offset: 0x27c
// Size: 0x1d7
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_tier3_rus_pmc_smg_surge" );
