...
#namespace character_civilian_uk_girl_surge_1;

// Namespace character_civilian_uk_girl_surge_1 / namespace_fcc7ca64792ac29
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x123
// Size: 0xb3
function private autoexec init()
{
    character = #"character_civilian_uk_girl_surge_1";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_civilian_uk_girl_surge_1" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "bodies_civilian_uk_girl_surge_1", xmodelalias\bodies_civilian_uk_girl_surge_1::main() );
