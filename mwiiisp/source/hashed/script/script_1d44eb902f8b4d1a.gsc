...
#namespace jup_civilian_hijack_unique_blocker_02;

// Namespace jup_civilian_hijack_unique_blocker_02 / namespace_a4685102e4d8a7f8
// Params 0
// Checksum 0x0, Offset: 0x1f5
// Size: 0x178
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_civilian_hijack_unique_blocker_02" );
