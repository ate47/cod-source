...
#namespace character_civilian_ams_male_2;

// Namespace character_civilian_ams_male_2 / namespace_e0af639dc8acb8c9
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x119
// Size: 0xb3
function private autoexec init()
{
    character = #"character_civilian_ams_male_2";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_civilian_ams_male_2" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "bodies_civilian_asm_male_2", xmodelalias\bodies_civilian_asm_male_2::main() );
