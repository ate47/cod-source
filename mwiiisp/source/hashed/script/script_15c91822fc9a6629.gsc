...
#namespace jup_enemy_cp_smg_tier1_security;

// Namespace jup_enemy_cp_smg_tier1_security / namespace_d039731e2aef1faf
// Params 0
// Checksum 0x0, Offset: 0x315
// Size: 0x228
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_cp_smg_tier1_security" );
...
function precache()
{
    agent_type = "actor_jup_enemy_cp_smg_tier1_security";
