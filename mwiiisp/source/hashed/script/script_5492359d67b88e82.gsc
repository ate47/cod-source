...
#namespace jup_enemy_gulag_guard_ar_outdoor;

// Namespace jup_enemy_gulag_guard_ar_outdoor / namespace_fee9ea2439e02eea
// Params 0
// Checksum 0x0, Offset: 0x235
// Size: 0x1a4
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_ar_outdoor" );
