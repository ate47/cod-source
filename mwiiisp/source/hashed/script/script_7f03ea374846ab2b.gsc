...
#namespace jup_ally_hero_soap_surge_b;

// Namespace jup_ally_hero_soap_surge_b / namespace_2511deaf593039ef
// Params 0
// Checksum 0x0, Offset: 0x192
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_soap_surge_b" );
