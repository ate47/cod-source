...
#namespace jup_enemy_rus_pmc_shotgun;

// Namespace jup_enemy_rus_pmc_shotgun / namespace_bcb7dc5e8fd35513
// Params 0
// Checksum 0x0, Offset: 0x240
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_shotgun" );
