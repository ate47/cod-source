...
#namespace jup_enemy_rus_pmc_smg_surge;

// Namespace jup_enemy_rus_pmc_smg_surge / namespace_6c3456c7d561341d
// Params 0
// Checksum 0x0, Offset: 0x254
// Size: 0x1a4
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_smg_surge" );
