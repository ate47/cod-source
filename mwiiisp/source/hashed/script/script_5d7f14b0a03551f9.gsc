...
#namespace jup_enemy_police_smg;

// Namespace jup_enemy_police_smg / namespace_20c357ee2942fa71
// Params 0
// Checksum 0x0, Offset: 0x23d
// Size: 0x1a4
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_police_smg" );
