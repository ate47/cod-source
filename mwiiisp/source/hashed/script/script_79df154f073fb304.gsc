...
#namespace jup_enemy_police_lmg;

// Namespace jup_enemy_police_lmg / namespace_ba4438edddc86044
// Params 0
// Checksum 0x0, Offset: 0x22c
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_police_lmg" );
