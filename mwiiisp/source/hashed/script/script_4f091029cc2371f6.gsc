...
#namespace jup_enemy_gulag_guard_shotgun;

// Namespace jup_enemy_gulag_guard_shotgun / namespace_70810daac77307f0
// Params 0
// Checksum 0x0, Offset: 0x259
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_gulag_guard_shotgun" );
