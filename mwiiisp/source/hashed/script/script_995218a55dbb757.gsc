...
#namespace c_jup_civ_london_female_03;

// Namespace c_jup_civ_london_female_03 / namespace_9ad8309fcc42344d
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x12b
// Size: 0xb3
function private autoexec init()
{
    character = #"c_jup_civ_london_female_03";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"c_jup_civ_london_female_03" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "test_alias_civ_london_female_3_body", xmodelalias\test_alias_civ_london_female_3_body::main() );
