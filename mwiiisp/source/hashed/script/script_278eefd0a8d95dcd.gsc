...
#namespace jup_civilian_rus_kas_female;

// Namespace jup_civilian_rus_kas_female / namespace_2c2b1960181c315b
// Params 0
// Checksum 0x0, Offset: 0x1f2
// Size: 0x178
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_civilian_rus_kas_female" );
