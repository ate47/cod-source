...
#namespace jup_enemy_hijack_pistol_02;

// Namespace jup_enemy_hijack_pistol_02 / namespace_6c95a875df844978
// Params 0
// Checksum 0x0, Offset: 0x200
// Size: 0x17d
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_hijack_pistol_02" );
