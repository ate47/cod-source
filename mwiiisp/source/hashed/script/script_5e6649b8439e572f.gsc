...
#namespace jup_enemy_rus_pmc_unique_silo_commander;

// Namespace jup_enemy_rus_pmc_unique_silo_commander / namespace_59a7330061daec29
// Params 0
// Checksum 0x0, Offset: 0x198
// Size: 0x188
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_unique_silo_commander" );
