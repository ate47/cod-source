...
#namespace jup_ally_hero_price_surge_b_bloody;

// Namespace jup_ally_hero_price_surge_b_bloody / namespace_d30b9c66c56b03e1
// Params 0
// Checksum 0x0, Offset: 0x228
// Size: 0x1a4
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_price_surge_b_bloody" );
