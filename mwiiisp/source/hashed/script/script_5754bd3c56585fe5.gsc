...
#namespace jup_civilian_rus_male_milbase_general;

// Namespace jup_civilian_rus_male_milbase_general / namespace_a6de9b54cf801a83
// Params 0
// Checksum 0x0, Offset: 0x1f5
// Size: 0x178
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_civilian_rus_male_milbase_general" );
