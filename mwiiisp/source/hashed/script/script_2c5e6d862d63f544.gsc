...
#namespace jup_enemy_tier3_rus_pmc_lmg_surge;

// Namespace jup_enemy_tier3_rus_pmc_lmg_surge / namespace_93461b8b9733218a
// Params 0
// Checksum 0x0, Offset: 0x277
// Size: 0x1d7
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_tier3_rus_pmc_lmg_surge" );
