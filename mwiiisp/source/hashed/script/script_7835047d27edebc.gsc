...
#namespace jup_enemy_rus_pmc_pistol;

// Namespace jup_enemy_rus_pmc_pistol / namespace_ed52b58a970c1298
// Params 0
// Checksum 0x0, Offset: 0x224
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_rus_pmc_pistol" );
