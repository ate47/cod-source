...
#namespace jup_spawner_zombie_deathworm_quest_s1;

// Namespace jup_spawner_zombie_deathworm_quest_s1 / namespace_7202ce0ccd61b1b9
// Params 0
...
function main()
{
    ...
    self.subclass_scriptbundle = getscriptbundle( %"hash_796e15528ece3777" );
