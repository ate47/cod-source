...
#namespace character_jup_zombie_base_male_long_shirt_gz_lightweight;

// Namespace character_jup_zombie_base_male_long_shirt_gz_lightweight / namespace_63c00250586da898
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0x10b
// Size: 0xb4
function private autoexec init()
{
    character = #"character_jup_zombie_base_male_long_shirt_gz_lightweight";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_jup_zombie_base_male_long_shirt_gz_lightweight" ] = &function_ecf17a96e49ab67;
        return;
    }
