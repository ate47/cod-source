...
function main()
{
    ...
    self.subclass_scriptbundle = getscriptbundle( %"ai_subclass:zombie_mangler" );
...
function precache()
{
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        level.agent_definition[ agent_type ][ "subclass" ] = getscriptbundle( %"ai_subclass:zombie_mangler" );
