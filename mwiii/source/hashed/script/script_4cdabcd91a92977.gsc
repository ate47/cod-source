...
function function_74b707898164ed78( reason, var_21907994a349f164, aeeventname, additionalkvps )
{
    ...
    self setplayerrejoinstate( 1, var_1517a9cfb1f4de62 );
}
...
function function_13399aa20634edce( aeeventname, var_1e904d14a41d4385 )
{
    ...
    {
        callsharedfunc( "challenges", "reportChallengeUserSerializedEventWrapper", function_6e2deb013c9ca85e( aeeventname ), var_1e904d14a41d4385 );
    }
}
