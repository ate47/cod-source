...
function main()
{
    ...
    self.subclass_scriptbundle = getscriptbundle( %"ai_subclass:zombie_base_armored_light" );
...
function precache()
{
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        level.agent_definition[ agent_type ][ "subclass" ] = getscriptbundle( %"ai_subclass:zombie_base_armored_light" );
