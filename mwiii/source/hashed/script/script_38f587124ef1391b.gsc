...
#namespace character_iw9_enemy_aq_ar_4;

// Namespace character_iw9_enemy_aq_ar_4 / namespace_fddc8368d2379337
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0xf9
// Size: 0xb4
function private autoexec init()
{
    character = #"character_iw9_enemy_aq_ar_4";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_iw9_enemy_aq_ar_4" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "bodies_iw9_enemy_aq_ar_4", xmodelalias\bodies_iw9_enemy_aq_ar_4::main() );
