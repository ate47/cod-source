...
{
    assertex( isdefined( self.grouppatrolname ) && self.grouppatrolname != "<dev string:x52>", "<dev string:x56>" );
...
function private function_7bcb65e6db709f70( patrolname, ent, followdistance, timestep )
{
    ...
    setaiformationleaderfollowdistance( level.formationlist[ patrolname ], followdistance );
...
function function_fded050d740c3e04( patrolname )
{
    if ( ai_formation::function_5e8d7d93ecffa23f( patrolname ) )
    {
        ...
        setaiformationleaderfollowdistance( level.formationlist[ patrolname ], 0 );
        leader = function_7a82c6e82e83e7d2( patrolname );
