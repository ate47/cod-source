...
#namespace character_iw9_enemy_aq_ar_5;

// Namespace character_iw9_enemy_aq_ar_5 / namespace_fddc8268d2379104
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0xf9
// Size: 0xb4
function private autoexec init()
{
    character = #"character_iw9_enemy_aq_ar_5";
    ...
    if ( issp() )
    {
        ...
        level.fncharacterxmodelalias[ %"character_iw9_enemy_aq_ar_5" ] = &function_ecf17a96e49ab67;
        return;
    }
...
function main()
{
    ...
    self setcharactermodelfromarray( "bodies_iw9_enemy_aq_ar_5", xmodelalias\bodies_iw9_enemy_aq_ar_5::main() );
