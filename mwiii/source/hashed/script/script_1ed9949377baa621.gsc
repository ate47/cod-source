...
function function_19e866494b6bb2d8( params )
{
    ...
    if ( isarray( instance.playerparticipants ) )
    {
        thread scripts\cp_mp\overlord::playevent( "quest_s1_rift_gate_unlock_contract_success", instance.playerparticipants, 3.5 );
    }
}
