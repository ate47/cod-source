...
version 1 {
    ...
    // root: bitSize: 0x1d78, members: 39
    ...
    // offset: 0x5c0, bitSize: 0x300(0x60 Byte(s)), array:0x18(hti:0xffff)
    uint utcRoundStartTimeSeconds[24];
    ...
    int cmdBurstHistogramRange;
    // offset: 0x950, bitSize: 0xd40(0x1a8 Byte(s))
    CommonMatchData commonMatchData;
    // offset: 0x1690, bitSize: 0x20(0x4 Byte(s))
    int serverScriptTimeTotal;
    // offset: 0x16b0, bitSize: 0x20(0x4 Byte(s))
    int serverScriptTimeMax;
