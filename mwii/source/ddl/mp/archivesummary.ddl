...
version 1 {
    // enums ..... 0 (0x0)
    // structs ... 2 (0x2)
    // bit size .. 49016 (0xbf78)
    // byte size . 6127 (0x17ef)
    // archive ... hash_248bef4b67df5b0b
    ...
    // root: bitSize: 0xbec8, members: 12
    ...
    uint matchLength;
    // offset: 0xbce0, bitSize: 0x20(0x4 Byte(s))
    int compassBuildID;
    // offset: 0xbd00, bitSize: 0x20(0x4 Byte(s))
    int dataBuildNumber;
    // offset: 0xbd20, bitSize: 0x40(0x8 Byte(s))
    uint64 serverGUID;
    // offset: 0xbd60, bitSize: 0x100(0x20 Byte(s))
    string(32) gametype;
    // offset: 0xbe60, bitSize: 0x20(0x4 Byte(s))
    int codeBuildNumber;
    // offset: 0xbe80, bitSize: 0x40(0x8 Byte(s))
    uint64 hostXUID;
    // offset: 0xbec0, bitSize: 0x1
    bool isHostDedi;
};
