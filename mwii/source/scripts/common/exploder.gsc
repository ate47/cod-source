...
addinitexploders( potentialexploders )
{
...
setupexploders()
{
    ...
    foreach ( exploder in level.init_exploders )
    {
        ...
        if ( isdefined( exploder.target ) )
        {
            ...
            {
                get_ent = scripts\engine\utility::get_target_ent( ent.v["target"] );
...
exploder_flag_wait( msg, exploderarray )
{
...
stop_exploder_proc( num, players, bkill )
{
    num = num + "";
...
stop_clientside_exploder( explodername, players, bkill )
{
...
brush_show()
{
    ...
    if ( !is_struct && scripts\common\utility::issp() && self.model.spawnflags & 1 )
    {
...
fire_effect()
{
    ...
    if ( isdefined( firefxsound ) )
        scripts\engine\utility::loop_fx_sound( firefxsound, origin, 1, ender );
