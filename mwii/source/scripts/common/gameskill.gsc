...
apply_difficulty_settings_shared( current_frac )
{
...
get_difficultysetting_frac( setting, frac )
{
    return get_difficultysetting( setting ) * frac;
}

get_difficultysetting( setting, gameskill )
{
...
get_difficultysetting_global( setting )
{
