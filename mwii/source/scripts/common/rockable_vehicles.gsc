...
rockable_car_watch_death()
{
    ...
    if ( isexplosivedamagemod( self.rockable_last_meansofdeath ) )
    {
        ...
        forwardstr = scripts\engine\utility::ter_op( vectordot( self.forward, btwn ) > 0, "front", "back" );
        rightstr = scripts\engine\utility::ter_op( vectordot( self.right, btwn ) > 0, "right", "left" );
