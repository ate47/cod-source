...
bb_isrequestedstance_refresh( asmname, statename, tostatename, params )
{
    requestedstance = scripts\asm\shared\utility::determinerequestedstance();
    return requestedstance == params;
}

bb_isrequestedstanceanddemeanor( asmname, statename, tostatename, params )
{
    return self._blackboard.desiredstance == params[0] && scripts\asm\asm::asm_getdemeanor() == params[1];
}

bb_setisincombat( bincombat )
{
...
bb_isweaponclass( asmname, statename, tostatename, params )
{
    return weaponclass( self.weapon ) == params;
}

bb_shoulddroprocketlauncher( asmname, statename, tostatename, params )
{
...
bb_requestcoverexposetype( exposetype )
{
...
bb_hadcovernode( asmname, statename, tostatename, params )
{
...
bb_requestturretpose( pose )
{
    self._blackboard.requestedturretpose = pose;
}

bb_hasshufflenode( asmname, statename, tostatename, params )
{
...
bb_meleeinprogress( asmname, statename, tostatename, params )
{
    return isdefined( self._blackboard.meleerequestedcomplete );
}

bb_meleecomplete( asmname, statename, tostatename, params )
{
...
bb_meleerequestinvalid( asmname, statename, tostatename, params )
{
    if ( !self.in_melee )
        return 1;
...
bb_meleechargeaborted( asmname, statename, tostatename, params )
{
...
bb_requestgrenadereturnthrow( bthrow )
{
...
bb_ispartdismembered( asmname, statename, tostatename, params )
{
...
bb_waspartjustdismembered( asmname, statename, tostatename, params )
{
    return waspartjustdismembered( params );
}

bb_werepartsdismemberedinorder( asm, statename, tostatename, params )
{
...
bb_setcanrodeo( side, _id_E7096CE45CDA4606 )
{
    ...
    self._blackboard.rodeo[side] = _id_E7096CE45CDA4606;
}
...
bb_isrodeorequested( asmname, statename, tostatename, params )
{
...
bb_canplaygesture( asmname, statename, tostatename, gesture )
{
