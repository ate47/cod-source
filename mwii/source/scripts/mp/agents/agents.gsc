...
add_humanoid_agent( agent_type, team, class, optional_spawnorigin, optional_spawnangles, optional_owner, _id_9FEE3FE2E8DDD1F3, respawn_on_death, difficulty, classcallback, disableloadout, _id_B72E32B38F8041C6, disablehealthregen, disablebattlechatter )
{
    ...
    if ( isdefined( agent ) )
        agent thread [[ agent scripts\mp\agents\agent_utility::agentfunc( "spawn" ) ]]( optional_spawnorigin, optional_spawnangles, optional_owner, _id_9FEE3FE2E8DDD1F3, respawn_on_death, difficulty, disableloadout, _id_B72E32B38F8041C6, disablehealthregen, disablebattlechatter );

    return agent;
}

spawn_agent_player( optional_spawnorigin, optional_spawnangles, optional_owner, _id_9FEE3FE2E8DDD1F3, respawn_on_death, difficulty, disableloadout, _id_B72E32B38F8041C6, disablehealthregen, disablebattlechatter )
{
    ...
    newspawnorigin = playerphysicstrace( _id_095E3F96CA970054, _id_EC89DA43F5A8E18D );

    if ( distancesquared( newspawnorigin, _id_095E3F96CA970054 ) > 1 )
    ...
    if ( isdefined( optional_owner ) )
        scripts\mp\agents\agent_utility::set_agent_team( optional_owner.team, optional_owner );
...
watchownerstatus( notifymsg, owner )
{
...
on_agent_generic_damaged( einflictor, eattacker, idamage, idflags, smeansofdeath, sweapon, vpoint, vdir, shitloc, timeoffset, modelindex, partname )
{
    ...
    if ( isdefined( eattacker ) && eattacker != self && idamage > 0 && ( !isdefined( shitloc ) || shitloc != "shield" ) )
    {
        ...
        eattacker _id_5762AC2F22202BA2::updatedamagefeedback( typehit, idamage >= self.health );
    }
