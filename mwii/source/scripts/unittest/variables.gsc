...
local()
{
    ...
    c = "hi";
    d = "bye0";
    scripts\unittest\util::test_print( "constant: " + a + " " + b + " " + c + " " + d );
    a = 0;
    b = a;
    b = 2;
    c = b;
    a = a;
    scripts\unittest\util::test_print( "assign: " + a + " " + b + " " + c + " " + d );
    c = 0;
    a = 1;
    b = 2;
    d = 3;
    scripts\unittest\util::test_print( "constant 2: " + a + " " + b + " " + c + " " + d );
    v = ( 0, 0, 0 );
    ...
    u = undefined;
    scripts\unittest\util::test_print( "u: " + isdefined( u ) );
    s0 = spawnstruct();
    s = s0;
    s = spawnstruct();
    a0 = [];
...
is_true_print( val, name )
{
    ...
    d = isdefined( val );
    scripts\unittest\util::test_print( "is_true: " + name + ": " + b + " isdefined: " + d );
}
