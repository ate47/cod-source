...
eq( x, y, xstr, ystr )
{
    ...
    scripts\unittest\util::test_print( xstr + " == " + ystr + ": " + z );
}
...
limit( i, str )
{
    scripts\unittest\util::test_print( i + " == " + str );
}
...
types()
{
    ...
    y = 2;
    z0 = x + y + x;
    scripts\unittest\util::test_print( "z0: " + z0 );
    z1 = z0 + x + y;
    scripts\unittest\util::test_print( "z1: " + z1 );
    z2 = z1 + 1.0;
    scripts\unittest\util::test_print( "z2: " + z2 );
    z3 = z2 + "ok";
    scripts\unittest\util::test_print( "z3: " + z3 );
    z4 = z3 + "bye";
    scripts\unittest\util::test_print( "z4: " + z4 );
}
