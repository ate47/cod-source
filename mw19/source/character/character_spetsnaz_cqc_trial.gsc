...
main()
{
    self setmodel( "_encstr_84FF1412AF502807C5EB5AA276963762801FB794D320" );
    scripts\code\character::attachhead( "_encstr_8CB71086AC16196EFAD5DC5B1BFADA0B36B2", xmodelalias\heads_usmc_male::main() );
    self.hatmodel = "_encstr_81431628CF597078C3CEC3AFCDC9A6FACA7A3B560F129D97";
...
precache()
{
    precachemodel( "_encstr_84FF1412AF502807C5EB5AA276963762801FB794D320" );
    scripts\code\character::precachemodelarray( xmodelalias\heads_usmc_male::main() );
    precachemodel( "_encstr_81431628CF597078C3CEC3AFCDC9A6FACA7A3B560F129D97" );
}
