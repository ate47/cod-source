...
main()
{
    self setmodel( "_encstr_84E0156AA07DB781F0870513C790D65713D931C2AB58C6" );
    scripts\code\character::attachhead( "_encstr_8CB71086AC16196EFAD5DC5B1BFADA0B36B2", xmodelalias\heads_usmc_male::main() );
    self.hatmodel = "_encstr_B8B81743CAD8ADACE8FA5DB9DA8DEBC416B95A6CF52CC9FA99";
...
precache()
{
    precachemodel( "_encstr_84E0156AA07DB781F0870513C790D65713D931C2AB58C6" );
    scripts\code\character::precachemodelarray( xmodelalias\heads_usmc_male::main() );
    precachemodel( "_encstr_B8B81743CAD8ADACE8FA5DB9DA8DEBC416B95A6CF52CC9FA99" );
}
