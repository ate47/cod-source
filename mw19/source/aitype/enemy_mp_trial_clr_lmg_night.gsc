...
main()
{
    ...
    self.accuracy = 0.3;
    self.weapon = scripts\mp\class::buildweapon( "_encstr_A2650D3B7B57574AFFAF4BDCA3811A", [ "_encstr_A5060F368537594E27C273ECACD74CB093" ], "_encstr_8BBA05185F8B99", "_encstr_8BBA05185F8B99" );
...
precache()
{
    var_0 = "_encstr_ADDA239B3B4B28763712F099FAC7B860E2AF0935A9F6F828FF9A0BC6D24F6C393DE1A7995C";
